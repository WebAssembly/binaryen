...
public:
  ...
  static const Address::address32_t kDefaultPageSize = 1<<16;
  static const Address::address32_t kDefaultPageSizeLog2 = 16;
  static const Address::address32_t kDefaultMaxSize32 = 1<<16;
