...
class Block : public SpecificExpression<Expression::BlockId> {
  Block() {}
  Block(MixedArena& allocator) : Block(), list(allocator) {}
  Name name;
  ExpressionList list;
  void finalize();
...
class Switch : public SpecificExpression<Expression::SwitchId> {
  Switch() { type = Type::unreachable; }
  Switch(MixedArena& allocator) : Switch(), targets(allocator) {}
...
class Call : public SpecificExpression<Expression::CallId> {
  Call() {}
  Call(MixedArena& allocator) : Call(), operands(allocator) {}
...
class CallIndirect : public SpecificExpression<Expression::CallIndirectId> {
  CallIndirect() {}
  CallIndirect(MixedArena& allocator) : CallIndirect(), operands(allocator) {}
  Signature sig;
  ExpressionList operands;
  Expression* target;
  Bool isReturn = false;
...
class Throw : public SpecificExpression<Expression::ThrowId> {
  Throw() {}
  Throw(MixedArena& allocator) : Throw(), operands(allocator) {}
  Name event;
  ExpressionList operands;
  void finalize();
};
...
class TupleMake : public SpecificExpression<Expression::TupleMakeId> {
  TupleMake() {}
  TupleMake(MixedArena& allocator) : TupleMake(), operands(allocator) {}
  ExpressionList operands;
  void finalize();
};
