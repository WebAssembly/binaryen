...
static bool willRemoveDebugInfo(const std::vector<OptimizationOptions::PassInfo>& passes) {
...
int main(int argc, const char* argv[]) {
  ...
  auto exitOnInvalidWasm = [&](const char* message) {
    ...
    if (std::any_of(options.passes.begin(), options.passes.end(), [](const OptimizationOptions::PassInfo& info) {
