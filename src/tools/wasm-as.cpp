...
int main(int argc, const char* argv[]) {
  ...
  Options options("wasm-as",
    "Assemble a .wast (WebAssembly text format) into a .wasm (WebAssembly binary format)");
  ...
  options
    ...
    .add("--source-map", "-sm", "Emit source map to the specified file", Options::Arguments::One,
      [&sourceMapFilename](
    ...
    .add("--symbolmap", "-s", "Emit a symbol map (indexes => names)", Options::Arguments::One,
