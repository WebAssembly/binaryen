...
static void generateCAPIDecl() {
  std::cout << "// src/binaryen-c.autogen.h\n";

  // TODO: convert all Expression classes to be autogenerated. For now, generate
  // from a specified list.

  autogenCAPIDecl<StructNew>();
  autogenCAPIDecl<StructGet>();
  autogenCAPIDecl<StructSet>();
}
