...
WasmBinaryReader::copyImportable(uint32_t kind, Importable& details) {
  switch (kind) {
    case ExternalKind::Function:
    case ExternalKind::Function | BinaryConsts::ExactImport:
      return wasm::copyImportable<Function>(details);
    case ExternalKind::Table:
      return wasm::copyImportable<Table>(details);
    case ExternalKind::Memory:
      return wasm::copyImportable<Memory>(details);
    case ExternalKind::Global:
      return wasm::copyImportable<Global>(details);
    case ExternalKind::Tag:
      return wasm::copyImportable<Tag>(details);
  }
  WASM_UNREACHABLE("unexpected kind");
}
