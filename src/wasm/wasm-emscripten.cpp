...
struct FixInvokeFunctionNamesWalker : public PostWalker<FixInvokeFunctionNamesWalker> {
  ...
  FixInvokeFunctionNamesWalker(Module& _wasm) : wasm(_wasm) {
    importRenames["emscripten_longjmp_jmpbuf"] = "emscripten_longjmp";
    toRemove.push_back("emscripten_longjmp_jmpbuf");
  }
  ...
  void visitImport(Import* curr) {
    ...
    Name newname = fixEmExceptionInvoke(curr->name, getSig(func));
