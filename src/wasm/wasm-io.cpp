...
void ModuleReader::readText(fs::path filename, Module& wasm) {
...
void ModuleReader::readBinary(fs::path filename,
                              Module& wasm,
                              fs::path sourceMapFilename) {
...
bool ModuleReader::isBinaryFile(fs::path filename) {
  std::ifstream infile;
...
void ModuleReader::read(fs::path filename,
                        Module& wasm,
                        fs::path sourceMapFilename) {
...
void ModuleWriter::writeText(Module& wasm, fs::path filename) {
...
void ModuleWriter::writeBinary(Module& wasm, fs::path filename) {
...
void ModuleWriter::write(Module& wasm, fs::path filename) {
