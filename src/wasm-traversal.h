...
#define DELEGATE(CLASS_TO_VISIT)                                                                   \
  return static_cast<SubType*>(this)->visit##CLASS_TO_VISIT(static_cast<CLASS_TO_VISIT*>(curr))
...
template <typename SubType, typename ReturnType = void> struct OverriddenVisitor {
...
#define UNIMPLEMENTED(CLASS_TO_VISIT)                                                              \
  ReturnType visit##CLASS_TO_VISIT(CLASS_TO_VISIT* curr) {                                         \
    static_assert(&SubType::visit##CLASS_TO_VISIT !=                                               \
...
//
template <typename SubType, typename VisitorType> struct Walker : public VisitorType {
  ...
  Expression* replaceCurrent(Expression* expression) { return *replacep = expression; }
  ...
  static void doVisitCallImport(SubType* self, Expression** currp) {
    self->visitCallImport((*currp)->cast<CallImport>());
  }
  ...
  static void doVisitAtomicWake(SubType* self, Expression** currp) {
    self->visitAtomicWake((*currp)->cast<AtomicWake>());
  }
...
struct PostWalker : public Walker<SubType, VisitorType> {
  ...
  static void scan(SubType* self, Expression** currp) {
    ...
    switch (curr->_id) {
      ...
      case Expression::Id::GetLocalId: {
        self->pushTask(
          SubType::doVisitGetLocal, currp); // TODO: optimize leaves with a direct call?
        break;
      }
      case Expression::Id::SetLocalId: {
...
struct ExpressionStackWalker : public PostWalker<SubType, VisitorType> {
  ...
  static void doPostVisit(SubType* self, Expression** currp) { self->expressionStack.pop_back(); }
...
struct LinearExecutionWalker : public PostWalker<SubType, VisitorType> {
  ...
  static void doNoteNonLinear(SubType* self, Expression** currp) { self->noteNonLinear(*currp); }
