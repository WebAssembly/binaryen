...
// to implement Abstract Interpretation with a transfer function that combines
// values with minimal type-based processing. A more detailed comparison between
// the algorithms can be found in the PDF at media/jfs_ai.pdf where the
// algorithm implemented here is called "Just Flow Stuff" (derogatory).
//
