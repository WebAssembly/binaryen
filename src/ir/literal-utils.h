...
inline Literal makeLiteralZero(Type type) { return makeLiteralFromInt32(0, type); }
...
inline Expression* makeZero(Type type, Module& wasm) { return makeFromInt32(0, type, wasm); }
