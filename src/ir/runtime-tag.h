...
class RuntimeTag {
public:
  RuntimeTag(const Tag& tagDefinition) : definition(&tagDefinition) {}
  RuntimeTag(RuntimeTag&& other) : definition(other.definition) {}
  // RuntimeTag(const RuntimeTag&) = delete;
  ...
  // friend bool operator==(const Tag& lhs, const RuntimeTag& rhs) {
  //     return &lhs == rhs.definition;
  // }
};
