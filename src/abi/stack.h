...
getStackSpace(Index local, Function* func, Index size, Module& wasm) {
  ...
  // This function expects to see code that was generated by Emscripten, and
  // further relies on a particular code idiom, specifically, the inclusion
  // of an exported function "stackSave" with a specific structure, from which
  // the identity of the global stack pointer (STACKTOP) may be inferred.
  //
  // We expect to find the module structured as follows:
  //
  //(module
  //  ...
