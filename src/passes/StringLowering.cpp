...
struct StringLowering : public StringGathering {
  ...
  void replaceInstructions(Module* module) {
    ...
    fromCharCodeArraySharedImport =
      addImport(module,
                "fromCharCodeArray",
                {nullSharedArray16, Type::i32, Type::i32},
                nnSharedExt);
    ...
    lengthSharedImport = addImport(module, "length", nullSharedExt, Type::i32);
    ...
    struct Replacer : public WalkerPass<PostWalker<Replacer>> {
      ...
      void visitStringNew(StringNew* curr) {
        ...
        auto& fromCodePointImport = shared ? lowering.fromCodePointSharedImport
                                           : lowering.fromCodePointImport;
      ...
      void visitStringEncode(StringEncode* curr) {
        ...
        auto& intoCharCodeArrayImport =
          shared ? lowering.intoCharCodeArraySharedImport
                 : lowering.intoCharCodeArrayImport;
        switch (curr->op) {
          case StringEncodeWTF16Array:
            replaceCurrent(
              builder.makeCall(intoCharCodeArrayImport,
      ...
      void visitStringTest(StringTest* curr) {
        ...
        auto& testImport =
          shared ? lowering.testSharedImport : lowering.testImport;
        replaceCurrent(builder.makeCall(testImport, {curr->ref}, Type::i32));
      }
      ...
      void visitStringMeasure(StringMeasure* curr) {
        ...
        replaceCurrent(builder.makeCall(lengthImport, {curr->ref}, Type::i32));
      }
      ...
      void visitStringSliceWTF(StringSliceWTF* curr) {
        ...
        auto nnExt = shared ? lowering.nnSharedExt : lowering.nnExt;
        replaceCurrent(builder.makeCall(
          substringImport, {curr->ref, curr->start, curr->end}, nnExt));
      }
    };
