...
// Utility class for inferring the proper WebAssembly types for unreachable
// control flow expressions and eliminating the redundant unreachable
// instructions generated by BinaryenIRWriter. After unreachable lowering, the
// only expressions that still have Unreachable type are Unreachables.
struct UnreachableLowerer
  ...
  // The public entry point of this class
  void lower(Function* func, Module* module) {
...
void Stackifier::emitFunctionEnd() {
  ...
  UnreachableLowerer().lower(func, module);
}
