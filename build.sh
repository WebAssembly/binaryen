...
g++ -O2 -std=c++11 src/binaryen-shell.cpp -g -o bin/binaryen-shell -msse2 -mfpmath=sse # use sse for math, avoid x87, necessarily for proper float rounding on 32-bit
