...
def find_end(module, start):
    # Find the index one past the closing parenthesis corresponding to the last
    # open parenthesis before `start`.
    depth = 1
    for end in range(start, len(module)):
        if depth == 0:
            break
        elif module[end] == '(':
            depth += 1
