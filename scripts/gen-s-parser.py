...
instructions = [
    ...
    ("struct.get_s",         "makeStructGet(s, Packed::Signed)"),
    ("struct.get_u",         "makeStructGet(s, Packed::Unsigned)"),
    ...
    ("array.get_s",         "makeArrayGet(s, Packed::Signed)"),
    ("array.get_u",         "makeArrayGet(s, Packed::Unsigned)"),
