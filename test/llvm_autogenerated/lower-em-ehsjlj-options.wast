(module
 ...
 (func $setThrew (param $0 i32) (param $1 i32) ;; 2
  (block $label$0
   (br_if $label$0
    (i32.load offset=12
     (i32.const 0)
 ...
 (func $setTempRet0 (param $0 i32) ;; 3
  (i32.store offset=20
   (i32.const 0)
   (get_local $0)
  )
 ...
 (func $__wasm_nullptr (type $FUNCSIG$v) ;; 7
  (unreachable)
 )
 (func $__importThunk_foo (type $FUNCSIG$v) ;; 8
  (call $foo)
 )
