(module
 ...
 (func $byval_arg_align8 (; 1 ;) (param $0 i32)
  (local $1 i32)
  (i32.store offset=4
   (i32.const 0)
   (tee_local $1
 ...
 (func $byval_arg_double (; 2 ;) (param $0 i32)
  (local $1 i32)
  (i32.store offset=4
   (i32.const 0)
   (tee_local $1
 ...
 (func $byval_param (; 3 ;) (param $0 i32)
  (call $ext_func
   (get_local $0)
  )
  (return)
 )
 (func $byval_empty_caller (; 4 ;) (param $0 i32)
  (call $ext_byval_func_empty
   (get_local $0)
  )
  (return)
 )
 (func $byval_empty_callee (; 5 ;) (param $0 i32)
  (call $ext_func_empty
   (get_local $0)
  )
  (return)
 )
 (func $big_byval (; 6 ;) (param $0 i32)
  (local $1 i32)
  (i32.store offset=4
   (i32.const 0)
   (tee_local $1
