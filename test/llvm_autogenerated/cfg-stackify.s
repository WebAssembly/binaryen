...
.LBB20_4:
	...
	i32.const	$push18=, 0
	i32.const	$push2=, 5
	i32.store	$drop=, 0($pop18), $pop2
	i32.const	$push17=, 0
	i32.eqz 	$push20=, $pop17
	br_if   	2, $pop20
.LBB20_6:
	end_block
	i32.const	$push10=, 0
