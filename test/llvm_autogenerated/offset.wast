(module
 ...
 (func $load_i32_with_folded_offset (param $0 i32) (result i32) ;; 0
  (i32.load offset=24
   (get_local $0)
  )
 )
 (func $load_i32_with_folded_gep_offset (param $0 i32) (result i32) ;; 1
  (i32.load offset=24
   (get_local $0)
  )
 )
 (func $load_i32_with_unfolded_gep_negative_offset (param $0 i32) (result i32) ;; 2
  (i32.load
   (i32.add
    (get_local $0)
    (i32.const -24)
 ...
 (func $load_i32_with_unfolded_offset (param $0 i32) (result i32) ;; 3
  (i32.load
   (i32.add
    (get_local $0)
    (i32.const 24)
 ...
 (func $load_i32_with_unfolded_gep_offset (param $0 i32) (result i32) ;; 4
  (i32.load
   (i32.add
    (get_local $0)
    (i32.const 24)
 ...
 (func $load_i64_with_folded_offset (param $0 i32) (result i64) ;; 5
  (i64.load offset=24
   (get_local $0)
  )
 )
 (func $load_i64_with_folded_gep_offset (param $0 i32) (result i64) ;; 6
  (i64.load offset=24
   (get_local $0)
  )
 )
 (func $load_i64_with_unfolded_gep_negative_offset (param $0 i32) (result i64) ;; 7
  (i64.load
   (i32.add
    (get_local $0)
    (i32.const -24)
 ...
 (func $load_i64_with_unfolded_offset (param $0 i32) (result i64) ;; 8
  (i64.load
   (i32.add
    (get_local $0)
    (i32.const 24)
 ...
 (func $load_i64_with_unfolded_gep_offset (param $0 i32) (result i64) ;; 9
  (i64.load
   (i32.add
    (get_local $0)
    (i32.const 24)
 ...
 (func $load_i32_with_folded_or_offset (param $0 i32) (result i32) ;; 10
 ...
 (func $store_i32_with_folded_offset (param $0 i32) ;; 11
  (i32.store offset=24
   (get_local $0)
   (i32.const 0)
  )
 )
 (func $store_i32_with_folded_gep_offset (param $0 i32) ;; 12
  (i32.store offset=24
   (get_local $0)
   (i32.const 0)
  )
 )
 (func $store_i32_with_unfolded_gep_negative_offset (param $0 i32) ;; 13
  (i32.store
   (i32.add
    (get_local $0)
    (i32.const -24)
 ...
 (func $store_i32_with_unfolded_offset (param $0 i32) ;; 14
  (i32.store
   (i32.add
    (get_local $0)
    (i32.const 24)
 ...
 (func $store_i32_with_unfolded_gep_offset (param $0 i32) ;; 15
  (i32.store
   (i32.add
    (get_local $0)
    (i32.const 24)
 ...
 (func $store_i64_with_folded_offset (param $0 i32) ;; 16
  (i64.store offset=24
   (get_local $0)
   (i64.const 0)
  )
 )
 (func $store_i64_with_folded_gep_offset (param $0 i32) ;; 17
  (i64.store offset=24
   (get_local $0)
   (i64.const 0)
  )
 )
 (func $store_i64_with_unfolded_gep_negative_offset (param $0 i32) ;; 18
  (i64.store
   (i32.add
    (get_local $0)
    (i32.const -24)
 ...
 (func $store_i64_with_unfolded_offset (param $0 i32) ;; 19
  (i64.store
   (i32.add
    (get_local $0)
    (i32.const 24)
 ...
 (func $store_i64_with_unfolded_gep_offset (param $0 i32) ;; 20
  (i64.store
   (i32.add
    (get_local $0)
    (i32.const 24)
 ...
 (func $store_i32_with_folded_or_offset (param $0 i32) ;; 21
  (i32.store8 offset=2
   (i32.and
    (get_local $0)
    (i32.const -4)
 ...
 (func $load_i32_from_numeric_address (result i32) ;; 22
  (i32.load offset=42
   (i32.const 0)
  )
 )
 (func $load_i32_from_global_address (result i32) ;; 23
  (i32.load offset=12
   (i32.const 0)
  )
 )
 ...
 (func $load_i8_s_with_folded_offset (param $0 i32) (result i32) ;; 26
  (i32.load8_s offset=24
   (get_local $0)
  )
 )
 (func $load_i8_s_with_folded_gep_offset (param $0 i32) (result i32) ;; 27
  (i32.load8_s offset=24
   (get_local $0)
  )
 )
 (func $load_i8_u_with_folded_offset (param $0 i32) (result i32) ;; 28
  (i32.load8_u offset=24
   (get_local $0)
  )
 )
 (func $load_i8_u_with_folded_gep_offset (param $0 i32) (result i32) ;; 29
  (i32.load8_u offset=24
   (get_local $0)
  )
 )
 (func $store_i8_with_folded_offset (param $0 i32) ;; 30
  (i32.store8 offset=24
   (get_local $0)
   (i32.const 0)
  )
 )
 (func $store_i8_with_folded_gep_offset (param $0 i32) ;; 31
  (i32.store8 offset=24
   (get_local $0)
   (i32.const 0)
  )
 )
 (func $aggregate_load_store (param $0 i32) (param $1 i32) ;; 32
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (set_local $2
 ...
 (func $aggregate_return (param $0 i32) ;; 33
 ...
 (func $aggregate_return_without_merge (param $0 i32) ;; 34
 ...
 (func $stackSave (result i32) ;; 35
  (i32.load offset=4
   (i32.const 0)
  )
 )
 (func $stackAlloc (param $0 i32) (result i32) ;; 36
  (local $1 i32)
  (set_local $1
   (i32.load offset=4
    (i32.const 0)
 ...
 (func $stackRestore (param $0 i32) ;; 37
  (i32.store offset=4
   (i32.const 0)
   (get_local $0)
  )
