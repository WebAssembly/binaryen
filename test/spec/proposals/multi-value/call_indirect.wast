...
(module
  ...
  (func $id-i32-f64 (type $over-i32-f64) (get_local 0) (get_local 1))
  (func $swap-i32-i64 (type $swap-i32-i64) (get_local 1) (get_local 0))
...
(assert_trap (invoke "dispatch" (i32.const 26) (i64.const 2)) "undefined element")
