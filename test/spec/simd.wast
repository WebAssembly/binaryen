(module
 ...
 (func (export "v128.store") (param $0 i32) (param $1 v128) (v128.store offset=0 align=16 (get_local $0) (get_local $1)))
 (func (export "v128.const") (result v128) (v128.const i32 1 2 3 4))
 (func (export "v128.shuffle") (param $0 v128) (param $1 v128) (result v128) (v8x16.shuffle 0 17 2 19 4 21 6 23 8 25 10 27 12 29 14 31 (get_local $0) (get_local $1)))
 (func (export "i8x16.splat") (param $0 i32) (result v128) (i8x16.splat (get_local $0)))
 (func (export "i8x16.extract_lane_s") (param $0 v128) (result i32) (i8x16.extract_lane_s 0 (get_local $0)))
 (func (export "i8x16.extract_lane_u") (param $0 v128) (result i32) (i8x16.extract_lane_u 0 (get_local $0)))
 (func (export "i8x16.replace_lane") (param $0 v128) (param $1 i32) (result v128) (i8x16.replace_lane 0 (get_local $0) (get_local $1)))
 (func (export "i16x8.splat") (param $0 i32) (result v128) (i16x8.splat (get_local $0)))
 (func (export "i16x8.extract_lane_s") (param $0 v128) (result i32) (i16x8.extract_lane_s 0 (get_local $0)))
 (func (export "i16x8.extract_lane_u") (param $0 v128) (result i32) (i16x8.extract_lane_u 0 (get_local $0)))
 (func (export "i16x8.replace_lane") (param $0 v128) (param $1 i32) (result v128) (i16x8.replace_lane 0 (get_local $0) (get_local $1)))
 (func (export "i32x4.splat") (param $0 i32) (result v128) (i32x4.splat (get_local $0)))
 (func (export "i32x4.extract_lane") (param $0 v128) (result i32) (i32x4.extract_lane 0 (get_local $0)))
 (func (export "i32x4.replace_lane") (param $0 v128) (param $1 i32) (result v128) (i32x4.replace_lane 0 (get_local $0) (get_local $1)))
 (func (export "i64x2.extract_lane") (param $0 v128) (result i64) (i64x2.extract_lane 0 (get_local $0)))
 (func (export "i64x2.replace_lane") (param $0 v128) (param $1 i64) (result v128) (i64x2.replace_lane 0 (get_local $0) (get_local $1)))
 (func (export "f32x4.splat") (param $0 f32) (result v128) (f32x4.splat (get_local $0)))
 (func (export "f32x4.extract_lane") (param $0 v128) (result f32) (f32x4.extract_lane 0 (get_local $0)))
 (func (export "f32x4.replace_lane") (param $0 v128) (param $1 f32) (result v128) (f32x4.replace_lane 0 (get_local $0) (get_local $1)))
 (func (export "f64x2.splat") (param $0 f64) (result v128) (f64x2.splat (get_local $0)))
 (func (export "f64x2.extract_lane") (param $0 v128) (result f64) (f64x2.extract_lane 0 (get_local $0)))
 (func (export "f64x2.replace_lane") (param $0 v128) (param $1 f64) (result v128) (f64x2.replace_lane 0 (get_local $0) (get_local $1)))
