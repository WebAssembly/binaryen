...
;; Alternative Syntax 2: new opcodes
;;
;; (func $test2 (export "test2")
;;   (i32.array.store
;;     (global.get $arr_4)
...
(assert_invalid
  (module
    ...
    (func (export "i32_set_immutable") (param $a (ref $a))
      (i32.store type=array (local.get $a) (i32.const 0) (i32.const 1))
    )
  )
  "array is immutable"
)
...
(module
  ...
  (func (export "i32.store_array_null")
    (local (ref null $t)) (i32.store type=array (local.get 0) (i32.const 0) (i32.const 0))
  )
)
