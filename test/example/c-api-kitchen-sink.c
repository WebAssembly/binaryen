...
void test_core() {
  ...
  BinaryenExpressionRef eqrefExpr = BinaryenRefNull(module, BinaryenTypeEqref());
  // TODO: BinaryenExpressionRef i31refExpr = BinaryenI31New(module, makeInt32(module, 0)),
  ...
  BinaryenExpressionRef valueList[] = {
    ...
    BinaryenSelect(module,
                   ...
                   BinaryenTypeFuncref()),
    // GC
    BinaryenRefEq(module, eqrefExpr, BinaryenRefNull(module, BinaryenTypeEqref())),
    // Exception handling
