...
int main() {
  ...
  the_relooper = RelooperCreate();
  {
    ...
    expressions[1] = BinaryenBlock(the_module, "bb0", children, 0, BinaryenNone());
  }
  ...
  expressions[5] = BinaryenReturn(the_module, expressions[0]);
  {
    ...
    expressions[6] = BinaryenBlock(the_module, "bb1", children, 2, BinaryenNone());
  }
  ...
  }
  {
    ...
    expressions[15] = BinaryenBlock(the_module, NULL, children, 2, BinaryenNone());
  }
