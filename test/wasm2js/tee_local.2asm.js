...
function asmFunc(global, env, buffer) {
 ...
 function $9($0_1, $1, $2_1) {
  ...
  $2_1 = +$2_1;
  var $3_1 = 0, $4_1 = 0;
  $2_1 = +($0_1 >>> 0) + 4294967296.0 * +($1 >>> 0) + (-.30000001192092896 + ($2_1 + 52.5));
  $0_1 = ~~$2_1 >>> 0;
  if (Math_abs($2_1) >= 1.0) {
   {
    if ($2_1 > 0.0) {
     $3_1 = ~~Math_min(Math_floor($2_1 / 4294967296.0), 4294967295.0) >>> 0
    } else {
     $3_1 = ~~Math_ceil(($2_1 - +(~~$2_1 >>> 0 >>> 0)) / 4294967296.0) >>> 0
    }
    $4_1 = $3_1;
   }
  } else {
 ...
 function legalstub$10($0_1, $1, $2_1, $3_1, $4_1, $5) {
  return 34.8;
 }
