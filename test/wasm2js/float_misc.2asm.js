...
function asmFunc(env) {
 ...
 function $7(x, y) {
  x = Math_fround(x);
  y = Math_fround(y);
  return Math_fround((wasm2js_scratch_store_i32(2, (wasm2js_scratch_store_f32(x), wasm2js_scratch_load_i32(2)) & 2147483647 | (wasm2js_scratch_store_f32(y), wasm2js_scratch_load_i32(2)) & -2147483648), wasm2js_scratch_load_f32()));
 }
