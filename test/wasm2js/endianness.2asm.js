...
function asmFunc(global, env, buffer) {
 ...
 function i32_store_little($0, $1) {
  i16_store_little($0, $1);
  i16_store_little($0 + 2 | 0, $1 >>> 16);
 }
 
 function i64_store_little($0, $1) {
  i32_store_little(0, $0);
  i32_store_little(4, $1);
 }
 ...
 function i32_load_little($0) {
  return i16_load_little($0) | i16_load_little($0 + 2 | 0) << 16;
 }
 
 function i64_load_little() {
  var $0 = 0;
  $0 = i32_load_little(0);
  i64toi32_i32$HIGH_BITS = i32_load_little(4);
  return $0;
 }
 
 function $6($0) {
  $0 = $0 | 0;
  i16_store_little(0, $0);
  return HEAP16[0 >> 1] | 0;
 }
 ...
 function $14($0) {
  $0 = Math_fround($0);
  i32_store_little(0, (wasm2js_scratch_store_f32($0), wasm2js_scratch_load_i32(0)));
 ...
 function $15($0) {
  ...
  i64_store_little(wasm2js_scratch_load_i32(0 | 0) | 0, $1);
  return +HEAPF64[0 >> 3];
 }
 ...
 function legalstub$13($0, $1) {
  i64_store_little($0, $1);
  $0 = HEAP32[0 >> 2];
  i64toi32_i32$HIGH_BITS = HEAP32[4 >> 2];
  setTempRet0(i64toi32_i32$HIGH_BITS | 0);
  return $0;
 }
