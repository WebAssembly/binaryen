...
function asmFunc(global, env) {
 ...
 function $9($0_1, $0$hi, $1_1, $2_1, $3_1, $4_1) {
  ...
  i64toi32_i32$0 = $0$hi;
  i64toi32_i32$1 = $0_1;
  $10 = +(i64toi32_i32$1 >>> 0) + +(i64toi32_i32$0 >>> 0) * 4294967296.0;
  i64toi32_i32$0 = $6$hi;
  i64toi32_i32$1 = 6;
  $21 = +(i64toi32_i32$1 >>> 0) + +(i64toi32_i32$0 >>> 0) * 4294967296.0;
  i64toi32_i32$0 = $7$hi;
  i64toi32_i32$1 = $7_1;
  i64toi32_i32$3 = $10 + (+Math_fround(-.30000001192092896) + ($2_1 + (+(40 >>> 0) + (+(-7 | 0) + (+Math_fround(5.5) + ($21 + (+(i64toi32_i32$1 >>> 0) + +(i64toi32_i32$0 >>> 0) * 4294967296.0 + 8.0)))))));
  if (Math_abs(i64toi32_i32$3) >= 1.0) {
   if (i64toi32_i32$3 > 0.0) {
    $14 = ~~Math_min(Math_floor(i64toi32_i32$3 * 2.3283064365386963e-10), 4294967296.0 - 1.0) >>> 0
   } else {
    $14 = ~~Math_ceil((i64toi32_i32$3 - +(~~i64toi32_i32$3 >>> 0 >>> 0)) * 2.3283064365386963e-10) >>> 0
   }
   $15 = $14;
  } else {
   $15 = 0
 ...
 function legalstub$9($0_1, $1_1, $2_1, $3_1, $4_1, $5_1) {
  ...
  if ((i64toi32_i32$3 & 63 | 0) >>> 0 >= 32 >>> 0) {
   ...
   $17 = (i64toi32_i32$0 & ((1 << i64toi32_i32$4 | 0) - 1 | 0) | 0) << (32 - i64toi32_i32$4 | 0) | 0 | (i64toi32_i32$1 >>> i64toi32_i32$4 | 0) | 0;
  }
  setTempRet0($17 | 0);
  i64toi32_i32$2 = $6$hi;
  return $6_1 | 0;
