	.text
	.file	"/b/build/slave/linux/build/src/src/work/gcc/gcc/testsuite/gcc.c-torture/execute/20040705-2.c"
...
# BB#0:                                 # %entry
	i32.const	$push0=, 0
	i32.const	$push9=, 0
	i32.load	$push8=, b($pop9):p2align=3
...
# BB#0:                                 # %entry
	i32.const	$push0=, 0
	i32.const	$push11=, 0
	i32.load	$push10=, b($pop11):p2align=3
...
# BB#0:                                 # %entry
	i32.const	$push0=, 0
	i32.const	$push9=, 0
	i32.load	$push8=, c($pop9):p2align=3
	tee_local	$push7=, $1=, $pop8
	i32.add 	$push1=, $pop7, $0
	i32.const	$push2=, 31
	i32.and 	$push3=, $pop1, $pop2
...
# BB#0:                                 # %entry
	i32.const	$push0=, 0
	i32.const	$push11=, 0
	i32.load	$push10=, c($pop11):p2align=3
	tee_local	$push9=, $1=, $pop10
	i32.const	$push1=, 5
	i32.shl 	$push2=, $0, $pop1
	i32.add 	$push3=, $pop9, $pop2
...
# BB#0:                                 # %entry
	i32.const	$push0=, 0
	i32.const	$push10=, 0
	i32.load	$push9=, b($pop10):p2align=3
...
# BB#0:                                 # %entry
	i32.const	$push0=, 0
	i32.const	$push10=, 0
	i32.load	$push9=, c($pop10):p2align=3
	tee_local	$push8=, $1=, $pop9
	i32.const	$push1=, 1
	i32.add 	$push2=, $pop8, $pop1
	i32.const	$push3=, 31
...
# BB#0:                                 # %entry
	i32.const	$push0=, 0
	i32.const	$push13=, 0
	i32.load	$push12=, b($pop13):p2align=3
...
# BB#0:                                 # %entry
	i32.const	$push0=, 0
	i32.const	$push13=, 0
	i32.load	$push12=, c($pop13):p2align=3
	tee_local	$push11=, $1=, $pop12
	i32.const	$push1=, 5
	i32.shr_u	$push2=, $pop11, $pop1
	i32.const	$push3=, 1
...
# BB#0:                                 # %entry
	i32.const	$push0=, 0
	i32.const	$push14=, 0
	i32.load	$push13=, b($pop14):p2align=3
...
# BB#0:                                 # %entry
	i32.const	$push0=, 0
	i32.const	$push12=, 0
	i32.load	$push11=, b($pop12):p2align=3
...
# BB#0:                                 # %entry
	i32.const	$push0=, 0
	i32.const	$push14=, 0
	i32.load	$push13=, c($pop14):p2align=3
	tee_local	$push12=, $1=, $pop13
	i32.const	$push1=, 5
	i32.shr_u	$push2=, $pop12, $pop1
	i32.const	$push3=, 1
...
# BB#0:                                 # %entry
	i32.const	$push0=, 0
	i32.const	$push12=, 0
	i32.load	$push11=, c($pop12):p2align=3
	tee_local	$push10=, $1=, $pop11
	i32.const	$push1=, 6
	i32.shr_u	$push2=, $pop10, $pop1
	i32.const	$push3=, 19
