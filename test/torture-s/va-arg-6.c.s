...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop51), $pop57
	i32.store	$drop=, 12($4), $1
	i32.const	$push0=, 4
	i32.add 	$push56=, $1, $pop0
	tee_local	$push55=, $2=, $pop56
	i32.store	$drop=, 12($4), $pop55
	block
	i32.load	$push1=, 0($1)
	i32.const	$push2=, 10
...
# BB#9:                                 # %if.end41
	...
	i32.store	$drop=, __stack_pointer($pop54), $pop53
	return  	$4
.LBB0_10:                               # %if.then40
	end_block                       # label0:
	call    	abort@FUNCTION
