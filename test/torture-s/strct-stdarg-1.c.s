...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop31), $pop36
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop38), $pop63
	i32.const	$push0=, 11
	i32.store8	$drop=, 53($2), $pop0
	i32.const	$push39=, 48
	...
	i32.store16	$drop=, 48($2), $pop3
	i32.const	$push4=, 21
	i32.store8	$drop=, 54($2), $pop4
	i32.const	$push5=, 30
	i32.store8	$drop=, 50($2), $pop5
	i32.const	$push6=, 12
	i32.store8	$drop=, 58($2), $pop6
	i32.const	$push7=, 31
