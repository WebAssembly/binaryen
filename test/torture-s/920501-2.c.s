...
.LBB1_5:                                # %for.body4
	...
	i32.const	$push15=, 1
	i32.const	$push14=, -2
	i32.add 	$push2=, $3, $pop14
	i32.shl 	$push3=, $pop15, $pop2
...
facts:                                  # @facts
	...
	.local  	i64, i64, i64, i32, i64, i64, i64, i64, i64, i32, i32, i32
# BB#0:                                 # %entry
...
.LBB2_6:                                # %for.body4.i
	...
	i32.shl 	$push3=, $pop48, $pop2
	i32.and 	$push4=, $pop3, $3
	i32.eqz 	$push101=, $pop4
	br_if   	0, $pop101      # 0: down to label20
# BB#7:                                 # %if.then5.i
...
.LBB2_11:                               # %for.body.i114
	...
	i32.add 	$2=, $2, $pop56
	i32.const	$push55=, 1
	i32.shr_u	$push54=, $1, $pop55
	tee_local	$push53=, $1=, $pop54
	br_if   	0, $pop53       # 0: up to label21
# BB#12:                                # %for.end.i116
                                        #   in Loop: Header=BB2_1 Depth=1
	end_loop                        # label22:
	block
...
.LBB2_14:                               # %for.body4.i125
	...
	i32.const	$push60=, 1
	i32.const	$push59=, -2
	i32.add 	$push9=, $2, $pop59
	i32.shl 	$push10=, $pop60, $pop9
	i32.and 	$push11=, $pop10, $3
	i32.eqz 	$push102=, $pop11
	br_if   	0, $pop102      # 0: down to label27
# BB#15:                                # %if.then5.i128
                                        #   in Loop: Header=BB2_14 Depth=2
	i64.mul 	$push12=, $10, $9
	i64.rem_u	$10=, $pop12, $0
...
.LBB2_19:                               # %for.body.i88
	...
	i32.add 	$2=, $2, $pop68
	i32.const	$push67=, 1
	i32.shr_u	$push66=, $1, $pop67
	tee_local	$push65=, $1=, $pop66
	br_if   	0, $pop65       # 0: up to label28
# BB#20:                                # %for.end.i90
                                        #   in Loop: Header=BB2_1 Depth=1
	end_loop                        # label29:
	i32.const	$push69=, 1
	i32.lt_s	$push14=, $2, $pop69
...
.LBB2_22:                               # %for.body4.i99
                                        ...
                                        # =>  This Inner Loop Header: Depth=2
	loop                            # label30:
	i64.mul 	$push15=, $10, $10
	i64.rem_u	$10=, $pop15, $0
	block
	i32.const	$push72=, 1
	i32.const	$push71=, -2
	i32.add 	$push16=, $2, $pop71
	i32.shl 	$push17=, $pop72, $pop16
	i32.and 	$push18=, $pop17, $3
	i32.eqz 	$push103=, $pop18
	br_if   	0, $pop103      # 0: down to label32
# BB#23:                                # %if.then5.i102
                                        #   in Loop: Header=BB2_22 Depth=2
	i64.mul 	$push19=, $10, $12
	i64.rem_u	$10=, $pop19, $0
...
.LBB2_26:                               # %powmod_ll.exit107
	...
	i64.sub 	$push23=, $11, $pop79
	i64.sub 	$push22=, $9, $11
	i64.gt_u	$push21=, $11, $9
	i64.select	$push24=, $pop23, $pop22, $pop21
	i64.const	$push78=, 4294967295
	i64.and 	$push25=, $pop24, $pop78
	i64.const	$push77=, 4294967295
	i64.and 	$push26=, $8, $pop77
...
.LBB2_32:                               # %gcd_ll.exit
	...
	end_block                       # label34:
	i32.add 	$14=, $15, $14
	i32.wrap/i64	$push90=, $10
	tee_local	$push89=, $2=, $pop90
	i32.const	$push88=, 1
	i32.eq  	$push32=, $pop89, $pop88
	br_if   	0, $pop32       # 0: down to label33
# BB#33:                                # %if.then26
                                        #   in Loop: Header=BB2_1 Depth=1
	i32.store	$drop=, 0($13), $2
	i64.const	$push94=, 4294967295
	i64.and 	$push33=, $10, $pop94
	i64.div_u	$push93=, $0, $pop33
	tee_local	$push92=, $0=, $pop93
	i64.const	$push91=, 1
	i64.eq  	$push34=, $pop92, $pop91
...
.LBB2_35:                               # %for.inc
	...
	i32.const	$push96=, 10000
	i32.lt_s	$push35=, $pop97, $pop96
...
# BB#0:                                 # %entry
	...
	i32.wrap/i64	$push7=, $pop15
	i32.const	$push8=, 7
	i32.ne  	$push9=, $pop7, $pop8
	br_if   	0, $pop9        # 0: down to label37
# BB#1:                                 # %entry
	i64.const	$push6=, -4294967296
	i64.and 	$push0=, $0, $pop6
