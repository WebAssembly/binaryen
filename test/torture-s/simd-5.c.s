...
# BB#0:                                 # %entry
	i32.const	$push0=, 0
	i32.load16_u	$1=, q1+4($pop0)
	i32.const	$push41=, 0
	i32.load16_u	$2=, q1+2($pop41)
	i32.const	$push40=, 0
	i32.load16_u	$3=, q1($pop40)
	i32.const	$push39=, 0
	i32.load16_u	$6=, q2($pop39)
	i32.const	$push38=, 0
	i32.load16_u	$5=, q2+2($pop38)
	i32.const	$push37=, 0
	i32.load16_u	$4=, q2+4($pop37)
	i32.const	$push36=, 0
	i32.load16_u	$7=, q3+6($pop36)
	i32.const	$push35=, 0
	i32.load16_u	$8=, q3+4($pop35)
	i32.const	$push34=, 0
	i32.load16_u	$9=, q3+2($pop34)
	i32.const	$push33=, 0
	i32.load16_u	$10=, q3($pop33)
	i32.const	$push32=, 0
	i32.load16_u	$14=, q4($pop32)
	i32.const	$push31=, 0
	i32.load16_u	$13=, q4+2($pop31)
	i32.const	$push30=, 0
	i32.load16_u	$12=, q4+4($pop30)
	i32.const	$push29=, 0
	i32.load16_u	$11=, q4+6($pop29)
	i32.const	$push28=, 0
	i32.const	$push27=, 0
	...
	i32.store16	$0=, w1+6($pop28), $pop6
	i32.const	$push25=, 0
	i32.mul 	$push5=, $4, $1
	i32.store16	$1=, w1+4($pop25), $pop5
	i32.const	$push24=, 0
	i32.mul 	$push4=, $5, $2
	i32.store16	$2=, w1+2($pop24), $pop4
	i32.const	$push23=, 0
	i32.mul 	$push3=, $6, $3
	i32.store16	$3=, w1($pop23), $pop3
	i32.const	$push22=, 0
	i32.mul 	$push10=, $11, $7
	i32.store16	$6=, w2+6($pop22), $pop10
	i32.const	$push21=, 0
	i32.mul 	$push9=, $12, $8
	i32.store16	$5=, w2+4($pop21), $pop9
	i32.const	$push20=, 0
	i32.mul 	$push8=, $13, $9
	i32.store16	$4=, w2+2($pop20), $pop8
	i32.const	$push19=, 0
	i32.mul 	$push7=, $14, $10
...
# BB#0:                                 # %entry
	...
	i32.store16	$0=, z1+6($pop28), $pop6
	i32.const	$push25=, 0
	i32.add 	$push5=, $4, $1
	i32.store16	$1=, z1+4($pop25), $pop5
	i32.const	$push24=, 0
	i32.add 	$push4=, $5, $2
	i32.store16	$2=, z1+2($pop24), $pop4
	i32.const	$push23=, 0
	i32.add 	$push3=, $6, $3
	i32.store16	$3=, z1($pop23), $pop3
	i32.const	$push22=, 0
	i32.sub 	$push10=, $7, $11
	i32.store16	$6=, z2+6($pop22), $pop10
	i32.const	$push21=, 0
	i32.sub 	$push9=, $8, $12
	i32.store16	$5=, z2+4($pop21), $pop9
	i32.const	$push20=, 0
	i32.sub 	$push8=, $9, $13
	i32.store16	$4=, z2+2($pop20), $pop8
	i32.const	$push19=, 0
	i32.sub 	$push7=, $10, $14
