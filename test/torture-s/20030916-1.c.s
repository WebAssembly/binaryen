...
# BB#0:                                 # %entry
	...
	i64.const	$push22=, 0
	i64.store	$drop=, 0($pop2):p2align=2, $pop22
	i32.const	$push3=, 16
	i32.add 	$push4=, $0, $pop3
	i64.const	$push21=, 0
	i64.store	$drop=, 0($pop4):p2align=2, $pop21
	i32.const	$push5=, 8
	i32.add 	$push6=, $0, $pop5
	i64.const	$push20=, 0
	i64.store	$drop=, 0($pop6):p2align=2, $pop20
	i32.const	$push7=, 0
	i32.store	$drop=, 992($0), $pop7
	i32.const	$push8=, 1020
	i32.add 	$push9=, $0, $pop8
	i32.const	$push19=, 0
	i32.store	$drop=, 0($pop9), $pop19
	i32.const	$push10=, 1012
	i32.add 	$push11=, $0, $pop10
	i64.const	$push18=, 0
	i64.store	$drop=, 0($pop11):p2align=2, $pop18
	i32.const	$push12=, 1004
	i32.add 	$push13=, $0, $pop12
	i64.const	$push17=, 0
	i64.store	$drop=, 0($pop13):p2align=2, $pop17
	i32.const	$push14=, 996
	i32.add 	$push15=, $0, $pop14
	i64.const	$push16=, 0
	i64.store	$drop=, 0($pop15):p2align=2, $pop16
                                        # fallthrough-return
	.endfunc
.Lfunc_end0:
	.size	f, .Lfunc_end0-f
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop24), $pop25
	i32.const	$0=, 0
.LBB1_1:                                # %for.body
...
# BB#2:                                 # %for.end
	...
	i64.const	$push39=, 0
	i64.store	$drop=, 0($pop6), $pop39
	i32.const	$1=, 0
	i32.const	$push7=, 1020
	i32.add 	$push8=, $2, $pop7
	i32.const	$push38=, 0
	i32.store	$drop=, 0($pop8), $pop38
	i32.const	$push9=, 1012
	i32.add 	$push10=, $2, $pop9
	i64.const	$push37=, 0
	i64.store	$drop=, 0($pop10):p2align=2, $pop37
	i32.const	$push11=, 1004
	i32.add 	$push12=, $2, $pop11
	i64.const	$push36=, 0
	i64.store	$drop=, 0($pop12):p2align=2, $pop36
	i32.const	$push13=, 996
	i32.add 	$push14=, $2, $pop13
	i64.const	$push35=, 0
	i64.store	$drop=, 0($pop14):p2align=2, $pop35
	i64.const	$push34=, 0
	i64.store	$drop=, 8($2), $pop34
	i64.const	$push33=, 0
	i64.store	$drop=, 0($2), $pop33
	i32.const	$push32=, 0
	i32.store	$drop=, 992($2), $pop32
	copy_local	$0=, $2
.LBB1_3:                                # %for.body3
                                        # =>This Inner Loop Header: Depth=1
	block
	...
	br_if   	2, $pop18       # 2: down to label2
# BB#4:                                 # %for.cond1
