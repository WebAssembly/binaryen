...
.LBB0_4:                                # %for.body9
	...
	i32.const	$push62=, 65
	i32.const	$push61=, 24
	i32.shl 	$push2=, $6, $pop61
	i32.const	$push60=, 24
	i32.shr_s	$push3=, $pop2, $pop60
	i32.const	$push59=, 95
	i32.gt_s	$push4=, $pop3, $pop59
	i32.select	$push5=, $pop62, $6, $pop4
...
# BB#6:                                 # %for.cond21.preheader
	...
	br_if   	0, $pop10       # 0: down to label12
.LBB0_7:                                # %for.body24
                                        #   Parent Loop BB0_1 Depth=1
                                        #     Parent Loop BB0_2 Depth=2
                                        #       Parent Loop BB0_3 Depth=3
...
.LBB0_11:                               # %for.body38
	...
	i32.const	$push73=, 65
	i32.const	$push72=, 24
	i32.shl 	$push14=, $6, $pop72
	i32.const	$push71=, 24
	i32.shr_s	$push15=, $pop14, $pop71
	i32.const	$push70=, 95
	i32.gt_s	$push16=, $pop15, $pop70
	i32.select	$push0=, $pop73, $6, $pop16
	tee_local	$push69=, $6=, $pop0
	i32.const	$push68=, 255
	i32.and 	$push17=, $pop69, $pop68
	i32.ne  	$push20=, $pop19, $pop17
	br_if   	10, $pop20      # 10: down to label1
# BB#12:                                # %for.inc50
...
# BB#13:                                # %for.end54
	...
	br_if   	7, $pop22       # 7: down to label2
# BB#14:                                # %for.cond61.preheader
	...
	br_if   	6, $pop25       # 6: down to label3
# BB#15:                                # %for.cond61
                                        #   in Loop: Header=BB0_3 Depth=3
	i32.const	$push80=, 2
	...
	br_if   	6, $pop28       # 6: down to label3
# BB#16:                                # %for.cond61.1
                                        #   in Loop: Header=BB0_3 Depth=3
	i32.const	$push86=, 3
	...
	br_if   	6, $pop31       # 6: down to label3
# BB#17:                                # %for.cond61.2
                                        #   in Loop: Header=BB0_3 Depth=3
	i32.const	$push88=, 4
	...
	br_if   	6, $pop34       # 6: down to label3
# BB#18:                                # %for.cond61.3
                                        #   in Loop: Header=BB0_3 Depth=3
	i32.const	$push90=, 5
	...
	br_if   	6, $pop37       # 6: down to label3
# BB#19:                                # %for.cond61.4
                                        #   in Loop: Header=BB0_3 Depth=3
	i32.const	$push92=, 6
	...
	br_if   	6, $pop40       # 6: down to label3
# BB#20:                                # %for.cond61.5
                                        #   in Loop: Header=BB0_3 Depth=3
	i32.const	$push94=, 7
	...
	br_if   	6, $pop43       # 6: down to label3
# BB#21:                                # %for.cond61.6
                                        #   in Loop: Header=BB0_3 Depth=3
	i32.const	$push96=, 8
	...
	br_if   	6, $pop46       # 6: down to label3
# BB#22:                                # %for.cond61.7
                                        #   in Loop: Header=BB0_3 Depth=3
	i32.const	$push98=, 1
	i32.add 	$5=, $5, $pop98
