...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop27), $pop76
	i32.const	$push31=, 64
	i32.add 	$push32=, $0, $pop31
	i32.const	$push0=, 28
	i32.add 	$push1=, $pop32, $pop0
	i32.const	$push2=, 257
	i32.store16	$drop=, 0($pop1), $pop2
	i32.const	$push33=, 64
