...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop11), $pop26
	i32.const	$push2=, 40
	...
	i64.store	$drop=, 24($0), $pop7
	i32.const	$push23=, 0
	i32.store	$drop=, 16($0), $pop23
	i32.const	$push22=, 0
	i32.store	$drop=, 20($0), $pop22
	i32.const	$push15=, 24
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop13), $pop32
	i32.const	$push17=, 16
...
.LBB1_11:                               # %while.end21.i
	...
	br_if   	4, $pop71       # 4: down to label1
# BB#12:                                # %if.end25.i
                                        #   in Loop: Header=BB1_6 Depth=2
	i32.const	$1=, 0
	i32.const	$push52=, 0
	i32.store	$drop=, 0($3), $pop52
	i32.load	$push9=, 8($4)
	i32.const	$push51=, 7
	i32.shl 	$push50=, $pop9, $pop51
	tee_local	$push49=, $0=, $pop50
	i32.store	$drop=, 12($7), $pop49
	br      	0               # 0: up to label7
.LBB1_13:                               # %if.then15.i
                                        #   in Loop: Header=BB1_1 Depth=1
	end_loop                        # label8:
	i32.store	$drop=, 0($2), $1
	i32.store	$drop=, 16($7), $4
	i32.const	$push23=, 16
