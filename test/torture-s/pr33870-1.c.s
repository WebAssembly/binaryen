...
# BB#15:                                # %if.then19.i
                                        #   in Loop: Header=BB0_3 Depth=2
	i32.store	$drop=, 0($10), $8
	br      	1               # 1: down to label9
.LBB0_16:                               # %if.else22.i
                                        #   in Loop: Header=BB0_3 Depth=2
	end_block                       # label16:
	i32.store	$drop=, 0($10), $2
...
.LBB0_44:                               # %if.end.i65
	...
	i32.store	$drop=, vx($pop122), $pop41
	i32.const	$push120=, 0
	i32.ne  	$7=, $10, $pop120
	i32.const	$push119=, 0
	i32.ne  	$6=, $11, $pop119
