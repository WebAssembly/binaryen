	.text
	.file	"/usr/local/google/home/dschuff/s/wasm-waterfall/src/work/gcc/gcc/testsuite/gcc.c-torture/execute/pr33870-1.c"
...
.LBB0_3:                                # %for.body
	...
	br_if   	1, $pop117      # 1: down to label5
# BB#4:                                 # %if.else
...
.LBB0_9:                                # %if.end.i
	...
	i32.eqz 	$push119=, $9
	br_if   	0, $pop119      # 0: down to label13
# BB#10:                                # %if.end.i
                                        #   in Loop: Header=BB0_6 Depth=3
	copy_local	$3=, $10
	copy_local	$8=, $9
	br_if   	1, $10          # 1: up to label10
.LBB0_11:                               # %merge_pagelist.exit
                                        #   in Loop: Header=BB0_3 Depth=2
	end_block                       # label13:
	end_loop
	br_if   	1, $9           # 1: down to label8
...
# BB#16:                                # %if.then9
	...
	copy_local	$7=, $pop59
	i32.eqz 	$push120=, $3
	br_if   	1, $pop120      # 1: down to label4
# BB#17:                                # %if.then9
                                        #   in Loop: Header=BB0_2 Depth=1
	i32.eqz 	$push121=, $8
	br_if   	1, $pop121      # 1: down to label4
...
.LBB0_19:                               # %while.body.i84
	...
	br_if   	0, $pop17       # 0: down to label16
# BB#20:                                # %if.then.i86
...
.LBB0_22:                               # %if.end.i95
	...
	i32.ne  	$6=, $9, $pop98
	i32.eqz 	$push122=, $9
	br_if   	3, $pop122      # 3: down to label3
# BB#23:                                # %if.end.i95
                                        #   in Loop: Header=BB0_19 Depth=2
	copy_local	$3=, $10
	copy_local	$8=, $9
	br_if   	0, $10          # 0: up to label14
...
# BB#31:                                # %for.body17
	...
	i32.eqz 	$push124=, $8
	br_if   	0, $pop124      # 0: down to label19
...
.LBB0_33:                               # %while.body.i54
	...
	br_if   	0, $pop31       # 0: down to label22
# BB#34:                                # %if.then.i56
...
.LBB0_36:                               # %if.end.i65
	...
	i32.ne  	$6=, $9, $pop109
	i32.eqz 	$push125=, $9
	br_if   	2, $pop125      # 2: down to label18
# BB#37:                                # %if.end.i65
                                        #   in Loop: Header=BB0_33 Depth=2
	copy_local	$8=, $10
	copy_local	$3=, $9
	br_if   	0, $10          # 0: up to label20
...
# BB#0:                                 # %entry
	...
	br_if   	0, $pop26       # 0: down to label23
# BB#1:                                 # %if.end
	i32.const	$push33=, 0
