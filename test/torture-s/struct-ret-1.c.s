...
# BB#0:                                 # %entry
	...
	tee_local	$push35=, $10=, $pop36
	i32.store	$drop=, __stack_pointer($pop28), $pop35
	i32.const	$push1=, 16
	...
	i32.const	$push34=, 16
	i32.add 	$push3=, $4, $pop34
	i32.load	$push4=, 0($pop3)
	i32.store	$drop=, 0($pop6), $pop4
	i32.const	$push9=, 44
	i32.add 	$push10=, $10, $pop9
	i64.const	$push7=, 32
	i64.shr_u	$push8=, $9, $pop7
	i64.store32	$drop=, 0($pop10), $pop8
	i32.const	$push11=, 40
	i32.add 	$push12=, $10, $pop11
	i64.store32	$drop=, 0($pop12), $9
	i32.const	$push13=, 32
	i32.add 	$push14=, $10, $pop13
	f64.store	$drop=, 0($pop14), $8
	i32.const	$push15=, 24
	i32.add 	$push16=, $10, $pop15
	f64.store	$drop=, 0($pop16), $3
	i32.const	$push17=, 20
	i32.add 	$push18=, $10, $pop17
	i32.store	$drop=, 0($pop18), $2
	i32.const	$push33=, 16
	i32.add 	$push19=, $10, $pop33
	i32.store	$drop=, 0($pop19), $5
	i64.const	$push32=, 32
	i64.shr_u	$push20=, $7, $pop32
	i64.store32	$drop=, 12($10), $pop20
	i64.store32	$drop=, 8($10), $7
	f64.store	$drop=, 0($10), $6
	i32.const	$push22=, out
	i32.const	$push21=, .L.str
	i32.call	$drop=, sprintf@FUNCTION, $pop22, $pop21, $10
	i32.const	$push24=, f.xr
	i32.const	$push23=, 33
	i32.call	$push0=, memcpy@FUNCTION, $0, $pop24, $pop23
	i32.store8	$drop=, 33($pop0), $2
	i32.const	$push31=, 0
	i32.const	$push29=, 64
...
main:                                   # @main
	.result 	i32
	.local  	f64, i64, i32, i32, f64, f64, i64, i32
# BB#0:                                 # %entry
	i32.const	$push41=, 0
	i32.const	$push38=, 0
	i32.load	$push39=, __stack_pointer($pop38)
	i32.const	$push40=, 256
	i32.sub 	$push90=, $pop39, $pop40
	tee_local	$push89=, $7=, $pop90
	i32.store	$drop=, __stack_pointer($pop41), $pop89
	i32.const	$push88=, 0
	f64.load	$0=, B1($pop88)
	i32.const	$push87=, 0
	i64.load	$1=, B1+8($pop87)
	i32.const	$push86=, 0
	i32.load	$2=, B1+16($pop86)
	i32.const	$push85=, 0
	i32.load8_s	$3=, c2($pop85)
	i32.const	$push84=, 0
	f64.load	$4=, d3($pop84)
	i32.const	$push83=, 0
	f64.load	$5=, B2($pop83)
	i32.const	$push82=, 0
	i64.load	$6=, B2+8($pop82)
	i32.const	$push1=, 96
	i32.add 	$push2=, $7, $pop1
	i32.const	$push81=, 0
	i32.load	$push0=, B2+16($pop81)
	i32.store	$drop=, 0($pop2), $pop0
	i32.const	$push3=, 88
	i32.add 	$push4=, $7, $pop3
	i64.store32	$drop=, 0($pop4), $6
	i32.const	$push5=, 80
	i32.add 	$push6=, $7, $pop5
	f64.store	$drop=, 0($pop6), $5
	i32.const	$push7=, 72
	i32.add 	$push8=, $7, $pop7
	f64.store	$drop=, 0($pop8), $4
	i32.const	$push42=, 48
	...
	i32.store	$drop=, 0($pop12), $2
	i32.const	$push15=, 92
	i32.add 	$push16=, $7, $pop15
	i64.const	$push13=, 32
	i64.shr_u	$push14=, $6, $pop13
	i64.store32	$drop=, 0($pop16), $pop14
	i64.store32	$drop=, 56($7), $1
	f64.store	$drop=, 48($7), $0
	i64.const	$push80=, 32
	i64.shr_u	$push17=, $1, $pop80
	i64.store32	$drop=, 60($7), $pop17
	...
	i32.const	$push79=, out
	i32.call	$drop=, strcpy@FUNCTION, $pop49, $pop79
	i32.const	$push50=, 24
	i32.add 	$push51=, $7, $pop50
	i32.const	$push78=, 20
	i32.add 	$push20=, $pop51, $pop78
	i32.const	$push77=, 0
	i32.load	$push21=, B1+20($pop77)
	i32.store	$drop=, 0($pop20), $pop21
	i32.const	$push52=, 24
	i32.add 	$push53=, $7, $pop52
	i32.const	$push76=, 16
	i32.add 	$push22=, $pop53, $pop76
	i32.const	$push75=, 0
	i32.load	$push23=, B1+16($pop75)
	i32.store	$drop=, 0($pop22), $pop23
	i32.const	$push24=, 36
	i32.add 	$push25=, $7, $pop24
	i32.const	$push74=, 0
	i32.load	$push26=, B1+12($pop74)
	...
	i32.const	$push73=, 0
	i32.load	$push29=, B1+8($pop73)
	i32.store	$drop=, 0($pop28), $pop29
	i32.const	$push72=, 0
	i32.load	$push30=, B1+4($pop72)
	i32.store	$drop=, 28($7), $pop30
	i32.const	$push71=, 0
	i32.load	$push31=, B1($pop71)
	i32.store	$drop=, 24($7), $pop31
	i32.const	$push70=, 0
	f64.load	$0=, d3($pop70)
	i32.const	$push69=, 0
	i32.load8_s	$2=, c2($pop69)
	i32.const	$push68=, 0
	i32.load	$3=, fp($pop68)
	i32.const	$push67=, 16
	i32.add 	$push32=, $7, $pop67
	i32.const	$push66=, 0
	i64.load	$push33=, B2+16($pop66)
	i64.store	$drop=, 0($pop32), $pop33
	i32.const	$push65=, 8
	i32.add 	$push34=, $7, $pop65
	i32.const	$push64=, 0
	i64.load	$push35=, B2+8($pop64)
	i64.store	$drop=, 0($pop34), $pop35
	i32.const	$push63=, 0
	i64.load	$push36=, B2($pop63)
	i64.store	$drop=, 0($7), $pop36
	i32.const	$push56=, 104
	i32.add 	$push57=, $7, $pop56
	i32.const	$push58=, 24
	i32.add 	$push59=, $7, $pop58
	call_indirect	$3, $pop57, $pop59, $2, $0, $7
	block
	i32.const	$push60=, 144
	i32.add 	$push61=, $7, $pop60
	i32.const	$push62=, out
	i32.call	$push37=, strcmp@FUNCTION, $pop61, $pop62
	br_if   	0, $pop37       # 0: down to label0
# BB#1:                                 # %if.end
	i32.const	$push91=, 0
	call    	exit@FUNCTION, $pop91
	unreachable
.LBB1_2:                                # %if.then
	end_block                       # label0:
	call    	abort@FUNCTION
