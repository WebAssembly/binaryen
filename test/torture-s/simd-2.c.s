...
# BB#0:                                 # %entry
	...
	i32.store16	$discard=, res+14($pop516), $pop0
	i32.const	$push512=, 0
	i32.const	$push511=, 0
	i32.add 	$push42=, $7, $1
	i32.store16	$push1=, k+12($pop511), $pop42
	i32.store16	$discard=, res+12($pop512), $pop1
	i32.const	$push510=, 0
	i32.const	$push509=, 0
	i32.add 	$push41=, $8, $2
	i32.store16	$push2=, k+10($pop509), $pop41
	i32.store16	$discard=, res+10($pop510), $pop2
	i32.const	$push508=, 0
	i32.const	$push507=, 0
	i32.add 	$push40=, $9, $3
	i32.store16	$push3=, k+8($pop507), $pop40
	i32.store16	$discard=, res+8($pop508), $pop3
	i32.const	$push506=, 0
	i32.add 	$push39=, $10, $0
	...
	i32.const	$push501=, 0
	i32.store16	$discard=, res+4($pop501), $4
	i32.const	$push500=, 0
	i32.store16	$discard=, res+2($pop500), $5
	i32.const	$push499=, 0
	i32.store16	$discard=, res($pop499), $0
	i32.const	$push44=, 16
	...
	i32.store16	$discard=, res+14($pop477), $pop4
	i32.const	$push473=, 0
	i32.const	$push472=, 0
	i32.mul 	$push65=, $7, $1
	i32.store16	$push5=, k+12($pop472), $pop65
	i32.store16	$discard=, res+12($pop473), $pop5
	i32.const	$push471=, 0
	i32.const	$push470=, 0
	i32.mul 	$push64=, $8, $2
	i32.store16	$push6=, k+10($pop470), $pop64
	i32.store16	$discard=, res+10($pop471), $pop6
	i32.const	$push469=, 0
	i32.const	$push468=, 0
	i32.mul 	$push63=, $9, $3
	i32.store16	$push7=, k+8($pop468), $pop63
	i32.store16	$discard=, res+8($pop469), $pop7
	i32.const	$push467=, 0
	i32.mul 	$push62=, $10, $0
	...
	i32.const	$push462=, 0
	i32.store16	$discard=, res+4($pop462), $4
	i32.const	$push461=, 0
	i32.store16	$discard=, res+2($pop461), $5
	i32.const	$push460=, 0
	i32.store16	$discard=, res($pop460), $0
	...
	i32.const	$push423=, 0
	i32.store16	$discard=, res+6($pop423), $4
	i32.const	$push422=, 0
	i32.store16	$discard=, res+4($pop422), $5
	i32.const	$push421=, 0
	i32.store16	$discard=, res+2($pop421), $6
	i32.const	$push420=, 0
	i32.store16	$discard=, res($pop420), $0
	...
	i32.store16	$discard=, res+14($pop396), $pop12
	i32.const	$push392=, 0
	i32.const	$push391=, 0
	i32.and 	$push108=, $7, $1
	i32.store16	$push13=, k+12($pop391), $pop108
	i32.store16	$discard=, res+12($pop392), $pop13
	i32.const	$push390=, 0
	i32.const	$push389=, 0
	i32.and 	$push107=, $8, $2
	i32.store16	$push14=, k+10($pop389), $pop107
	i32.store16	$discard=, res+10($pop390), $pop14
	i32.const	$push388=, 0
	i32.const	$push387=, 0
	i32.and 	$push106=, $9, $3
	i32.store16	$push15=, k+8($pop387), $pop106
	i32.store16	$discard=, res+8($pop388), $pop15
	i32.const	$push386=, 0
	...
	i32.const	$push381=, 0
	i32.store16	$discard=, res+4($pop381), $4
	i32.const	$push380=, 0
	i32.store16	$discard=, res+2($pop380), $5
	i32.const	$push379=, 0
	i32.store16	$discard=, res($pop379), $0
	...
	i32.store16	$discard=, res+14($pop356), $pop16
	i32.const	$push352=, 0
	i32.const	$push351=, 0
	i32.or  	$push130=, $7, $1
	i32.store16	$push17=, k+12($pop351), $pop130
	i32.store16	$discard=, res+12($pop352), $pop17
	i32.const	$push350=, 0
	i32.const	$push349=, 0
	i32.or  	$push129=, $8, $2
	i32.store16	$push18=, k+10($pop349), $pop129
	i32.store16	$discard=, res+10($pop350), $pop18
	i32.const	$push348=, 0
	i32.const	$push347=, 0
	i32.or  	$push128=, $9, $3
	i32.store16	$push19=, k+8($pop347), $pop128
	i32.store16	$discard=, res+8($pop348), $pop19
	i32.const	$push346=, 0
	i32.or  	$push127=, $10, $0
	...
	i32.const	$push341=, 0
	i32.store16	$discard=, res+4($pop341), $4
	i32.const	$push340=, 0
	i32.store16	$discard=, res+2($pop340), $5
	i32.const	$push339=, 0
	i32.store16	$discard=, res($pop339), $0
	...
	i32.store16	$discard=, res+14($pop316), $pop20
	i32.const	$push312=, 0
	i32.const	$push311=, 0
	i32.xor 	$push152=, $1, $7
	i32.store16	$push21=, k+12($pop311), $pop152
	i32.store16	$discard=, res+12($pop312), $pop21
	i32.const	$push310=, 0
	i32.const	$push309=, 0
	i32.xor 	$push151=, $2, $8
	i32.store16	$push22=, k+10($pop309), $pop151
	i32.store16	$discard=, res+10($pop310), $pop22
	i32.const	$push308=, 0
	i32.const	$push307=, 0
	i32.xor 	$push150=, $3, $9
	i32.store16	$push23=, k+8($pop307), $pop150
	i32.store16	$discard=, res+8($pop308), $pop23
	i32.const	$push306=, 0
	...
	i32.const	$push301=, 0
	i32.store16	$discard=, res+4($pop301), $4
	i32.const	$push300=, 0
	i32.store16	$discard=, res+2($pop300), $5
	i32.const	$push299=, 0
	i32.store16	$discard=, res($pop299), $0
	...
	i32.store16	$discard=, res+14($pop289), $pop24
	i32.const	$push285=, 0
	...
	i32.store16	$discard=, res+12($pop284), $pop25
	i32.const	$push281=, 0
	...
	i32.store16	$discard=, res+10($pop280), $pop26
	i32.const	$push277=, 0
	i32.const	$push276=, 0
	i32.const	$push275=, 0
	i32.sub 	$push172=, $pop275, $0
	i32.store16	$push27=, k+8($pop276), $pop172
	i32.store16	$discard=, res+8($pop277), $pop27
	i32.const	$push274=, 0
	...
	i32.const	$push262=, 0
	i32.store16	$discard=, res+6($pop262), $6
	i32.const	$push261=, 0
	i32.store16	$discard=, res+4($pop261), $5
	i32.const	$push260=, 0
	i32.store16	$discard=, res+2($pop260), $4
	i32.const	$push259=, 0
	i32.store16	$discard=, res($pop259), $0
	...
	i32.const	$push224=, 0
	i32.store16	$discard=, res+6($pop224), $0
	i32.const	$push223=, 0
	i32.store16	$discard=, res+4($pop223), $6
	i32.const	$push222=, 0
	i32.store16	$discard=, res+2($pop222), $5
	i32.const	$push221=, 0
	i32.const	$push220=, 0
	i32.const	$push219=, -1
	...
	i32.store16	$discard=, res($pop221), $pop32
