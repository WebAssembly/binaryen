...
# BB#0:                                 # %entry
	...
	i32.store16	$drop=, k+14($pop0), $pop653
	i32.const	$push652=, 0
	i32.const	$push651=, 0
	...
	i32.store16	$drop=, k+12($pop652), $pop648
	i32.const	$push647=, 0
	i32.const	$push646=, 0
	...
	i32.store16	$drop=, k+10($pop647), $pop643
	i32.const	$push642=, 0
	i32.const	$push641=, 0
	...
	i32.store16	$drop=, k+8($pop642), $pop638
	i32.const	$push637=, 0
	i32.const	$push636=, 0
	...
	i32.store16	$drop=, k+6($pop637), $pop633
	i32.const	$push632=, 0
	i32.const	$push631=, 0
	...
	i32.store16	$drop=, k+4($pop632), $pop628
	i32.const	$push627=, 0
	i32.const	$push626=, 0
	...
	i32.store16	$drop=, k+2($pop627), $pop623
	i32.const	$push622=, 0
	i32.const	$push621=, 0
	...
	i32.store16	$drop=, k($pop622), $pop618
	i32.const	$push617=, 0
	i32.store16	$drop=, res+14($pop617), $0
	i32.const	$push616=, 0
	i32.store16	$drop=, res+12($pop616), $1
	i32.const	$push615=, 0
	i32.store16	$drop=, res+10($pop615), $2
	i32.const	$push614=, 0
	i32.store16	$drop=, res+8($pop614), $3
	i32.const	$push613=, 0
	i32.store16	$drop=, res+6($pop613), $4
	i32.const	$push612=, 0
	i32.store16	$drop=, res+4($pop612), $5
	i32.const	$push611=, 0
	i32.store16	$drop=, res+2($pop611), $6
	i32.const	$push610=, 0
	i32.store16	$drop=, res($pop610), $7
	i32.const	$push17=, 16
	...
	i32.store16	$drop=, k+14($pop602), $pop598
	i32.const	$push597=, 0
	i32.const	$push596=, 0
	...
	i32.store16	$drop=, k+12($pop597), $pop593
	i32.const	$push592=, 0
	i32.const	$push591=, 0
	...
	i32.store16	$drop=, k+10($pop592), $pop588
	i32.const	$push587=, 0
	i32.const	$push586=, 0
	...
	i32.store16	$drop=, k+8($pop587), $pop583
	i32.const	$push582=, 0
	i32.const	$push581=, 0
	...
	i32.store16	$drop=, k+6($pop582), $pop578
	i32.const	$push577=, 0
	i32.const	$push576=, 0
	...
	i32.store16	$drop=, k+4($pop577), $pop573
	i32.const	$push572=, 0
	i32.const	$push571=, 0
	...
	i32.store16	$drop=, k+2($pop572), $pop568
	i32.const	$push567=, 0
	i32.const	$push566=, 0
	...
	i32.store16	$drop=, k($pop567), $pop563
	i32.const	$push562=, 0
	i32.store16	$drop=, res+14($pop562), $0
	i32.const	$push561=, 0
	i32.store16	$drop=, res+12($pop561), $1
	i32.const	$push560=, 0
	i32.store16	$drop=, res+10($pop560), $2
	i32.const	$push559=, 0
	i32.store16	$drop=, res+8($pop559), $3
	i32.const	$push558=, 0
	i32.store16	$drop=, res+6($pop558), $4
	i32.const	$push557=, 0
	i32.store16	$drop=, res+4($pop557), $5
	i32.const	$push556=, 0
	i32.store16	$drop=, res+2($pop556), $6
	i32.const	$push555=, 0
	i32.store16	$drop=, res($pop555), $7
	...
	i32.store16	$drop=, k+14($pop546), $pop542
	i32.const	$push541=, 0
	i32.const	$push540=, 0
	...
	i32.store16	$drop=, k+12($pop541), $pop537
	i32.const	$push536=, 0
	i32.const	$push535=, 0
	...
	i32.store16	$drop=, k+10($pop536), $pop532
	i32.const	$push531=, 0
	i32.const	$push530=, 0
	...
	i32.store16	$drop=, k+8($pop531), $pop527
	i32.const	$push526=, 0
	i32.const	$push525=, 0
	...
	i32.store16	$drop=, k+6($pop526), $pop522
	i32.const	$push521=, 0
	i32.const	$push520=, 0
	...
	i32.store16	$drop=, k+4($pop521), $pop517
	i32.const	$push516=, 0
	i32.const	$push515=, 0
	...
	i32.store16	$drop=, k+2($pop516), $pop512
	i32.const	$push511=, 0
	i32.const	$push510=, 0
	...
	i32.store16	$drop=, k($pop511), $pop507
	i32.const	$push506=, 0
	i32.store16	$drop=, res+14($pop506), $0
	i32.const	$push505=, 0
	i32.store16	$drop=, res+12($pop505), $1
	i32.const	$push504=, 0
	i32.store16	$drop=, res+10($pop504), $2
	i32.const	$push503=, 0
	i32.store16	$drop=, res+8($pop503), $3
	i32.const	$push502=, 0
	i32.store16	$drop=, res+6($pop502), $4
	i32.const	$push501=, 0
	i32.store16	$drop=, res+4($pop501), $5
	i32.const	$push500=, 0
	i32.store16	$drop=, res+2($pop500), $6
	i32.const	$push499=, 0
	i32.store16	$drop=, res($pop499), $7
	...
	i32.store16	$drop=, k+14($pop489), $pop485
	i32.const	$push484=, 0
	i32.const	$push483=, 0
	...
	i32.store16	$drop=, k+12($pop484), $pop480
	i32.const	$push479=, 0
	i32.const	$push478=, 0
	...
	i32.store16	$drop=, k+10($pop479), $pop475
	i32.const	$push474=, 0
	i32.const	$push473=, 0
	...
	i32.store16	$drop=, k+8($pop474), $pop470
	i32.const	$push469=, 0
	i32.const	$push468=, 0
	...
	i32.store16	$drop=, k+6($pop469), $pop465
	i32.const	$push464=, 0
	i32.const	$push463=, 0
	...
	i32.store16	$drop=, k+4($pop464), $pop460
	i32.const	$push459=, 0
	i32.const	$push458=, 0
	...
	i32.store16	$drop=, k+2($pop459), $pop455
	i32.const	$push454=, 0
	i32.const	$push453=, 0
	...
	i32.store16	$drop=, k($pop454), $pop450
	i32.const	$push449=, 0
	i32.store16	$drop=, res+14($pop449), $0
	i32.const	$push448=, 0
	i32.store16	$drop=, res+12($pop448), $1
	i32.const	$push447=, 0
	i32.store16	$drop=, res+10($pop447), $2
	i32.const	$push446=, 0
	i32.store16	$drop=, res+8($pop446), $3
	i32.const	$push445=, 0
	i32.store16	$drop=, res+6($pop445), $4
	i32.const	$push444=, 0
	i32.store16	$drop=, res+4($pop444), $5
	i32.const	$push443=, 0
	i32.store16	$drop=, res+2($pop443), $6
	i32.const	$push442=, 0
	i32.store16	$drop=, res($pop442), $7
	...
	i32.store16	$drop=, k+14($pop433), $pop429
	i32.const	$push428=, 0
	i32.const	$push427=, 0
	...
	i32.store16	$drop=, k+12($pop428), $pop424
	i32.const	$push423=, 0
	i32.const	$push422=, 0
	...
	i32.store16	$drop=, k+10($pop423), $pop419
	i32.const	$push418=, 0
	i32.const	$push417=, 0
	...
	i32.store16	$drop=, k+8($pop418), $pop414
	i32.const	$push413=, 0
	i32.const	$push412=, 0
	...
	i32.store16	$drop=, k+6($pop413), $pop409
	i32.const	$push408=, 0
	i32.const	$push407=, 0
	...
	i32.store16	$drop=, k+4($pop408), $pop404
	i32.const	$push403=, 0
	i32.const	$push402=, 0
	...
	i32.store16	$drop=, k+2($pop403), $pop399
	i32.const	$push398=, 0
	i32.const	$push397=, 0
	...
	i32.store16	$drop=, k($pop398), $pop394
	i32.const	$push393=, 0
	i32.store16	$drop=, res+14($pop393), $0
	i32.const	$push392=, 0
	i32.store16	$drop=, res+12($pop392), $1
	i32.const	$push391=, 0
	i32.store16	$drop=, res+10($pop391), $2
	i32.const	$push390=, 0
	i32.store16	$drop=, res+8($pop390), $3
	i32.const	$push389=, 0
	i32.store16	$drop=, res+6($pop389), $4
	i32.const	$push388=, 0
	i32.store16	$drop=, res+4($pop388), $5
	i32.const	$push387=, 0
	i32.store16	$drop=, res+2($pop387), $6
	i32.const	$push386=, 0
	i32.store16	$drop=, res($pop386), $7
	...
	i32.store16	$drop=, k+14($pop377), $pop373
	i32.const	$push372=, 0
	i32.const	$push371=, 0
	...
	i32.store16	$drop=, k+12($pop372), $pop368
	i32.const	$push367=, 0
	i32.const	$push366=, 0
	...
	i32.store16	$drop=, k+10($pop367), $pop363
	i32.const	$push362=, 0
	i32.const	$push361=, 0
	...
	i32.store16	$drop=, k+8($pop362), $pop358
	i32.const	$push357=, 0
	i32.const	$push356=, 0
	...
	i32.store16	$drop=, k+6($pop357), $pop353
	i32.const	$push352=, 0
	i32.const	$push351=, 0
	...
	i32.store16	$drop=, k+4($pop352), $pop348
	i32.const	$push347=, 0
	i32.const	$push346=, 0
	...
	i32.store16	$drop=, k+2($pop347), $pop343
	i32.const	$push342=, 0
	i32.const	$push341=, 0
	...
	i32.store16	$drop=, k($pop342), $pop338
	i32.const	$push337=, 0
	...
	i32.const	$push333=, 0
	i32.store16	$drop=, res+6($pop333), $4
	i32.const	$push332=, 0
	i32.store16	$drop=, res+4($pop332), $5
	i32.const	$push331=, 0
	i32.store16	$drop=, res+2($pop331), $6
	i32.const	$push330=, 0
	i32.store16	$drop=, res($pop330), $7
	...
	i32.store16	$drop=, k+14($pop321), $pop317
	i32.const	$push316=, 0
	i32.const	$push315=, 0
	i32.const	$push314=, 0
	...
	i32.store16	$drop=, k+12($pop316), $pop312
	i32.const	$push311=, 0
	i32.const	$push310=, 0
	i32.const	$push309=, 0
	...
	i32.store16	$drop=, k+10($pop311), $pop307
	i32.const	$push306=, 0
	i32.const	$push305=, 0
	i32.const	$push304=, 0
	...
	i32.store16	$drop=, k+8($pop306), $pop302
	i32.const	$push301=, 0
	i32.const	$push300=, 0
	i32.const	$push299=, 0
	...
	i32.store16	$drop=, k+6($pop301), $pop297
	i32.const	$push296=, 0
	i32.const	$push295=, 0
	i32.const	$push294=, 0
	...
	i32.store16	$drop=, k+4($pop296), $pop292
	i32.const	$push291=, 0
	i32.const	$push290=, 0
	i32.const	$push289=, 0
	...
	i32.store16	$drop=, k+2($pop291), $pop287
	i32.const	$push286=, 0
	i32.const	$push285=, 0
	i32.const	$push284=, 0
	...
	i32.store16	$drop=, k($pop286), $pop282
	i32.const	$push281=, 0
	i32.store16	$drop=, res+14($pop281), $0
	i32.const	$push280=, 0
	i32.store16	$drop=, res+12($pop280), $1
	i32.const	$push279=, 0
	i32.store16	$drop=, res+10($pop279), $2
	i32.const	$push278=, 0
	i32.store16	$drop=, res+8($pop278), $3
	i32.const	$push277=, 0
	i32.store16	$drop=, res+6($pop277), $4
	i32.const	$push276=, 0
	i32.store16	$drop=, res+4($pop276), $5
	i32.const	$push275=, 0
	i32.store16	$drop=, res+2($pop275), $6
	i32.const	$push274=, 0
	i32.store16	$drop=, res($pop274), $7
	...
	i32.store16	$drop=, k+14($pop264), $pop261
	i32.const	$push260=, 0
	i32.const	$push259=, 0
	...
	i32.store16	$drop=, k+12($pop260), $pop256
	i32.const	$push255=, 0
	i32.const	$push254=, 0
	...
	i32.store16	$drop=, k+10($pop255), $pop251
	i32.const	$push250=, 0
	i32.const	$push249=, 0
	...
	i32.store16	$drop=, k+8($pop250), $pop246
	i32.const	$push245=, 0
	i32.const	$push244=, 0
	...
	i32.store16	$drop=, k+6($pop245), $pop241
	i32.const	$push240=, 0
	i32.const	$push239=, 0
	...
	i32.store16	$drop=, k+4($pop240), $pop236
	i32.const	$push235=, 0
	i32.const	$push234=, 0
	...
	i32.store16	$drop=, k+2($pop235), $pop231
	i32.const	$push230=, 0
	i32.const	$push229=, 0
	...
	i32.store16	$drop=, k($pop230), $pop226
	i32.const	$push225=, 0
	i32.store16	$drop=, res+14($pop225), $0
	i32.const	$push224=, 0
	i32.store16	$drop=, res+12($pop224), $1
	i32.const	$push223=, 0
	i32.store16	$drop=, res+10($pop223), $2
	i32.const	$push222=, 0
	i32.store16	$drop=, res+8($pop222), $3
	i32.const	$push221=, 0
	i32.store16	$drop=, res+6($pop221), $4
	i32.const	$push220=, 0
	i32.store16	$drop=, res+4($pop220), $5
	i32.const	$push219=, 0
	i32.store16	$drop=, res+2($pop219), $6
	i32.const	$push218=, 0
	i32.store16	$drop=, res($pop218), $7
