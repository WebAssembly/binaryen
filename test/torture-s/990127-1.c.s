...
.LBB0_4:                                # %while.cond.2
	...
	i32.const	$push120=, 0
	i32.eq  	$push121=, $3, $pop120
	br_if   	1, $pop121      # 1: down to label3
# BB#5:                                 # %while.body.2
...
.LBB0_7:                                # %while.cond.3
	...
	i32.const	$push122=, 0
	i32.eq  	$push123=, $3, $pop122
	br_if   	1, $pop123      # 1: down to label5
# BB#8:                                 # %while.body.3
...
.LBB0_10:                               # %while.cond.4
	...
	i32.const	$push124=, 0
	i32.eq  	$push125=, $3, $pop124
	br_if   	1, $pop125      # 1: down to label7
# BB#11:                                # %while.body.4
...
.LBB0_13:                               # %while.cond.5
	...
	i32.const	$push126=, 0
	i32.eq  	$push127=, $3, $pop126
	br_if   	1, $pop127      # 1: down to label9
# BB#14:                                # %while.body.5
...
.LBB0_16:                               # %while.cond.6
	...
	i32.const	$push128=, 0
	i32.eq  	$push129=, $3, $pop128
	br_if   	1, $pop129      # 1: down to label11
# BB#17:                                # %while.body.6
...
.LBB0_19:                               # %while.cond.7
	...
	i32.const	$push130=, 0
	i32.eq  	$push131=, $3, $pop130
	br_if   	1, $pop131      # 1: down to label13
# BB#20:                                # %while.body.7
...
.LBB0_22:                               # %while.cond.8
	...
	i32.const	$push132=, 0
	i32.eq  	$push133=, $3, $pop132
	br_if   	1, $pop133      # 1: down to label15
# BB#23:                                # %while.body.8
...
.LBB0_25:                               # %while.cond.9
	...
	i32.const	$push134=, 0
	i32.eq  	$push135=, $3, $pop134
	br_if   	1, $pop135      # 1: down to label17
# BB#26:                                # %while.body.9
