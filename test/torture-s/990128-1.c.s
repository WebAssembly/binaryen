...
# BB#0:                                 # %for.inc.i.preheader.i.preheader
	i32.const	$push1=, 0
	i32.const	$push2=, sss
	i32.store	$drop=, ss($pop1), $pop2
	i32.const	$push29=, 0
	i32.const	$push3=, sss+4
	i32.store	$drop=, sss($pop29), $pop3
	i32.const	$push28=, 0
	i32.const	$push4=, sss+8
	i32.store	$drop=, sss+4($pop28), $pop4
	i32.const	$push27=, 0
	i32.const	$push5=, sss+12
	i32.store	$drop=, sss+8($pop27), $pop5
	i32.const	$push26=, 0
	i32.const	$push6=, sss+16
	i32.store	$drop=, sss+12($pop26), $pop6
	i32.const	$push25=, 0
	i32.const	$push7=, sss+20
	i32.store	$drop=, sss+16($pop25), $pop7
	i32.const	$push24=, 0
	i32.const	$push8=, sss+24
	i32.store	$drop=, sss+20($pop24), $pop8
	i32.const	$push23=, 0
	i32.const	$push9=, sss+28
	i32.store	$drop=, sss+24($pop23), $pop9
	i32.const	$push22=, 0
	i32.const	$push10=, sss+32
	i32.store	$drop=, sss+28($pop22), $pop10
	i32.const	$push21=, 0
	i32.const	$push11=, sss+36
	i32.store	$drop=, sss+32($pop21), $pop11
	i32.const	$1=, ss
	i32.const	$push20=, 0
	i32.load	$2=, count($pop20)
	i32.const	$push19=, 0
	i32.const	$push18=, ss
	i32.store	$drop=, p($pop19), $pop18
	i32.const	$push17=, 0
	i32.const	$push16=, 0
