...
.LBB0_3:                                # %for.end
	...
	i32.store	$discard=, 0($pop196), $pop195
	return
	.endfunc
.Lfunc_end0:
	.size	f, .Lfunc_end0-f
...
.LBB2_2:                                # %while.body
	...
	i32.load	$push1=, 0($1)
	i32.const	$push13=, 0
	i32.const	$push12=, 2000
	i32.call	$discard=, memset@FUNCTION, $pop1, $pop13, $pop12
	copy_local	$1=, $2
...
# BB#0:                                 # %entry
	...
	i32.store	$discard=, 12($pop15), $1
	i32.const	$push0=, 2
	i32.shl 	$push1=, $0, $pop0
	i32.const	$push14=, -4
	i32.add 	$1=, $pop1, $pop14
.LBB3_1:                                # %while.cond
                                        # =>This Inner Loop Header: Depth=1
	block
	loop                            # label10:
