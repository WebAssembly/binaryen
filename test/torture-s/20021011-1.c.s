...
# BB#0:                                 # %entry
	...
	i32.store8	$drop=, buf+8($pop44), $pop41
	i32.const	$push40=, 0
	i32.const	$push39=, 0
	i64.load	$push38=, .L.str($pop39):p2align=0
	tee_local	$push37=, $1=, $pop38
	i64.store	$drop=, buf($pop40), $pop37
	block
...
# BB#1:                                 # %for.body.preheader
	i32.const	$push48=, 0
	i32.store8	$drop=, buf+8($pop48), $0
	i32.const	$push47=, 0
	i64.store	$drop=, buf($pop47), $1
...
# BB#2:                                 # %for.cond
	...
	i32.store8	$drop=, buf+9($pop57), $pop54
	i32.const	$push53=, 0
	i32.const	$push52=, 0
	i64.load	$push51=, .L.str($pop52):p2align=0
	tee_local	$push50=, $1=, $pop51
	i64.store	$drop=, buf+1($pop53):p2align=0, $pop50
...
# BB#3:                                 # %for.cond.1
	i32.const	$push60=, 0
	i32.store8	$drop=, buf+10($pop60), $0
	i32.const	$push59=, 0
	i64.store	$drop=, buf+2($pop59):p2align=1, $1
...
# BB#4:                                 # %for.cond.2
	...
	i32.store8	$drop=, buf+11($pop69), $pop66
	i32.const	$push65=, 0
	i32.const	$push64=, 0
	i64.load	$push63=, .L.str($pop64):p2align=0
	tee_local	$push62=, $1=, $pop63
	i64.store	$drop=, buf+3($pop65):p2align=0, $pop62
...
# BB#5:                                 # %for.cond.3
	i32.const	$push72=, 0
	i32.store8	$drop=, buf+12($pop72), $0
	i32.const	$push71=, 0
	i64.store	$drop=, buf+4($pop71):p2align=2, $1
...
# BB#6:                                 # %for.cond.4
	...
	i32.store8	$drop=, buf+13($pop81), $pop78
	i32.const	$push77=, 0
	i32.const	$push76=, 0
	i64.load	$push75=, .L.str($pop76):p2align=0
	tee_local	$push74=, $1=, $pop75
	i64.store	$drop=, buf+5($pop77):p2align=0, $pop74
...
# BB#8:                                 # %for.cond.6
	...
	i32.store8	$drop=, buf+15($pop93), $pop90
	i32.const	$push89=, 0
	i32.const	$push88=, 0
	i64.load	$push87=, .L.str($pop88):p2align=0
	tee_local	$push86=, $1=, $pop87
	i64.store	$drop=, buf+7($pop89):p2align=0, $pop86
...
# BB#9:                                 # %for.cond.7
	i32.const	$push96=, 0
	i32.store8	$drop=, buf+16($pop96), $0
	i32.const	$push95=, 0
	i64.store	$drop=, buf+8($pop95), $1
...
# BB#10:                                # %for.cond.8
	...
	i32.store8	$drop=, buf+17($pop105), $pop102
	i32.const	$push101=, 0
	i32.const	$push100=, 0
	i64.load	$push99=, .L.str($pop100):p2align=0
	tee_local	$push98=, $1=, $pop99
	i64.store	$drop=, buf+9($pop101):p2align=0, $pop98
...
# BB#11:                                # %for.cond.9
	i32.const	$push108=, 0
	i32.store8	$drop=, buf+18($pop108), $0
	i32.const	$push107=, 0
	i64.store	$drop=, buf+10($pop107):p2align=1, $1
...
# BB#12:                                # %for.cond.10
	...
	i32.store8	$drop=, buf+19($pop117), $pop114
	i32.const	$push113=, 0
	i32.const	$push112=, 0
	i64.load	$push111=, .L.str($pop112):p2align=0
	tee_local	$push110=, $1=, $pop111
	i64.store	$drop=, buf+11($pop113):p2align=0, $pop110
...
# BB#13:                                # %for.cond.11
	i32.const	$push120=, 0
	i32.store8	$drop=, buf+20($pop120), $0
	i32.const	$push119=, 0
	i64.store	$drop=, buf+12($pop119):p2align=2, $1
...
# BB#14:                                # %for.cond.12
	...
	i32.store8	$drop=, buf+21($pop129), $pop126
	i32.const	$push125=, 0
	i32.const	$push124=, 0
	i64.load	$push123=, .L.str($pop124):p2align=0
	tee_local	$push122=, $1=, $pop123
	i64.store	$drop=, buf+13($pop125):p2align=0, $pop122
...
# BB#15:                                # %for.cond.13
	i32.const	$push132=, 0
	i32.store8	$drop=, buf+22($pop132), $0
	i32.const	$push131=, 0
	i64.store	$drop=, buf+14($pop131):p2align=1, $1
...
# BB#16:                                # %for.cond.14
	...
	i32.store8	$drop=, buf+23($pop136), $pop30
	i32.const	$push134=, 0
	i32.const	$push133=, 0
	i64.load	$push31=, .L.str($pop133):p2align=0
	i64.store	$drop=, buf+15($pop134):p2align=0, $pop31
