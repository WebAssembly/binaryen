...
# BB#0:                                 # %entry
	...
	i32.store	$1=, __stack_pointer($pop14), $pop18
	i32.load	$2=, 4($0)
	block
	i32.const	$push0=, 8
	i32.add 	$push1=, $0, $pop0
	i32.load	$push20=, 0($pop1)
...
# BB#1:                                 # %if.then
	...
	i32.const	$push21=, 0
	i32.call	$push6=, fn1@FUNCTION, $pop5, $pop4, $pop3, $pop2, $pop21
	i32.eqz 	$push23=, $pop6
	br_if   	0, $pop23       # 0: down to label0
# BB#2:                                 # %cond.true
	i32.const	$push7=, 33816706
	i32.call	$3=, fn3@FUNCTION, $pop7
	i32.const	$push8=, .L.str.1
	i32.const	$push22=, 0
	i32.call	$push9=, fn4@FUNCTION, $pop8, $pop22
...
# BB#0:                                 # %entry
	...
	i32.store	$push12=, __stack_pointer($pop8), $pop9
