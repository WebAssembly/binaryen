...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop40), $pop46
...
# BB#9:                                 # %if.end41
	...
	i32.store	$drop=, __stack_pointer($pop43), $pop42
	return
.LBB0_10:                               # %if.then40
	end_block                       # label0:
	call    	abort@FUNCTION
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop15), $pop16
	i32.const	$push0=, 32
