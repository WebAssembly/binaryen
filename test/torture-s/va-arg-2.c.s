...
.LBB3_2:                                # %while.cond
	...
	i32.eqz 	$push27=, $pop17
	br_if   	2, $pop27       # 2: down to label7
# BB#3:                                 # %while.body
...
.LBB5_2:                                # %while.cond
	...
	i32.eqz 	$push27=, $pop17
	br_if   	2, $pop27       # 2: down to label13
# BB#3:                                 # %while.body
...
.LBB6_2:                                # %while.cond
	...
	i32.eqz 	$push27=, $pop17
	br_if   	2, $pop27       # 2: down to label16
# BB#3:                                 # %while.body
...
.LBB7_2:                                # %while.cond
	...
	i32.eqz 	$push27=, $pop17
	br_if   	2, $pop27       # 2: down to label19
# BB#3:                                 # %while.body
...
.LBB9_2:                                # %while.cond
	...
	i32.eqz 	$push27=, $pop17
	br_if   	2, $pop27       # 2: down to label25
# BB#3:                                 # %while.body
	...
	i32.const	$push19=, 16
	i32.ge_u	$push4=, $pop20, $pop19
	br_if   	1, $pop4        # 1: down to label26
# BB#4:                                 # %to_hex.exit
                                        #   in Loop: Header=BB9_2 Depth=1
	i32.const	$push26=, 1
	i32.add 	$8=, $8, $pop26
...
.LBB10_2:                               # %while.cond
	...
	i32.eqz 	$push27=, $pop17
	br_if   	2, $pop27       # 2: down to label28
# BB#3:                                 # %while.body
...
.LBB11_2:                               # %while.cond
	...
	i32.eqz 	$push27=, $pop17
	br_if   	2, $pop27       # 2: down to label31
# BB#3:                                 # %while.body
	...
	i32.const	$push19=, 16
	i32.ge_u	$push4=, $pop20, $pop19
	br_if   	1, $pop4        # 1: down to label32
# BB#4:                                 # %to_hex.exit
                                        #   in Loop: Header=BB11_2 Depth=1
	i32.const	$push26=, 1
	i32.add 	$10=, $10, $pop26
...
# BB#0:                                 # %entry
	...
	i32.const	$push1=, 5
	i32.ne  	$push2=, $pop0, $pop1
	br_if   	0, $pop2        # 0: down to label35
# BB#1:
.LBB12_2:                               # %while.cond
                                        # =>This Inner Loop Header: Depth=1
	loop    	                # label36:
...
# BB#3:                                 # %while.body
	...
	i32.const	$push19=, 16
	i32.ge_u	$push4=, $pop20, $pop19
	br_if   	1, $pop4        # 1: down to label35
# BB#4:                                 # %to_hex.exit
                                        #   in Loop: Header=BB12_2 Depth=1
	i32.const	$push26=, 1
	i32.add 	$11=, $11, $pop26
...
# BB#0:                                 # %entry
	...
	i32.const	$push14=, 4
	i32.ne  	$push1=, $pop0, $pop14
	br_if   	0, $pop1        # 0: down to label38
# BB#1:
.LBB13_2:                               # %while.cond
                                        # =>This Inner Loop Header: Depth=1
	loop    	                # label39:
	...
	i32.eqz 	$push27=, $pop17
	br_if   	2, $pop27       # 2: down to label37
# BB#3:                                 # %while.body
...
# BB#3:                                 # %while.body
	...
	i32.const	$push19=, 16
	i32.ge_u	$push4=, $pop20, $pop19
	br_if   	1, $pop4        # 1: down to label41
# BB#4:                                 # %to_hex.exit
                                        #   in Loop: Header=BB14_2 Depth=1
	i32.const	$push26=, 1
	i32.add 	$13=, $13, $pop26
...
# BB#0:                                 # %entry
	...
	i32.const	$push1=, 2
	i32.ne  	$push2=, $pop0, $pop1
	br_if   	0, $pop2        # 0: down to label44
# BB#1:
.LBB15_2:                               # %while.cond
                                        # =>This Inner Loop Header: Depth=1
	loop    	                # label45:
	...
	i32.eqz 	$push27=, $pop17
	br_if   	2, $pop27       # 2: down to label43
# BB#3:                                 # %while.body
	...
	i32.const	$push19=, 16
	i32.ge_u	$push4=, $pop20, $pop19
	br_if   	1, $pop4        # 1: down to label44
# BB#4:                                 # %to_hex.exit
                                        #   in Loop: Header=BB15_2 Depth=1
	i32.const	$push26=, 1
	i32.add 	$14=, $14, $pop26
...
# BB#0:                                 # %entry
	...
	i32.const	$push14=, 1
	i32.ne  	$push1=, $pop0, $pop14
	br_if   	0, $pop1        # 0: down to label47
# BB#1:
.LBB16_2:                               # %while.cond
                                        # =>This Inner Loop Header: Depth=1
	loop    	                # label48:
...
# BB#3:                                 # %while.body
	...
	i32.const	$push19=, 16
	i32.ge_u	$push3=, $pop20, $pop19
	br_if   	1, $pop3        # 1: down to label47
# BB#4:                                 # %to_hex.exit
                                        #   in Loop: Header=BB16_2 Depth=1
	i32.const	$push26=, 1
	i32.add 	$15=, $15, $pop26
