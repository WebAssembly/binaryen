...
# BB#0:                                 # %entry
	...
	i32.store16	$drop=, u+2($pop1), $pop57
	i32.const	$push56=, 0
	i32.const	$push55=, 0
	...
	i32.store16	$drop=, u($pop56), $pop53
	i32.const	$push52=, 0
	...
	f32.store	$drop=, v+12($pop47), $pop43
	i32.const	$push42=, 0
	...
	f32.store	$drop=, v+8($pop42), $pop39
	i32.const	$push38=, 0
	...
	f32.store	$drop=, v+4($pop38), $pop35
	i32.const	$push34=, 0
