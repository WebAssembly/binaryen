...
.LBB4_3:                                # %if.else
	...
	i32.const	$push4=, 0
	i32.eq  	$push5=, $1, $pop4
	br_if   	1, $pop5        # 1: down to label12
.LBB4_4:                                # %if.end38
	end_block                       # label13:
	return
.LBB4_5:                                # %if.then3
...
.LBB5_3:                                # %if.else
	...
	i32.const	$push4=, 0
	i32.eq  	$push5=, $1, $pop4
	br_if   	1, $pop5        # 1: down to label15
.LBB5_4:                                # %if.end38
	end_block                       # label16:
	return
.LBB5_5:                                # %if.then3
...
# BB#1:                                 # %if.then
	i32.const	$push2=, 0
	i32.eq  	$push3=, $1, $pop2
	br_if   	1, $pop3        # 1: down to label19
# BB#2:                                 # %if.then1
	call    	abort@FUNCTION
	unreachable
.LBB6_3:                                # %if.else
...
# BB#1:                                 # %if.then
	i32.const	$push2=, 0
	i32.eq  	$push3=, $1, $pop2
	br_if   	1, $pop3        # 1: down to label22
# BB#2:                                 # %if.then1
	call    	abort@FUNCTION
	unreachable
.LBB7_3:                                # %if.else
	...
	i32.const	$push4=, 0
	i32.eq  	$push5=, $1, $pop4
	br_if   	1, $pop5        # 1: down to label21
.LBB7_4:                                # %if.end38
	end_block                       # label22:
	return
.LBB7_5:                                # %if.then3
