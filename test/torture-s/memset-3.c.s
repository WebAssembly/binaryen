	.text
	.file	"/b/build/slave/linux/build/src/buildbot/work/gcc/gcc/testsuite/gcc.c-torture/execute/memset-3.c"
	.globl	reset
	.type	reset,@function
reset:                                  # @reset
	.local  	i32
...
# BB#15:                                # %for.inc12.i246
	...
	br_if   	$pop50, BB2_14
	br      	BB2_17
BB2_16:                                 # %if.then10.i242
	call    	abort
	unreachable
BB2_17:                                 # %for.body19.preheader.i249
                                        #   in Loop: Header=BB2_1 Depth=1
...
# BB#27:                                # %for.inc12.i283
	...
	br_if   	$pop70, BB2_26
	br      	BB2_29
BB2_28:                                 # %if.then10.i279
	call    	abort
	unreachable
BB2_29:                                 # %for.body19.preheader.i286
                                        #   in Loop: Header=BB2_1 Depth=1
...
BB2_45:                                 # %for.end149
	...
	call    	exit, $pop271
	unreachable
BB2_46:                                 # %if.then23.i287
	call    	abort
	unreachable
BB2_47:                                 # %if.then23.i250
	call    	abort
	unreachable
BB2_48:                                 # %if.then23.i
	call    	abort
