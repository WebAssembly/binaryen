...
# BB#0:                                 # %entry
	...
	i32.call	$discard=, memset@FUNCTION, $pop60, $pop111, $pop110
	i32.const	$push61=, 2592
	i32.add 	$push62=, $4, $pop61
	i32.const	$push109=, 0
	i32.const	$push0=, 1024
	i32.call	$discard=, memset@FUNCTION, $pop62, $pop109, $pop0
	i32.const	$push63=, 1056
	i32.add 	$push64=, $4, $pop63
	i32.const	$push108=, 0
	i32.const	$push1=, 512
	i32.call	$discard=, memset@FUNCTION, $pop64, $pop108, $pop1
	i32.const	$push65=, 288
	i32.add 	$push66=, $4, $pop65
	i32.const	$push107=, 0
	i32.const	$push2=, 256
	i32.call	$discard=, memset@FUNCTION, $pop66, $pop107, $pop2
	i32.const	$push4=, 19088743
	i32.store	$discard=, 2592($4), $pop4
	i32.const	$push5=, 17767
	i32.store16	$discard=, 1056($4), $pop5
	i32.const	$push6=, 115
	i32.store8	$discard=, 288($4), $pop6
	i64.const	$push3=, 81985529216486895
	i64.store	$discard=, 5664($4), $pop3
	i32.const	$push67=, 5664
	i32.add 	$push68=, $4, $pop67
	i32.store	$discard=, 28($4), $pop68
	i32.const	$push69=, 2592
	i32.add 	$push70=, $4, $pop69
	i32.store	$discard=, 24($4), $pop70
	i32.const	$push71=, 1056
	i32.add 	$push72=, $4, $pop71
	i32.store	$discard=, 20($4), $pop72
	i32.const	$push73=, 288
	i32.add 	$push74=, $4, $pop73
	i32.store	$discard=, 16($4), $pop74
	i32.const	$push75=, 28
	i32.add 	$5=, $4, $pop75
	i32.const	$push76=, 24
	i32.add 	$1=, $4, $pop76
