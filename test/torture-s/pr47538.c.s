...
# BB#0:                                 # %entry
	...
	f64.store	$drop=, 0($0), $pop31
	f64.load	$push30=, 8($1)
	tee_local	$push29=, $8=, $pop30
	f64.store	$drop=, 8($0), $pop29
	i32.load	$5=, 16($0)
	f64.const	$11=, 0x0p0
	block
...
# BB#1:                                 # %if.else
	...
	i32.const	$push3=, 2
	i32.ne  	$push4=, $pop33, $pop3
	br_if   	0, $pop4        # 0: down to label1
# BB#2:                                 # %if.then6
	f64.load	$push25=, 0($6)
	f64.mul 	$push36=, $4, $pop25
	tee_local	$push35=, $11=, $pop36
	f64.store	$drop=, 8($5), $pop35
	f64.add 	$push26=, $11, $11
	f64.store	$drop=, 0($5), $pop26
	return
...
.LBB0_5:                                # %for.body
	...
	f64.div 	$push46=, $pop10, $pop11
	tee_local	$push45=, $8=, $pop46
	f64.store	$drop=, 0($0), $pop45
	i32.const	$push44=, 8
	i32.add 	$0=, $0, $pop44
	i32.const	$push43=, 8
	i32.add 	$1=, $1, $pop43
	...
	tee_local	$push40=, $9=, $pop41
	i32.le_u	$push13=, $pop40, $7
...
.LBB0_7:                                # %for.end
	...
	f64.div 	$push51=, $pop21, $pop16
	tee_local	$push50=, $8=, $pop51
	f64.store	$drop=, 0($pop23), $pop50
	f64.mul 	$push24=, $11, $8
	f64.add 	$push49=, $10, $pop24
	tee_local	$push48=, $11=, $pop49
	f64.add 	$11=, $pop48, $11
.LBB0_8:                                # %if.end53
	end_block                       # label0:
	f64.store	$drop=, 0($5), $11
                                        # fallthrough-return
	.endfunc
.Lfunc_end0:
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop100), $pop138
	...
	i64.store	$drop=, 40($2), $pop7
	i32.const	$push135=, 0
	i64.load	$push8=, .Lmain.c($pop135)
	i64.store	$drop=, 32($2), $pop8
	...
	i32.store	$drop=, 80($2), $pop109
	i32.store	$drop=, 104($2), $2
	...
	i64.store	$drop=, 64($2), $pop17
	i64.const	$push18=, 4618441417868443648
	i64.store	$drop=, 72($2), $pop18
	i32.const	$push129=, 0
	i32.load	$push19=, .Lmain.e+4($pop129)
	i32.store	$drop=, 4($2), $pop19
	i32.const	$push128=, 0
	i32.load	$push20=, .Lmain.e($pop128)
	i32.store	$drop=, 0($2), $pop20
	i32.const	$push127=, 0
...
# BB#12:                                # %if.end46
	...
	i64.store	$drop=, 0($2), $pop87
	i32.const	$push156=, 0
	i64.load	$push88=, .Lmain.e+8($pop156)
	i64.store	$drop=, 8($2), $pop88
