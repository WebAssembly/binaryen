...
# BB#0:                                 # %entry
	...
	f64.store	$drop=, 0($0), $pop33
	f64.load	$push32=, 8($1)
	tee_local	$push31=, $11=, $pop32
	f64.store	$drop=, 8($0), $pop31
	i32.load	$5=, 16($0)
	block
	block
...
# BB#2:                                 # %if.then6
	f64.load	$push26=, 0($6)
	f64.mul 	$push38=, $4, $pop26
	tee_local	$push37=, $10=, $pop38
	f64.store	$drop=, 8($5), $pop37
	f64.add 	$push27=, $10, $10
	f64.store	$drop=, 0($5), $pop27
	return
.LBB0_3:                                # %if.then
	end_block                       # label1:
	i64.const	$push28=, 0
	i64.store	$drop=, 0($5), $pop28
	return
...
.LBB0_8:                                # %for.end
	...
	f64.store	$drop=, 0($pop23), $pop52
	f64.mul 	$push24=, $10, $8
	f64.add 	$push51=, $11, $pop24
	tee_local	$push50=, $10=, $pop51
	f64.add 	$push25=, $pop50, $10
	f64.store	$drop=, 0($5), $pop25
                                        # fallthrough-return
	.endfunc
.Lfunc_end0:
