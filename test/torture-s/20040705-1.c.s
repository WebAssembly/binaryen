...
# BB#0:                                 # %entry
	...
	i32.store16	$drop=, d+8($pop0), $pop2
	return
	.endfunc
.Lfunc_end15:
...
# BB#0:                                 # %entry
	...
	i32.store8	$drop=, d+10($pop0), $pop5
	return
	.endfunc
.Lfunc_end16:
...
# BB#0:                                 # %entry
	...
	i32.const	$push2=, 1
	i32.add 	$push3=, $pop1, $pop2
	i32.store16	$drop=, d+8($pop0), $pop3
	return
	.endfunc
.Lfunc_end24:
...
# BB#0:                                 # %entry
	...
	i32.const	$push6=, 24
	i32.shr_u	$push5=, $pop4, $pop6
	i32.store8	$drop=, d+11($pop0), $pop5
	return
	.endfunc
.Lfunc_end44:
...
# BB#0:                                 # %entry
	...
	i32.div_u	$push2=, $pop1, $0
	i32.store8	$drop=, d+10($pop0), $pop2
	return
	.endfunc
.Lfunc_end97:
...
# BB#0:                                 # %entry
	...
	i32.div_u	$push2=, $pop1, $0
	i32.store8	$drop=, d+11($pop0), $pop2
	return
	.endfunc
.Lfunc_end98:
...
# BB#0:                                 # %entry
	...
	i32.const	$push2=, 17
	i32.div_u	$push3=, $pop1, $pop2
	i32.store8	$drop=, d+10($pop0), $pop3
	return
	.endfunc
.Lfunc_end160:
...
# BB#0:                                 # %entry
	...
	i32.div_u	$push3=, $pop1, $pop2
	i32.store8	$drop=, d+11($pop0), $pop3
	return
	.endfunc
.Lfunc_end161:
...
# BB#0:                                 # %if.end1610
	...
	i32.store	$drop=, c+8($pop6), $pop2
	i32.const	$push5=, 0
	i32.const	$push3=, -1147377476
	i32.store	$drop=, d+8($pop5), $pop3
	i32.const	$push4=, 0
	return  	$pop4
	.endfunc
.Lfunc_end171:
