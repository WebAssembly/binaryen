...
# BB#0:                                 # %entry
	...
	i32.add 	$push1=, $pop7, $0
	i32.const	$push2=, 63
	i32.and 	$push3=, $pop1, $pop2
	i32.const	$push4=, -64
	i32.and 	$push5=, $1, $pop4
	i32.or  	$push6=, $pop3, $pop5
	i32.store	$discard=, b+8($pop0), $pop6
	return
	.endfunc
.Lfunc_end9:
...
# BB#0:                                 # %entry
	...
	i32.store	$discard=, b+8($pop0), $pop8
	return
	.endfunc
.Lfunc_end10:
...
# BB#0:                                 # %entry
	i32.const	$push0=, 0
	i32.const	$push5=, 0
	i32.load	$push1=, b+8($pop5)
	i32.const	$push2=, 17
	i32.shl 	$push3=, $0, $pop2
	i32.add 	$push4=, $pop1, $pop3
	i32.store	$discard=, b+8($pop0), $pop4
	return
	.endfunc
.Lfunc_end11:
...
# BB#0:                                 # %entry
	...
	i32.and 	$push5=, $1, $pop4
	i32.or  	$push6=, $pop3, $pop5
	i32.store	$discard=, c+8($pop0), $pop6
	return
	.endfunc
.Lfunc_end12:
...
# BB#0:                                 # %entry
	...
	i32.and 	$push7=, $1, $pop6
	i32.or  	$push8=, $pop5, $pop7
	i32.store	$discard=, c+8($pop0), $pop8
	return
	.endfunc
.Lfunc_end13:
...
# BB#0:                                 # %entry
	i32.const	$push0=, 0
	i32.const	$push5=, 0
	i32.load	$push1=, c+8($pop5)
	i32.const	$push2=, 6
	i32.shl 	$push3=, $0, $pop2
	i32.add 	$push4=, $pop1, $pop3
	i32.store	$discard=, c+8($pop0), $pop4
	return
	.endfunc
.Lfunc_end14:
...
# BB#0:                                 # %entry
	...
	i32.store16	$discard=, d+8($pop0), $pop2
	return
	.endfunc
.Lfunc_end15:
...
# BB#0:                                 # %entry
	i32.const	$push0=, 0
	i32.const	$push7=, 0
	i32.load	$push1=, d+8($pop7)
	i32.const	$push2=, 16
	i32.shl 	$push3=, $0, $pop2
	i32.add 	$push4=, $pop1, $pop3
	i32.const	$push6=, 16
	i32.shr_u	$push5=, $pop4, $pop6
	i32.store8	$discard=, d+10($pop0), $pop5
	return
	.endfunc
.Lfunc_end16:
...
# BB#0:                                 # %entry
	i32.const	$push0=, 0
	i32.const	$push5=, 0
	i32.load	$push1=, d+8($pop5)
	i32.const	$push2=, 24
	i32.shl 	$push3=, $0, $pop2
	i32.add 	$push4=, $pop1, $pop3
	i32.store	$discard=, d+8($pop0), $pop4
	return
	.endfunc
.Lfunc_end17:
...
# BB#0:                                 # %entry
	...
	i32.store	$discard=, b+8($pop0), $pop7
	return
	.endfunc
.Lfunc_end18:
...
# BB#0:                                 # %entry
	...
	i32.store	$discard=, b+8($pop0), $pop3
	return
	.endfunc
.Lfunc_end20:
...
# BB#0:                                 # %entry
	...
	i32.and 	$push6=, $1, $pop5
	i32.or  	$push7=, $pop4, $pop6
	i32.store	$discard=, c+8($pop0), $pop7
	return
	.endfunc
.Lfunc_end21:
...
# BB#0:                                 # %entry
	...
	i32.store	$discard=, c+8($pop0), $pop3
	return
	.endfunc
.Lfunc_end22:
...
# BB#0:                                 # %entry
	...
	i32.const	$push2=, 1
	i32.add 	$push3=, $pop1, $pop2
	i32.store16	$discard=, d+8($pop0), $pop3
	return
	.endfunc
.Lfunc_end24:
...
# BB#0:                                 # %entry
	...
	i32.add 	$push3=, $pop1, $pop2
	i32.store	$discard=, d+8($pop0), $pop3
	return
	.endfunc
.Lfunc_end26:
...
# BB#0:                                 # %entry
	...
	i32.load	$push1=, d+8($pop7)
	i32.and 	$push6=, $pop5, $pop1
	i32.store	$discard=, d+8($pop0), $pop6
	return
	.endfunc
.Lfunc_end70:
...
# BB#0:                                 # %entry
	...
	i32.store	$discard=, b+8($pop0), $pop9
	return
	.endfunc
.Lfunc_end91:
...
# BB#0:                                 # %entry
	...
	i32.and 	$push8=, $1, $pop7
	i32.or  	$push9=, $pop6, $pop8
	i32.store	$discard=, c+8($pop0), $pop9
	return
	.endfunc
.Lfunc_end94:
...
# BB#0:                                 # %entry
	...
	i32.div_u	$push2=, $pop1, $0
	i32.store8	$discard=, d+10($pop0), $pop2
	return
	.endfunc
.Lfunc_end97:
...
# BB#0:                                 # %entry
	...
	i32.store	$discard=, b+8($pop0), $pop10
	return
	.endfunc
.Lfunc_end154:
...
# BB#0:                                 # %entry
	...
	i32.load	$push9=, b+8($pop10)
	tee_local	$push8=, $1=, $pop9
	i32.const	$push1=, 2228224
	i32.div_u	$push2=, $pop8, $pop1
	i32.const	$push3=, 17
...
# BB#0:                                 # %entry
	...
	i32.const	$push2=, 17
	i32.div_u	$push3=, $pop1, $pop2
	i32.store8	$discard=, d+10($pop0), $pop3
	return
	.endfunc
.Lfunc_end160:
...
# BB#0:                                 # %entry
	...
	i32.and 	$push9=, $1, $pop8
	i32.or  	$push10=, $pop7, $pop9
	i32.store	$discard=, c+8($pop0), $pop10
	return
	.endfunc
.Lfunc_end166:
...
# BB#0:                                 # %if.end1610
	...
	i32.store	$discard=, b+8($pop1), $pop0
	i32.const	$push6=, 0
	i32.const	$push2=, -2147483595
	i32.store	$discard=, c+8($pop6), $pop2
	i32.const	$push5=, 0
	i32.const	$push3=, -1147377476
	i32.store	$discard=, d+8($pop5), $pop3
	i32.const	$push4=, 0
	return  	$pop4
	.endfunc
.Lfunc_end171:
