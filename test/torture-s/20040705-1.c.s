...
# BB#0:                                 # %entry
	...
	i32.store8	$drop=, d+10($pop2), $pop5
                                        # fallthrough-return
	.endfunc
.Lfunc_end16:
...
# BB#0:                                 # %entry
	...
	i32.const	$push6=, 24
	i32.shr_u	$push5=, $pop4, $pop6
	i32.store8	$drop=, d+11($pop2), $pop5
                                        # fallthrough-return
	.endfunc
.Lfunc_end44:
...
# BB#0:                                 # %if.end1610
	...
	i32.store	$drop=, c+8($pop1), $pop0
	i32.const	$push6=, 0
	i32.const	$push2=, 560051
	i32.store	$drop=, b+8($pop6), $pop2
	i32.const	$push5=, 0
