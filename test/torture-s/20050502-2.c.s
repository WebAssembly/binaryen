...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop17), $pop32
	i32.const	$push1=, 14
	...
	i32.store16	$drop=, 0($pop5), $pop3
	i32.const	$push29=, 0
	i64.load	$push6=, .Lmain.x($pop29):p2align=0
	i64.store	$drop=, 4($1):p2align=2, $pop6
	i32.const	$push7=, 8
...
# BB#1:                                 # %if.end
	i32.const	$push10=, 77
	i32.store8	$drop=, 0($0), $pop10
	i32.const	$push35=, 0
	i32.store8	$drop=, 12($1), $pop35
	i32.const	$push23=, 4
