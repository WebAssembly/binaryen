...
# BB#4:                                 # %to_hex.exit.i
	...
	i32.const	$push21=, 1
	i32.add 	$12=, $12, $pop21
	i32.load8_u	$push3=, .L.str($16)
	i32.eq  	$push4=, $15, $pop3
...
.LBB17_2:                               # %while.cond.i
	...
	i32.const	$push23=, 0
	i32.eq  	$push24=, $pop16, $pop23
	br_if   	2, $pop24       # 2: down to label66
# BB#3:                                 # %while.body.i
...
# BB#4:                                 # %to_hex.exit.i
	...
	i32.const	$push21=, 1
	i32.add 	$15=, $15, $pop21
	i32.load8_u	$push3=, .L.str($19)
	i32.eq  	$push4=, $18, $pop3
