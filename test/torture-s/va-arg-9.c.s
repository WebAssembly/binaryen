...
.LBB2_1:                                # %while.cond.i
	...
	i32.const	$push21=, 0
	i32.eq  	$push22=, $pop18, $pop21
	br_if   	3, $pop22       # 3: down to label7
# BB#2:                                 # %while.body.i
...
.LBB3_1:                                # %while.cond.i
	...
	i32.const	$push21=, 0
	i32.eq  	$push22=, $pop18, $pop21
	br_if   	3, $pop22       # 3: down to label12
# BB#2:                                 # %while.body.i
	...
	i32.const	$push13=, 16
	i32.ge_u	$push14=, $pop19, $pop13
	br_if   	2, $pop14       # 2: down to label13
# BB#3:                                 # %to_hex.exit.i
                                        #   in Loop: Header=BB3_1 Depth=1
	i32.const	$push15=, 1
	i32.add 	$1=, $1, $pop15
...
# BB#0:                                 # %entry
	...
	i32.const	$push4=, 14
	i32.ne  	$push5=, $pop3, $pop4
	br_if   	0, $pop5        # 0: down to label16
.LBB4_1:                                # %while.cond.i
                                        # =>This Inner Loop Header: Depth=1
	block
	block
...
# BB#2:                                 # %while.body.i
	...
	i32.const	$push13=, 16
	i32.ge_u	$push14=, $pop19, $pop13
	br_if   	2, $pop14       # 2: down to label18
# BB#3:                                 # %to_hex.exit.i
                                        #   in Loop: Header=BB4_1 Depth=1
	i32.const	$push15=, 1
	i32.add 	$2=, $2, $pop15
...
# BB#0:                                 # %entry
	...
	i32.const	$push4=, 13
	i32.ne  	$push5=, $pop3, $pop4
	br_if   	0, $pop5        # 0: down to label21
.LBB5_1:                                # %while.cond.i
                                        # =>This Inner Loop Header: Depth=1
	block
	block
	...
	i32.const	$push21=, 0
	i32.eq  	$push22=, $pop18, $pop21
	br_if   	3, $pop22       # 3: down to label22
# BB#2:                                 # %while.body.i
	...
	i32.const	$push13=, 16
	i32.ge_u	$push14=, $pop19, $pop13
	br_if   	2, $pop14       # 2: down to label23
# BB#3:                                 # %to_hex.exit.i
                                        #   in Loop: Header=BB5_1 Depth=1
	i32.const	$push15=, 1
	i32.add 	$3=, $3, $pop15
...
# BB#0:                                 # %entry
	...
	i32.const	$push4=, 12
	i32.ne  	$push5=, $pop3, $pop4
	br_if   	0, $pop5        # 0: down to label26
.LBB6_1:                                # %while.cond.i
                                        # =>This Inner Loop Header: Depth=1
	block
	block
	...
	i32.const	$push21=, 0
	i32.eq  	$push22=, $pop18, $pop21
	br_if   	3, $pop22       # 3: down to label27
# BB#2:                                 # %while.body.i
	...
	i32.const	$push13=, 16
	i32.ge_u	$push14=, $pop19, $pop13
	br_if   	2, $pop14       # 2: down to label28
# BB#3:                                 # %to_hex.exit.i
                                        #   in Loop: Header=BB6_1 Depth=1
	i32.const	$push15=, 1
	i32.add 	$4=, $4, $pop15
...
# BB#0:                                 # %entry
	...
	i32.const	$push4=, 11
	i32.ne  	$push5=, $pop3, $pop4
	br_if   	0, $pop5        # 0: down to label31
.LBB7_1:                                # %while.cond.i
                                        # =>This Inner Loop Header: Depth=1
	block
	block
	...
	i32.const	$push21=, 0
	i32.eq  	$push22=, $pop18, $pop21
	br_if   	3, $pop22       # 3: down to label32
# BB#2:                                 # %while.body.i
	...
	i32.const	$push13=, 16
	i32.ge_u	$push14=, $pop19, $pop13
	br_if   	2, $pop14       # 2: down to label33
# BB#3:                                 # %to_hex.exit.i
                                        #   in Loop: Header=BB7_1 Depth=1
	i32.const	$push15=, 1
	i32.add 	$5=, $5, $pop15
...
# BB#0:                                 # %entry
	...
	i32.const	$push4=, 10
	i32.ne  	$push5=, $pop3, $pop4
	br_if   	0, $pop5        # 0: down to label36
.LBB8_1:                                # %while.cond.i
                                        # =>This Inner Loop Header: Depth=1
	block
	block
	...
	i32.const	$push21=, 0
	i32.eq  	$push22=, $pop18, $pop21
	br_if   	3, $pop22       # 3: down to label37
# BB#2:                                 # %while.body.i
	...
	i32.const	$push13=, 16
	i32.ge_u	$push14=, $pop19, $pop13
	br_if   	2, $pop14       # 2: down to label38
# BB#3:                                 # %to_hex.exit.i
                                        #   in Loop: Header=BB8_1 Depth=1
	i32.const	$push15=, 1
	i32.add 	$6=, $6, $pop15
...
# BB#0:                                 # %entry
	...
	i32.const	$push4=, 9
	i32.ne  	$push5=, $pop3, $pop4
	br_if   	0, $pop5        # 0: down to label41
.LBB9_1:                                # %while.cond.i
                                        # =>This Inner Loop Header: Depth=1
	block
	block
	...
	i32.const	$push21=, 0
	i32.eq  	$push22=, $pop18, $pop21
	br_if   	3, $pop22       # 3: down to label42
# BB#2:                                 # %while.body.i
	...
	i32.const	$push13=, 16
	i32.ge_u	$push14=, $pop19, $pop13
	br_if   	2, $pop14       # 2: down to label43
# BB#3:                                 # %to_hex.exit.i
                                        #   in Loop: Header=BB9_1 Depth=1
	i32.const	$push15=, 1
	i32.add 	$7=, $7, $pop15
...
# BB#0:                                 # %entry
	...
	i32.const	$push4=, 8
	i32.ne  	$push5=, $pop3, $pop4
	br_if   	0, $pop5        # 0: down to label46
.LBB10_1:                               # %while.cond.i
	...
	i32.const	$push21=, 0
	i32.eq  	$push22=, $pop18, $pop21
	br_if   	3, $pop22       # 3: down to label47
# BB#2:                                 # %while.body.i
	...
	i32.const	$push13=, 16
	i32.ge_u	$push14=, $pop19, $pop13
	br_if   	2, $pop14       # 2: down to label48
# BB#3:                                 # %to_hex.exit.i
                                        #   in Loop: Header=BB10_1 Depth=1
	i32.const	$push15=, 1
	i32.add 	$8=, $8, $pop15
...
# BB#0:                                 # %entry
	...
	i32.const	$push4=, 7
	i32.ne  	$push5=, $pop3, $pop4
	br_if   	0, $pop5        # 0: down to label51
.LBB11_1:                               # %while.cond.i
	...
	i32.const	$push21=, 0
	i32.eq  	$push22=, $pop18, $pop21
	br_if   	3, $pop22       # 3: down to label52
# BB#2:                                 # %while.body.i
	...
	i32.const	$push13=, 16
	i32.ge_u	$push14=, $pop19, $pop13
	br_if   	2, $pop14       # 2: down to label53
# BB#3:                                 # %to_hex.exit.i
                                        #   in Loop: Header=BB11_1 Depth=1
	i32.const	$push15=, 1
	i32.add 	$9=, $9, $pop15
...
.LBB12_1:                               # %while.cond.i
	...
	i32.const	$push21=, 0
	i32.eq  	$push22=, $pop18, $pop21
	br_if   	3, $pop22       # 3: down to label57
# BB#2:                                 # %while.body.i
	...
	i32.const	$push13=, 16
	i32.ge_u	$push14=, $pop19, $pop13
	br_if   	2, $pop14       # 2: down to label58
# BB#3:                                 # %to_hex.exit.i
                                        #   in Loop: Header=BB12_1 Depth=1
	i32.const	$push15=, 1
	i32.add 	$10=, $10, $pop15
...
# BB#0:                                 # %entry
	...
	i32.const	$push4=, 5
	i32.ne  	$push5=, $pop3, $pop4
	br_if   	0, $pop5        # 0: down to label61
.LBB13_1:                               # %while.cond.i
	...
	i32.const	$push21=, 0
	i32.eq  	$push22=, $pop18, $pop21
	br_if   	3, $pop22       # 3: down to label62
# BB#2:                                 # %while.body.i
	...
	i32.const	$push13=, 16
	i32.ge_u	$push14=, $pop19, $pop13
	br_if   	2, $pop14       # 2: down to label63
# BB#3:                                 # %to_hex.exit.i
                                        #   in Loop: Header=BB13_1 Depth=1
	i32.const	$push15=, 1
	i32.add 	$11=, $11, $pop15
...
# BB#0:                                 # %entry
	...
	i32.const	$push4=, 4
	i32.ne  	$push5=, $pop3, $pop4
	br_if   	0, $pop5        # 0: down to label66
.LBB14_1:                               # %while.cond.i
	...
	i32.const	$push21=, 0
	i32.eq  	$push22=, $pop18, $pop21
	br_if   	3, $pop22       # 3: down to label67
# BB#2:                                 # %while.body.i
	...
	i32.const	$push13=, 16
	i32.ge_u	$push14=, $pop19, $pop13
	br_if   	2, $pop14       # 2: down to label68
# BB#3:                                 # %to_hex.exit.i
                                        #   in Loop: Header=BB14_1 Depth=1
	i32.const	$push15=, 1
	i32.add 	$12=, $12, $pop15
...
# BB#0:                                 # %entry
	...
	i32.const	$push4=, 3
	i32.ne  	$push5=, $pop3, $pop4
	br_if   	0, $pop5        # 0: down to label71
.LBB15_1:                               # %while.cond.i
	...
	i32.const	$push21=, 0
	i32.eq  	$push22=, $pop18, $pop21
	br_if   	3, $pop22       # 3: down to label72
# BB#2:                                 # %while.body.i
	...
	i32.const	$push13=, 16
	i32.ge_u	$push14=, $pop19, $pop13
	br_if   	2, $pop14       # 2: down to label73
# BB#3:                                 # %to_hex.exit.i
                                        #   in Loop: Header=BB15_1 Depth=1
	i32.const	$push15=, 1
	i32.add 	$13=, $13, $pop15
...
# BB#0:                                 # %entry
	...
	i32.const	$push4=, 2
	i32.ne  	$push5=, $pop3, $pop4
	br_if   	0, $pop5        # 0: down to label76
.LBB16_1:                               # %while.cond.i
	...
	i32.const	$push21=, 0
	i32.eq  	$push22=, $pop18, $pop21
	br_if   	3, $pop22       # 3: down to label77
# BB#2:                                 # %while.body.i
	...
	i32.const	$push13=, 16
	i32.ge_u	$push14=, $pop19, $pop13
	br_if   	2, $pop14       # 2: down to label78
# BB#3:                                 # %to_hex.exit.i
                                        #   in Loop: Header=BB16_1 Depth=1
	i32.const	$push15=, 1
	i32.add 	$14=, $14, $pop15
...
# BB#0:                                 # %entry
	...
	i32.const	$push4=, 1
	i32.ne  	$push5=, $pop3, $pop4
	br_if   	0, $pop5        # 0: down to label81
.LBB17_1:                               # %while.cond.i
	...
	i32.const	$push21=, 0
	i32.eq  	$push22=, $pop18, $pop21
	br_if   	3, $pop22       # 3: down to label82
# BB#2:                                 # %while.body.i
	...
	i32.const	$push13=, 16
	i32.ge_u	$push14=, $pop19, $pop13
	br_if   	2, $pop14       # 2: down to label83
# BB#3:                                 # %to_hex.exit.i
                                        #   in Loop: Header=BB17_1 Depth=1
	i32.const	$push15=, 1
	i32.add 	$15=, $15, $pop15
