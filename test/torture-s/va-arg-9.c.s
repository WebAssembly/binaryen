...
.LBB2_2:                                # %while.cond.i
	...
	br_if   	2, $pop24       # 2: down to label4
# BB#3:                                 # %while.body.i
...
.LBB5_2:                                # %while.cond.i
	...
	i32.eqz 	$push24=, $pop16
	br_if   	2, $pop24       # 2: down to label13
# BB#3:                                 # %while.body.i
...
.LBB6_2:                                # %while.cond.i
	...
	i32.eqz 	$push24=, $pop16
	br_if   	2, $pop24       # 2: down to label16
# BB#3:                                 # %while.body.i
...
.LBB7_2:                                # %while.cond.i
	...
	i32.eqz 	$push24=, $pop16
	br_if   	2, $pop24       # 2: down to label19
# BB#3:                                 # %while.body.i
...
.LBB9_2:                                # %while.cond.i
	...
	i32.eqz 	$push24=, $pop16
	br_if   	2, $pop24       # 2: down to label25
# BB#3:                                 # %while.body.i
...
.LBB10_2:                               # %while.cond.i
	...
	i32.eqz 	$push24=, $pop16
	br_if   	2, $pop24       # 2: down to label28
# BB#3:                                 # %while.body.i
...
.LBB11_2:                               # %while.cond.i
	...
	i32.eqz 	$push24=, $pop16
	br_if   	2, $pop24       # 2: down to label31
# BB#3:                                 # %while.body.i
...
# BB#3:                                 # %while.body.i
	...
	i32.const	$push18=, 16
	i32.ge_u	$push3=, $pop19, $pop18
	br_if   	1, $pop3        # 1: down to label35
# BB#4:                                 # %to_hex.exit.i
                                        #   in Loop: Header=BB12_2 Depth=1
	i32.const	$push23=, 1
	i32.add 	$10=, $10, $pop23
...
# BB#0:                                 # %entry
	...
	i32.const	$push1=, 5
	i32.ne  	$push2=, $pop0, $pop1
	br_if   	0, $pop2        # 0: down to label38
# BB#1:                                 # %while.cond.i.preheader
	i32.load	$12=, 12($15)
.LBB13_2:                               # %while.cond.i
	...
	i32.eqz 	$push24=, $pop16
	br_if   	2, $pop24       # 2: down to label37
# BB#3:                                 # %while.body.i
...
# BB#0:                                 # %entry
	...
	i32.const	$push13=, 4
	i32.ne  	$push1=, $pop0, $pop13
	br_if   	0, $pop1        # 0: down to label41
# BB#1:                                 # %while.cond.i.preheader
	i32.load	$13=, 12($16)
...
# BB#3:                                 # %while.body.i
	...
	i32.const	$push18=, 16
	i32.ge_u	$push2=, $pop19, $pop18
	br_if   	1, $pop2        # 1: down to label41
# BB#4:                                 # %to_hex.exit.i
                                        #   in Loop: Header=BB14_2 Depth=1
	i32.const	$push23=, 1
	i32.add 	$12=, $12, $pop23
...
.LBB15_2:                               # %while.cond.i
	...
	i32.eqz 	$push24=, $pop16
	br_if   	2, $pop24       # 2: down to label43
# BB#3:                                 # %while.body.i
	...
	i32.const	$push18=, 16
	i32.ge_u	$push3=, $pop19, $pop18
	br_if   	1, $pop3        # 1: down to label44
# BB#4:                                 # %to_hex.exit.i
                                        #   in Loop: Header=BB15_2 Depth=1
	i32.const	$push23=, 1
	i32.add 	$13=, $13, $pop23
...
# BB#0:                                 # %entry
	...
	i32.const	$push1=, 2
	i32.ne  	$push2=, $pop0, $pop1
	br_if   	0, $pop2        # 0: down to label47
# BB#1:                                 # %while.cond.i.preheader
	i32.load	$15=, 12($18)
...
# BB#0:                                 # %entry
	...
	i32.const	$push13=, 1
	i32.ne  	$push1=, $pop0, $pop13
	br_if   	0, $pop1        # 0: down to label50
# BB#1:                                 # %while.cond.i.preheader
	i32.load	$16=, 12($19)
.LBB17_2:                               # %while.cond.i
	...
	i32.eqz 	$push24=, $pop16
	br_if   	2, $pop24       # 2: down to label49
# BB#3:                                 # %while.body.i
	...
	i32.const	$push18=, 16
	i32.ge_u	$push2=, $pop19, $pop18
	br_if   	1, $pop2        # 1: down to label50
# BB#4:                                 # %to_hex.exit.i
                                        #   in Loop: Header=BB17_2 Depth=1
	i32.const	$push23=, 1
	i32.add 	$15=, $15, $pop23
