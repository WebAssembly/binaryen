...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, bad_addr+40($pop0), $pop6
	i32.const	$push55=, 0
	i32.const	$push7=, 2048
	i32.store	$drop=, bad_addr+44($pop55), $pop7
	i32.const	$push54=, 0
	i32.const	$push8=, 4096
	i32.store	$drop=, bad_addr+48($pop54), $pop8
	i32.const	$push53=, 0
	i32.const	$push9=, 8192
	i32.store	$drop=, bad_addr+52($pop53), $pop9
	i32.const	$push52=, 0
	i32.const	$push10=, 16384
	i32.store	$drop=, bad_addr+56($pop52), $pop10
	i32.const	$push51=, 0
	i32.const	$push11=, 32768
	i32.store	$drop=, bad_addr+60($pop51), $pop11
	i32.const	$push50=, 0
	i32.const	$push12=, 65536
	i32.store	$drop=, bad_addr+64($pop50), $pop12
	i32.const	$push49=, 0
	i32.const	$push13=, 131072
	i32.store	$drop=, bad_addr+68($pop49), $pop13
	i32.const	$push48=, 0
	i32.const	$push14=, 262144
	i32.store	$drop=, bad_addr+72($pop48), $pop14
	i32.const	$push47=, 0
	i32.const	$push15=, 524288
	i32.store	$drop=, bad_addr+76($pop47), $pop15
	i32.const	$push46=, 0
	i32.const	$push16=, 1048576
	i32.store	$drop=, bad_addr+80($pop46), $pop16
	i32.const	$push45=, 0
	i32.const	$push17=, 2097152
	i32.store	$drop=, bad_addr+84($pop45), $pop17
	i32.const	$push44=, 0
	i32.const	$push18=, 4194304
	i32.store	$drop=, bad_addr+88($pop44), $pop18
	i32.const	$push43=, 0
	i32.const	$push19=, 8388608
	i32.store	$drop=, bad_addr+92($pop43), $pop19
	i32.const	$push42=, 0
	i32.const	$push20=, 16777216
	i32.store	$drop=, bad_addr+96($pop42), $pop20
	i32.const	$push41=, 0
	i32.const	$push21=, 33554432
	i32.store	$drop=, bad_addr+100($pop41), $pop21
	i32.const	$push40=, 0
	i32.const	$push22=, 67108864
	i32.store	$drop=, bad_addr+104($pop40), $pop22
	i32.const	$push39=, 0
	i32.const	$push23=, 134217728
	i32.store	$drop=, bad_addr+108($pop39), $pop23
	i32.const	$push38=, 0
	i32.const	$push24=, 268435456
	i32.store	$drop=, bad_addr+112($pop38), $pop24
	i32.const	$push37=, 0
	i32.const	$push25=, 536870912
	i32.store	$drop=, bad_addr+116($pop37), $pop25
	i32.const	$push36=, 0
	i32.const	$push26=, 1073741824
	i32.store	$drop=, bad_addr+120($pop36), $pop26
	i32.const	$push35=, 0
	i32.const	$push27=, -2147483648
	i32.store	$drop=, bad_addr+124($pop35), $pop27
	i32.const	$push34=, 0
	i32.const	$push28=, 33
	i32.store	$drop=, arr_used($pop34), $pop28
	i32.const	$push33=, 0
	i64.const	$push1=, 8589934593
	i64.store	$drop=, bad_addr($pop33), $pop1
	i32.const	$push32=, 0
	i64.const	$push2=, 34359738372
	i64.store	$drop=, bad_addr+8($pop32), $pop2
	i32.const	$push31=, 0
	i64.const	$push3=, 137438953488
	i64.store	$drop=, bad_addr+16($pop31), $pop3
	i32.const	$push30=, 0
	i64.const	$push4=, 549755813952
	i64.store	$drop=, bad_addr+24($pop30), $pop4
	i32.const	$push29=, 0
	i64.const	$push5=, 2199023255808
	i64.store	$drop=, bad_addr+32($pop29), $pop5
	return
	.endfunc
.Lfunc_end0:
