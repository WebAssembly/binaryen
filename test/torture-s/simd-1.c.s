...
# BB#0:                                 # %entry
	...
	i32.const	$push209=, 0
	i32.add 	$push5=, $3, $0
	i32.store	$0=, k+8($pop209), $pop5
	i32.const	$push208=, 0
	i32.add 	$push4=, $4, $1
	i32.store	$1=, k+4($pop208), $pop4
	i32.const	$push207=, 0
	i32.add 	$push3=, $5, $2
	i32.store	$2=, k($pop207), $pop3
	i32.const	$push206=, 0
	i32.store	$5=, res+12($pop206), $6
	i32.const	$push205=, 0
	i32.store	$discard=, res+8($pop205), $0
	i32.const	$push204=, 0
	i32.store	$discard=, res+4($pop204), $1
	i32.const	$push203=, 0
	i32.store	$push7=, res($pop203), $2
	...
	i32.const	$push193=, 0
	i32.mul 	$push16=, $3, $0
	i32.store	$0=, k+8($pop193), $pop16
	i32.const	$push192=, 0
	i32.mul 	$push15=, $4, $1
	i32.store	$1=, k+4($pop192), $pop15
	i32.const	$push191=, 0
	i32.mul 	$push14=, $5, $2
	i32.store	$2=, k($pop191), $pop14
	i32.const	$push190=, 0
	i32.store	$5=, res+12($pop190), $6
	i32.const	$push189=, 0
	i32.store	$discard=, res+8($pop189), $0
	i32.const	$push188=, 0
	i32.store	$discard=, res+4($pop188), $1
	i32.const	$push187=, 0
	i32.store	$push18=, res($pop187), $2
	...
	i32.const	$push186=, 0
	i32.load	$push26=, i($pop186)
	i32.const	$push185=, 0
	i32.load	$push30=, j($pop185)
	...
	i32.const	$push182=, 0
	i32.load	$push24=, i+8($pop182)
	i32.const	$push181=, 0
	i32.load	$push28=, j+8($pop181)
	...
	i32.const	$push177=, 0
	i32.store	$discard=, k+8($pop177), $2
	i32.const	$push176=, 0
	i32.store	$discard=, k+4($pop176), $1
	i32.const	$push175=, 0
	i32.store	$discard=, k($pop175), $0
	i32.const	$push174=, 0
	i32.store	$discard=, res+12($pop174), $5
	i32.const	$push173=, 0
	i32.store	$discard=, res+8($pop173), $2
	i32.const	$push172=, 0
	i32.store	$discard=, res+4($pop172), $1
	i32.const	$push171=, 0
	i32.store	$push32=, res($pop171), $0
	i32.const	$push35=, 15
	i32.const	$push34=, 7
	i32.const	$push170=, 7
	i32.const	$push33=, 6
	...
	i32.const	$push160=, 0
	i32.and 	$push40=, $3, $0
	i32.store	$0=, k+8($pop160), $pop40
	i32.const	$push159=, 0
	i32.and 	$push39=, $4, $1
	i32.store	$1=, k+4($pop159), $pop39
	i32.const	$push158=, 0
	i32.and 	$push38=, $5, $2
	i32.store	$2=, k($pop158), $pop38
	i32.const	$push157=, 0
	i32.store	$5=, res+12($pop157), $6
	i32.const	$push156=, 0
	i32.store	$discard=, res+8($pop156), $0
	i32.const	$push155=, 0
	i32.store	$discard=, res+4($pop155), $1
	i32.const	$push154=, 0
	i32.store	$push42=, res($pop154), $2
	i32.const	$push46=, 2
	i32.const	$push45=, 4
	i32.const	$push44=, 20
	i32.const	$push43=, 8
	...
	i32.const	$push144=, 0
	i32.or  	$push51=, $3, $0
	i32.store	$0=, k+8($pop144), $pop51
	i32.const	$push143=, 0
	i32.or  	$push50=, $4, $1
	i32.store	$1=, k+4($pop143), $pop50
	i32.const	$push142=, 0
	i32.or  	$push49=, $5, $2
	i32.store	$2=, k($pop142), $pop49
	i32.const	$push141=, 0
	i32.store	$5=, res+12($pop141), $6
	i32.const	$push140=, 0
	i32.store	$discard=, res+8($pop140), $0
	i32.const	$push139=, 0
	i32.store	$discard=, res+4($pop139), $1
	i32.const	$push138=, 0
	i32.store	$push53=, res($pop138), $2
	...
	i32.const	$push128=, 0
	i32.xor 	$push62=, $0, $3
	i32.store	$0=, k+8($pop128), $pop62
	i32.const	$push127=, 0
	i32.xor 	$push61=, $1, $4
	i32.store	$1=, k+4($pop127), $pop61
	i32.const	$push126=, 0
	i32.xor 	$push60=, $2, $5
	i32.store	$2=, k($pop126), $pop60
	i32.const	$push125=, 0
	i32.store	$5=, res+12($pop125), $6
	i32.const	$push124=, 0
	i32.store	$discard=, res+8($pop124), $0
	i32.const	$push123=, 0
	i32.store	$discard=, res+4($pop123), $1
	i32.const	$push122=, 0
	i32.store	$push64=, res($pop122), $2
	...
	i32.store	$0=, k($pop111), $pop70
	i32.const	$push109=, 0
	i32.store	$discard=, res+12($pop109), $5
	i32.const	$push108=, 0
	i32.store	$discard=, res+8($pop108), $2
	i32.const	$push107=, 0
	i32.store	$discard=, res+4($pop107), $1
	i32.const	$push106=, 0
	i32.store	$push74=, res($pop106), $0
	...
	i32.store	$0=, k($pop95), $pop80
	i32.const	$push93=, 0
	i32.store	$discard=, res+12($pop93), $5
	i32.const	$push92=, 0
	i32.store	$discard=, res+8($pop92), $2
	i32.const	$push91=, 0
	i32.store	$discard=, res+4($pop91), $1
	i32.const	$push90=, 0
	i32.store	$push84=, res($pop90), $0
