...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, k+12($pop0), $pop277
	i32.const	$push276=, 0
	i32.const	$push275=, 0
	...
	i32.store	$drop=, k+8($pop276), $pop272
	i32.const	$push271=, 0
	i32.const	$push270=, 0
	...
	i32.store	$drop=, k+4($pop271), $pop267
	i32.const	$push266=, 0
	i32.const	$push265=, 0
	...
	i32.store	$drop=, k($pop266), $pop262
	i32.const	$push261=, 0
	i32.store	$drop=, res+12($pop261), $0
	i32.const	$push260=, 0
	i32.store	$drop=, res+8($pop260), $1
	i32.const	$push259=, 0
	i32.store	$drop=, res+4($pop259), $2
	i32.const	$push258=, 0
	i32.store	$drop=, res($pop258), $3
	...
	i32.store	$drop=, k+12($pop257), $pop253
	i32.const	$push252=, 0
	i32.const	$push251=, 0
	...
	i32.store	$drop=, k+8($pop252), $pop248
	i32.const	$push247=, 0
	i32.const	$push246=, 0
	...
	i32.store	$drop=, k+4($pop247), $pop243
	i32.const	$push242=, 0
	i32.const	$push241=, 0
	...
	i32.store	$drop=, k($pop242), $pop238
	i32.const	$push237=, 0
	i32.store	$drop=, res+12($pop237), $0
	i32.const	$push236=, 0
	i32.store	$drop=, res+8($pop236), $1
	i32.const	$push235=, 0
	i32.store	$drop=, res+4($pop235), $2
	i32.const	$push234=, 0
	i32.store	$drop=, res($pop234), $3
	...
	i32.store	$drop=, k+12($pop233), $pop229
	i32.const	$push228=, 0
	i32.const	$push227=, 0
	...
	i32.store	$drop=, k+8($pop228), $pop224
	i32.const	$push223=, 0
	i32.const	$push222=, 0
	...
	i32.store	$drop=, k+4($pop223), $pop219
	i32.const	$push218=, 0
	i32.const	$push217=, 0
	...
	i32.store	$drop=, k($pop218), $pop214
	i32.const	$push213=, 0
	...
	i32.store	$drop=, k+12($pop208), $pop204
	i32.const	$push203=, 0
	i32.const	$push202=, 0
	...
	i32.store	$drop=, k+8($pop203), $pop199
	i32.const	$push198=, 0
	i32.const	$push197=, 0
	...
	i32.store	$drop=, k+4($pop198), $pop194
	i32.const	$push193=, 0
	i32.const	$push192=, 0
	...
	i32.store	$drop=, k($pop193), $pop189
	i32.const	$push188=, 0
	i32.store	$drop=, res+12($pop188), $0
	i32.const	$push187=, 0
	i32.store	$drop=, res+8($pop187), $1
	i32.const	$push186=, 0
	i32.store	$drop=, res+4($pop186), $2
	i32.const	$push185=, 0
	i32.store	$drop=, res($pop185), $3
	i32.const	$push47=, 2
	i32.const	$push46=, 4
	i32.const	$push45=, 20
	i32.const	$push44=, 8
	...
	i32.store	$drop=, k+12($pop184), $pop180
	i32.const	$push179=, 0
	i32.const	$push178=, 0
	...
	i32.store	$drop=, k+8($pop179), $pop175
	i32.const	$push174=, 0
	i32.const	$push173=, 0
	...
	i32.store	$drop=, k+4($pop174), $pop170
	i32.const	$push169=, 0
	i32.const	$push168=, 0
	...
	i32.store	$drop=, k($pop169), $pop165
	i32.const	$push164=, 0
	...
	i32.store	$drop=, k+12($pop160), $pop156
	i32.const	$push155=, 0
	i32.const	$push154=, 0
	...
	i32.store	$drop=, k+8($pop155), $pop151
	i32.const	$push150=, 0
	i32.const	$push149=, 0
	...
	i32.store	$drop=, k+4($pop150), $pop146
	i32.const	$push145=, 0
	i32.const	$push144=, 0
	...
	i32.store	$drop=, k($pop145), $pop141
	i32.const	$push140=, 0
	i32.store	$drop=, res+12($pop140), $0
	i32.const	$push139=, 0
	i32.store	$drop=, res+8($pop139), $1
	i32.const	$push138=, 0
	i32.store	$drop=, res+4($pop138), $2
	i32.const	$push137=, 0
	i32.store	$drop=, res($pop137), $3
	...
	i32.store	$drop=, k+12($pop136), $pop132
	i32.const	$push131=, 0
	i32.const	$push130=, 0
	i32.const	$push129=, 0
	...
	i32.store	$drop=, k+8($pop131), $pop127
	i32.const	$push126=, 0
	i32.const	$push125=, 0
	i32.const	$push124=, 0
	...
	i32.store	$drop=, k+4($pop126), $pop122
	i32.const	$push121=, 0
	i32.const	$push120=, 0
	i32.const	$push119=, 0
	...
	i32.store	$drop=, k($pop121), $pop117
	i32.const	$push116=, 0
	i32.store	$drop=, res+12($pop116), $0
	i32.const	$push115=, 0
	i32.store	$drop=, res+8($pop115), $1
	i32.const	$push114=, 0
	i32.store	$drop=, res+4($pop114), $2
	i32.const	$push113=, 0
	i32.store	$drop=, res($pop113), $3
	...
	i32.store	$drop=, k+12($pop111), $pop108
	i32.const	$push107=, 0
	i32.const	$push106=, 0
	...
	i32.store	$drop=, k+8($pop107), $pop103
	i32.const	$push102=, 0
	i32.const	$push101=, 0
	...
	i32.store	$drop=, k+4($pop102), $pop98
	i32.const	$push97=, 0
	i32.const	$push96=, 0
	...
	i32.store	$drop=, k($pop97), $pop93
	i32.const	$push92=, 0
	i32.store	$drop=, res+12($pop92), $0
	i32.const	$push91=, 0
	i32.store	$drop=, res+8($pop91), $1
	i32.const	$push90=, 0
	i32.store	$drop=, res+4($pop90), $2
	i32.const	$push89=, 0
	i32.store	$drop=, res($pop89), $3
