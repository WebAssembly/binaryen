...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop17), $pop23
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop13), $pop20
	i32.const	$push0=, 1310730
	i32.store	$drop=, 32($0), $pop0
	i32.const	$push1=, 21
	i32.store16	$drop=, 38($0), $pop1
	i32.const	$push2=, 11
	i32.store16	$drop=, 36($0), $pop2
