...
# BB#0:                                 # %if.end
	i32.const	$push1=, 0
	i64.const	$push3=, 1
	i64.store	$discard=, bid_Kx192+32($pop1), $pop3
	i32.const	$push64=, 0
	i32.const	$push63=, 0
	i32.const	$push62=, 0
	i32.const	$push61=, 0
	...
	i64.store	$push5=, bid_Kx192+80($pop36), $pop4
	i64.store	$push6=, bid_Kx192+104($pop37), $pop5
	i64.store	$push7=, bid_Kx192+128($pop38), $pop6
	i64.store	$push8=, bid_Kx192+152($pop39), $pop7
	i64.store	$push9=, bid_Kx192+176($pop40), $pop8
	i64.store	$push10=, bid_Kx192+200($pop41), $pop9
	i64.store	$push11=, bid_Kx192+224($pop42), $pop10
	i64.store	$push12=, bid_Kx192+248($pop43), $pop11
	i64.store	$push13=, bid_Kx192+272($pop44), $pop12
	i64.store	$push14=, bid_Kx192+296($pop45), $pop13
	i64.store	$push15=, bid_Kx192+320($pop46), $pop14
	i64.store	$push16=, bid_Kx192+344($pop47), $pop15
	i64.store	$push17=, bid_Kx192+368($pop48), $pop16
	i64.store	$push18=, bid_Kx192+392($pop49), $pop17
	i64.store	$push19=, bid_Kx192+416($pop50), $pop18
	i64.store	$push20=, bid_Kx192+440($pop51), $pop19
	i64.store	$push21=, bid_Kx192+464($pop52), $pop20
	i64.store	$push22=, bid_Kx192+488($pop53), $pop21
	i64.store	$push23=, bid_Kx192+512($pop54), $pop22
	i64.store	$push24=, bid_Kx192+536($pop55), $pop23
	i64.store	$push25=, bid_Kx192+560($pop56), $pop24
	i64.store	$push26=, bid_Kx192+584($pop57), $pop25
	i64.store	$push27=, bid_Kx192+608($pop58), $pop26
	i64.store	$push28=, bid_Kx192+632($pop59), $pop27
	i64.store	$push29=, bid_Kx192+656($pop60), $pop28
	i64.store	$push30=, bid_Kx192+680($pop61), $pop29
	i64.store	$push31=, bid_Kx192+704($pop62), $pop30
	i64.store	$push32=, bid_Kx192+728($pop63), $pop31
	i64.store	$discard=, bid_Kx192+752($pop64), $pop32
	i32.const	$push33=, 0
	return  	$pop33
	.endfunc
.Lfunc_end0:
