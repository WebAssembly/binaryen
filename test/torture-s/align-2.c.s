...
# BB#12:                                # %if.end53
	...
	br_if   	0, $pop38       # 0: down to label12
# BB#13:                                # %if.end58
	block
	i32.const	$push108=, 0
...
# BB#15:                                # %if.end66
	...
	br_if   	0, $pop47       # 0: down to label15
# BB#16:                                # %if.end70
	block
	i32.const	$push111=, 0
...
# BB#18:                                # %if.end79
	...
	br_if   	0, $pop56       # 0: down to label18
# BB#19:                                # %if.end84
	block
	i32.const	$push115=, 0
	...
	br_if   	0, $pop61       # 0: down to label19
# BB#20:                                # %if.end88
	block
	i32.const	$push116=, 0
...
# BB#23:                                # %if.end101
	...
	br_if   	0, $pop77       # 0: down to label23
# BB#24:                                # %if.end105
	block
	i32.const	$push122=, 0
	...
	br_if   	0, $pop80       # 0: down to label24
# BB#25:                                # %if.end110
	block
	i32.const	$push124=, 0
	...
	br_if   	0, $pop85       # 0: down to label25
# BB#26:                                # %if.end114
	block
	i32.const	$push125=, 0
	...
	br_if   	0, $pop88       # 0: down to label26
# BB#27:                                # %if.end118
	block
	i32.const	$push127=, 0
	...
	br_if   	0, $pop93       # 0: down to label27
# BB#28:                                # %if.end122
	i32.const	$push94=, 0
	return  	$pop94
.LBB0_29:                               # %if.then121
