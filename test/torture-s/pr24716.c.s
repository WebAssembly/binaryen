...
.LBB0_7:                                # %do.body10.preheader
	...
	end_block                       # label4:
	i32.const	$push12=, 2
	i32.shl 	$push4=, $0, $pop12
	i32.const	$push11=, W
	i32.add 	$2=, $pop4, $pop11
.LBB0_8:                                # %do.body10
                                        #   Parent Loop BB0_1 Depth=1
...
.LBB0_11:                               # %do.cond16
	...
	i32.const	$4=, 0
	i32.const	$push14=, 1
	i32.lt_s	$push5=, $1, $pop14
	br_if   	0, $pop5        # 0: up to label9
# BB#12:                                # %do.cond19
                                        #   in Loop: Header=BB0_8 Depth=2
	end_loop                        # label10:
	i32.const	$push15=, 0
	i32.gt_s	$push6=, $0, $pop15
...
.LBB1_11:                               # %do.cond33.i
	...
	loop                            # label28:
	i32.const	$push19=, 2
	i32.shl 	$push6=, $4, $pop19
	i32.load	$push18=, Link($pop6)
	tee_local	$push17=, $4=, $pop18
	i32.const	$push5=, -1
	i32.ne  	$push7=, $pop17, $pop5
