...
# BB#0:                                 # %entry
	...
	i32.store8	$drop=, 0($pop32), $pop7
	i64.load	$2=, 0($8)
	i32.const	$push31=, 16
	i32.add 	$push30=, $10, $pop31
	tee_local	$push29=, $5=, $pop30
	i64.store	$drop=, 0($pop29), $1
	i64.load	$1=, 32($10)
	i32.const	$push28=, 8
	i32.add 	$push27=, $10, $pop28
	tee_local	$push26=, $4=, $pop27
	i64.store	$drop=, 0($pop26), $2
	i64.store	$drop=, 0($10), $1
	i32.const	$push8=, 1
	...
	i32.store8	$drop=, 0($6), $pop9
	i64.store	$drop=, 0($5), $1
	i64.store	$drop=, 0($4), $2
	i64.store	$drop=, 0($10), $3
...
# BB#0:                                 # %entry
	...
	i32.store8	$drop=, 0($pop43), $pop7
	i64.load	$2=, 0($8)
	i32.const	$push42=, 16
	i32.add 	$push41=, $9, $pop42
	tee_local	$push40=, $5=, $pop41
	i64.store	$drop=, 0($pop40), $1
	i64.load	$1=, 32($9)
	i32.const	$push39=, 8
	i32.add 	$push38=, $9, $pop39
	tee_local	$push37=, $4=, $pop38
	i64.store	$drop=, 0($pop37), $2
	i64.store	$drop=, 0($9), $1
	i32.const	$push8=, 1
...
# BB#0:                                 # %entry
	...
	i32.load	$push17=, 0($8)
	i32.store	$drop=, 0($pop52):p2align=0, $pop17
	i32.const	$push7=, 12
	...
	tee_local	$push48=, $8=, $pop49
	i32.load	$push20=, 0($9)
	i32.store	$drop=, 0($pop48):p2align=0, $pop20
	i32.const	$push21=, 4
	i32.add 	$push22=, $4, $pop21
	i32.load	$push23=, 36($11)
	i32.store	$drop=, 0($pop22):p2align=0, $pop23
	i32.load8_u	$push24=, 0($7)
	i32.store8	$drop=, 0($3), $pop24
	i64.load	$push25=, 0($6)
	i64.store	$drop=, 0($10):p2align=0, $pop25
	i64.load	$push26=, 0($5)
	i64.store	$drop=, 0($8):p2align=0, $pop26
	i64.load	$push27=, 0($11)
	i64.store	$drop=, 0($4):p2align=0, $pop27
