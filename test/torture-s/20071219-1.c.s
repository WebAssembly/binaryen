...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop17), $pop48
	i32.const	$push21=, 32
	...
	i64.const	$push41=, 0
	i64.store	$drop=, 0($pop42), $pop41
	i64.const	$push40=, 0
	i64.store	$drop=, 32($6), $pop40
	i32.const	$push27=, 32
	...
	i32.store8	$drop=, 0($pop36), $pop5
	i32.const	$push35=, 16
	i32.add 	$push34=, $6, $pop35
	tee_local	$push33=, $4=, $pop34
	i64.load	$push6=, 0($1)
	i64.store	$drop=, 0($pop33), $pop6
	i32.const	$push32=, 8
	i32.add 	$push31=, $6, $pop32
	tee_local	$push30=, $5=, $pop31
	i64.load	$push7=, 0($2)
	i64.store	$drop=, 0($pop30), $pop7
	i64.load	$push8=, 32($6)
	i64.store	$drop=, 0($6), $pop8
	i32.const	$push9=, 1
	call    	foo@FUNCTION, $6, $pop9
	i32.load8_u	$push10=, 0($0)
	i32.store8	$drop=, 0($3), $pop10
	i64.load	$push11=, 0($1)
	i64.store	$drop=, 0($4), $pop11
	i64.load	$push12=, 0($2)
	i64.store	$drop=, 0($5), $pop12
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop24), $pop61
	i32.const	$push28=, 32
	...
	i64.const	$push54=, 0
	i64.store	$drop=, 0($pop55), $pop54
	i64.const	$push53=, 0
	i64.store	$drop=, 32($6), $pop53
	i32.const	$push34=, 32
	...
	i32.store8	$drop=, 0($pop49), $pop5
	i32.const	$push48=, 16
	i32.add 	$push47=, $6, $pop48
	tee_local	$push46=, $3=, $pop47
	i64.load	$push6=, 0($0)
	i64.store	$drop=, 0($pop46), $pop6
	i32.const	$push45=, 8
	i32.add 	$push44=, $6, $pop45
	tee_local	$push43=, $4=, $pop44
	i64.load	$push7=, 0($1)
	i64.store	$drop=, 0($pop43), $pop7
	i64.load	$push8=, 32($6)
	i64.store	$drop=, 0($6), $pop8
	i32.const	$push9=, 1
	call    	foo@FUNCTION, $6, $pop9
	i32.load8_u	$push10=, 0($5)
	i32.store8	$drop=, 0($2), $pop10
	i64.load	$push11=, 0($0)
	i64.store	$drop=, 0($3), $pop11
	i64.load	$push12=, 0($1)
	i64.store	$drop=, 0($4), $pop12
	i64.load	$push13=, 32($6)
	i64.store	$drop=, 0($6), $pop13
	i32.const	$push42=, 0
	...
	i64.store	$drop=, 0($4), $pop19
	i64.load	$push20=, 0($5):p2align=0
	i64.store	$drop=, 0($6), $pop20
	i32.const	$push36=, 0
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop32), $pop81
	i32.const	$push36=, 32
	...
	i64.const	$push74=, 0
	i64.store	$drop=, 0($pop75), $pop74
	i64.const	$push73=, 0
	i64.store	$drop=, 32($8), $pop73
	i32.const	$push42=, 32
	...
	i32.load8_u	$push5=, 0($0)
	i32.store8	$drop=, 0($pop69), $pop5
	i32.const	$push68=, 16
	i32.add 	$push67=, $8, $pop68
	tee_local	$push66=, $4=, $pop67
	i64.load	$push6=, 0($1)
	i64.store	$drop=, 0($pop66), $pop6
	i32.const	$push65=, 8
	i32.add 	$push64=, $8, $pop65
	tee_local	$push63=, $5=, $pop64
	i64.load	$push7=, 0($2)
	i64.store	$drop=, 0($pop63), $pop7
	i64.load	$push8=, 32($8)
	i64.store	$drop=, 0($8), $pop8
	i32.const	$push9=, 1
	...
	i32.store	$drop=, 0($pop13):p2align=0, $pop15
	i32.const	$push55=, 16
	i32.add 	$push54=, $6, $pop55
	tee_local	$push53=, $0=, $pop54
	i32.load	$push16=, 0($1)
	i32.store	$drop=, 0($pop53):p2align=0, $pop16
	i32.const	$push17=, 12
	...
	i32.store	$drop=, 0($pop18):p2align=0, $pop20
	i32.const	$push51=, 8
	i32.add 	$push50=, $6, $pop51
	tee_local	$push49=, $1=, $pop50
	i32.load	$push21=, 0($2)
	i32.store	$drop=, 0($pop49):p2align=0, $pop21
	i32.const	$push22=, 4
	i32.add 	$push23=, $6, $pop22
	i32.load	$push24=, 36($8)
	i32.store	$drop=, 0($pop23):p2align=0, $pop24
	i32.load8_u	$push25=, 0($3)
	i32.store8	$drop=, 0($7), $pop25
	i64.load	$push26=, 0($4)
	i64.store	$drop=, 0($0):p2align=0, $pop26
	i64.load	$push27=, 0($5)
	i64.store	$drop=, 0($1):p2align=0, $pop27
	i64.load	$push28=, 0($8)
	i64.store	$drop=, 0($6):p2align=0, $pop28
	i32.const	$push48=, 0
