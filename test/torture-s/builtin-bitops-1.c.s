...
.LBB18_1:                               # %for.body
	...
	loop                            # label41:
	i32.const	$push214=, 2
	i32.shl 	$push3=, $0, $pop214
	i32.const	$push213=, ints
	i32.add 	$push212=, $pop3, $pop213
	tee_local	$push211=, $1=, $pop212
	i32.load	$push210=, 0($pop211)
	tee_local	$push209=, $10=, $pop210
	i32.ctz 	$push208=, $pop209
	tee_local	$push207=, $2=, $pop208
	i32.const	$push206=, 1
	i32.add 	$push4=, $pop207, $pop206
	i32.const	$push205=, 0
	i32.select	$6=, $pop4, $pop205, $10
	i32.const	$3=, 0
	block
	i32.eqz 	$push416=, $10
...
.LBB18_3:                               # %for.cond.i
	...
	loop                            # label44:
	copy_local	$push217=, $5
	tee_local	$push216=, $3=, $pop217
	i32.const	$push215=, 31
	i32.gt_u	$push5=, $pop216, $pop215
...
# BB#4:                                 # %for.body.i
	...
	i32.add 	$5=, $3, $pop219
	i32.const	$push218=, 1
	i32.shl 	$push6=, $pop218, $3
	i32.and 	$push7=, $pop6, $10
	i32.eqz 	$push417=, $pop7
...
# BB#10:                                # %for.inc.i819
	...
	i32.add 	$3=, $3, $pop226
	i32.const	$push225=, 1
	i32.add 	$push224=, $5, $pop225
	tee_local	$push223=, $5=, $pop224
	i32.const	$push222=, 32
	i32.lt_u	$push11=, $pop223, $pop222
...
.LBB18_17:                              # %for.body.i950
                                        ...
                                        # =>  This Inner Loop Header: Depth=2
	loop                            # label51:
	i32.shr_u	$push17=, $3, $10
	i32.const	$push235=, 1
	i32.and 	$push18=, $pop17, $pop235
...
# BB#18:                                # %for.inc.i953
	...
	i32.lt_u	$push20=, $pop237, $pop236
	br_if   	0, $pop20       # 0: up to label51
.LBB18_19:                              # %my_clrsb.exit
                                        #   in Loop: Header=BB18_1 Depth=1
	end_loop                        # label52:
	i32.const	$push241=, -1
	i32.add 	$push21=, $5, $pop241
...
.LBB18_24:                              # %for.body.i1115
	...
	loop                            # label55:
	i32.const	$push253=, 1
	i32.shl 	$push29=, $pop253, $10
	i32.and 	$push30=, $pop29, $3
	i32.const	$push252=, 0
	i32.ne  	$push31=, $pop30, $pop252
	i32.add 	$6=, $pop31, $6
	i32.const	$push251=, 1
	i32.add 	$push250=, $10, $pop251
	tee_local	$push249=, $10=, $pop250
	i32.const	$push248=, 32
	i32.ne  	$push32=, $pop249, $pop248
...
.LBB18_28:                              # %for.body41
	...
	loop                            # label57:
	i32.const	$push268=, 2
	i32.shl 	$push36=, $0, $pop268
	i32.const	$push267=, longs
	i32.add 	$push266=, $pop36, $pop267
	...
	i32.const	$push260=, 1
	i32.add 	$push37=, $pop261, $pop260
	i32.const	$push259=, 0
	i32.select	$6=, $pop37, $pop259, $10
	i32.const	$3=, 0
	block
	i32.eqz 	$push419=, $10
...
.LBB18_30:                              # %for.cond.i1193
                                        ...
                                        # =>  This Inner Loop Header: Depth=2
	loop                            # label60:
	copy_local	$push271=, $5
	tee_local	$push270=, $3=, $pop271
	i32.const	$push269=, 31
	i32.gt_u	$push38=, $pop270, $pop269
...
# BB#31:                                # %for.body.i1197
	...
	i32.add 	$5=, $3, $pop273
	i32.const	$push272=, 1
	i32.shl 	$push39=, $pop272, $3
	i32.and 	$push40=, $pop39, $10
	i32.eqz 	$push420=, $pop40
...
# BB#37:                                # %for.inc.i1279
	...
	i32.add 	$3=, $3, $pop280
	i32.const	$push279=, 1
	i32.add 	$push278=, $5, $pop279
	tee_local	$push277=, $5=, $pop278
	i32.const	$push276=, 32
	i32.lt_u	$push44=, $pop277, $pop276
...
# BB#45:                                # %for.inc.i1443
	...
	i32.lt_u	$push53=, $pop291, $pop290
	br_if   	0, $pop53       # 0: up to label67
.LBB18_46:                              # %my_clrsbl.exit
                                        #   in Loop: Header=BB18_28 Depth=1
	end_loop                        # label68:
	i32.const	$push295=, -1
	i32.add 	$push54=, $5, $pop295
...
.LBB18_55:                              # %for.body92
	...
	i32.const	$push324=, 0
	i32.const	$push323=, 3
	i32.shl 	$push69=, $5, $pop323
	i32.const	$push322=, longlongs
	i32.add 	$push321=, $pop69, $pop322
	tee_local	$push320=, $1=, $pop321
	i64.load	$push319=, 0($pop320)
	tee_local	$push318=, $9=, $pop319
	i64.ctz 	$push317=, $pop318
	tee_local	$push316=, $4=, $pop317
	i64.const	$push315=, 1
	i64.add 	$push70=, $pop316, $pop315
	i32.wrap/i64	$push71=, $pop70
	i64.eqz 	$push314=, $9
	tee_local	$push313=, $6=, $pop314
	i32.select	$0=, $pop324, $pop71, $pop313
	i32.const	$10=, 0
	block
...
.LBB18_57:                              # %for.cond.i1687
	...
	loop                            # label76:
	copy_local	$10=, $3
	i64.const	$push325=, 63
	i64.gt_u	$push72=, $8, $pop325
...
.LBB18_62:                              # %for.body.i1763
	...
	loop                            # label79:
	i64.const	$push331=, 1
	i64.const	$push330=, 4294967295
	i64.and 	$push77=, $8, $pop330
	i64.shl 	$push78=, $pop331, $pop77
	i64.and 	$push79=, $pop78, $9
	i64.const	$push329=, 0
	i64.ne  	$push80=, $pop79, $pop329
...
# BB#63:                                # %for.inc.i1767
	...
	i64.add 	$8=, $8, $pop337
	i32.const	$push336=, 1
	i32.add 	$10=, $10, $pop336
	i64.const	$push335=, 1
	i64.add 	$push334=, $7, $pop335
	tee_local	$push333=, $7=, $pop334
	i64.const	$push332=, 64
	i64.lt_u	$push81=, $pop333, $pop332
...
.LBB18_66:                              # %for.body.i1805
	...
	loop                            # label81:
	i64.const	$push339=, 1
	i64.shl 	$push83=, $pop339, $8
	i64.and 	$push84=, $pop83, $9
	i64.const	$push338=, 0
	i64.ne  	$push85=, $pop84, $pop338
	br_if   	1, $pop85       # 1: down to label82
# BB#67:                                # %for.inc.i1809
                                        #   in Loop: Header=BB18_66 Depth=2
	i32.const	$push344=, 1
	i32.add 	$10=, $10, $pop344
	i64.const	$push343=, 1
	i64.add 	$push342=, $8, $pop343
	tee_local	$push341=, $8=, $pop342
	i64.const	$push340=, 64
	i64.lt_u	$push86=, $pop341, $pop340
...
.LBB18_69:                              # %if.end120
	...
	i64.load	$push347=, 0($1)
	tee_local	$push346=, $9=, $pop347
	i64.const	$push345=, 63
	i64.shr_u	$4=, $pop346, $pop345
	i32.const	$10=, 1
	i64.const	$7=, 1
	i64.const	$8=, 62
...
# BB#93:                                # %for.inc.i1796
	...
	i32.const	$push379=, 1
	i32.add 	$push378=, $3, $pop379
	tee_local	$push377=, $3=, $pop378
...
.LBB18_110:                             # %for.body.i1547
	...
	i32.wrap/i64	$3=, $8
	i64.const	$push400=, -1
	i64.add 	$push1=, $8, $pop400
	copy_local	$8=, $pop1
	i32.const	$push399=, 1
	i32.ne  	$push163=, $3, $pop399
...
# BB#124:                               # %if.end740
	i64.const	$push407=, -1
	i32.call	$3=, __builtin_clrsbll@FUNCTION, $pop407
	i64.const	$8=, 62
	i64.const	$9=, 1
	i32.const	$10=, 1
