...
.LBB12_2:                               # %for.cond
	...
	br_if   	1, $pop2        # 1: down to label20
# BB#3:                                 # %for.body
...
.LBB15_1:                               # %for.body
	...
	i64.ne  	$push3=, $pop2, $1
	br_if   	1, $pop3        # 1: down to label26
# BB#2:                                 # %for.inc
...
.LBB18_1:                               # %for.body
	...
	block
	i32.eqz 	$push397=, $10
	br_if   	0, $pop397      # 0: down to label33
...
# BB#4:                                 # %for.body.i
	...
	br_if   	0, $pop398      # 0: up to label35
...
.LBB18_6:                               # %my_ffs.exit
	...
	end_block                       # label33:
	i32.ne  	$push6=, $6, $3
	br_if   	1, $pop6        # 1: down to label31
# BB#7:                                 # %if.end
                                        #   in Loop: Header=BB18_1 Depth=1
	block
	i32.eqz 	$push399=, $10
	br_if   	0, $pop399      # 0: down to label36
# BB#8:                                 # %land.lhs.true
                                        #   in Loop: Header=BB18_1 Depth=1
	i32.clz 	$6=, $10
	i32.const	$5=, 0
...
.LBB18_9:                               # %for.body.i816
	...
	br_if   	1, $pop8        # 1: down to label37
# BB#10:                                # %for.inc.i819
	...
	br_if   	0, $pop9        # 0: up to label38
.LBB18_11:                              # %my_clz.exit
                                        #   in Loop: Header=BB18_1 Depth=1
	end_loop
	end_block                       # label37:
	i32.ne  	$push10=, $6, $5
	br_if   	2, $pop10       # 2: down to label31
...
.LBB18_13:                              # %for.body.i875
	...
	br_if   	1, $pop12       # 1: down to label39
# BB#14:                                # %for.inc.i878
	...
	br_if   	0, $pop13       # 0: up to label40
.LBB18_15:                              # %my_ctz.exit
                                        #   in Loop: Header=BB18_1 Depth=1
	end_loop
	end_block                       # label39:
	i32.ne  	$push14=, $2, $3
	br_if   	2, $pop14       # 2: down to label31
.LBB18_16:                              # %if.end19
                                        #   in Loop: Header=BB18_1 Depth=1
	end_block                       # label36:
...
.LBB18_17:                              # %for.body.i948
	...
	br_if   	1, $pop17       # 1: down to label41
# BB#18:                                # %for.inc.i951
...
.LBB18_19:                              # %my_clrsb.exit
	...
	br_if   	1, $pop20       # 1: down to label31
...
.LBB18_21:                              # %for.body.i1030
	...
	br_if   	0, $pop24       # 0: up to label43
# BB#22:                                # %my_popcount.exit
                                        #   in Loop: Header=BB18_1 Depth=1
	end_loop
	i32.popcnt	$push25=, $3
	i32.ne  	$push26=, $pop25, $5
	br_if   	1, $pop26       # 1: down to label31
...
# BB#25:                                # %my_parity.exit
	...
	br_if   	1, $pop32       # 1: down to label31
# BB#26:                                # %for.cond
                                        #   in Loop: Header=BB18_1 Depth=1
	i32.const	$push249=, 1
...
.LBB18_28:                              # %for.body41
	...
	block
	i32.eqz 	$push400=, $10
	br_if   	0, $pop400      # 0: down to label46
...
.LBB18_30:                              # %for.cond.i1185
	...
	br_if   	1, $pop36       # 1: down to label47
# BB#31:                                # %for.body.i1189
	...
	br_if   	0, $pop401      # 0: up to label48
...
.LBB18_33:                              # %my_ffsl.exit
	...
	end_block                       # label46:
	i32.ne  	$push39=, $6, $3
	br_if   	1, $pop39       # 1: down to label31
# BB#34:                                # %if.end49
                                        #   in Loop: Header=BB18_28 Depth=1
	block
	i32.eqz 	$push402=, $10
	br_if   	0, $pop402      # 0: down to label49
...
.LBB18_36:                              # %for.body.i1266
	...
	br_if   	1, $pop41       # 1: down to label50
# BB#37:                                # %for.inc.i1269
	...
	br_if   	0, $pop42       # 0: up to label51
.LBB18_38:                              # %my_clzl.exit
                                        #   in Loop: Header=BB18_28 Depth=1
	end_loop
	end_block                       # label50:
	i32.ne  	$push43=, $6, $5
	br_if   	2, $pop43       # 2: down to label31
...
.LBB18_40:                              # %for.body.i1345
	...
	br_if   	1, $pop45       # 1: down to label52
# BB#41:                                # %for.inc.i1348
	...
	br_if   	0, $pop46       # 0: up to label53
.LBB18_42:                              # %my_ctzl.exit
                                        #   in Loop: Header=BB18_28 Depth=1
	end_loop
	end_block                       # label52:
	i32.ne  	$push47=, $2, $3
	br_if   	2, $pop47       # 2: down to label31
.LBB18_43:                              # %if.end67
                                        #   in Loop: Header=BB18_28 Depth=1
	end_block                       # label49:
...
.LBB18_44:                              # %for.body.i1426
	...
	br_if   	1, $pop50       # 1: down to label54
# BB#45:                                # %for.inc.i1429
...
.LBB18_46:                              # %my_clrsbl.exit
	...
	br_if   	1, $pop53       # 1: down to label31
...
.LBB18_48:                              # %for.body.i1511
	...
	br_if   	0, $pop57       # 0: up to label56
# BB#49:                                # %my_popcountl.exit
                                        #   in Loop: Header=BB18_28 Depth=1
	end_loop
	i32.popcnt	$push58=, $3
	i32.ne  	$push59=, $pop58, $5
	br_if   	1, $pop59       # 1: down to label31
...
# BB#52:                                # %my_parityl.exit
	...
	br_if   	1, $pop65       # 1: down to label31
# BB#53:                                # %for.cond39
                                        #   in Loop: Header=BB18_28 Depth=1
	i32.const	$push303=, 1
...
.LBB18_57:                              # %for.cond.i1667
	...
	br_if   	1, $pop70       # 1: down to label59
# BB#58:                                # %for.body.i1671
	...
	br_if   	0, $pop72       # 0: up to label60
.LBB18_59:                              # %my_ffsll.exit1673
                                        #   in Loop: Header=BB18_55 Depth=1
	end_loop
	end_block                       # label59:
	i32.ne  	$push73=, $0, $10
	br_if   	1, $pop73       # 1: down to label31
# BB#60:                                # %if.end100
                                        #   in Loop: Header=BB18_55 Depth=1
	block
	br_if   	0, $6           # 0: down to label61
...
.LBB18_62:                              # %for.body.i1739
	...
	br_if   	1, $pop77       # 1: down to label62
# BB#63:                                # %for.inc.i1743
	...
	br_if   	0, $pop78       # 0: up to label63
.LBB18_64:                              # %my_clzll.exit1745
                                        #   in Loop: Header=BB18_55 Depth=1
	end_loop
	end_block                       # label62:
	i32.ne  	$push79=, $3, $10
	br_if   	2, $pop79       # 2: down to label31
...
.LBB18_66:                              # %for.body.i1781
	...
	br_if   	1, $pop82       # 1: down to label64
# BB#67:                                # %for.inc.i1785
	...
	br_if   	0, $pop83       # 0: up to label65
.LBB18_68:                              # %my_ctzll.exit1787
                                        #   in Loop: Header=BB18_55 Depth=1
	end_loop
	end_block                       # label64:
	i32.ne  	$push84=, $3, $10
	br_if   	2, $pop84       # 2: down to label31
.LBB18_69:                              # %if.end120
                                        #   in Loop: Header=BB18_55 Depth=1
	end_block                       # label61:
...
.LBB18_70:                              # %for.body.i1845
	...
	br_if   	1, $pop87       # 1: down to label66
# BB#71:                                # %for.inc.i1849
...
.LBB18_72:                              # %my_clrsbll.exit1852
	...
	br_if   	1, $pop90       # 1: down to label31
# BB#73:                                # %if.end127
                                        #   in Loop: Header=BB18_55 Depth=1
	i64.popcnt	$7=, $9
	i32.const	$10=, 0
...
.LBB18_77:                              # %for.body.i2005
	...
	br_if   	0, $pop100      # 0: up to label69
# BB#78:                                # %my_parityll.exit2007
	...
	br_if   	2, $pop102      # 2: down to label30
# BB#79:                                # %for.cond90
                                        #   in Loop: Header=BB18_55 Depth=1
	i32.const	$push362=, 1
	...
	br_if   	0, $pop103      # 0: up to label58
# BB#80:                                # %if.end148
	end_loop
	i32.const	$push104=, 0
...
# BB#84:                                # %my_clrsb.exit2288
	...
	br_if   	0, $pop119      # 0: down to label31
...
# BB#88:                                # %for.body.i1989
	...
	br_if   	0, $pop131      # 0: down to label31
# BB#89:                                # %for.body.i1912
	...
	br_if   	0, $pop135      # 0: down to label31
# BB#90:                                # %for.body.i1832
	...
	br_if   	0, $pop139      # 0: down to label31
# BB#91:                                # %if.end423
	i32.const	$push363=, -1
...
.LBB18_92:                              # %for.body.i1769
	...
	br_if   	1, $pop403      # 1: down to label70
# BB#93:                                # %for.inc.i1772
	...
	br_if   	0, $pop142      # 0: up to label71
.LBB18_94:                              # %my_clrsb.exit1775
	...
	br_if   	0, $pop145      # 0: down to label31
# BB#95:                                # %if.end440
	i64.const	$8=, 0
	i64.const	$push371=, 0
	...
	br_if   	0, $pop148      # 0: down to label31
...
.LBB18_97:                              # %for.body.i1691
	...
	br_if   	1, $pop149      # 1: down to label72
# BB#98:                                # %for.inc.i1695
	...
	br_if   	0, $pop150      # 0: up to label73
# BB#99:                                # %if.then460
	end_loop
	call    	abort@FUNCTION
	unreachable
...
.LBB18_101:                             # %for.body.i1655
	...
	br_if   	1, $pop151      # 1: down to label74
# BB#102:                               # %for.inc.i1659
	...
	br_if   	0, $pop152      # 0: up to label75
.LBB18_103:                             # %my_clrsbll.exit1662
	end_loop
	end_block                       # label74:
	i32.ne  	$push153=, $3, $10
	br_if   	0, $pop153      # 0: down to label31
...
.LBB18_105:                             # %for.body.i1598
	...
	br_if   	1, $pop154      # 1: down to label76
# BB#106:                               # %for.inc.i1602
	...
	br_if   	0, $pop155      # 0: up to label77
# BB#107:                               # %if.then489
	end_loop
	call    	abort@FUNCTION
	unreachable
.LBB18_108:                             # %if.end490
	...
	br_if   	0, $pop157      # 0: down to label31
...
# BB#110:                               # %my_clrsbll.exit1419
	...
	br_if   	0, $pop163      # 0: down to label31
# BB#111:                               # %for.body.i1333
	...
	br_if   	0, $pop167      # 0: down to label31
...
# BB#115:                               # %for.body.i1015
	...
	br_if   	0, $pop179      # 0: down to label31
...
# BB#117:                               # %for.body.i864
	...
	br_if   	0, $pop187      # 0: down to label31
# BB#118:                               # %if.end740
	i64.const	$push388=, -1
...
.LBB18_119:                             # %for.body.i810
	...
	br_if   	1, $pop190      # 1: down to label78
# BB#120:                               # %for.inc.i
	...
	br_if   	0, $pop191      # 0: up to label79
.LBB18_121:                             # %my_clrsbll.exit
	...
	br_if   	0, $pop194      # 0: down to label31
# BB#122:                               # %if.end753
	i32.const	$push195=, 0
