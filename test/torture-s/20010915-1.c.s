...
# BB#0:                                 # %entry
	...
	i32.store	$push22=, 0($pop14), $pop15
	...
	i32.const	$push17=, 5
	i32.call	$discard=, x@FUNCTION, $pop17, $2
	block
	i32.const	$push16=, 0
...
# BB#4:                                 # %lor.lhs.false.i
	...
	i32.store	$discard=, check($pop9), $pop11
	i32.const	$push12=, 2
	i32.ge_s	$push13=, $5, $pop12
...
# BB#6:                                 # %lor.lhs.false.i45
	...
	i32.store	$discard=, check($pop42), $pop17
	i32.const	$push41=, 1
	i32.ge_s	$push18=, $5, $pop41
	br_if   	0, $pop18       # 0: down to label3
# BB#7:                                 # %s.exit48
	i32.const	$push45=, 0
	i32.const	$push44=, 0
	i32.store	$discard=, u($pop45), $pop44
	i32.load	$push20=, 0($4)
	i32.const	$push43=, 1
...
.LBB1_10:                               # %while.body
	...
	i32.load8_u	$push25=, 0($pop54)
	i32.const	$push53=, 255
	i32.and 	$push26=, $3, $pop53
...
# BB#13:                                # %r.exit
	...
	i32.const	$push66=, 0
	i32.const	$push65=, 1
	i32.add 	$push30=, $1, $pop65
	i32.store	$discard=, r.cnt($pop66), $pop30
	i32.const	$push64=, 1
	i32.add 	$3=, $3, $pop64
	i32.const	$push63=, 0
	i32.store8	$discard=, r.c.0($pop63), $3
	i32.const	$push62=, 1
	i32.add 	$5=, $5, $pop62
	i32.const	$push61=, 4
	i32.add 	$2=, $2, $pop61
	i32.const	$push60=, 0
	i32.store	$push0=, o($pop60), $5
