...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop78), $pop88
...
# BB#2:                                 # %if.end
	...
	i32.store8	$drop=, 0($2), $pop93
	i32.const	$push92=, 0
	i32.store	$drop=, cnt($pop92), $3
	i32.const	$push7=, 6
	i32.ne  	$push8=, $1, $pop7
