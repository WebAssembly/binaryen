...
# BB#0:                                 # %entry
	...
	i32.const	$push80=, 32
	i32.sub 	$push92=, $pop79, $pop80
	tee_local	$push91=, $6=, $pop92
	i32.store	$drop=, __stack_pointer($pop81), $pop91
...
# BB#1:                                 # %lor.lhs.false3
	...
	i32.add 	$push94=, $0, $pop2
	tee_local	$push93=, $2=, $pop94
	i32.load8_u	$push3=, 0($pop93)
	br_if   	0, $pop3        # 0: down to label0
# BB#2:                                 # %if.end
	i32.const	$push4=, 0
	i32.load	$push5=, cnt($pop4)
	i32.const	$push6=, 1
	i32.add 	$push97=, $pop5, $pop6
	tee_local	$push96=, $3=, $pop97
	i32.store8	$drop=, 0($2), $pop96
	i32.const	$push95=, 0
	i32.store	$drop=, cnt($pop95), $3
	i32.const	$push7=, 6
	i32.ne  	$push8=, $1, $pop7
	br_if   	0, $pop8        # 0: down to label0
# BB#3:                                 # %if.end9
	i32.load	$push101=, 12($6)
	tee_local	$push100=, $2=, $pop101
	i32.const	$push9=, 4
	i32.add 	$push99=, $pop100, $pop9
	tee_local	$push98=, $1=, $pop99
	i32.store	$drop=, 12($6), $pop98
	i32.load	$push10=, 0($2)
	i32.const	$push11=, 5
...
# BB#7:                                 # %sw.bb
	i32.const	$push44=, 8
	i32.add 	$push104=, $2, $pop44
	tee_local	$push103=, $1=, $pop104
	i32.store	$drop=, 12($6), $pop103
	i32.const	$push45=, 4
	i32.add 	$push46=, $2, $pop45
	i32.load	$push47=, 0($pop46)
	i32.const	$push102=, 9
	i32.ne  	$push48=, $pop47, $pop102
	br_if   	2, $pop48       # 2: down to label0
# BB#8:                                 # %sw.bb
	i32.const	$push49=, 0
	i32.load	$push43=, v1($pop49)
	i32.const	$push105=, 9
	i32.ne  	$push50=, $pop43, $pop105
	br_if   	2, $pop50       # 2: down to label0
# BB#9:                                 # %if.end22
	i32.const	$push85=, 16
	i32.add 	$push86=, $6, $pop85
	i32.const	$push51=, 12
	i32.add 	$push54=, $pop86, $pop51
	i32.const	$push110=, 12
	i32.add 	$push52=, $1, $pop110
	i32.load	$push53=, 0($pop52):p2align=0
	i32.store	$drop=, 0($pop54), $pop53
	i32.const	$push87=, 16
	i32.add 	$push88=, $6, $pop87
	i32.const	$push55=, 8
	i32.add 	$push58=, $pop88, $pop55
	i32.const	$push109=, 8
	i32.add 	$push56=, $1, $pop109
	i32.load	$push57=, 0($pop56):p2align=0
	i32.store	$drop=, 0($pop58), $pop57
	i32.const	$push59=, 24
	i32.add 	$push108=, $2, $pop59
	tee_local	$push107=, $3=, $pop108
	i32.store	$drop=, 12($6), $pop107
	i32.const	$push60=, 4
	i32.add 	$push61=, $1, $pop60
	i32.load	$push62=, 0($pop61):p2align=0
	i32.store	$drop=, 20($6), $pop62
	i32.load	$push63=, 0($1):p2align=0
	i32.store	$drop=, 16($6), $pop63
	i32.const	$push89=, 16
	i32.add 	$push90=, $6, $pop89
	i32.const	$push106=, v4
	i32.const	$push64=, 16
	i32.call	$push65=, memcmp@FUNCTION, $pop90, $pop106, $pop64
	br_if   	2, $pop65       # 2: down to label0
# BB#10:                                # %if.end28
	i32.const	$push66=, 28
	i32.add 	$push113=, $2, $pop66
	tee_local	$push112=, $1=, $pop113
	i32.store	$drop=, 12($6), $pop112
	i32.load	$push67=, 0($3)
	i32.const	$push111=, v4
	i32.ne  	$push68=, $pop67, $pop111
	br_if   	2, $pop68       # 2: down to label0
# BB#11:                                # %if.end34
	i32.const	$push70=, 32
	i32.add 	$push71=, $2, $pop70
	i32.store	$drop=, 12($6), $pop71
	block
	i32.load	$push72=, 0($1)
	i32.const	$push73=, 3
...
# BB#16:                                # %if.end53
	...
	i64.load	$push122=, 0($pop32)
	tee_local	$push121=, $4=, $pop122
	i32.wrap/i64	$push33=, $pop121
	i32.const	$push34=, 8
...
# BB#17:                                # %if.end59
	...
	i32.store	$drop=, 12($6), $pop37
	i64.const	$push38=, 32
	i64.shr_u	$push39=, $4, $pop38
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop70), $pop86
...
# BB#2:                                 # %if.end
	...
	i32.store	$drop=, cnt($pop4), $pop90
	i32.const	$push7=, 64
	i32.or  	$push8=, $3, $pop7
	i32.store8	$drop=, 0($2), $pop8
	i32.const	$push9=, 10
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop66), $pop110
	i32.const	$push109=, 0
	i32.const	$push108=, 0
	...
	i32.store	$drop=, v1($pop109), $pop105
	i32.const	$push104=, 0
	i32.const	$push103=, 0
	...
	i32.store	$drop=, 160($4), $pop10
	i32.store	$drop=, 144($4), $0
	i32.store	$drop=, 156($4), $1
	i32.const	$push11=, v4
	i32.store	$drop=, 152($4), $pop11
	i32.const	$push72=, 160
	i32.add 	$push73=, $4, $pop72
	i32.store	$drop=, 148($4), $pop73
	block
	i32.const	$push94=, 0
...
# BB#1:                                 # %if.end
	...
	i32.store	$drop=, 0($pop19), $pop17
	i32.const	$push20=, 128
	i32.add 	$push21=, $4, $pop20
	i32.const	$push121=, 8
	i32.store	$drop=, 0($pop21), $pop121
	i32.const	$push120=, 0
	i32.const	$push78=, 96
	i32.add 	$push79=, $4, $pop78
	i32.const	$push119=, 8
	...
	i64.store	$drop=, v5+8($pop120), $pop117
	i32.const	$push116=, 0
	i64.load	$push115=, 96($4)
	tee_local	$push114=, $3=, $pop115
	i64.store	$drop=, v5($pop116), $pop114
	i64.store	$drop=, 120($4), $2
	i64.store	$drop=, 112($4), $3
	i32.const	$push113=, 1
...
# BB#4:                                 # %if.end14
	...
	i32.store	$drop=, 0($pop39), $pop37
	i32.const	$push41=, 84
	i32.add 	$push42=, $4, $pop41
	i32.const	$push141=, 0
	i32.load	$push40=, v4+4($pop141):p2align=0
	i32.store	$drop=, 0($pop42), $pop40
	i32.const	$push140=, 0
	i32.const	$push139=, 8
	i32.add 	$push43=, $4, $pop139
	i64.load	$push44=, 0($pop43)
	i64.store	$drop=, v5+8($pop140), $pop44
	i32.const	$push138=, 0
	i64.load	$push45=, 0($4)
	i64.store	$drop=, v5($pop138), $pop45
	i32.const	$push137=, 0
	i32.load	$push46=, v4($pop137):p2align=0
	i32.store	$drop=, 80($4), $pop46
	i32.const	$push136=, 0
	...
	i64.store	$drop=, 0($pop47):p2align=2, $pop48
	i32.const	$push132=, 0
	i64.load	$push49=, v4($pop132):p2align=0
	i64.store	$drop=, 64($4):p2align=2, $pop49
	i32.const	$push50=, 48
	i32.add 	$push51=, $4, $pop50
	i64.const	$push52=, 16
	i64.store	$drop=, 0($pop51), $pop52
	i32.const	$push53=, 40
	i32.add 	$push54=, $4, $pop53
	i32.store	$drop=, 0($pop54), $1
	i64.store	$drop=, 16($4), $2
	i32.const	$push86=, 16
	...
	i32.store	$drop=, 0($pop56), $pop89
	i32.const	$push57=, 32
	i32.add 	$push58=, $4, $pop57
	i32.const	$push90=, 80
	i32.add 	$push91=, $4, $pop90
	i32.store	$drop=, 0($pop58), $pop91
	i64.store	$drop=, 24($4), $3
	i32.const	$push59=, 3
