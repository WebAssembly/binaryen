	.text
	.file	"/b/build/slave/linux/build/src/buildbot/work/gcc/gcc/testsuite/gcc.c-torture/execute/960513-1.c"
	.globl	f
	.type	f,@function
f:                                      # @f
...
# BB#0:                                 # %entry
	...
	i32.const	$17=, 128
	i32.add 	$17=, $31, $17
	call    	__addtf3, $17, $7, $4, $pop9, $pop8
	i32.const	$18=, 128
	i32.add 	$18=, $31, $18
	i32.add 	$push10=, $18, $5
	i64.load	$4=, 0($pop10)
	...
	i32.const	$21=, 96
	i32.add 	$21=, $31, $21
	call    	__addtf3, $21, $7, $4, $pop13, $pop12
	i32.const	$22=, 96
	i32.add 	$22=, $31, $22
	i32.add 	$push14=, $22, $5
	i64.load	$4=, 0($pop14)
	...
	i32.const	$25=, 64
	i32.add 	$25=, $31, $25
	call    	__addtf3, $25, $7, $4, $pop17, $pop16
	i32.const	$26=, 64
	i32.add 	$26=, $31, $26
	i32.add 	$push18=, $26, $5
	i64.load	$4=, 0($pop18)
	...
	i32.const	$29=, 32
	i32.add 	$29=, $31, $29
	call    	__addtf3, $29, $7, $4, $pop21, $pop20
	i32.const	$30=, 32
	i32.add 	$30=, $31, $30
	i32.add 	$push22=, $30, $5
	i64.load	$4=, 0($pop22)
	...
	i32.const	$33=, 0
	i32.add 	$33=, $31, $33
	call    	__addtf3, $33, $7, $4, $pop25, $pop24
	i64.load	$2=, 0($31)
	i32.add 	$push28=, $0, $5
	i32.const	$34=, 0
	i32.add 	$34=, $31, $34
