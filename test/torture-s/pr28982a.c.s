...
.LBB0_3:                                # %while.end
	...
	end_block                       # label0:
	i32.const	$push150=, 0
	f32.store	$drop=, results($pop150), $60
	i32.const	$push149=, 0
	f32.store	$drop=, results+4($pop149), $59
	i32.const	$push148=, 0
	f32.store	$drop=, results+8($pop148), $58
	i32.const	$push147=, 0
	f32.store	$drop=, results+12($pop147), $57
	i32.const	$push146=, 0
	f32.store	$drop=, results+16($pop146), $56
	i32.const	$push145=, 0
	f32.store	$drop=, results+20($pop145), $55
	i32.const	$push144=, 0
	f32.store	$drop=, results+24($pop144), $54
	i32.const	$push143=, 0
	f32.store	$drop=, results+28($pop143), $53
	i32.const	$push142=, 0
	f32.store	$drop=, results+32($pop142), $52
	i32.const	$push141=, 0
	f32.store	$drop=, results+36($pop141), $51
	i32.const	$push140=, 0
	f32.store	$drop=, results+40($pop140), $50
	i32.const	$push139=, 0
	f32.store	$drop=, results+44($pop139), $49
	i32.const	$push138=, 0
	f32.store	$drop=, results+48($pop138), $48
	i32.const	$push137=, 0
	f32.store	$drop=, results+52($pop137), $47
	i32.const	$push136=, 0
	f32.store	$drop=, results+56($pop136), $46
	i32.const	$push135=, 0
	f32.store	$drop=, results+60($pop135), $45
	i32.const	$push134=, 0
	f32.store	$drop=, results+64($pop134), $44
	i32.const	$push133=, 0
	f32.store	$drop=, results+68($pop133), $43
	i32.const	$push132=, 0
	f32.store	$drop=, results+72($pop132), $42
	i32.const	$push131=, 0
	f32.store	$drop=, results+76($pop131), $41
	return
	.endfunc
.Lfunc_end0:
