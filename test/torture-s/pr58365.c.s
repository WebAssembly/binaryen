...
.LBB1_2:                                # %if.end.i
	...
	i32.const	$push40=, 0
	i32.store	$drop=, 0($pop9), $pop40
	i32.const	$push10=, 16
	i32.add 	$push11=, $0, $pop10
	i64.const	$push12=, 0
	i64.store	$drop=, 0($pop11), $pop12
	i64.const	$push39=, 0
	i64.store	$drop=, 8($0), $pop39
.LBB1_3:                                # %bar.exit
	end_block                       # label0:
	i32.const	$push47=, 0
	i32.load	$push13=, 12($0)
	i32.store	$drop=, h+4($pop47), $pop13
	i32.const	$push46=, 0
	i32.load	$push14=, 8($0)
	i32.store	$drop=, h($pop46), $pop14
	i32.const	$push45=, 0
	i32.const	$push15=, 24
	i32.add 	$push16=, $0, $pop15
	i32.load	$push17=, 0($pop16)
	i32.store	$drop=, h+16($pop45), $pop17
	i32.const	$push44=, 0
	i32.const	$push18=, 20
	i32.add 	$push19=, $0, $pop18
	i32.load	$push20=, 0($pop19)
	i32.store	$drop=, h+12($pop44), $pop20
	i32.const	$push43=, 0
	i32.const	$push21=, 16
	i32.add 	$push22=, $0, $pop21
	i32.load	$push23=, 0($pop22)
	i32.store	$drop=, h+8($pop43), $pop23
	i32.const	$push42=, 0
	i32.const	$push24=, 1
	i32.store	$drop=, f+4($pop42), $pop24
	block
	i32.const	$push41=, 0
...
# BB#4:                                 # %if.end
	...
	i32.store	$drop=, __stack_pointer($pop32), $pop31
	i32.const	$push48=, 0
	return  	$pop48
.LBB1_5:                                # %if.then
	end_block                       # label2:
