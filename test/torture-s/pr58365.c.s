...
.LBB1_2:                                # %if.end.i
	...
	i32.const	$push37=, 0
	i32.store	$discard=, 0($pop9), $pop37
	i32.const	$push10=, 16
...
.LBB1_3:                                # %bar.exit
	...
	i32.store	$discard=, h+4($pop44), $pop13
	i32.const	$push43=, 0
	i32.load	$push14=, 8($0)
	i32.store	$discard=, h($pop43), $pop14
	i32.const	$push42=, 0
	i32.const	$push15=, 24
	i32.add 	$push16=, $0, $pop15
	i32.load	$push17=, 0($pop16)
	i32.store	$discard=, h+16($pop42), $pop17
	i32.const	$push41=, 0
	i32.const	$push18=, 20
	i32.add 	$push19=, $0, $pop18
	i32.load	$push20=, 0($pop19)
	i32.store	$discard=, h+12($pop41), $pop20
	i32.const	$push40=, 0
	i32.const	$push21=, 16
	i32.add 	$push22=, $0, $pop21
	i32.load	$push23=, 0($pop22)
	i32.store	$discard=, h+8($pop40), $pop23
	i32.const	$push39=, 0
	i32.load	$2=, h+4($pop39)
	i32.const	$push38=, 0
	i32.const	$push24=, 1
	i32.store	$discard=, f+4($pop38), $pop24
	block
