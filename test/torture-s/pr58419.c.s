...
# BB#1:                                 # %lor.rhs
	i32.const	$push61=, 0
	i32.store	$drop=, 0($0), $pop61
	i32.const	$3=, 1
	i32.const	$push60=, 0
	i32.const	$push59=, 1
	i32.store16	$drop=, c($pop60), $pop59
	i32.const	$push58=, 0
	i32.load	$2=, i($pop58)
	i32.const	$push57=, 0
	i32.load	$4=, k($pop57)
...
# BB#3:                                 # %lor.rhs.1
	i32.const	$5=, 0
	i32.const	$push70=, 0
	i32.store	$drop=, 0($0), $pop70
	i32.const	$3=, 1
	i32.const	$push69=, 0
	i32.const	$push68=, 1
	i32.store16	$drop=, c($pop69), $pop68
	i32.const	$push67=, 0
	i32.load	$2=, i($pop67)
	i32.const	$push66=, 0
	i32.load	$4=, k($pop66)
...
# BB#5:                                 # %lor.rhs.2
	i32.const	$push79=, 0
	i32.store	$drop=, 0($0), $pop79
	i32.const	$3=, 1
	i32.const	$push78=, 0
	i32.const	$push77=, 1
	i32.store16	$drop=, c($pop78), $pop77
	i32.const	$push76=, 0
	i32.load	$2=, i($pop76)
	i32.const	$push75=, 0
	i32.load	$4=, k($pop75)
...
# BB#7:                                 # %lor.rhs.3
	i32.const	$5=, 0
	i32.const	$push88=, 0
	i32.store	$drop=, 0($0), $pop88
	i32.const	$3=, 1
	i32.const	$push87=, 0
	i32.const	$push86=, 1
	i32.store16	$drop=, c($pop87), $pop86
	i32.const	$push85=, 0
	i32.load	$2=, i($pop85)
	i32.const	$push84=, 0
	i32.load	$4=, k($pop84)
...
# BB#9:                                 # %lor.rhs.4
	i32.const	$push97=, 0
	i32.store	$drop=, 0($0), $pop97
	i32.const	$3=, 1
	i32.const	$push96=, 0
	i32.const	$push95=, 1
	i32.store16	$drop=, c($pop96), $pop95
	i32.const	$push94=, 0
	i32.load	$2=, i($pop94)
	i32.const	$push93=, 0
	i32.load	$4=, k($pop93)
...
# BB#11:                                # %lor.rhs.5
	...
	i32.const	$push105=, 0
	i32.const	$push104=, 1
	i32.store16	$drop=, c($pop105), $pop104
	i32.const	$push103=, 0
	i32.load	$2=, i($pop103)
	i32.const	$push102=, 0
	i32.load	$4=, k($pop102)
...
# BB#13:                                # %lor.rhs.6
	i32.const	$push115=, 0
	i32.store	$drop=, 0($0), $pop115
	i32.const	$3=, 1
	i32.const	$push114=, 0
	i32.const	$push113=, 1
	i32.store16	$drop=, c($pop114), $pop113
	i32.const	$push112=, 0
	i32.load	$2=, i($pop112)
	i32.const	$push111=, 0
	i32.load	$4=, k($pop111)
...
# BB#15:                                # %lor.rhs.7
	i32.const	$5=, 0
	i32.const	$push124=, 0
	i32.store	$drop=, 0($0), $pop124
	i32.const	$push123=, 0
	i32.const	$push40=, 1
	i32.store16	$drop=, c($pop123), $pop40
.LBB2_16:                               # %lor.end.7
	end_block                       # label7:
	i32.const	$push41=, 0
	i32.store16	$drop=, h($pop41), $1
	i32.const	$push128=, 0
	i32.store	$drop=, g($pop128), $5
	i32.const	$push127=, 0
	i32.store8	$drop=, e($pop127), $4
	i32.const	$push126=, 0
	i32.const	$push42=, 226
	i32.store8	$drop=, b($pop126), $pop42
