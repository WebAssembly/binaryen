...
# BB#0:                                 # %entry
	...
	i32.const	$push4=, 0
	i32.const	$push1=, 1
	i32.store16	$discard=, c($pop4), $pop1
	i32.const	$push3=, 0
...
# BB#0:                                 # %entry
	...
	i32.const	$push82=, 0
	i32.const	$push1=, 234
	i32.store8	$discard=, b($pop82), $pop1
	i32.const	$3=, 1
	i32.const	$1=, 1
	block
	i32.const	$push81=, 0
...
# BB#1:                                 # %lor.rhs
	...
	i32.const	$push86=, 0
	i32.const	$push85=, 1
	i32.store16	$discard=, c($pop86), $pop85
	i32.const	$push84=, 0
	i32.store	$discard=, 0($0), $pop84
.LBB2_2:                                # %lor.end
	end_block                       # label0:
	i32.const	$push94=, 0
	i32.store	$discard=, g($pop94), $1
	block
	i32.const	$push93=, 0
...
# BB#3:                                 # %lor.rhs.1
	...
	i32.const	$push97=, 0
	i32.const	$push96=, 1
	i32.store16	$discard=, c($pop97), $pop96
	i32.const	$push95=, 0
	i32.store	$discard=, 0($0), $pop95
	i32.const	$3=, 0
.LBB2_4:                                # %lor.end.1
	end_block                       # label1:
	i32.const	$push105=, 0
	i32.store	$discard=, g($pop105), $3
	i32.const	$3=, 1
	i32.const	$1=, 1
	block
	i32.const	$push104=, 0
...
# BB#5:                                 # %lor.rhs.2
	...
	i32.const	$push108=, 0
	i32.const	$push107=, 1
	i32.store16	$discard=, c($pop108), $pop107
	i32.const	$push106=, 0
	i32.store	$discard=, 0($0), $pop106
.LBB2_6:                                # %lor.end.2
	end_block                       # label2:
	i32.const	$push116=, 0
	i32.store	$discard=, g($pop116), $1
	block
	i32.const	$push115=, 0
...
# BB#7:                                 # %lor.rhs.3
	...
	i32.const	$push119=, 0
	i32.const	$push118=, 1
	i32.store16	$discard=, c($pop119), $pop118
	i32.const	$push117=, 0
	i32.store	$discard=, 0($0), $pop117
	i32.const	$3=, 0
.LBB2_8:                                # %lor.end.3
	end_block                       # label3:
	i32.const	$push127=, 0
	i32.store	$discard=, g($pop127), $3
	i32.const	$3=, 1
	i32.const	$1=, 1
	block
	i32.const	$push126=, 0
...
# BB#9:                                 # %lor.rhs.4
	...
	i32.const	$push130=, 0
	i32.const	$push129=, 1
	i32.store16	$discard=, c($pop130), $pop129
	i32.const	$push128=, 0
	i32.store	$discard=, 0($0), $pop128
.LBB2_10:                               # %lor.end.4
	end_block                       # label4:
	i32.const	$push138=, 0
	i32.store	$discard=, g($pop138), $1
	block
	i32.const	$push137=, 0
...
# BB#11:                                # %lor.rhs.5
	...
	i32.const	$push141=, 0
	i32.const	$push140=, 1
	i32.store16	$discard=, c($pop141), $pop140
	i32.const	$push139=, 0
	i32.store	$discard=, 0($0), $pop139
	i32.const	$3=, 0
.LBB2_12:                               # %lor.end.5
	end_block                       # label5:
	i32.const	$push149=, 0
	i32.store	$discard=, g($pop149), $3
	i32.const	$3=, 1
	i32.const	$1=, 1
	block
	i32.const	$push148=, 0
...
# BB#13:                                # %lor.rhs.6
	...
	i32.const	$push152=, 0
	i32.const	$push151=, 1
	i32.store16	$discard=, c($pop152), $pop151
	i32.const	$push150=, 0
	i32.store	$discard=, 0($0), $pop150
.LBB2_14:                               # %lor.end.6
	end_block                       # label6:
	i32.const	$push163=, 0
...
# BB#15:                                # %lor.rhs.7
	i32.const	$push165=, 0
	i32.const	$push73=, 1
	i32.store16	$discard=, c($pop165), $pop73
	i32.const	$push164=, 0
	i32.store	$discard=, 0($0), $pop164
	i32.const	$3=, 0
.LBB2_16:                               # %lor.end.7
	end_block                       # label7:
	i32.const	$push170=, 0
	...
	i32.store8	$discard=, b($pop167), $pop74
