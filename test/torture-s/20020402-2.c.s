...
# BB#0:                                 # %entry
	...
	i32.const	$push76=, 0
	i32.const	$push1=, 5
	i32.store	$discard=, MyPte+12($pop76), $pop1
	i32.const	$push75=, 0
	i32.const	$push2=, MyPte+16
	i32.store	$discard=, Local1($pop75), $pop2
	i32.const	$push74=, 0
	i32.const	$push3=, MyPte+20
	i32.store	$discard=, Local2($pop74), $pop3
	i32.const	$push73=, 0
	i32.const	$push4=, MyPte+24
	i32.store	$discard=, Local3($pop73), $pop4
	i32.const	$push72=, 0
	i32.const	$push5=, MyPte+28
	i32.store	$discard=, RDbf1($pop72), $pop5
	i32.const	$push71=, 0
	i32.const	$push6=, MyPte+32
	i32.store	$discard=, RDbf2($pop71), $pop6
	i32.const	$push70=, 0
	i32.const	$push7=, MyPte+36
	i32.store	$discard=, RDbf3($pop70), $pop7
	i32.const	$push69=, 0
	i32.const	$push8=, 1
	i32.store	$discard=, MyPte+36($pop69), $pop8
	i32.const	$push68=, 0
	i32.const	$push9=, MyPte+156
	i32.store	$discard=, IntVc1($pop68), $pop9
	i32.const	$push67=, 0
	i32.const	$push10=, MyPte+160
	i32.store	$discard=, IntVc2($pop67), $pop10
	i32.const	$push66=, 0
	i32.const	$push11=, MyPte+164
	i32.store	$discard=, IntCode3($pop66), $pop11
	i32.const	$push65=, 0
	i32.const	$push12=, MyPte+168
	i32.store	$discard=, IntCode4($pop65), $pop12
	i32.const	$push64=, 0
	i32.const	$push13=, MyPte+172
	i32.store	$discard=, IntCode5($pop64), $pop13
	i32.const	$push63=, 0
	i32.const	$push14=, MyPte+176
	i32.store	$discard=, IntCode6($pop63), $pop14
	i32.const	$push62=, 0
	i32.const	$push15=, MyPte+180
	i32.store	$discard=, Workspace($pop62), $pop15
	i32.const	$push61=, 0
	i32.const	$push16=, MyPte+184
	i32.store	$discard=, Workspace+4($pop61), $pop16
	i32.const	$push60=, 0
	i32.const	$push17=, MyPte+188
	i32.store	$discard=, Workspace+8($pop60), $pop17
	i32.const	$push59=, 0
	i32.const	$push18=, MyPte+192
	i32.store	$discard=, Workspace+12($pop59), $pop18
	i32.const	$push58=, 0
	i32.const	$push19=, MyPte+196
	i32.store	$discard=, Workspace+16($pop58), $pop19
	i32.const	$push57=, 0
	i32.const	$push20=, MyPte+200
	i32.store	$discard=, Workspace+20($pop57), $pop20
	i32.const	$push56=, 0
	i32.const	$push21=, MyPte+204
	i32.store	$discard=, Workspace+24($pop56), $pop21
	i32.const	$push55=, 0
	i32.const	$push22=, MyPte+208
	i32.store	$discard=, Workspace+28($pop55), $pop22
	i32.const	$push54=, 0
	i32.const	$push23=, MyPte+212
	i32.store	$discard=, Workspace+32($pop54), $pop23
	i32.const	$push53=, 0
	i32.const	$push24=, MyPte+216
	i32.store	$discard=, Workspace+36($pop53), $pop24
	i32.const	$push52=, 0
	i32.const	$push25=, MyPte+220
	i32.store	$discard=, Workspace+40($pop52), $pop25
	i32.const	$push51=, 0
	i32.const	$push26=, MyPte+108
	i32.store	$discard=, Lom1($pop51), $pop26
	i32.const	$push50=, 0
	i32.const	$push27=, MyPte+112
	i32.store	$discard=, Lom2($pop50), $pop27
	i32.const	$push49=, 0
	i32.const	$push28=, MyPte+116
	i32.store	$discard=, Lom3($pop49), $pop28
	i32.const	$push48=, 0
	i32.const	$push29=, MyPte+120
	i32.store	$discard=, Lom4($pop48), $pop29
	i32.const	$push47=, 0
	i32.const	$push30=, MyPte+124
	i32.store	$discard=, Lom5($pop47), $pop30
	i32.const	$push46=, 0
	i32.const	$push31=, MyPte+128
	i32.store	$discard=, Lom6($pop46), $pop31
	i32.const	$push45=, 0
	i32.const	$push32=, MyPte+132
	i32.store	$discard=, Lom7($pop45), $pop32
	i32.const	$push44=, 0
	i32.const	$push33=, MyPte+136
	i32.store	$discard=, Lom8($pop44), $pop33
	i32.const	$push43=, 0
	i32.const	$push34=, MyPte+140
	i32.store	$discard=, Lom9($pop43), $pop34
	i32.const	$push42=, 0
	i32.const	$push35=, MyPte+144
	i32.store	$discard=, Lom10($pop42), $pop35
	i32.const	$push41=, 0
	i32.const	$push36=, MyPte+148
	i32.store	$discard=, RDbf11($pop41), $pop36
	i32.const	$push40=, 0
	i32.const	$push37=, MyPte+152
	i32.store	$discard=, RDbf12($pop40), $pop37
	i32.const	$push39=, 0
	i32.const	$push38=, 0
	i32.store	$discard=, MyPte+8($pop39), $pop38
	return
	.endfunc
.Lfunc_end0:
