...
# BB#0:                                 # %entry
	...
	i32.const	$push46=, 0
	i32.const	$push1=, 5
	i32.store	$drop=, MyPte+12($pop46), $pop1
	i32.const	$push45=, 0
	i32.const	$push2=, MyPte+16
	i32.store	$drop=, Local1($pop45), $pop2
	i32.const	$push44=, 0
	i32.const	$push3=, MyPte+20
	i32.store	$drop=, Local2($pop44), $pop3
	i32.const	$push43=, 0
	i32.const	$push4=, MyPte+24
	i32.store	$drop=, Local3($pop43), $pop4
	i32.const	$push42=, 0
	i32.const	$push5=, MyPte+28
	i32.store	$drop=, RDbf1($pop42), $pop5
	i32.const	$push41=, 0
	i32.const	$push40=, 0
	i32.store	$push39=, MyPte+8($pop41), $pop40
	tee_local	$push38=, $0=, $pop39
	i32.const	$push6=, MyPte+32
	i32.store	$drop=, RDbf2($pop38), $pop6
	i32.const	$push7=, MyPte+36
	i32.store	$drop=, RDbf3($0), $pop7
	i32.const	$push8=, 1
	i32.store	$drop=, MyPte+36($0), $pop8
	i32.const	$push9=, MyPte+156
	i32.store	$drop=, IntVc1($0), $pop9
	i32.const	$push10=, MyPte+160
	i32.store	$drop=, IntVc2($0), $pop10
	i32.const	$push11=, MyPte+164
	i32.store	$drop=, IntCode3($0), $pop11
	i32.const	$push12=, MyPte+168
	i32.store	$drop=, IntCode4($0), $pop12
	i32.const	$push13=, MyPte+172
	i32.store	$drop=, IntCode5($0), $pop13
	i32.const	$push14=, MyPte+176
	i32.store	$drop=, IntCode6($0), $pop14
	i32.const	$push15=, MyPte+180
	i32.store	$drop=, Workspace($0), $pop15
	i32.const	$push16=, MyPte+184
	i32.store	$drop=, Workspace+4($0), $pop16
	i32.const	$push17=, MyPte+188
	i32.store	$drop=, Workspace+8($0), $pop17
	i32.const	$push18=, MyPte+192
	i32.store	$drop=, Workspace+12($0), $pop18
	i32.const	$push19=, MyPte+196
	i32.store	$drop=, Workspace+16($0), $pop19
	i32.const	$push20=, MyPte+200
	i32.store	$drop=, Workspace+20($0), $pop20
	i32.const	$push21=, MyPte+204
	i32.store	$drop=, Workspace+24($0), $pop21
	i32.const	$push22=, MyPte+208
	i32.store	$drop=, Workspace+28($0), $pop22
	i32.const	$push23=, MyPte+212
	i32.store	$drop=, Workspace+32($0), $pop23
	i32.const	$push24=, MyPte+216
	i32.store	$drop=, Workspace+36($0), $pop24
	i32.const	$push25=, MyPte+220
	i32.store	$drop=, Workspace+40($0), $pop25
	i32.const	$push26=, MyPte+108
	i32.store	$drop=, Lom1($0), $pop26
	i32.const	$push27=, MyPte+112
	i32.store	$drop=, Lom2($0), $pop27
	i32.const	$push28=, MyPte+116
	i32.store	$drop=, Lom3($0), $pop28
	i32.const	$push29=, MyPte+120
	i32.store	$drop=, Lom4($0), $pop29
	i32.const	$push30=, MyPte+124
	i32.store	$drop=, Lom5($0), $pop30
	i32.const	$push31=, MyPte+128
	i32.store	$drop=, Lom6($0), $pop31
	i32.const	$push32=, MyPte+132
	i32.store	$drop=, Lom7($0), $pop32
	i32.const	$push33=, MyPte+136
	i32.store	$drop=, Lom8($0), $pop33
	i32.const	$push34=, MyPte+140
	i32.store	$drop=, Lom9($0), $pop34
	i32.const	$push35=, MyPte+144
	i32.store	$drop=, Lom10($0), $pop35
	i32.const	$push36=, MyPte+148
	i32.store	$drop=, RDbf11($0), $pop36
	i32.const	$push37=, MyPte+152
	i32.store	$drop=, RDbf12($0), $pop37
                                        # fallthrough-return
	.endfunc
.Lfunc_end0:
