...
# BB#0:                                 # %entry
	...
	call    	__addtf3@FUNCTION, $pop77, $pop214, $pop211, $5, $4
	i32.const	$push78=, 16
	...
	call    	__multf3@FUNCTION, $pop95, $11, $10, $7, $6
...
# BB#5:                                 # %entry
	...
	i32.call	$push50=, __netf2@FUNCTION, $0, $1, $pop248, $pop49
	br_if   	0, $pop50       # 0: down to label0
# BB#6:                                 # %entry
	i64.const	$push249=, 0
	i64.const	$push51=, 4612961451915608064
	i32.call	$push52=, __netf2@FUNCTION, $2, $3, $pop249, $pop51
	br_if   	0, $pop52       # 0: down to label0
# BB#7:                                 # %entry
	i64.const	$push250=, 0
	i64.const	$push53=, 4613040616752807936
	i32.call	$push54=, __eqtf2@FUNCTION, $10, $11, $pop250, $pop53
