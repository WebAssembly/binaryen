...
.LBB6_1:                                # %for.body
                                        # =>This Inner Loop Header: Depth=1
	loop                            # label12:
	i32.load	$push16=, a+16384($1)
	tee_local	$push15=, $0=, $pop16
	i64.extend_s/i32	$push1=, $pop15
	...
	i32.const	$push12=, 31
	i32.shr_s	$push0=, $0, $pop12
	i32.sub 	$push5=, $pop4, $pop0
	i32.const	$push11=, -3
	i32.mul 	$push6=, $pop5, $pop11
	i32.add 	$push7=, $pop6, $0
	i32.store	$drop=, c+16384($1), $pop7
	i32.const	$push10=, 4
...
.LBB7_1:                                # %for.body
                                        # =>This Inner Loop Header: Depth=1
	loop                            # label14:
	i32.load	$push13=, b+16384($1)
	tee_local	$push12=, $0=, $pop13
	i64.extend_u/i32	$push0=, $pop12
	i64.const	$push11=, 2863311531
	i64.mul 	$push1=, $pop0, $pop11
	i64.const	$push10=, 33
	i64.shr_u	$push2=, $pop1, $pop10
	i32.wrap/i64	$push3=, $pop2
	i32.const	$push9=, -3
	i32.mul 	$push4=, $pop3, $pop9
	i32.add 	$push5=, $pop4, $0
	i32.store	$drop=, d+16384($1), $pop5
	i32.const	$push8=, 4
	i32.add 	$push7=, $1, $pop8
	tee_local	$push6=, $1=, $pop7
	br_if   	0, $pop6        # 0: up to label14
# BB#2:                                 # %for.end
	end_loop                        # label15:
                                        # fallthrough-return
	.endfunc
...
.LBB11_1:                               # %for.body
                                        # =>This Inner Loop Header: Depth=1
	loop                            # label22:
	i32.load	$push20=, b+16384($2)
	tee_local	$push19=, $0=, $pop20
	i64.extend_u/i32	$push0=, $0
	i64.const	$push18=, 2938661835
	i64.mul 	$push1=, $pop0, $pop18
	i64.const	$push17=, 32
	i64.shr_u	$push2=, $pop1, $pop17
	i32.wrap/i64	$push16=, $pop2
	tee_local	$push15=, $1=, $pop16
	i32.sub 	$push3=, $pop19, $pop15
	i32.const	$push14=, 1
	i32.shr_u	$push4=, $pop3, $pop14
	i32.add 	$push5=, $pop4, $1
	i32.const	$push13=, 4
	i32.shr_u	$push6=, $pop5, $pop13
	i32.const	$push12=, -19
	i32.mul 	$push7=, $pop6, $pop12
	i32.add 	$push8=, $pop7, $0
	i32.store	$drop=, d+16384($2), $pop8
	i32.const	$push11=, 4
	i32.add 	$push10=, $2, $pop11
	tee_local	$push9=, $2=, $pop10
	br_if   	0, $pop9        # 0: up to label22
# BB#2:                                 # %for.end
	end_loop                        # label23:
                                        # fallthrough-return
	.endfunc
