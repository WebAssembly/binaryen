...
# BB#0:                                 # %entry
	...
	i32.store	$push25=, 0($pop13), $pop21
	tee_local	$push24=, $6=, $pop25
	i32.const	$push17=, 16
	i32.add 	$push18=, $pop24, $pop17
	i32.const	$push0=, 1
	i32.add 	$push1=, $1, $pop0
	call    	__floatsitf@FUNCTION, $pop18, $pop1
	i32.const	$push19=, 16
	...
	i32.const	$push23=, 8
	i32.add 	$push6=, $6, $pop23
	i64.load	$4=, 0($pop6)
	i64.load	$5=, 0($6)
	i32.const	$push22=, 8
	i32.add 	$push7=, $0, $pop22
	i64.store	$drop=, 0($pop7), $2
	i32.const	$push8=, 24
	i32.add 	$push9=, $0, $pop8
	i64.store	$drop=, 0($pop9), $4
	i64.store	$drop=, 0($0), $3
	i64.store	$drop=, 16($0), $5
