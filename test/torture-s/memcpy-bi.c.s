...
# BB#2:                                 # %check.exit
	...
	i32.store16	$drop=, dst($pop253), $pop27
	block
	i32.const	$push28=, 1
	i32.eqz 	$push676=, $pop28
	br_if   	0, $pop676      # 0: down to label3
# BB#3:                                 # %check.exit172
	i32.const	$push259=, 0
	i32.const	$push258=, 0
	i32.load8_u	$push29=, src+2($pop258)
	i32.store8	$drop=, dst+2($pop259), $pop29
	i32.const	$push257=, 0
	i32.const	$push256=, 0
	i32.load16_u	$push30=, src($pop256)
	i32.store16	$drop=, dst($pop257), $pop30
...
# BB#4:                                 # %check.exit176
	...
	i32.store8	$drop=, dst+4($pop264), $pop33
	i32.const	$push262=, 0
	i32.store	$drop=, dst($pop262), $4
...
# BB#5:                                 # %check.exit184
	...
	i32.store16	$drop=, dst+4($pop271), $pop36
	i32.const	$push269=, 0
	i32.const	$push268=, 0
	i32.load	$push37=, src($pop268)
	i32.store	$drop=, dst($pop269), $pop37
...
# BB#6:                                 # %check.exit188
	...
	i32.store8	$drop=, dst+6($pop277), $pop40
	i32.const	$push275=, 0
	i32.store16	$drop=, dst+4($pop275), $4
	i32.const	$push274=, 0
	i32.store	$drop=, dst($pop274), $0
...
# BB#7:                                 # %check.exit192
	...
	i32.store8	$drop=, dst+8($pop285), $pop43
	i32.const	$push283=, 0
	i32.const	$push282=, 0
	i64.load	$push44=, src($pop282)
	i64.store	$drop=, dst($pop283), $pop44
...
# BB#8:                                 # %check.exit200
	...
	i32.store16	$drop=, dst+8($pop290), $pop47
	i32.const	$push288=, 0
	i64.store	$drop=, dst($pop288), $1
...
# BB#9:                                 # %check.exit204
	...
	i32.store8	$drop=, dst+10($pop298), $pop50
	i32.const	$push296=, 0
	i32.store16	$drop=, dst+8($pop296), $4
	i32.const	$push295=, 0
	i32.const	$push294=, 0
	i64.load	$push51=, src($pop294)
	i64.store	$drop=, dst($pop295), $pop51
...
# BB#10:                                # %check.exit208
	...
	i32.store	$drop=, dst+8($pop304), $pop54
	i32.const	$push302=, 0
	i64.store	$drop=, dst($pop302), $1
...
# BB#11:                                # %check.exit212
	...
	i32.store8	$drop=, dst+12($pop312), $pop57
	i32.const	$push310=, 0
	i32.store	$drop=, dst+8($pop310), $4
	i32.const	$push309=, 0
	i32.const	$push308=, 0
...
# BB#12:                                # %check.exit216
	...
	i32.store16	$drop=, dst+12($pop319), $pop61
	i32.const	$push317=, 0
	i32.store	$drop=, dst+8($pop317), $4
	i32.const	$push316=, 0
	i64.store	$drop=, dst($pop316), $1
...
# BB#13:                                # %check.exit220
	...
	i32.store8	$drop=, dst+14($pop329), $pop64
	i32.const	$push327=, 0
	i32.store16	$drop=, dst+12($pop327), $4
	i32.const	$push326=, 0
	i32.store	$drop=, dst+8($pop326), $0
	i32.const	$push325=, 0
	i32.const	$push324=, 0
	i64.load	$push65=, src($pop324)
	i64.store	$drop=, dst($pop325), $pop65
...
# BB#14:                                # %check.exit224
	...
	i64.store	$drop=, dst+8($pop336), $pop68
	i32.const	$push334=, 0
	i64.store	$drop=, dst($pop334), $1
...
# BB#15:                                # %check.exit228
	...
	i32.store8	$drop=, dst+16($pop344), $pop71
	i32.const	$push342=, 0
	i64.store	$drop=, dst+8($pop342), $1
	i32.const	$push341=, 0
	i32.const	$push340=, 0
	i64.load	$push72=, src($pop340)
	i64.store	$drop=, dst($pop341), $pop72
...
# BB#16:                                # %check.exit232
	...
	i32.store16	$drop=, dst+16($pop351), $pop75
	i32.const	$push349=, 0
	i64.store	$drop=, dst+8($pop349), $1
	i32.const	$push348=, 0
	i64.store	$drop=, dst($pop348), $2
...
# BB#17:                                # %check.exit236
	...
	i32.store8	$drop=, dst+18($pop361), $pop78
	i32.const	$push359=, 0
	i32.store16	$drop=, dst+16($pop359), $4
	i32.const	$push358=, 0
	i64.store	$drop=, dst+8($pop358), $1
	i32.const	$push357=, 0
	i32.const	$push356=, 0
	i64.load	$push79=, src($pop356)
	i64.store	$drop=, dst($pop357), $pop79
...
# BB#18:                                # %check.exit240
	...
	i32.store	$drop=, dst+16($pop369), $pop82
	i32.const	$push367=, 0
	i64.store	$drop=, dst+8($pop367), $1
	i32.const	$push366=, 0
	i64.store	$drop=, dst($pop366), $2
...
# BB#19:                                # %check.exit244
	...
	i32.store8	$drop=, dst+20($pop379), $pop85
	i32.const	$push377=, 0
	i32.store	$drop=, dst+16($pop377), $4
	i32.const	$push376=, 0
	i64.store	$drop=, dst+8($pop376), $1
	i32.const	$push375=, 0
	i32.const	$push374=, 0
	i64.load	$push86=, src($pop374)
	i64.store	$drop=, dst($pop375), $pop86
...
# BB#20:                                # %check.exit248
	...
	i32.store16	$drop=, dst+20($pop389), $pop89
	i32.const	$push387=, 0
	i64.load	$2=, src($pop387)
	i32.const	$push386=, 0
	i32.store	$drop=, dst+16($pop386), $4
	i32.const	$push385=, 0
	i64.store	$drop=, dst+8($pop385), $1
	i32.const	$push384=, 0
	i64.store	$drop=, dst($pop384), $2
...
# BB#21:                                # %check.exit252
	...
	i32.store8	$drop=, dst+22($pop400), $pop92
	i32.const	$push398=, 0
	i32.store16	$drop=, dst+20($pop398), $4
	i32.const	$push397=, 0
	i32.store	$drop=, dst+16($pop397), $0
	i32.const	$push396=, 0
	i64.store	$drop=, dst+8($pop396), $1
	i32.const	$push395=, 0
	i32.const	$push394=, 0
	i64.load	$push93=, src($pop394)
	i64.store	$drop=, dst($pop395), $pop93
...
# BB#22:                                # %check.exit256
	...
	i64.store	$drop=, dst+16($pop409), $pop96
	i32.const	$push407=, 0
	i64.store	$drop=, dst+8($pop407), $1
	i32.const	$push406=, 0
	i64.store	$drop=, dst($pop406), $2
...
# BB#23:                                # %check.exit260
	...
	i32.store8	$drop=, dst+24($pop419), $pop99
	i32.const	$push417=, 0
	i64.store	$drop=, dst+16($pop417), $1
	i32.const	$push416=, 0
	i64.store	$drop=, dst+8($pop416), $2
	i32.const	$push415=, 0
	i32.const	$push414=, 0
	i64.load	$push100=, src($pop414)
	i64.store	$drop=, dst($pop415), $pop100
...
# BB#24:                                # %check.exit264
	...
	i32.store16	$drop=, dst+24($pop429), $pop103
	i32.const	$push427=, 0
	i64.load	$3=, src($pop427)
	i32.const	$push426=, 0
	i64.store	$drop=, dst+16($pop426), $1
	i32.const	$push425=, 0
	i64.store	$drop=, dst+8($pop425), $2
	i32.const	$push424=, 0
	i64.store	$drop=, dst($pop424), $3
...
# BB#25:                                # %check.exit268
	...
	i32.store8	$drop=, dst+26($pop440), $pop106
	i32.const	$push438=, 0
	i32.store16	$drop=, dst+24($pop438), $4
	i32.const	$push437=, 0
	i64.store	$drop=, dst+16($pop437), $1
	i32.const	$push436=, 0
	i64.store	$drop=, dst+8($pop436), $2
	i32.const	$push435=, 0
	i32.const	$push434=, 0
	i64.load	$push107=, src($pop434)
	i64.store	$drop=, dst($pop435), $pop107
...
# BB#26:                                # %check.exit272
	...
	i32.store	$drop=, dst+24($pop451), $pop110
	i32.const	$push449=, 0
	i64.load	$3=, src($pop449)
	i32.const	$push448=, 0
	i64.store	$drop=, dst+16($pop448), $1
	i32.const	$push447=, 0
	i64.store	$drop=, dst+8($pop447), $2
	i32.const	$push446=, 0
	i64.store	$drop=, dst($pop446), $3
...
# BB#27:                                # %check.exit276
	...
	i32.store8	$drop=, dst+28($pop462), $pop113
	i32.const	$push460=, 0
	i32.store	$drop=, dst+24($pop460), $4
	i32.const	$push459=, 0
	i64.store	$drop=, dst+16($pop459), $1
	i32.const	$push458=, 0
	i64.store	$drop=, dst+8($pop458), $2
	i32.const	$push457=, 0
	i32.const	$push456=, 0
	i64.load	$push114=, src($pop456)
	i64.store	$drop=, dst($pop457), $pop114
...
# BB#28:                                # %check.exit280
	...
	i32.store16	$drop=, dst+28($pop476), $pop118
	i32.const	$push474=, 0
	i64.load	$1=, src+16($pop474)
	i32.const	$push473=, 0
	i64.load	$2=, src+8($pop473)
	i32.const	$push472=, 0
	i32.store	$drop=, dst+24($pop472), $4
	i32.const	$push471=, 0
	i64.load	$3=, src($pop471)
	i32.const	$push470=, 0
	i64.store	$drop=, dst+16($pop470), $1
	i32.const	$push469=, 0
	i64.store	$drop=, dst+8($pop469), $2
	i32.const	$push468=, 0
	i64.store	$drop=, dst($pop468), $3
...
# BB#30:                                # %check.exit288
	...
	i64.store	$drop=, dst+24($pop488), $pop125
	i32.const	$push486=, 0
	i64.load	$3=, src($pop486)
	i32.const	$push485=, 0
	i64.store	$drop=, dst+16($pop485), $1
	i32.const	$push484=, 0
	i64.store	$drop=, dst+8($pop484), $2
	i32.const	$push483=, 0
	i64.store	$drop=, dst($pop483), $3
