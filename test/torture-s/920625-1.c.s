...
# BB#0:                                 # %entry
	...
	i32.const	$push32=, 8
	i32.add 	$push5=, $pop40, $pop32
	i32.const	$push31=, 0
	i64.load	$push4=, pts+24($pop31)
	i64.store	$discard=, 0($pop5), $pop4
	i32.const	$push30=, 0
	i64.load	$push6=, pts($pop30)
	i64.store	$discard=, 112($1), $pop6
	i32.const	$push29=, 0
	i64.load	$push7=, pts+16($pop29)
