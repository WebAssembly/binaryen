...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop4), $pop14
	i64.load	$push13=, 0($1):p2align=2
	tee_local	$push12=, $2=, $pop13
	i64.store	$drop=, 16($3), $pop12
	i64.store	$drop=, 8($3):p2align=2, $2
	i32.const	$push8=, 24
...
# BB#0:                                 # %entry
	...
	i64.store	$drop=, 16($0), $pop1
	i64.const	$push19=, 4767060206663237632
	i64.store	$drop=, 8($0):p2align=2, $pop19
	i32.const	$push15=, 24
