...
# BB#0:                                 # %entry
	...
	i32.const	$push102=, 0
	i32.add 	$push0=, $1, $0
	i32.store	$push101=, res($pop102), $pop0
...
# BB#16:                                # %verify.exit84
	...
	i32.const	$push122=, 0
	i32.store	$discard=, res($pop122), $0
	i32.const	$push121=, 0
...
# BB#18:                                # %verify.exit90
	...
	i32.const	$push125=, 0
	i32.store	$discard=, res($pop125), $0
	i32.const	$push124=, 0
...
# BB#20:                                # %verify.exit96
	...
	i32.store	$1=, k($pop130), $pop96
	i32.const	$push129=, 0
	i32.store	$discard=, k+4($pop129), $0
	i32.const	$push128=, 0
	i32.store	$push97=, res($pop128), $1
	i32.const	$push127=, 0
