...
# BB#0:                                 # %entry
	...
	i32.const	$push113=, 0
	i32.const	$push4=, 1
	i32.store	$drop=, should_optimize($pop113), $pop4
	i32.const	$push112=, 0
	i32.load	$push111=, stdout($pop112)
	tee_local	$push110=, $3=, $pop111
	i32.const	$push109=, .L.str
	i32.const	$push108=, 0
	i32.call	$drop=, __fprintf_chk@FUNCTION, $pop110, $2, $pop109, $pop108
	block
	i32.const	$push107=, 0
...
# BB#3:                                 # %if.end6
	i32.const	$push121=, 0
	i32.const	$push10=, 1
	i32.store	$drop=, should_optimize($pop121), $pop10
	i32.const	$push120=, .L.str.1
	i32.const	$push119=, 0
	i32.call	$drop=, __fprintf_chk@FUNCTION, $3, $2, $pop120, $pop119
	i32.const	$push118=, 0
...
# BB#6:                                 # %if.end17
	...
	i32.const	$push127=, 0
	i32.call	$drop=, __fprintf_chk@FUNCTION, $3, $2, $pop128, $pop127
	i32.const	$push126=, 0
...
# BB#9:                                 # %if.end28
	i32.const	$push137=, 0
	i32.const	$push22=, 1
	i32.store	$drop=, should_optimize($pop137), $pop22
	i32.const	$push136=, .L.str.3
	i32.const	$push135=, 0
	i32.call	$drop=, __fprintf_chk@FUNCTION, $3, $2, $pop136, $pop135
	i32.const	$push134=, 0
...
# BB#13:                                # %if.end43
	i32.const	$push147=, 0
	i32.const	$push146=, 0
	i32.store	$drop=, should_optimize($pop147), $pop146
...
# BB#18:                                # %if.end61
	...
	i32.call	$drop=, __fprintf_chk@FUNCTION, $3, $2, $pop155, $pop89
	i32.const	$push154=, 0
...
# BB#19:                                # %if.end65
	i32.const	$push159=, 0
	i32.const	$push158=, 0
	i32.store	$drop=, should_optimize($pop159), $pop158
...
# BB#24:                                # %if.end83
	...
	i32.call	$drop=, __fprintf_chk@FUNCTION, $3, $2, $pop167, $pop97
	i32.const	$push166=, 0
...
# BB#27:                                # %if.end94
	...
	i32.call	$drop=, __fprintf_chk@FUNCTION, $3, $2, $pop173, $pop101
...
# BB#30:                                # %if.end105
	...
	i32.call	$drop=, __fprintf_chk@FUNCTION, $3, $2, $pop178, $pop105
