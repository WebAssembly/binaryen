...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop17), $pop22
	i64.const	$push0=, 0
	i64.store	$drop=, 8($3):p2align=2, $pop0
	block
	i32.const	$push1=, 0
