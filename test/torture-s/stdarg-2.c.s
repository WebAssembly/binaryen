...
# BB#0:                                 # %entry
	...
	i32.const	$push44=, 32
	i32.sub 	$push54=, $pop43, $pop44
	tee_local	$push53=, $2=, $pop54
	i32.store	$drop=, __stack_pointer($pop45), $pop53
	block
	block
	block
	block
...
.LBB0_5:                                # %sw.bb9
	...
	i32.const	$push23=, -8
	i32.and 	$push61=, $pop22, $pop23
	tee_local	$push60=, $0=, $pop61
	i32.load	$push25=, 0($pop60)
...
# BB#1:                                 # %if.then
	...
	i32.store	$drop=, gap($pop20), $pop15
	i32.load	$push3=, 0($2)
	i32.const	$push4=, 13
...
# BB#2:                                 # %lor.lhs.false
	...
	i32.store	$drop=, gap($pop23), $pop10
	f64.load	$push11=, 0($2)
...
.LBB1_3:                                # %if.end6
	end_block                       # label5:
	i32.const	$push14=, 0
	i32.store	$drop=, bar_arg($pop14), $0
	return
.LBB1_4:                                # %if.then5
	end_block                       # label4:
	call    	abort@FUNCTION
...
# BB#0:                                 # %entry
	i32.const	$push0=, 0
	i32.store	$drop=, gap($pop0), $1
	i32.const	$push5=, 0
	i32.const	$push1=, 4
	i32.add 	$push2=, $1, $pop1
	i32.store	$drop=, gap($pop5), $pop2
	i32.const	$push4=, 0
	i32.load	$push3=, 0($1)
...
# BB#1:                                 # %if.then.i
	...
	i32.store	$drop=, gap($pop21), $pop16
	i32.load	$push3=, 0($1)
	i32.const	$push4=, 13
	i32.ne  	$push5=, $pop3, $pop4
...
# BB#2:                                 # %lor.lhs.false.i
	...
	i32.store	$drop=, gap($pop11), $pop10
	f64.load	$push12=, 0($1)
...
.LBB3_3:                                # %bar.exit
	end_block                       # label7:
	i32.const	$push24=, 0
	i32.store	$drop=, bar_arg($pop24), $0
	return
.LBB3_4:                                # %if.then5.i
	end_block                       # label6:
	call    	abort@FUNCTION
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, 16($pop7), $1
	i32.const	$push0=, 4
	i32.add 	$push1=, $1, $pop0
	i32.store	$drop=, 16($2), $pop1
	i32.const	$push3=, 0
	i32.load	$push2=, 0($1)
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop18), $pop22
	i32.store	$drop=, 16($3), $1
	block
	block
	i32.const	$push0=, 16386
	i32.ne  	$push1=, $0, $pop0
...
# BB#1:                                 # %if.then.i
	...
	i32.store	$drop=, gap($pop29), $pop24
	i32.load	$push3=, 0($1)
	i32.const	$push4=, 13
	i32.ne  	$push5=, $pop3, $pop4
...
# BB#2:                                 # %lor.lhs.false.i
	...
	i32.store	$drop=, gap($pop32), $pop10
	f64.load	$push11=, 0($1)
	f64.const	$push12=, -0x1.cp3
	f64.ne  	$push13=, $pop11, $pop12
...
# BB#1:                                 # %if.then.i
	...
	i32.store	$drop=, gap($pop31), $pop26
	i32.load	$push5=, 0($1)
	i32.const	$push6=, 13
...
# BB#2:                                 # %lor.lhs.false.i
	...
	i32.store	$drop=, gap($pop34), $pop12
	f64.load	$push13=, 0($1)
...
.LBB11_3:                               # %bar.exit
	end_block                       # label21:
	i32.const	$push16=, 0
	i32.store	$drop=, bar_arg($pop16), $0
	i32.const	$push23=, 0
	i32.const	$push21=, 16
...
# BB#0:                                 # %entry
	...
	i32.const	$push46=, 48
	i32.sub 	$push56=, $pop45, $pop46
	tee_local	$push55=, $2=, $pop56
	i32.store	$drop=, __stack_pointer($pop47), $pop55
	i32.const	$push1=, 44
...
# BB#3:                                 # %sw.bb.i
	...
	i32.const	$push34=, -8
	i32.and 	$push58=, $pop33, $pop34
	tee_local	$push57=, $1=, $pop58
	f64.load	$push36=, 0($pop57)
...
.LBB12_5:                               # %sw.bb9.i
	...
	i32.const	$push25=, -8
	i32.and 	$push63=, $pop24, $pop25
	tee_local	$push62=, $1=, $pop63
	f64.load	$push26=, 8($pop62)
	i32.load	$push27=, 0($1)
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop54), $pop76
	i32.const	$push0=, 79
	i32.store	$drop=, 160($0), $pop0
...
# BB#1:                                 # %if.end
	...
	i64.store	$drop=, 152($0), $pop3
	i32.const	$push4=, 13
	i32.store	$drop=, 144($0), $pop4
...
# BB#4:                                 # %if.end9
	...
	i64.store	$drop=, 88($0), $pop18
	i32.const	$push19=, 1
	i32.store	$drop=, 80($0), $pop19
	i32.const	$push20=, 5
	i32.const	$push66=, 80
...
# BB#7:                                 # %if.end18
	...
	i64.store	$drop=, 56($0), $pop30
	i64.const	$push31=, 2031
	i64.store	$drop=, 48($0), $pop31
	i32.const	$push32=, 8
	i32.const	$push70=, 48
...
# BB#10:                                # %if.end27
	...
	i64.const	$push45=, 0
	i64.store	$drop=, 8($0), $pop45
	i32.const	$push46=, 2030
	i32.store	$drop=, 0($0), $pop46
	i32.const	$push47=, 11
