...
.LBB0_1:                                # %for.body
	...
	i32.const	$push130=, 0
	f32.store	$discard=, gf($pop130), $1
	i32.const	$push129=, 0
	f32.store	$discard=, gf+4($pop129), $2
	i32.const	$push128=, 0
	f32.store	$discard=, gf+8($pop128), $3
	i32.const	$push127=, 0
	f32.store	$discard=, gf+12($pop127), $4
	i32.const	$push126=, 0
	f32.store	$discard=, gf+16($pop126), $5
	i32.const	$push125=, 0
	f32.store	$discard=, gf+20($pop125), $6
	i32.const	$push124=, 0
	f32.store	$discard=, gf+24($pop124), $7
	i32.const	$push123=, 0
	f32.store	$discard=, gf+28($pop123), $8
	i32.const	$push122=, 0
	f32.store	$discard=, gf+32($pop122), $9
	i32.const	$push121=, 0
	f32.store	$discard=, gf+36($pop121), $10
	i32.const	$push120=, 0
	f32.store	$discard=, gf+40($pop120), $11
	i32.const	$push119=, 0
	f32.store	$discard=, gf+44($pop119), $12
	i32.const	$push118=, 0
	f32.store	$discard=, gf+48($pop118), $13
	i32.const	$push117=, 0
	f32.store	$discard=, gf+52($pop117), $14
	i32.const	$push116=, 0
	f32.store	$discard=, gf+56($pop116), $15
	i32.const	$push115=, 0
	f32.store	$discard=, gf+60($pop115), $16
	i32.const	$push114=, 0
	f32.store	$discard=, gf+64($pop114), $17
	i32.const	$push113=, 0
	f32.store	$discard=, gf+68($pop113), $18
	i32.const	$push112=, 0
	f32.store	$discard=, gf+72($pop112), $19
	i32.const	$push111=, 0
	f32.store	$discard=, gf+76($pop111), $20
	i32.const	$push110=, 0
	f32.store	$discard=, gf+80($pop110), $21
	i32.const	$push109=, 0
	f32.store	$discard=, gf+84($pop109), $22
	i32.const	$push108=, 0
	f32.store	$discard=, gf+88($pop108), $23
	i32.const	$push107=, 0
	f32.store	$discard=, gf+92($pop107), $24
	i32.const	$push106=, 0
	f32.store	$discard=, gf+96($pop106), $25
	i32.const	$push105=, 0
	f32.store	$discard=, gf+100($pop105), $26
	i32.const	$push104=, 0
	f32.store	$discard=, gf+104($pop104), $27
	i32.const	$push103=, 0
	f32.store	$discard=, gf+108($pop103), $28
	i32.const	$push102=, 0
	f32.store	$discard=, gf+112($pop102), $29
	i32.const	$push101=, 0
	f32.store	$discard=, gf+116($pop101), $30
	i32.const	$push100=, 0
	f32.store	$discard=, gf+120($pop100), $31
...
.LBB0_2:                                # %for.end
	...
	end_block                       # label0:
	i32.const	$push290=, 0
	f64.store	$discard=, gd($pop290), $129
	i32.const	$push289=, 0
	f64.store	$discard=, gd+8($pop289), $130
	i32.const	$push288=, 0
	f64.store	$discard=, gd+16($pop288), $131
	i32.const	$push287=, 0
	f64.store	$discard=, gd+24($pop287), $132
	i32.const	$push286=, 0
	f64.store	$discard=, gd+32($pop286), $133
	i32.const	$push285=, 0
	f64.store	$discard=, gd+40($pop285), $134
	i32.const	$push284=, 0
	f64.store	$discard=, gd+48($pop284), $135
	i32.const	$push283=, 0
	f64.store	$discard=, gd+56($pop283), $136
	i32.const	$push282=, 0
	f64.store	$discard=, gd+64($pop282), $137
	i32.const	$push281=, 0
	f64.store	$discard=, gd+72($pop281), $138
	i32.const	$push280=, 0
	f64.store	$discard=, gd+80($pop280), $139
	i32.const	$push279=, 0
	f64.store	$discard=, gd+88($pop279), $140
	i32.const	$push278=, 0
	f64.store	$discard=, gd+96($pop278), $141
	i32.const	$push277=, 0
	f64.store	$discard=, gd+104($pop277), $142
	i32.const	$push276=, 0
	f64.store	$discard=, gd+112($pop276), $143
	i32.const	$push275=, 0
	f64.store	$discard=, gd+120($pop275), $144
	i32.const	$push274=, 0
	f64.store	$discard=, gd+128($pop274), $145
	i32.const	$push273=, 0
	f64.store	$discard=, gd+136($pop273), $146
	i32.const	$push272=, 0
	f64.store	$discard=, gd+144($pop272), $147
	i32.const	$push271=, 0
	f64.store	$discard=, gd+152($pop271), $148
	i32.const	$push270=, 0
	f64.store	$discard=, gd+160($pop270), $149
	i32.const	$push269=, 0
	f64.store	$discard=, gd+168($pop269), $150
	i32.const	$push268=, 0
	f64.store	$discard=, gd+176($pop268), $151
	i32.const	$push267=, 0
	f64.store	$discard=, gd+184($pop267), $152
	i32.const	$push266=, 0
	f64.store	$discard=, gd+192($pop266), $153
	i32.const	$push265=, 0
	f64.store	$discard=, gd+200($pop265), $154
	i32.const	$push264=, 0
	f64.store	$discard=, gd+208($pop264), $155
	i32.const	$push263=, 0
	f64.store	$discard=, gd+216($pop263), $156
	i32.const	$push262=, 0
	f64.store	$discard=, gd+224($pop262), $157
	i32.const	$push261=, 0
	f64.store	$discard=, gd+232($pop261), $158
	i32.const	$push260=, 0
	f64.store	$discard=, gd+240($pop260), $159
	i32.const	$push259=, 0
