...
.LBB7_1:                                # %for.body
	...
	i64.store32	$drop=, 0($pop0), $pop4
	i32.const	$push7=, 4
	i32.add 	$push6=, $0, $pop7
	tee_local	$push5=, $0=, $pop6
	br_if   	0, $pop5        # 0: up to label14
# BB#2:                                 # %for.end
	end_loop                        # label15:
                                        # fallthrough-return
	.endfunc
...
.LBB12_1:                               # %for.body
	...
	br_if   	0, $pop85       # 0: up to label24
# BB#2:                                 # %for.end
	end_loop                        # label25:
	i32.const	$1=, 0
	i32.const	$push94=, 0
	i32.const	$push3=, 2147483647
	i32.store	$drop=, a+16380($pop94), $pop3
	i32.const	$push93=, 0
	i64.const	$push4=, -9223372030412324864
	i64.store	$drop=, a($pop93), $pop4
	i32.const	$push92=, 0
	i32.const	$push5=, -1
	i32.store	$drop=, b+16380($pop92), $pop5
	call    	f1@FUNCTION
	call    	f2@FUNCTION
	i32.const	$0=, 0
.LBB12_3:                               # %for.body4
...
.LBB12_7:                               # %for.body17
	...
	br_if   	3, $pop24       # 3: down to label30
# BB#8:                                 # %lor.lhs.false22
	...
	br_if   	3, $pop30       # 3: down to label30
# BB#9:                                 # %for.cond15
                                        #   in Loop: Header=BB12_7 Depth=1
	i32.const	$push116=, 4
	i32.add 	$1=, $1, $pop116
...
.LBB12_11:                              # %for.body34
	...
	br_if   	4, $pop37       # 4: down to label29
# BB#12:                                # %lor.lhs.false39
	...
	br_if   	4, $pop43       # 4: down to label29
# BB#13:                                # %for.cond32
                                        #   in Loop: Header=BB12_11 Depth=1
	i32.const	$push127=, 4
	i32.add 	$1=, $1, $pop127
...
.LBB12_15:                              # %for.body51
	...
	br_if   	5, $pop50       # 5: down to label28
# BB#16:                                # %lor.lhs.false56
	...
	br_if   	5, $pop56       # 5: down to label28
# BB#17:                                # %for.cond49
                                        #   in Loop: Header=BB12_15 Depth=1
	i32.const	$push138=, 4
	i32.add 	$1=, $1, $pop138
...
.LBB12_19:                              # %for.body68
	...
	br_if   	6, $pop63       # 6: down to label27
# BB#20:                                # %lor.lhs.false73
	...
	br_if   	6, $pop69       # 6: down to label27
# BB#21:                                # %for.cond66
                                        #   in Loop: Header=BB12_19 Depth=1
	i32.const	$push149=, 4
	i32.add 	$1=, $1, $pop149
...
.LBB12_23:                              # %for.body85
	...
	br_if   	7, $pop76       # 7: down to label26
# BB#24:                                # %lor.lhs.false90
	...
	br_if   	7, $pop82       # 7: down to label26
# BB#25:                                # %for.cond83
                                        #   in Loop: Header=BB12_23 Depth=1
	i32.const	$push160=, 4
	i32.add 	$1=, $1, $pop160
