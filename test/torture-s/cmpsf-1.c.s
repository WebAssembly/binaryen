...
# BB#3:                                 # %if.end
	...
	br_if   	8, $pop10       # 8: down to label1
# BB#4:                                 # %if.end10
                                        #   in Loop: Header=BB6_2 Depth=2
	i32.const	$push47=, 13
	...
	br_if   	7, $pop15       # 7: down to label2
# BB#5:                                 # %if.end15
                                        #   in Loop: Header=BB6_2 Depth=2
	...
	br_if   	6, $pop23       # 6: down to label3
# BB#6:                                 # %if.end20
                                        #   in Loop: Header=BB6_2 Depth=2
	i32.const	$push55=, 13
	...
	br_if   	5, $pop28       # 5: down to label4
# BB#7:                                 # %if.end25
                                        #   in Loop: Header=BB6_2 Depth=2
	...
	br_if   	4, $pop33       # 4: down to label5
# BB#8:                                 # %if.end30
                                        #   in Loop: Header=BB6_2 Depth=2
	i32.const	$push62=, 24
	i32.add 	$4=, $4, $pop62
