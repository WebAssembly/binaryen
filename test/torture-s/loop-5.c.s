...
# BB#2:                                 # %ap.exit.1.i
	...
	i32.store	$drop=, t($pop46), $pop43
	i32.const	$push42=, 2
	i32.shl 	$push6=, $1, $pop42
	i32.const	$push41=, a
	i32.add 	$push7=, $pop6, $pop41
	i32.const	$push40=, 3
	i32.store	$drop=, 0($pop7), $pop40
	i32.const	$push39=, 3
...
# BB#3:                                 # %ap.exit.2.i
	...
	i32.store	$drop=, t($pop53), $pop51
	i32.const	$push50=, 2
	i32.shl 	$push10=, $2, $pop50
	i32.const	$push49=, a
	i32.add 	$push11=, $pop10, $pop49
	i32.const	$push48=, 2
	i32.store	$drop=, 0($pop11), $pop48
	i32.const	$push47=, 0
