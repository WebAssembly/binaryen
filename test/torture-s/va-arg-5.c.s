...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop23), $pop31
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop37), $pop45
	i32.store	$drop=, 12($4), $1
	i32.const	$push0=, 15
	i32.add 	$push1=, $1, $pop0
	i32.const	$push2=, -16
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop30), $pop39
	i32.const	$push31=, 64
