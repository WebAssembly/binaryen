...
# BB#0:                                 # %entry
	...
	i32.store	$discard=, 0($pop1), $pop132
	i32.const	$push2=, 20
	i32.add 	$0=, $2, $pop2
	i32.const	$1=, 1
.LBB1_1:                                # %for.body
...
# BB#2:                                 # %for.end
	...
	i32.store8	$discard=, p($pop9), $pop11
	i32.const	$push185=, 0
	i32.const	$push87=, 8
	...
	i32.store8	$discard=, p+1($pop185), $pop14
	i32.const	$push183=, 0
	i32.const	$push89=, 8
	...
	i32.store8	$discard=, p+2($pop183), $pop17
	i32.const	$push181=, 0
	i32.const	$push91=, 8
	...
	i32.store8	$discard=, p+3($pop181), $pop20
	i32.const	$push179=, 0
	i32.const	$push93=, 8
	...
	i32.store8	$discard=, p+4($pop179), $pop23
	i32.const	$push177=, 0
	i32.const	$push95=, 8
	...
	i32.store8	$discard=, p+5($pop177), $pop26
	i32.const	$push175=, 0
	i32.const	$push97=, 8
	...
	i32.store8	$discard=, p+6($pop175), $pop29
	i32.const	$push173=, 0
	i32.const	$push99=, 8
	...
	i32.store8	$discard=, p+7($pop173), $pop32
	i32.const	$push171=, 0
	i32.const	$push101=, 8
	...
	i32.store8	$discard=, p+8($pop171), $pop35
	i32.const	$push169=, 0
	i32.const	$push103=, 8
	...
	i32.store8	$discard=, p+9($pop169), $pop38
	i32.const	$push167=, 0
	i32.const	$push105=, 8
	...
	i32.store8	$discard=, p+10($pop167), $pop41
	i32.const	$push165=, 0
	i32.const	$push107=, 8
	...
	i32.store8	$discard=, p+11($pop165), $pop44
	i32.const	$push163=, 0
	i32.const	$push109=, 8
	...
	i32.store8	$discard=, p+12($pop163), $pop47
	i32.const	$push161=, 0
	i32.const	$push111=, 8
	...
	i32.store8	$discard=, p+13($pop161), $pop50
	i32.const	$push159=, 0
	i32.const	$push113=, 8
	...
	i32.store8	$discard=, p+14($pop159), $pop53
	i32.const	$push157=, 0
	i32.const	$push115=, 8
	...
	i32.store8	$discard=, p+15($pop157), $pop56
	i32.const	$push155=, 0
	i32.const	$push117=, 8
	...
	i32.store8	$discard=, p+16($pop155), $pop59
	i32.const	$push153=, 0
	i32.const	$push119=, 8
	...
	i32.store8	$discard=, p+17($pop153), $pop62
	i32.const	$push151=, 0
	i32.const	$push121=, 8
	...
	i32.store8	$discard=, p+18($pop151), $pop65
	i32.const	$push149=, 0
	i32.const	$push123=, 8
	...
	i32.store8	$discard=, p+19($pop149), $pop68
	i32.const	$push147=, 0
	i32.const	$push125=, 8
	...
	i32.store8	$discard=, p+21($pop145), $pop74
	i32.const	$push143=, 0
	i32.const	$push129=, 8
	...
	i32.store8	$discard=, p+22($pop143), $pop77
