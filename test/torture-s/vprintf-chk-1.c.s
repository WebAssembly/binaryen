...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop90), $pop94
...
# BB#3:                                 # %if.end
	i32.const	$push102=, 0
	i32.const	$push101=, 0
	i32.store	$drop=, should_optimize($pop102), $pop101
...
.LBB1_6:                                # %sw.bb9
	...
	i32.const	$push105=, 0
	i32.const	$push70=, 1
	i32.store	$drop=, should_optimize($pop105), $pop70
...
.LBB1_10:                               # %sw.bb21
	...
	i32.const	$push112=, 0
	i32.const	$push111=, 1
	i32.store	$drop=, should_optimize($pop112), $pop111
...
.LBB1_14:                               # %sw.bb33
	...
	i32.const	$push119=, 0
	i32.const	$push56=, 1
	i32.store	$drop=, should_optimize($pop119), $pop56
...
.LBB1_18:                               # %sw.bb45
	...
	i32.const	$push126=, 0
	i32.const	$push125=, 0
	i32.store	$drop=, should_optimize($pop126), $pop125
...
# BB#19:                                # %if.end49
	i32.const	$push129=, 0
	i32.const	$push128=, 0
	i32.store	$drop=, should_optimize($pop129), $pop128
...
.LBB1_42:                               # %sw.bb117
	...
	i32.const	$push168=, 0
	i32.const	$push167=, 0
	i32.store	$drop=, should_optimize($pop168), $pop167
...
.LBB1_45:                               # %sw.epilog
	...
	i32.store	$drop=, __stack_pointer($pop93), $pop92
	return
.LBB1_46:                               # %sw.default
	end_block                       # label1:
	call    	abort@FUNCTION
