...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop504), $pop574
	block
	block
	block
	block
...
# BB#1:                                 # %if.end
	i32.store	$drop=, 4($9), $1
	i32.const	$push2=, 4
	i32.add 	$push3=, $1, $pop2
	i32.store	$drop=, 4($9), $pop3
	i32.const	$push4=, 0
...
# BB#3:                                 # %if.end.i
	...
	i32.const	$push581=, 0
	i32.const	$push8=, 1
	i32.store	$drop=, bar.lastn($pop581), $pop8
	i32.const	$push580=, 0
	i32.const	$push579=, 0
	i32.store	$drop=, bar.lastc($pop580), $pop579
.LBB1_4:                                # %if.end3.i
	end_block                       # label11:
	i32.const	$push9=, 24
...
# BB#5:                                 # %if.then.i312
	...
	i32.store	$drop=, bar.lastc($pop587), $pop15
	i32.const	$push586=, 8
	i32.add 	$push585=, $1, $pop586
	tee_local	$push584=, $8=, $pop585
	i32.store	$drop=, 4($9), $pop584
...
# BB#6:                                 # %if.end3.i319
	...
	i32.const	$push590=, 0
	i32.const	$push18=, 2
	i32.store	$drop=, bar.lastn($pop590), $pop18
	i32.const	$push589=, 0
	i32.const	$push588=, 0
	i32.store	$drop=, bar.lastc($pop589), $pop588
...
# BB#7:                                 # %if.end3.i319.1
	i32.const	$push591=, 0
	i32.const	$push23=, 1
	i32.store	$drop=, bar.lastc($pop591), $pop23
...
# BB#8:                                 # %if.end3.i333
	...
	i32.store	$drop=, 4($9), $pop29
	i32.load16_u	$push30=, 0($8):p2align=0
	i32.store16	$drop=, 344($9), $pop30
	i32.const	$push31=, 2
	i32.add 	$push32=, $8, $pop31
	i32.load8_u	$push33=, 0($pop32)
	i32.store8	$drop=, 346($9), $pop33
	i32.load8_u	$0=, 344($9)
	i32.const	$push594=, 0
	i32.const	$push593=, 0
	i32.store	$drop=, bar.lastc($pop594), $pop593
	i32.const	$push592=, 0
	i32.const	$push34=, 3
	i32.store	$drop=, bar.lastn($pop592), $pop34
	i32.const	$push35=, 24
...
# BB#9:                                 # %if.end3.i333.1
	i32.const	$push595=, 0
	i32.const	$push37=, 1
	i32.store	$drop=, bar.lastc($pop595), $pop37
...
# BB#10:                                # %if.end3.i333.2
	i32.const	$push596=, 0
	i32.const	$push41=, 2
	i32.store	$drop=, bar.lastc($pop596), $pop41
...
# BB#11:                                # %if.end3.i347
	...
	i32.store	$drop=, 4($9), $pop600
	i32.const	$push46=, 12
	i32.add 	$push47=, $1, $pop46
	i32.load	$0=, 0($pop47):p2align=0
	i32.const	$push599=, 0
	i32.const	$push48=, 4
	i32.store	$drop=, bar.lastn($pop599), $pop48
	i32.const	$push598=, 0
	i32.const	$push597=, 0
	i32.store	$drop=, bar.lastc($pop598), $pop597
...
# BB#12:                                # %if.end3.i347.1
	i32.const	$push602=, 0
	i32.const	$push53=, 1
	i32.store	$drop=, bar.lastc($pop602), $pop53
...
# BB#13:                                # %if.end3.i347.2
	i32.const	$push603=, 0
	i32.const	$push58=, 2
	i32.store	$drop=, bar.lastc($pop603), $pop58
...
# BB#14:                                # %if.end3.i347.3
	i32.const	$push604=, 0
	i32.const	$push63=, 3
	i32.store	$drop=, bar.lastc($pop604), $pop63
...
# BB#15:                                # %if.end3.i361
	...
	i32.store	$drop=, 4($9), $pop608
	i32.load	$push69=, 0($8):p2align=0
	i32.store	$drop=, 336($9), $pop69
	i32.const	$push70=, 4
	i32.add 	$push71=, $8, $pop70
	i32.load8_u	$push72=, 0($pop71)
	i32.store8	$drop=, 340($9), $pop72
	i32.load8_u	$0=, 336($9)
	i32.const	$push607=, 0
	i32.const	$push606=, 0
	i32.store	$drop=, bar.lastc($pop607), $pop606
	i32.const	$push605=, 0
	i32.const	$push73=, 5
	i32.store	$drop=, bar.lastn($pop605), $pop73
	i32.const	$push74=, 40
...
# BB#16:                                # %if.end3.i361.1
	i32.const	$push610=, 0
	i32.const	$push76=, 1
	i32.store	$drop=, bar.lastc($pop610), $pop76
...
# BB#17:                                # %if.end3.i361.2
	i32.const	$push611=, 0
	i32.const	$push80=, 2
	i32.store	$drop=, bar.lastc($pop611), $pop80
...
# BB#18:                                # %if.end3.i361.3
	i32.const	$push612=, 0
	i32.const	$push84=, 3
	i32.store	$drop=, bar.lastc($pop612), $pop84
...
# BB#19:                                # %if.end3.i361.4
	i32.const	$push614=, 0
	i32.const	$push613=, 4
	i32.store	$drop=, bar.lastc($pop614), $pop613
...
# BB#20:                                # %if.end3.i375
	...
	i32.store	$drop=, 4($9), $pop619
	i32.load	$push92=, 0($2):p2align=0
	i32.store	$drop=, 328($9), $pop92
	i32.const	$push618=, 4
	i32.add 	$push93=, $2, $pop618
	i32.load16_u	$push94=, 0($pop93):p2align=0
	i32.store16	$drop=, 332($9), $pop94
	i32.load8_u	$8=, 328($9)
	i32.const	$push617=, 0
	i32.const	$push616=, 0
	i32.store	$drop=, bar.lastc($pop617), $pop616
	i32.const	$push615=, 0
	i32.const	$push95=, 6
	i32.store	$drop=, bar.lastn($pop615), $pop95
	i32.const	$push96=, 48
...
# BB#21:                                # %if.end3.i375.1
	i32.const	$push621=, 0
	i32.const	$push98=, 1
	i32.store	$drop=, bar.lastc($pop621), $pop98
...
# BB#22:                                # %if.end3.i375.2
	i32.const	$push622=, 0
	i32.const	$push102=, 2
	i32.store	$drop=, bar.lastc($pop622), $pop102
...
# BB#23:                                # %if.end3.i375.3
	i32.const	$push623=, 0
	i32.const	$push106=, 3
	i32.store	$drop=, bar.lastc($pop623), $pop106
...
# BB#24:                                # %if.end3.i375.4
	i32.const	$push624=, 0
	i32.const	$push110=, 4
	i32.store	$drop=, bar.lastc($pop624), $pop110
...
# BB#25:                                # %if.end3.i375.5
	i32.const	$push625=, 0
	i32.const	$push114=, 5
	i32.store	$drop=, bar.lastc($pop625), $pop114
...
# BB#26:                                # %if.end3.i389
	...
	i32.const	$push626=, 0
	i32.const	$push127=, 7
	i32.store	$drop=, bar.lastn($pop626), $pop127
...
# BB#27:                                # %if.end3.i389.1
	i32.const	$push629=, 0
	i32.const	$push130=, 1
	i32.store	$drop=, bar.lastc($pop629), $pop130
...
# BB#28:                                # %if.end3.i389.2
	i32.const	$push630=, 0
	i32.const	$push134=, 2
	i32.store	$drop=, bar.lastc($pop630), $pop134
...
# BB#29:                                # %if.end3.i389.3
	i32.const	$push631=, 0
	i32.const	$push138=, 3
	i32.store	$drop=, bar.lastc($pop631), $pop138
...
# BB#30:                                # %if.end3.i389.4
	i32.const	$push632=, 0
	i32.const	$push142=, 4
	i32.store	$drop=, bar.lastc($pop632), $pop142
...
# BB#31:                                # %if.end3.i389.5
	i32.const	$push633=, 0
	i32.const	$push146=, 5
	i32.store	$drop=, bar.lastc($pop633), $pop146
...
# BB#32:                                # %if.end3.i389.6
	i32.const	$push634=, 0
	i32.const	$push150=, 6
	i32.store	$drop=, bar.lastc($pop634), $pop150
...
# BB#33:                                # %if.end3.i403
	i32.const	$push640=, 0
	i32.const	$push154=, 7
	i32.store	$drop=, bar.lastc($pop640), $pop154
	i32.const	$push639=, 0
	i32.const	$push155=, 8
	i32.store	$drop=, bar.lastn($pop639), $pop155
	i32.const	$push156=, 48
	i32.add 	$push638=, $1, $pop156
	tee_local	$push637=, $0=, $pop638
	i32.store	$drop=, 4($9), $pop637
	i32.const	$push157=, 40
	i32.add 	$push158=, $1, $pop157
	i64.load	$push159=, 0($pop158):p2align=0
	i64.store	$drop=, 312($9), $pop159
	i32.const	$push636=, 0
	i32.const	$push635=, 0
	i32.store	$drop=, bar.lastc($pop636), $pop635
...
# BB#34:                                # %if.end3.i403.1
	i32.const	$push642=, 0
	i32.const	$push641=, 1
	i32.store	$drop=, bar.lastc($pop642), $pop641
...
# BB#35:                                # %if.end3.i403.2
	...
	i32.store	$drop=, bar.lastc($pop648), $pop644
...
# BB#36:                                # %if.end3.i403.3
	...
	i32.store	$drop=, bar.lastc($pop655), $pop652
...
# BB#37:                                # %if.end3.i403.4
	...
	i32.store	$drop=, bar.lastc($pop662), $pop659
...
# BB#38:                                # %if.end3.i403.5
	...
	i32.store	$drop=, bar.lastc($pop669), $pop666
...
# BB#39:                                # %if.end3.i403.6
	...
	i32.store	$drop=, bar.lastc($pop676), $pop673
...
# BB#40:                                # %if.end3.i403.7
	...
	i32.store	$drop=, bar.lastc($pop682), $pop679
...
# BB#41:                                # %for.body104
	...
	i32.store	$drop=, bar.lastc($pop195), $pop688
	i32.const	$8=, 8
...
# BB#43:                                # %if.end.i412
	...
	i32.const	$push694=, 0
	i32.const	$push693=, 9
	i32.store	$drop=, bar.lastn($pop694), $pop693
	i32.const	$push692=, 0
	i32.const	$push691=, 0
	i32.store	$drop=, bar.lastc($pop692), $pop691
...
# BB#45:                                # %if.end3.i417.1
	...
	i32.store	$drop=, bar.lastc($pop704), $pop701
...
# BB#46:                                # %if.end3.i417.2
	...
	i32.store	$drop=, bar.lastc($pop711), $pop708
...
# BB#47:                                # %if.end3.i417.3
	...
	i32.store	$drop=, bar.lastc($pop718), $pop715
...
# BB#48:                                # %if.end3.i417.4
	...
	i32.store	$drop=, bar.lastc($pop725), $pop722
...
# BB#49:                                # %if.end3.i417.5
	...
	i32.store	$drop=, bar.lastc($pop732), $pop729
...
# BB#50:                                # %if.end3.i417.6
	...
	i32.store	$drop=, bar.lastc($pop739), $pop736
...
# BB#51:                                # %if.end3.i417.7
	...
	i32.store	$drop=, bar.lastc($pop746), $pop743
...
# BB#53:                                # %for.body116
	...
	i32.store	$drop=, bar.lastc($pop252), $pop757
...
# BB#55:                                # %if.end.i426
	...
	i32.store	$drop=, bar.lastn($pop762), $pop761
	i32.const	$push760=, 0
	i32.const	$push759=, 0
	i32.store	$drop=, bar.lastc($pop760), $pop759
...
# BB#57:                                # %if.end3.i431.1
	...
	i32.store	$drop=, bar.lastc($pop772), $pop769
...
# BB#58:                                # %if.end3.i431.2
	...
	i32.store	$drop=, bar.lastc($pop779), $pop776
...
# BB#59:                                # %if.end3.i431.3
	...
	i32.store	$drop=, bar.lastc($pop786), $pop783
...
# BB#60:                                # %if.end3.i431.4
	...
	i32.store	$drop=, bar.lastc($pop793), $pop790
...
# BB#61:                                # %if.end3.i431.5
	...
	i32.store	$drop=, bar.lastc($pop800), $pop797
...
# BB#62:                                # %if.end3.i431.6
	...
	i32.store	$drop=, bar.lastc($pop807), $pop804
...
# BB#63:                                # %if.end3.i431.7
	...
	i32.store	$drop=, bar.lastc($pop814), $pop811
...
# BB#64:                                # %if.end3.i431.8
	...
	i32.store	$drop=, bar.lastc($pop821), $pop818
...
# BB#65:                                # %if.end3.i431.9
	...
	i32.store	$drop=, bar.lastc($pop828), $pop825
...
# BB#66:                                # %bar.exit434.9
	...
	i32.store	$drop=, bar.lastc($pop836), $pop833
	...
	i32.store8	$drop=, 0($pop316), $pop315
...
.LBB1_67:                               # %for.body128
	...
	br_if   	0, $pop326      # 0: down to label16
# BB#68:                                # %if.then.i438
                                        #   in Loop: Header=BB1_67 Depth=1
	i32.ne  	$push328=, $0, $7
	br_if   	3, $pop328      # 3: down to label10
# BB#69:                                # %if.end.i440
                                        #   in Loop: Header=BB1_67 Depth=1
	i32.const	$8=, 11
	i32.const	$0=, 0
	...
	i32.store	$drop=, bar.lastn($pop841), $pop840
	i32.const	$push839=, 0
	i32.const	$push838=, 0
	i32.store	$drop=, bar.lastc($pop839), $pop838
.LBB1_70:                               # %if.end3.i445
	...
	br_if   	2, $pop332      # 2: down to label10
# BB#71:                                # %bar.exit448
                                        #   in Loop: Header=BB1_67 Depth=1
	i32.const	$push852=, 0
	i32.const	$push851=, 1
	...
	i32.store	$drop=, bar.lastc($pop852), $pop849
	i32.const	$7=, 11
	i32.const	$push848=, 1
...
.LBB1_73:                               # %for.body140
	...
	br_if   	0, $pop342      # 0: down to label19
# BB#74:                                # %if.then.i452
                                        #   in Loop: Header=BB1_73 Depth=1
	i32.ne  	$push344=, $0, $7
	br_if   	3, $pop344      # 3: down to label10
# BB#75:                                # %if.end.i454
                                        #   in Loop: Header=BB1_73 Depth=1
	i32.const	$8=, 12
	i32.const	$0=, 0
	...
	i32.store	$drop=, bar.lastn($pop861), $pop860
	i32.const	$push859=, 0
	i32.const	$push858=, 0
	i32.store	$drop=, bar.lastc($pop859), $pop858
.LBB1_76:                               # %if.end3.i459
	...
	br_if   	2, $pop348      # 2: down to label10
# BB#77:                                # %bar.exit462
                                        #   in Loop: Header=BB1_73 Depth=1
	i32.const	$push872=, 0
	i32.const	$push871=, 1
	...
	i32.store	$drop=, bar.lastc($pop872), $pop869
	i32.const	$7=, 12
	i32.const	$push868=, 1
	...
	br_if   	0, $pop349      # 0: up to label17
# BB#78:                                # %for.end146
	end_loop                        # label18:
	...
	i32.store8	$drop=, 0($pop353), $pop352
...
.LBB1_79:                               # %for.body152
	...
	br_if   	0, $pop363      # 0: down to label22
# BB#80:                                # %if.then.i466
                                        #   in Loop: Header=BB1_79 Depth=1
	i32.ne  	$push365=, $0, $7
	br_if   	3, $pop365      # 3: down to label10
# BB#81:                                # %if.end.i468
                                        #   in Loop: Header=BB1_79 Depth=1
	i32.const	$8=, 13
	i32.const	$0=, 0
	...
	i32.store	$drop=, bar.lastn($pop881), $pop880
	i32.const	$push879=, 0
	i32.const	$push878=, 0
	i32.store	$drop=, bar.lastc($pop879), $pop878
.LBB1_82:                               # %if.end3.i473
	...
	br_if   	2, $pop369      # 2: down to label10
# BB#83:                                # %bar.exit476
                                        #   in Loop: Header=BB1_79 Depth=1
	i32.const	$push892=, 0
	i32.const	$push891=, 1
	...
	i32.store	$drop=, bar.lastc($pop892), $pop889
	i32.const	$7=, 13
	i32.const	$push888=, 1
	...
	br_if   	0, $pop370      # 0: up to label20
# BB#84:                                # %for.end158
	end_loop                        # label21:
	...
	i32.store16	$drop=, 0($pop374), $pop373
...
.LBB1_85:                               # %for.body164
	...
	br_if   	0, $pop384      # 0: down to label25
# BB#86:                                # %if.then.i480
                                        #   in Loop: Header=BB1_85 Depth=1
	i32.ne  	$push386=, $0, $7
	br_if   	3, $pop386      # 3: down to label10
# BB#87:                                # %if.end.i482
                                        #   in Loop: Header=BB1_85 Depth=1
	i32.const	$8=, 14
	i32.const	$0=, 0
	...
	i32.store	$drop=, bar.lastn($pop901), $pop900
	i32.const	$push899=, 0
	i32.const	$push898=, 0
	i32.store	$drop=, bar.lastc($pop899), $pop898
.LBB1_88:                               # %if.end3.i487
	...
	br_if   	2, $pop390      # 2: down to label10
# BB#89:                                # %bar.exit490
                                        #   in Loop: Header=BB1_85 Depth=1
	i32.const	$push912=, 0
	i32.const	$push911=, 1
	...
	i32.store	$drop=, bar.lastc($pop912), $pop909
	i32.const	$7=, 14
	i32.const	$push908=, 1
	...
	br_if   	0, $pop391      # 0: up to label23
# BB#90:                                # %for.end170
	end_loop                        # label24:
	...
	i32.store8	$drop=, 0($pop395), $pop394
	...
	i32.store16	$drop=, 0($pop399), $pop398
...
.LBB1_91:                               # %for.body176
	...
	br_if   	0, $pop409      # 0: down to label28
# BB#92:                                # %if.then.i494
                                        #   in Loop: Header=BB1_91 Depth=1
	i32.ne  	$push411=, $0, $7
	br_if   	3, $pop411      # 3: down to label10
# BB#93:                                # %if.end.i496
                                        #   in Loop: Header=BB1_91 Depth=1
	i32.const	$8=, 15
	i32.const	$0=, 0
	...
	i32.store	$drop=, bar.lastn($pop922), $pop921
	i32.const	$push920=, 0
	i32.const	$push919=, 0
	i32.store	$drop=, bar.lastc($pop920), $pop919
.LBB1_94:                               # %if.end3.i501
	...
	br_if   	2, $pop415      # 2: down to label10
# BB#95:                                # %bar.exit504
                                        #   in Loop: Header=BB1_91 Depth=1
	i32.const	$push933=, 0
	i32.const	$push932=, 1
	...
	i32.store	$drop=, bar.lastc($pop933), $pop930
	i32.const	$7=, 15
	i32.const	$push929=, 1
	...
	br_if   	0, $pop416      # 0: up to label26
# BB#96:                                # %for.end182
	end_loop                        # label27:
	...
	i32.store	$drop=, 0($pop420), $pop419
...
.LBB1_97:                               # %for.body188
	...
	br_if   	0, $pop430      # 0: down to label31
# BB#98:                                # %if.then.i508
                                        #   in Loop: Header=BB1_97 Depth=1
	i32.ne  	$push432=, $0, $7
	br_if   	3, $pop432      # 3: down to label10
# BB#99:                                # %if.end.i510
                                        #   in Loop: Header=BB1_97 Depth=1
	i32.const	$8=, 16
	i32.const	$0=, 0
	...
	i32.store	$drop=, bar.lastn($pop942), $pop941
	i32.const	$push940=, 0
	i32.const	$push939=, 0
	i32.store	$drop=, bar.lastc($pop940), $pop939
.LBB1_100:                              # %if.end3.i515
	...
	br_if   	2, $pop436      # 2: down to label10
# BB#101:                               # %bar.exit518
                                        #   in Loop: Header=BB1_97 Depth=1
	i32.const	$push953=, 0
	i32.const	$push952=, 1
	...
	i32.store	$drop=, bar.lastc($pop953), $pop950
	i32.const	$7=, 16
	i32.const	$push949=, 1
...
.LBB1_103:                              # %for.body200
	...
	br_if   	0, $pop439      # 0: down to label34
# BB#104:                               # %if.then.i522
                                        #   in Loop: Header=BB1_103 Depth=1
	i32.ne  	$push441=, $0, $7
	br_if   	3, $pop441      # 3: down to label10
# BB#105:                               # %if.end.i524
                                        #   in Loop: Header=BB1_103 Depth=1
	i32.const	$8=, 31
	i32.const	$0=, 0
	...
	i32.store	$drop=, bar.lastn($pop961), $pop960
	i32.const	$push959=, 0
	i32.const	$push958=, 0
	i32.store	$drop=, bar.lastc($pop959), $pop958
.LBB1_106:                              # %if.end3.i529
	...
	br_if   	2, $pop445      # 2: down to label10
# BB#107:                               # %bar.exit532
                                        #   in Loop: Header=BB1_103 Depth=1
	i32.const	$push972=, 0
	i32.const	$push971=, 1
	...
	i32.store	$drop=, bar.lastc($pop972), $pop969
	i32.const	$7=, 31
	i32.const	$push968=, 1
	...
	br_if   	0, $pop446      # 0: up to label32
# BB#108:                               # %for.end206
	end_loop                        # label33:
	...
	i32.store	$drop=, 0($pop453), $pop452
	...
	i32.store	$drop=, 0($pop457), $pop456
	...
	i32.store	$drop=, 0($pop461), $pop460
	...
	i32.store	$drop=, 0($pop465), $pop464
...
.LBB1_109:                              # %for.body212
	...
	br_if   	0, $pop475      # 0: down to label37
# BB#110:                               # %if.then.i536
                                        #   in Loop: Header=BB1_109 Depth=1
	i32.ne  	$push477=, $0, $7
	br_if   	3, $pop477      # 3: down to label10
# BB#111:                               # %if.end.i538
                                        #   in Loop: Header=BB1_109 Depth=1
	i32.const	$8=, 32
	i32.const	$0=, 0
	...
	i32.store	$drop=, bar.lastn($pop986), $pop985
	i32.const	$push984=, 0
	i32.const	$push983=, 0
	i32.store	$drop=, bar.lastc($pop984), $pop983
.LBB1_112:                              # %if.end3.i543
	...
	br_if   	2, $pop480      # 2: down to label10
# BB#113:                               # %bar.exit546
                                        #   in Loop: Header=BB1_109 Depth=1
	i32.const	$push996=, 0
	i32.const	$push995=, 1
	...
	i32.store	$drop=, bar.lastc($pop996), $pop993
	i32.const	$7=, 32
	i32.const	$push992=, 1
...
.LBB1_115:                              # %for.body224
	...
	br_if   	0, $pop483      # 0: down to label40
# BB#116:                               # %if.then.i550
                                        #   in Loop: Header=BB1_115 Depth=1
	i32.ne  	$push485=, $0, $7
	br_if   	3, $pop485      # 3: down to label10
# BB#117:                               # %if.end.i552
                                        #   in Loop: Header=BB1_115 Depth=1
	i32.const	$8=, 35
	i32.const	$0=, 0
	...
	i32.store	$drop=, bar.lastn($pop1004), $pop1003
	i32.const	$push1002=, 0
	i32.const	$push1001=, 0
	i32.store	$drop=, bar.lastc($pop1002), $pop1001
.LBB1_118:                              # %if.end3.i557
	...
	br_if   	2, $pop489      # 2: down to label10
# BB#119:                               # %bar.exit560
                                        #   in Loop: Header=BB1_115 Depth=1
	...
	i32.store	$drop=, bar.lastc($pop1015), $pop1012
	i32.const	$7=, 35
	...
	br_if   	0, $pop490      # 0: up to label38
# BB#120:                               # %for.end230
	end_loop                        # label39:
	i32.const	$push491=, 332
	i32.add 	$push492=, $1, $pop491
	i32.store	$drop=, 4($9), $pop492
	i32.const	$push570=, 8
...
.LBB1_121:                              # %for.body236
	...
	br_if   	0, $pop493      # 0: down to label43
# BB#122:                               # %if.then.i564
                                        #   in Loop: Header=BB1_121 Depth=1
	i32.ne  	$push495=, $0, $8
	br_if   	3, $pop495      # 3: down to label10
# BB#123:                               # %if.end.i566
                                        #   in Loop: Header=BB1_121 Depth=1
	i32.const	$0=, 0
	i32.const	$push1021=, 0
	i32.const	$push1020=, 72
	i32.store	$drop=, bar.lastn($pop1021), $pop1020
	i32.const	$push1019=, 0
	i32.const	$push1018=, 0
	i32.store	$drop=, bar.lastc($pop1019), $pop1018
.LBB1_124:                              # %if.end3.i571
	...
	br_if   	2, $pop499      # 2: down to label10
# BB#125:                               # %bar.exit574
                                        #   in Loop: Header=BB1_121 Depth=1
	...
	i32.store	$drop=, bar.lastc($pop1032), $pop1029
	i32.const	$8=, 72
	...
	br_if   	0, $pop500      # 0: up to label41
# BB#126:                               # %for.end242
	end_loop                        # label42:
	i32.const	$push507=, 0
	i32.const	$push505=, 352
	i32.add 	$push506=, $9, $pop505
	i32.store	$drop=, __stack_pointer($pop507), $pop506
	return
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop257), $pop412
	i32.const	$push0=, 4368
	i32.store16	$drop=, 760($1), $pop0
	i32.const	$push1=, 24
	i32.store8	$drop=, 752($1), $pop1
	i32.const	$push2=, 25
	i32.store8	$drop=, 753($1), $pop2
	i32.const	$push3=, 26
	i32.store8	$drop=, 754($1), $pop3
	i32.const	$push4=, 32
	i32.store8	$drop=, 744($1), $pop4
	i32.const	$push5=, 33
	i32.store8	$drop=, 745($1), $pop5
	i32.const	$push6=, 34
	i32.store8	$drop=, 746($1), $pop6
	i32.const	$push7=, 40
	i32.store8	$drop=, 736($1), $pop7
	i32.const	$push8=, 35
	i32.store8	$drop=, 747($1), $pop8
	i32.const	$push9=, 41
	i32.store8	$drop=, 737($1), $pop9
	i32.const	$push10=, 42
	i32.store8	$drop=, 738($1), $pop10
	i32.const	$push11=, 43
	i32.store8	$drop=, 739($1), $pop11
	i32.const	$push12=, 48
	i32.store8	$drop=, 728($1), $pop12
	i32.const	$push13=, 44
	i32.store8	$drop=, 740($1), $pop13
	i32.const	$push14=, 49
	i32.store8	$drop=, 729($1), $pop14
	i32.const	$push15=, 50
	i32.store8	$drop=, 730($1), $pop15
	i32.const	$push16=, 51
	i32.store8	$drop=, 731($1), $pop16
	i32.const	$push17=, 52
	i32.store8	$drop=, 732($1), $pop17
	i32.const	$push18=, 56
	i32.store8	$drop=, 720($1), $pop18
	i32.const	$push19=, 53
	i32.store8	$drop=, 733($1), $pop19
	i32.const	$push20=, 57
	i32.store8	$drop=, 721($1), $pop20
	i32.const	$push21=, 58
	i32.store8	$drop=, 722($1), $pop21
	i32.const	$push22=, 59
	i32.store8	$drop=, 723($1), $pop22
	i32.const	$push23=, 60
	i32.store8	$drop=, 724($1), $pop23
	i32.const	$push24=, 61
	i32.store8	$drop=, 725($1), $pop24
	i32.const	$push25=, 62
	i32.store8	$drop=, 726($1), $pop25
	i32.const	$push26=, 64
	i32.store8	$drop=, 712($1), $pop26
	i32.const	$push27=, 65
	i32.store8	$drop=, 713($1), $pop27
	i32.const	$push28=, 66
	i32.store8	$drop=, 714($1), $pop28
	i32.const	$push29=, 67
	i32.store8	$drop=, 715($1), $pop29
	i32.const	$push30=, 68
	i32.store8	$drop=, 716($1), $pop30
	i32.const	$push31=, 69
	i32.store8	$drop=, 717($1), $pop31
	i32.const	$push32=, 70
	i32.store8	$drop=, 718($1), $pop32
	i32.const	$push33=, 71
	i32.store8	$drop=, 719($1), $pop33
	i32.const	$push34=, 72
	i32.store8	$drop=, 696($1), $pop34
	i32.const	$push35=, 73
	i32.store8	$drop=, 697($1), $pop35
	i32.const	$push36=, 74
	i32.store8	$drop=, 698($1), $pop36
	i32.const	$push37=, 75
	i32.store8	$drop=, 699($1), $pop37
	i32.const	$push38=, 76
	i32.store8	$drop=, 700($1), $pop38
	i32.const	$push39=, 77
	i32.store8	$drop=, 701($1), $pop39
	i32.const	$push40=, 78
	i32.store8	$drop=, 702($1), $pop40
	i32.const	$push41=, 79
	i32.store8	$drop=, 703($1), $pop41
	i32.const	$push411=, 64
	i32.store8	$drop=, 704($1), $pop411
	i32.const	$push42=, 80
	i32.store8	$drop=, 680($1), $pop42
	i32.const	$push43=, 81
	i32.store8	$drop=, 681($1), $pop43
	i32.const	$push44=, 82
	i32.store8	$drop=, 682($1), $pop44
	i32.const	$push45=, 83
	i32.store8	$drop=, 683($1), $pop45
	i32.const	$push46=, 84
	i32.store8	$drop=, 684($1), $pop46
	i32.const	$push47=, 85
	i32.store8	$drop=, 685($1), $pop47
	i32.const	$push48=, 86
	i32.store8	$drop=, 686($1), $pop48
	i32.const	$push49=, 87
	i32.store8	$drop=, 687($1), $pop49
	i32.const	$push50=, 88
	i32.store8	$drop=, 688($1), $pop50
	i32.const	$push51=, 89
	i32.store8	$drop=, 689($1), $pop51
	i32.const	$push410=, 88
	i32.store8	$drop=, 664($1), $pop410
	i32.const	$push409=, 89
	i32.store8	$drop=, 665($1), $pop409
	i32.const	$push52=, 90
	i32.store8	$drop=, 666($1), $pop52
	i32.const	$push53=, 91
	i32.store8	$drop=, 667($1), $pop53
	i32.const	$push54=, 92
	i32.store8	$drop=, 668($1), $pop54
	i32.const	$push55=, 93
	i32.store8	$drop=, 669($1), $pop55
	i32.const	$push56=, 94
	i32.store8	$drop=, 670($1), $pop56
	i32.const	$push57=, 95
	i32.store8	$drop=, 671($1), $pop57
	i32.const	$push408=, 80
	i32.store8	$drop=, 672($1), $pop408
	i32.const	$push407=, 81
	i32.store8	$drop=, 673($1), $pop407
	i32.const	$push406=, 82
	i32.store8	$drop=, 674($1), $pop406
	i32.const	$push58=, 96
	i32.store8	$drop=, 648($1), $pop58
	i32.const	$push59=, 97
	i32.store8	$drop=, 649($1), $pop59
	i32.const	$push60=, 98
	i32.store8	$drop=, 650($1), $pop60
	i32.const	$push61=, 99
	i32.store8	$drop=, 651($1), $pop61
	i32.const	$push62=, 100
	i32.store8	$drop=, 652($1), $pop62
	i32.const	$push63=, 101
	i32.store8	$drop=, 653($1), $pop63
	i32.const	$push64=, 102
	i32.store8	$drop=, 654($1), $pop64
	i32.const	$push65=, 103
	i32.store8	$drop=, 655($1), $pop65
	i32.const	$push66=, 104
	i32.store8	$drop=, 656($1), $pop66
	i32.const	$push67=, 105
	i32.store8	$drop=, 657($1), $pop67
	i32.const	$push68=, 106
	i32.store8	$drop=, 658($1), $pop68
	i32.const	$push69=, 107
	i32.store8	$drop=, 659($1), $pop69
	i32.const	$push405=, 104
	i32.store8	$drop=, 632($1), $pop405
	i32.const	$push404=, 105
	i32.store8	$drop=, 633($1), $pop404
	i32.const	$push403=, 106
	i32.store8	$drop=, 634($1), $pop403
	i32.const	$push402=, 107
	i32.store8	$drop=, 635($1), $pop402
	i32.const	$push70=, 108
	i32.store8	$drop=, 636($1), $pop70
	i32.const	$push71=, 109
	i32.store8	$drop=, 637($1), $pop71
	i32.const	$push72=, 110
	i32.store8	$drop=, 638($1), $pop72
	i32.const	$push73=, 111
	i32.store8	$drop=, 639($1), $pop73
	i32.const	$push401=, 96
	i32.store8	$drop=, 640($1), $pop401
	i32.const	$push400=, 97
	i32.store8	$drop=, 641($1), $pop400
	i32.const	$push399=, 98
	i32.store8	$drop=, 642($1), $pop399
	i32.const	$push398=, 99
	i32.store8	$drop=, 643($1), $pop398
	i32.const	$push397=, 100
	i32.store8	$drop=, 644($1), $pop397
	i32.const	$push74=, 112
	i32.store8	$drop=, 616($1), $pop74
	i32.const	$push75=, 113
	i32.store8	$drop=, 617($1), $pop75
	i32.const	$push76=, 114
	i32.store8	$drop=, 618($1), $pop76
	i32.const	$push77=, 115
	i32.store8	$drop=, 619($1), $pop77
	i32.const	$push78=, 116
	i32.store8	$drop=, 620($1), $pop78
	i32.const	$push79=, 117
	i32.store8	$drop=, 621($1), $pop79
	i32.const	$push80=, 118
	i32.store8	$drop=, 622($1), $pop80
	i32.const	$push81=, 119
	i32.store8	$drop=, 623($1), $pop81
	i32.const	$push82=, 120
	i32.store8	$drop=, 624($1), $pop82
	i32.const	$push83=, 121
	i32.store8	$drop=, 625($1), $pop83
	i32.const	$push84=, 122
	i32.store8	$drop=, 626($1), $pop84
	i32.const	$push85=, 123
	i32.store8	$drop=, 627($1), $pop85
	i32.const	$push86=, 124
	i32.store8	$drop=, 628($1), $pop86
	i32.const	$push87=, 125
	i32.store8	$drop=, 629($1), $pop87
	i32.const	$push396=, 120
	i32.store8	$drop=, 600($1), $pop396
	i32.const	$push395=, 121
	i32.store8	$drop=, 601($1), $pop395
	i32.const	$push394=, 122
	i32.store8	$drop=, 602($1), $pop394
	i32.const	$push393=, 123
	i32.store8	$drop=, 603($1), $pop393
	i32.const	$push392=, 124
	i32.store8	$drop=, 604($1), $pop392
	i32.const	$push391=, 125
	i32.store8	$drop=, 605($1), $pop391
	i32.const	$push88=, 126
	i32.store8	$drop=, 606($1), $pop88
	i32.const	$push89=, 127
	i32.store8	$drop=, 607($1), $pop89
	i32.const	$push390=, 112
	i32.store8	$drop=, 608($1), $pop390
	i32.const	$push389=, 113
	i32.store8	$drop=, 609($1), $pop389
	i32.const	$push388=, 114
	i32.store8	$drop=, 610($1), $pop388
	i32.const	$push387=, 115
	i32.store8	$drop=, 611($1), $pop387
	i32.const	$push386=, 116
	i32.store8	$drop=, 612($1), $pop386
	i32.const	$push385=, 117
	i32.store8	$drop=, 613($1), $pop385
	i32.const	$push384=, 118
	i32.store8	$drop=, 614($1), $pop384
	i32.const	$push90=, 128
	i32.store8	$drop=, 584($1), $pop90
	i32.const	$push91=, 129
	i32.store8	$drop=, 585($1), $pop91
	i32.const	$push92=, 130
	i32.store8	$drop=, 586($1), $pop92
	i32.const	$push93=, 131
	i32.store8	$drop=, 587($1), $pop93
	i32.const	$push94=, 132
	i32.store8	$drop=, 588($1), $pop94
	i32.const	$push95=, 133
	i32.store8	$drop=, 589($1), $pop95
	i32.const	$push96=, 134
	i32.store8	$drop=, 590($1), $pop96
	i32.const	$push97=, 135
	i32.store8	$drop=, 591($1), $pop97
	i32.const	$push98=, 136
	i32.store8	$drop=, 592($1), $pop98
	i32.const	$push99=, 137
	i32.store8	$drop=, 593($1), $pop99
	i32.const	$push100=, 138
	i32.store8	$drop=, 594($1), $pop100
	i32.const	$push101=, 139
	i32.store8	$drop=, 595($1), $pop101
	i32.const	$push102=, 140
	i32.store8	$drop=, 596($1), $pop102
	i32.const	$push103=, 141
	i32.store8	$drop=, 597($1), $pop103
	i32.const	$push104=, 142
	i32.store8	$drop=, 598($1), $pop104
	i32.const	$push105=, 143
	i32.store8	$drop=, 599($1), $pop105
	i32.const	$0=, 0
.LBB2_1:                                # %for.body180
                                        # =>This Inner Loop Header: Depth=1
	loop                            # label44:
...
# BB#2:                                 # %for.body191.preheader
	...
	i32.store	$drop=, 520($1), $pop109
	i32.const	$push110=, 1284
	i32.store16	$drop=, 524($1), $pop110
	i32.const	$push111=, 151521030
	i32.store	$drop=, 526($1):p2align=1, $pop111
	i32.const	$push112=, 2826
	i32.store16	$drop=, 530($1), $pop112
	i32.const	$push113=, 3340
	i32.store16	$drop=, 532($1), $pop113
	i32.const	$push114=, 14
	i32.store8	$drop=, 534($1), $pop114
	i32.const	$push115=, 15
	i32.store8	$drop=, 535($1), $pop115
	i32.const	$push116=, 16
	i32.store8	$drop=, 536($1), $pop116
	i32.const	$push117=, 17
	i32.store8	$drop=, 537($1), $pop117
	i32.const	$push118=, 18
	i32.store8	$drop=, 538($1), $pop118
	i32.const	$push119=, 19
	i32.store8	$drop=, 539($1), $pop119
	i32.const	$push120=, 20
	i32.store8	$drop=, 540($1), $pop120
	i32.const	$push121=, 21
	i32.store8	$drop=, 541($1), $pop121
	i32.const	$push122=, 22
	i32.store8	$drop=, 542($1), $pop122
	i32.const	$push123=, 23
	i32.store8	$drop=, 543($1), $pop123
	i32.const	$push419=, 24
	i32.store8	$drop=, 544($1), $pop419
	i32.const	$push124=, 25
	i32.store8	$drop=, 545($1), $pop124
	i32.const	$push125=, 26
	i32.store8	$drop=, 546($1), $pop125
	i32.const	$push126=, 27
	i32.store8	$drop=, 547($1), $pop126
	i32.const	$push127=, 28
	i32.store8	$drop=, 548($1), $pop127
	i32.const	$push128=, 29
	i32.store8	$drop=, 549($1), $pop128
	i32.const	$push129=, 30
	i32.store8	$drop=, 550($1), $pop129
	i32.const	$push130=, 31
	i32.store8	$drop=, 551($1), $pop130
	i32.const	$0=, 0
.LBB2_3:                                # %for.body202
                                        # =>This Inner Loop Header: Depth=1
	loop                            # label46:
...
# BB#6:                                 # %for.end220
	...
	i32.store8	$drop=, 0($pop158), $pop160
	i64.load	$push161=, 696($1)
	i64.store	$drop=, 352($1):p2align=2, $pop161
	...
	i32.store16	$drop=, 0($pop162), $pop164
	i64.load	$push165=, 680($1)
	i64.store	$drop=, 340($1):p2align=2, $pop165
	...
	i32.store8	$drop=, 0($pop167), $pop169
	...
	i32.store16	$drop=, 0($pop170), $pop172
	i64.load	$push173=, 664($1)
	i64.store	$drop=, 328($1):p2align=2, $pop173
	...
	i32.store	$drop=, 0($pop174), $pop176
	i64.load	$push177=, 648($1)
	i64.store	$drop=, 316($1):p2align=2, $pop177
	...
	i32.store8	$drop=, 0($pop179), $pop181
	...
	i32.store	$drop=, 0($pop182), $pop184
	i64.load	$push185=, 632($1)
	i64.store	$drop=, 300($1):p2align=2, $pop185
	...
	i32.store16	$drop=, 0($pop186), $pop188
	...
	i32.store	$drop=, 0($pop189), $pop191
	i64.load	$push192=, 616($1)
	i64.store	$drop=, 284($1):p2align=2, $pop192
	...
	i32.store8	$drop=, 0($pop194), $pop196
	...
	i32.store16	$drop=, 0($pop197), $pop199
	...
	i32.store	$drop=, 0($pop200), $pop202
	i64.load	$push203=, 600($1)
	i64.store	$drop=, 268($1):p2align=2, $pop203
	...
	i64.store	$drop=, 0($pop204):p2align=2, $pop206
	i64.load	$push207=, 584($1)
	i64.store	$drop=, 252($1):p2align=2, $pop207
	...
	i64.store	$drop=, 0($pop210):p2align=2, $pop212
	...
	i64.store	$drop=, 0($pop214):p2align=2, $pop216
	...
	i64.store	$drop=, 0($pop217):p2align=2, $pop219
	i64.load	$push220=, 520($1)
	i64.store	$drop=, 188($1):p2align=2, $pop220
