...
# BB#2:                                 # %if.end
	...
	i32.store	$discard=, bar.lastn($pop0), $0
.LBB0_3:                                # %if.end3
	end_block                       # label1:
	i32.const	$push4=, 3
...
# BB#3:                                 # %if.end.i
	...
	i32.const	$push489=, 0
	i32.const	$push41=, 1
	i32.store	$discard=, bar.lastn($pop489), $pop41
	i32.const	$push488=, 0
	i32.const	$push487=, 0
	i32.store	$discard=, bar.lastc($pop488), $pop487
.LBB1_4:                                # %if.end3.i
	end_block                       # label9:
	i32.const	$push42=, 24
...
# BB#5:                                 # %if.then.i314
	...
	i32.store	$discard=, bar.lastc($pop493), $pop48
	i32.const	$push492=, 8
...
# BB#6:                                 # %if.end3.i321
	...
	i32.const	$push496=, 0
	i32.const	$push51=, 2
	i32.store	$discard=, bar.lastn($pop496), $pop51
	i32.const	$push495=, 0
	i32.const	$push494=, 0
	i32.store	$discard=, bar.lastc($pop495), $pop494
...
# BB#7:                                 # %if.end3.i321.1
	i32.const	$push497=, 0
	i32.const	$push56=, 1
	i32.store	$discard=, bar.lastc($pop497), $pop56
...
# BB#8:                                 # %if.end3.i335
	...
	i32.store16	$discard=, 344($5), $pop64
	i32.store8	$discard=, 346($5), $0
	i32.load8_u	$0=, 344($5)
	i32.const	$push500=, 0
	i32.const	$push66=, 3
	i32.store	$discard=, bar.lastn($pop500), $pop66
	i32.const	$push499=, 0
	i32.const	$push498=, 0
	i32.store	$discard=, bar.lastc($pop499), $pop498
	i32.const	$push67=, 24
...
# BB#9:                                 # %if.end3.i335.1
	...
	i32.const	$push502=, 0
	i32.const	$push69=, 1
	i32.store	$discard=, bar.lastc($pop502), $pop69
	i32.const	$push70=, 25
...
# BB#10:                                # %if.end3.i335.2
	...
	i32.const	$push503=, 0
	i32.const	$push72=, 2
	i32.store	$discard=, bar.lastc($pop503), $pop72
	i32.const	$push73=, 26
...
# BB#11:                                # %if.end3.i349
	i32.const	$push76=, 0
	i32.const	$push75=, 3
	i32.store	$discard=, bar.lastc($pop76), $pop75
	i32.const	$push77=, 16
	...
	i32.const	$push506=, 0
	i32.const	$push80=, 4
	i32.store	$discard=, bar.lastn($pop506), $pop80
	i32.const	$push505=, 0
	i32.const	$push504=, 0
...
# BB#12:                                # %if.end3.i349.1
	i32.const	$push85=, 1
	i32.store	$discard=, bar.lastc($6), $pop85
...
# BB#13:                                # %if.end3.i349.2
	i32.const	$push507=, 0
	i32.const	$push90=, 2
	i32.store	$discard=, bar.lastc($pop507), $pop90
...
# BB#14:                                # %if.end3.i349.3
	i32.const	$push508=, 0
	i32.const	$push95=, 3
	i32.store	$discard=, bar.lastc($pop508), $pop95
...
# BB#15:                                # %if.end3.i363
	...
	i32.store	$discard=, 336($5), $pop101
	i32.store8	$discard=, 340($5), $0
	i32.load8_u	$0=, 336($5)
	i32.const	$push104=, 0
	i32.const	$push105=, 5
	i32.store	$discard=, bar.lastn($pop104), $pop105
	i32.const	$push510=, 0
	i32.const	$push509=, 0
...
# BB#16:                                # %if.end3.i363.1
	i32.load8_u	$0=, 337($5)
	i32.const	$push108=, 1
	i32.store	$discard=, bar.lastc($1), $pop108
...
# BB#17:                                # %if.end3.i363.2
	...
	i32.const	$push511=, 0
	i32.const	$push111=, 2
	i32.store	$discard=, bar.lastc($pop511), $pop111
...
# BB#18:                                # %if.end3.i363.3
	...
	i32.const	$push512=, 0
	i32.const	$push114=, 3
	i32.store	$discard=, bar.lastc($pop512), $pop114
...
# BB#20:                                # %if.end3.i377
	...
	i32.store	$discard=, 328($5), $pop121
	i32.store16	$discard=, 332($5), $1
	i32.load8_u	$1=, 328($5)
	i32.const	$push516=, 0
	i32.const	$push123=, 6
	i32.store	$discard=, bar.lastn($pop516), $pop123
	i32.const	$push515=, 0
	i32.const	$push514=, 0
	i32.store	$discard=, bar.lastc($pop515), $pop514
...
# BB#21:                                # %if.end3.i377.1
	...
	i32.const	$push517=, 0
	i32.const	$push126=, 1
	i32.store	$discard=, bar.lastc($pop517), $pop126
...
# BB#22:                                # %if.end3.i377.2
	...
	i32.const	$push518=, 0
	i32.const	$push129=, 2
	i32.store	$discard=, bar.lastc($pop518), $pop129
...
# BB#23:                                # %if.end3.i377.3
	...
	i32.const	$push519=, 0
	i32.const	$push132=, 3
	i32.store	$discard=, bar.lastc($pop519), $pop132
...
# BB#24:                                # %if.end3.i377.4
	...
	i32.const	$push520=, 0
	i32.const	$push135=, 4
	i32.store	$discard=, bar.lastc($pop520), $pop135
...
# BB#25:                                # %if.end3.i377.5
	...
	i32.const	$push521=, 0
	i32.const	$push138=, 5
	i32.store	$discard=, bar.lastc($pop521), $pop138
...
# BB#26:                                # %if.end3.i391
	...
	i32.store	$discard=, 320($5), $pop143
	i32.store8	$discard=, 326($5), $1
	i32.store16	$discard=, 324($5), $6
	i32.load8_u	$0=, 320($5)
	i32.const	$push524=, 0
	i32.const	$push148=, 7
	i32.store	$discard=, bar.lastn($pop524), $pop148
	i32.const	$push523=, 0
	i32.const	$push522=, 0
	i32.store	$discard=, bar.lastc($pop523), $pop522
...
# BB#27:                                # %if.end3.i391.1
	...
	i32.const	$push525=, 0
	i32.const	$push151=, 1
	i32.store	$discard=, bar.lastc($pop525), $pop151
...
# BB#28:                                # %if.end3.i391.2
	...
	i32.const	$push526=, 0
	i32.const	$push154=, 2
	i32.store	$discard=, bar.lastc($pop526), $pop154
...
# BB#29:                                # %if.end3.i391.3
	...
	i32.const	$push527=, 0
	i32.const	$push157=, 3
	i32.store	$discard=, bar.lastc($pop527), $pop157
...
# BB#30:                                # %if.end3.i391.4
	...
	i32.const	$push528=, 0
	i32.const	$push160=, 4
	i32.store	$discard=, bar.lastc($pop528), $pop160
...
# BB#31:                                # %if.end3.i391.5
	...
	i32.const	$push529=, 0
	i32.const	$push163=, 5
	i32.store	$discard=, bar.lastc($pop529), $pop163
...
# BB#32:                                # %if.end3.i391.6
	...
	i32.const	$push530=, 0
	i32.const	$push166=, 6
	i32.store	$discard=, bar.lastc($pop530), $pop166
...
# BB#33:                                # %if.end3.i405
	...
	i32.const	$push170=, 0
	i32.const	$push169=, 7
	i32.store	$discard=, bar.lastc($pop170), $pop169
	i64.store	$discard=, 312($5), $8
	i32.load8_s	$0=, 312($5)
	i32.const	$push533=, 0
	i32.const	$push174=, 8
	i32.store	$discard=, bar.lastn($pop533), $pop174
...
# BB#41:                                # %bar.exit408.7
	...
	i32.store	$discard=, bar.lastc($pop578), $pop575
	...
	i32.store8	$discard=, 0($pop207), $pop206
	i32.store	$discard=, 300($5), $9
	i32.store	$discard=, 296($5), $7
	i32.const	$9=, 8
	i32.const	$6=, 0
.LBB1_42:                               # %for.body104
...
# BB#44:                                # %if.end.i414
	...
	i32.const	$push580=, 9
	i32.store	$discard=, bar.lastn($pop1), $pop580
...
# BB#46:                                # %bar.exit422
	...
	i32.add 	$0=, $0, $pop589
	i32.const	$push588=, 0
	i32.store	$discard=, bar.lastc($pop588), $0
	i32.const	$push587=, 1
	i32.add 	$6=, $6, $pop587
	i32.const	$9=, 9
	i32.const	$push586=, 9
...
# BB#47:                                # %for.end110
	...
	i32.store16	$discard=, 0($pop222), $pop221
	i32.store	$discard=, 284($5), $6
	i32.store	$discard=, 280($5), $9
	copy_local	$9=, $1
	i32.const	$6=, 0
.LBB1_48:                               # %for.body116
                                        # =>This Inner Loop Header: Depth=1
...
# BB#50:                                # %if.end.i428
	...
	i32.store	$discard=, bar.lastn($pop2), $pop592
...
# BB#52:                                # %bar.exit436
	...
	i32.add 	$0=, $0, $pop601
	i32.const	$push600=, 0
	i32.store	$discard=, bar.lastc($pop600), $0
	i32.const	$push599=, 1
	i32.add 	$6=, $6, $pop599
	i32.const	$9=, 10
...
# BB#53:                                # %for.end122
	...
	i32.store8	$discard=, 0($pop237), $pop236
	...
	i32.store16	$discard=, 0($pop241), $pop240
	i32.store	$discard=, 268($5), $6
	i32.store	$discard=, 264($5), $9
	copy_local	$9=, $1
	i32.const	$6=, 0
.LBB1_54:                               # %for.body128
                                        # =>This Inner Loop Header: Depth=1
...
# BB#56:                                # %if.end.i442
	...
	i32.store	$discard=, bar.lastn($pop3), $pop605
...
# BB#58:                                # %bar.exit450
	...
	i32.add 	$0=, $0, $pop614
	i32.const	$push613=, 0
	i32.store	$discard=, bar.lastc($pop613), $0
	i32.const	$push612=, 1
	i32.add 	$6=, $6, $pop612
	i32.const	$9=, 11
...
# BB#59:                                # %for.end134
	...
	i32.store	$discard=, 0($pop255), $pop254
	i32.store	$discard=, 252($5), $6
	i32.store	$discard=, 248($5), $9
	copy_local	$9=, $1
	i32.const	$6=, 0
.LBB1_60:                               # %for.body140
                                        # =>This Inner Loop Header: Depth=1
...
# BB#62:                                # %if.end.i456
	...
	i32.store	$discard=, bar.lastn($pop4), $pop618
...
# BB#64:                                # %bar.exit464
	...
	i32.add 	$0=, $0, $pop627
	i32.const	$push626=, 0
	i32.store	$discard=, bar.lastc($pop626), $0
	i32.const	$push625=, 1
	i32.add 	$6=, $6, $pop625
	i32.const	$9=, 12
...
# BB#65:                                # %for.end146
	...
	i32.store8	$discard=, 0($pop270), $pop269
	...
	i32.store	$discard=, 0($pop274), $pop273
	i32.store	$discard=, 236($5), $6
	i32.store	$discard=, 232($5), $9
	copy_local	$9=, $1
	i32.const	$6=, 0
.LBB1_66:                               # %for.body152
                                        # =>This Inner Loop Header: Depth=1
...
# BB#68:                                # %if.end.i470
	...
	i32.store	$discard=, bar.lastn($pop5), $pop631
...
# BB#70:                                # %bar.exit478
	...
	i32.add 	$0=, $0, $pop640
	i32.const	$push639=, 0
	i32.store	$discard=, bar.lastc($pop639), $0
	i32.const	$push638=, 1
	i32.add 	$6=, $6, $pop638
	i32.const	$9=, 13
...
# BB#71:                                # %for.end158
	...
	i32.store16	$discard=, 0($pop289), $pop288
	...
	i32.store	$discard=, 0($pop293), $pop292
	i32.store	$discard=, 220($5), $6
	i32.store	$discard=, 216($5), $9
	copy_local	$9=, $1
	i32.const	$6=, 0
.LBB1_72:                               # %for.body164
                                        # =>This Inner Loop Header: Depth=1
...
# BB#74:                                # %if.end.i484
	...
	i32.store	$discard=, bar.lastn($pop6), $pop644
...
# BB#76:                                # %bar.exit492
	...
	i32.add 	$0=, $0, $pop653
	i32.const	$push652=, 0
	i32.store	$discard=, bar.lastc($pop652), $0
	i32.const	$push651=, 1
	i32.add 	$6=, $6, $pop651
	i32.const	$9=, 14
...
# BB#77:                                # %for.end170
	...
	i32.store	$discard=, 0($pop315), $pop314
	i32.store	$discard=, 204($5), $6
	i32.store	$discard=, 200($5), $9
	copy_local	$9=, $1
	i32.const	$6=, 0
.LBB1_78:                               # %for.body176
                                        # =>This Inner Loop Header: Depth=1
...
# BB#80:                                # %if.end.i498
	...
	i32.store	$discard=, bar.lastn($pop7), $pop658
...
# BB#82:                                # %bar.exit506
	...
	i32.add 	$0=, $0, $pop667
	i32.const	$push666=, 0
	i32.store	$discard=, bar.lastc($pop666), $0
	i32.const	$push665=, 1
	i32.add 	$6=, $6, $pop665
	i32.const	$9=, 15
...
# BB#83:                                # %for.end182
	...
	i32.store	$discard=, 0($pop330), $pop329
	...
	i32.store	$discard=, 0($pop334), $pop333
	i32.store	$discard=, 188($5), $6
	i32.store	$discard=, 184($5), $9
	copy_local	$9=, $1
	i32.const	$6=, 0
.LBB1_84:                               # %for.body188
                                        # =>This Inner Loop Header: Depth=1
...
# BB#86:                                # %if.end.i512
	...
	i32.store	$discard=, bar.lastn($pop8), $pop671
...
# BB#88:                                # %bar.exit520
	...
	i32.add 	$0=, $0, $pop680
	i32.const	$push679=, 0
	i32.store	$discard=, bar.lastc($pop679), $0
	i32.const	$push678=, 1
	i32.add 	$6=, $6, $pop678
	i32.const	$9=, 16
...
# BB#89:                                # %for.end194
	...
	i32.call	$discard=, memcpy@FUNCTION, $pop456, $3, $pop681
	copy_local	$9=, $1
	i32.const	$6=, 0
.LBB1_90:                               # %for.body200
                                        # =>This Inner Loop Header: Depth=1
...
# BB#92:                                # %if.end.i526
	...
	i32.store	$discard=, bar.lastn($pop9), $pop683
...
# BB#94:                                # %bar.exit534
	...
	i32.add 	$0=, $0, $pop692
	i32.const	$push691=, 0
	i32.store	$discard=, bar.lastc($pop691), $0
	i32.const	$push690=, 1
	i32.add 	$6=, $6, $pop690
	i32.const	$9=, 31
...
# BB#95:                                # %for.end206
	...
	i32.store	$discard=, 0($pop375), $pop374
	i32.store	$discard=, 124($5), $6
	i32.store	$discard=, 120($5), $9
	copy_local	$9=, $1
	i32.const	$6=, 0
.LBB1_96:                               # %for.body212
                                        # =>This Inner Loop Header: Depth=1
...
# BB#98:                                # %if.end.i540
	...
	i32.store	$discard=, bar.lastn($pop10), $pop701
...
# BB#100:                               # %bar.exit548
	...
	i32.add 	$0=, $0, $pop709
	i32.const	$push708=, 0
	i32.store	$discard=, bar.lastc($pop708), $0
	i32.const	$push707=, 1
	i32.add 	$6=, $6, $pop707
	i32.const	$9=, 32
...
# BB#101:                               # %for.end218
	...
	i32.call	$discard=, memcpy@FUNCTION, $pop474, $2, $pop710
	copy_local	$9=, $1
	i32.const	$6=, 0
...
# BB#104:                               # %if.end.i554
	...
	i32.store	$discard=, bar.lastn($pop11), $pop712
...
# BB#106:                               # %bar.exit562
	...
	i32.add 	$0=, $0, $pop721
	i32.const	$push720=, 0
	i32.store	$discard=, bar.lastc($pop720), $0
	i32.const	$push719=, 1
	i32.add 	$6=, $6, $pop719
	i32.const	$9=, 35
...
# BB#107:                               # %for.end230
	...
	i32.store	$discard=, 4($5), $pop395
	i32.const	$push477=, 8
	i32.add 	$push478=, $5, $pop477
	i32.const	$push722=, 72
	i32.call	$discard=, memcpy@FUNCTION, $pop478, $4, $pop722
	i32.const	$6=, 0
...
# BB#110:                               # %if.end.i568
	...
	i32.store	$discard=, bar.lastn($pop12), $pop724
...
# BB#112:                               # %bar.exit576
	...
	i32.add 	$0=, $0, $pop733
	i32.const	$push732=, 0
	i32.store	$discard=, bar.lastc($pop732), $0
	i32.const	$push731=, 1
	i32.add 	$6=, $6, $pop731
	i32.const	$1=, 72
...
# BB#113:                               # %for.end242
	...
	i32.store	$discard=, 0($pop410), $pop409
	return
...
# BB#0:                                 # %entry
	...
	i32.store16	$discard=, 760($pop414), $pop28
	i32.const	$push29=, 24
	i32.store8	$discard=, 752($2), $pop29
	i32.const	$push30=, 25
	i32.store8	$discard=, 753($2), $pop30
	i32.const	$push31=, 26
	i32.store8	$discard=, 754($2), $pop31
	i32.const	$push32=, 32
	i32.store8	$discard=, 744($2), $pop32
	i32.const	$push33=, 33
	i32.store8	$discard=, 745($2), $pop33
	i32.const	$push34=, 34
	i32.store8	$discard=, 746($2), $pop34
	i32.const	$push35=, 35
	i32.store8	$discard=, 747($2), $pop35
	i32.const	$push36=, 40
	i32.store8	$discard=, 736($2), $pop36
	i32.const	$push37=, 41
	i32.store8	$discard=, 737($2), $pop37
	i32.const	$push38=, 42
	i32.store8	$discard=, 738($2), $pop38
	i32.const	$push39=, 43
	i32.store8	$discard=, 739($2), $pop39
	i32.const	$push40=, 44
	i32.store8	$discard=, 740($2), $pop40
	i32.const	$push41=, 48
	i32.store8	$discard=, 728($2), $pop41
	i32.const	$push42=, 49
	i32.store8	$discard=, 729($2), $pop42
	i32.const	$push43=, 50
	i32.store8	$discard=, 730($2), $pop43
	i32.const	$push44=, 51
	i32.store8	$discard=, 731($2), $pop44
	i32.const	$push45=, 52
	i32.store8	$discard=, 732($2), $pop45
	i32.const	$push46=, 53
	i32.store8	$discard=, 733($2), $pop46
	i32.const	$push47=, 56
	i32.store8	$discard=, 720($2), $pop47
	i32.const	$push48=, 57
	i32.store8	$discard=, 721($2), $pop48
	i32.const	$push49=, 58
	i32.store8	$discard=, 722($2), $pop49
	i32.const	$push50=, 59
	i32.store8	$discard=, 723($2), $pop50
	i32.const	$push51=, 60
	i32.store8	$discard=, 724($2), $pop51
	i32.const	$push52=, 61
	i32.store8	$discard=, 725($2), $pop52
	i32.const	$push53=, 62
	i32.store8	$discard=, 726($2), $pop53
	i32.const	$push55=, 65
	i32.store8	$discard=, 713($2), $pop55
	i32.const	$push56=, 66
	i32.store8	$discard=, 714($2), $pop56
	i32.const	$push57=, 67
	i32.store8	$discard=, 715($2), $pop57
	i32.const	$push58=, 68
	i32.store8	$discard=, 716($2), $pop58
	i32.const	$push59=, 69
	i32.store8	$discard=, 717($2), $pop59
	i32.const	$push60=, 70
	i32.store8	$discard=, 718($2), $pop60
	i32.const	$push61=, 71
	i32.store8	$discard=, 719($2), $pop61
	i32.const	$push62=, 72
	i32.store8	$discard=, 696($2), $pop62
	i32.const	$push63=, 73
	i32.store8	$discard=, 697($2), $pop63
	i32.const	$push64=, 74
	i32.store8	$discard=, 698($2), $pop64
	i32.const	$push65=, 75
	i32.store8	$discard=, 699($2), $pop65
	i32.const	$push66=, 76
	i32.store8	$discard=, 700($2), $pop66
	i32.const	$push67=, 77
	i32.store8	$discard=, 701($2), $pop67
	i32.const	$push68=, 78
	i32.store8	$discard=, 702($2), $pop68
	i32.const	$push69=, 79
	i32.store8	$discard=, 703($2), $pop69
	i32.const	$push54=, 64
	i32.store8	$push0=, 712($2), $pop54
	i32.store8	$discard=, 704($2), $pop0
	i32.const	$push73=, 83
	i32.store8	$discard=, 683($2), $pop73
	i32.const	$push74=, 84
	i32.store8	$discard=, 684($2), $pop74
	i32.const	$push75=, 85
	i32.store8	$discard=, 685($2), $pop75
	i32.const	$push76=, 86
	i32.store8	$discard=, 686($2), $pop76
	i32.const	$push77=, 87
	i32.store8	$discard=, 687($2), $pop77
	i32.const	$push78=, 88
	i32.store8	$push4=, 688($2), $pop78
	i32.store8	$discard=, 664($2), $pop4
	i32.const	$push79=, 89
	i32.store8	$push5=, 689($2), $pop79
	i32.store8	$discard=, 665($2), $pop5
	i32.const	$push80=, 90
	i32.store8	$discard=, 666($2), $pop80
	i32.const	$push81=, 91
	i32.store8	$discard=, 667($2), $pop81
	i32.const	$push82=, 92
	i32.store8	$discard=, 668($2), $pop82
	i32.const	$push83=, 93
	i32.store8	$discard=, 669($2), $pop83
	i32.const	$push84=, 94
	i32.store8	$discard=, 670($2), $pop84
	i32.const	$push85=, 95
	i32.store8	$discard=, 671($2), $pop85
	i32.const	$push70=, 80
	i32.store8	$push1=, 680($2), $pop70
	i32.store8	$discard=, 672($2), $pop1
	i32.const	$push71=, 81
	i32.store8	$push2=, 681($2), $pop71
	i32.store8	$discard=, 673($2), $pop2
	i32.const	$push72=, 82
	i32.store8	$push3=, 682($2), $pop72
	i32.store8	$discard=, 674($2), $pop3
	i32.const	$push91=, 101
	i32.store8	$discard=, 653($2), $pop91
	i32.const	$push92=, 102
	i32.store8	$discard=, 654($2), $pop92
	i32.const	$push93=, 103
	i32.store8	$discard=, 655($2), $pop93
	i32.const	$push94=, 104
	i32.store8	$push11=, 656($2), $pop94
	i32.store8	$discard=, 632($2), $pop11
	i32.const	$push95=, 105
	i32.store8	$push12=, 657($2), $pop95
	i32.store8	$discard=, 633($2), $pop12
	i32.const	$push96=, 106
	i32.store8	$push13=, 658($2), $pop96
	i32.store8	$discard=, 634($2), $pop13
	i32.const	$push97=, 107
	i32.store8	$push14=, 659($2), $pop97
	i32.store8	$discard=, 635($2), $pop14
	i32.const	$push98=, 108
	i32.store8	$discard=, 636($2), $pop98
	i32.const	$push99=, 109
	i32.store8	$discard=, 637($2), $pop99
	i32.const	$push100=, 110
	i32.store8	$discard=, 638($2), $pop100
	i32.const	$push101=, 111
	i32.store8	$discard=, 639($2), $pop101
	i32.const	$push86=, 96
	i32.store8	$push6=, 648($2), $pop86
	i32.store8	$discard=, 640($2), $pop6
	i32.const	$push87=, 97
	i32.store8	$push7=, 649($2), $pop87
	i32.store8	$discard=, 641($2), $pop7
	i32.const	$push88=, 98
	i32.store8	$push8=, 650($2), $pop88
	i32.store8	$discard=, 642($2), $pop8
	i32.const	$push89=, 99
	i32.store8	$push9=, 651($2), $pop89
	i32.store8	$discard=, 643($2), $pop9
	i32.const	$push90=, 100
	i32.store8	$push10=, 652($2), $pop90
	i32.store8	$discard=, 644($2), $pop10
	i32.const	$push109=, 119
	i32.store8	$discard=, 623($2), $pop109
	i32.const	$push110=, 120
	i32.store8	$push22=, 624($2), $pop110
	i32.store8	$discard=, 600($2), $pop22
	i32.const	$push111=, 121
	i32.store8	$push23=, 625($2), $pop111
	i32.store8	$discard=, 601($2), $pop23
	i32.const	$push112=, 122
	i32.store8	$push24=, 626($2), $pop112
	i32.store8	$discard=, 602($2), $pop24
	i32.const	$push113=, 123
	i32.store8	$push25=, 627($2), $pop113
	i32.store8	$discard=, 603($2), $pop25
	i32.const	$push114=, 124
	i32.store8	$push26=, 628($2), $pop114
	i32.store8	$discard=, 604($2), $pop26
	i32.const	$push115=, 125
	i32.store8	$push27=, 629($2), $pop115
	i32.store8	$discard=, 605($2), $pop27
...
# BB#6:                                 # %for.end220
	...
	i32.call	$discard=, memcpy@FUNCTION, $pop352, $pop354, $pop237
