...
# BB#0:                                 # %entry
	...
	i32.store	$push27=, __stack_pointer($pop17), $pop25
...
.LBB1_1:                                # %for.body
	...
	i32.const	$push33=, 16
	i32.call	$6=, foo@FUNCTION, $pop22, $pop33
	copy_local	$7=, $2
	block
	i32.const	$push32=, -1
...
.LBB1_4:                                # %if.else10
	...
	i32.const	$push38=, 16
	i32.const	$push37=, 4
	i32.eq  	$push6=, $3, $pop37
	i32.select	$7=, $pop39, $pop38, $pop6
.LBB1_5:                                # %if.end15
                                        #   in Loop: Header=BB1_1 Depth=1
	end_block                       # label7:
	i32.ne  	$push7=, $6, $7
...
# BB#6:                                 # %if.end18
	...
	i32.const	$push41=, 7
	i32.call	$6=, foo@FUNCTION, $pop24, $pop41
	copy_local	$7=, $4
	block
	i32.const	$push40=, 6
	i32.gt_s	$push8=, $5, $pop40
	br_if   	0, $pop8        # 0: down to label9
# BB#7:                                 # %if.else22
                                        #   in Loop: Header=BB1_1 Depth=1
	copy_local	$7=, $2
	i32.const	$push42=, 3
	i32.gt_s	$push9=, $5, $pop42
...
# BB#8:                                 # %if.else28
	...
	i32.const	$push44=, 8
	i32.const	$push43=, 4
	i32.eq  	$push10=, $3, $pop43
	i32.select	$7=, $pop45, $pop44, $pop10
.LBB1_9:                                # %if.end34
                                        #   in Loop: Header=BB1_1 Depth=1
	end_block                       # label9:
	i32.ne  	$push11=, $6, $7
...
# BB#10:                                # %if.end37
	...
	i32.add 	$2=, $2, $pop49
	i32.add 	$4=, $4, $0
	i32.store	$push48=, 12($1), $3
	tee_local	$push47=, $5=, $pop48
	i32.add 	$push0=, $pop47, $0
	copy_local	$3=, $pop0
	i32.const	$push46=, 17
	i32.lt_s	$push12=, $5, $pop46
