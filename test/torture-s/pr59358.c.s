...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop15), $pop24
	i32.const	$push23=, 1
...
.LBB1_1:                                # %for.body
	...
	i32.const	$push31=, 16
	i32.call	$3=, foo@FUNCTION, $pop20, $pop31
	copy_local	$4=, $0
	block
	i32.const	$push30=, -1
...
# BB#6:                                 # %if.end18
	...
	block
	i32.const	$push38=, 6
	i32.gt_s	$push7=, $5, $pop38
	br_if   	0, $pop7        # 0: down to label9
# BB#7:                                 # %if.else22
                                        #   in Loop: Header=BB1_1 Depth=1
	block
	i32.const	$push40=, 4
	i32.lt_s	$push8=, $5, $pop40
...
.LBB1_9:                                # %if.else28
	...
	i32.const	$push43=, 8
	i32.const	$push42=, 4
	i32.eq  	$push9=, $1, $pop42
	i32.select	$5=, $pop44, $pop43, $pop9
.LBB1_10:                               # %if.end34
                                        #   in Loop: Header=BB1_1 Depth=1
	end_block                       # label9:
	i32.ne  	$push10=, $4, $5
...
# BB#11:                                # %if.end37
	...
	i32.lt_s	$5=, $1, $pop46
	i32.const	$push45=, 1
	i32.add 	$push0=, $1, $pop45
	copy_local	$1=, $pop0
	br_if   	0, $5           # 0: up to label5
# BB#12:                                # %for.end
	end_loop                        # label6:
	i32.const	$push18=, 0
	i32.const	$push16=, 16
