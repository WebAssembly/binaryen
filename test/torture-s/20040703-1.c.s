...
.LBB0_17:                               # %if.else3.i
	end_block                       # label1:
	i32.store	$drop=, 8($12), $9
	i32.store	$drop=, 4($12), $10
	i32.const	$push43=, -1
	i32.const	$push50=, 0
	i32.const	$push41=, 32
