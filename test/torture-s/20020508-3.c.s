...
# BB#11:                                # %if.end86
	...
	br_if   	0, $pop85       # 0: down to label11
# BB#12:                                # %if.end93
	block
...
# BB#13:                                # %if.end112
	...
	br_if   	0, $pop94       # 0: down to label13
# BB#14:                                # %if.end122
	block
	i32.const	$push95=, 4
	...
	br_if   	0, $pop100      # 0: down to label14
# BB#15:                                # %if.end131
	block
	i32.shl 	$push101=, $6, $1
...
# BB#17:                                # %if.end146
	...
	br_if   	0, $pop114      # 0: down to label17
# BB#18:                                # %if.end154
	block
	i32.const	$push115=, 4
	...
	br_if   	0, $pop120      # 0: down to label18
# BB#19:                                # %if.end161
	block
	...
	br_if   	0, $pop125      # 0: down to label19
# BB#20:                                # %if.end178
	block
	...
	br_if   	0, $pop130      # 0: down to label20
# BB#21:                                # %if.end195
	i32.const	$push131=, 0
