...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, 60($pop38), $1
	i32.load	$push37=, 60($6)
	tee_local	$push36=, $1=, $pop37
	i32.const	$push35=, 4
	i32.add 	$push1=, $pop36, $pop35
	i32.store	$drop=, 60($6), $pop1
	i32.load	$4=, 0($1)
	i32.const	$push2=, 8
	i32.add 	$push3=, $1, $pop2
	i32.store	$drop=, 60($6), $pop3
	i32.load	$5=, 4($1)
	i32.store	$drop=, 20($6), $4
	i32.store	$drop=, 24($6), $5
	i32.const	$push4=, 12
	i32.add 	$push5=, $1, $pop4
	i32.store	$drop=, 60($6), $pop5
	i32.load	$4=, 8($1)
	i32.const	$push6=, 16
	i32.add 	$push7=, $1, $pop6
	i32.store	$drop=, 60($6), $pop7
	i32.load	$5=, 12($1)
	i32.const	$push8=, 20
	i32.add 	$push9=, $1, $pop8
	i32.store	$drop=, 60($6), $pop9
	i32.load	$2=, 16($1)
	i32.const	$push10=, 24
	i32.add 	$push11=, $1, $pop10
	i32.store	$drop=, 60($6), $pop11
	i32.load	$3=, 20($1)
	i32.store	$drop=, 28($6), $4
	i32.store	$drop=, 32($6), $5
	i32.store	$drop=, 36($6), $2
	i32.store	$drop=, 40($6), $3
	i32.const	$push12=, 28
	i32.add 	$push13=, $1, $pop12
	i32.store	$drop=, 60($6), $pop13
	i32.load	$4=, 24($1)
	i32.const	$push14=, 32
	i32.add 	$push15=, $1, $pop14
	i32.store	$drop=, 60($6), $pop15
	i32.load	$5=, 28($1)
	i32.const	$push16=, 36
	i32.add 	$push17=, $1, $pop16
	i32.store	$drop=, 60($6), $pop17
	i32.load	$2=, 32($1)
	i32.const	$push18=, 40
	i32.add 	$push19=, $1, $pop18
	i32.store	$drop=, 60($6), $pop19
	i32.load	$1=, 36($1)
	i32.store	$drop=, 44($6), $4
	i32.store	$drop=, 48($6), $5
	i32.store	$drop=, 52($6), $2
	i32.store	$drop=, 56($6), $1
	i32.const	$push0=, 0
...
# BB#0:                                 # %entry
	...
	i32.load	$push2=, 0($2)
	i32.store	$drop=, 24($7), $pop2
	i32.const	$push3=, 8
	i32.add 	$push4=, $2, $pop3
	i32.store	$drop=, 60($7), $pop4
	i32.load	$5=, 4($2)
	i32.const	$push5=, 12
	i32.add 	$push6=, $2, $pop5
	i32.store	$drop=, 60($7), $pop6
	i32.load	$6=, 8($2)
	i32.const	$push7=, 16
	i32.add 	$push8=, $2, $pop7
	i32.store	$drop=, 60($7), $pop8
	i32.load	$3=, 12($2)
	i32.const	$push9=, 20
	i32.add 	$push10=, $2, $pop9
	i32.store	$drop=, 60($7), $pop10
	i32.load	$4=, 16($2)
	i32.store	$drop=, 28($7), $5
	i32.store	$drop=, 32($7), $6
	i32.store	$drop=, 36($7), $3
	i32.store	$drop=, 40($7), $4
	i32.const	$push11=, 24
	i32.add 	$push12=, $2, $pop11
	i32.store	$drop=, 60($7), $pop12
	i32.load	$5=, 20($2)
	i32.const	$push13=, 28
	...
	i32.store	$drop=, 60($7), $pop16
	i32.load	$3=, 28($2)
	i32.const	$push17=, 36
	i32.add 	$push18=, $2, $pop17
	i32.store	$drop=, 60($7), $pop18
	i32.load	$2=, 32($2)
	i32.store	$drop=, 44($7), $5
	i32.store	$drop=, 48($7), $6
	i32.store	$drop=, 52($7), $3
	i32.store	$drop=, 56($7), $2
	i64.const	$push0=, 4294967296
	i64.store	$drop=, 16($7), $pop0
	i32.const	$push30=, 16
...
# BB#2:                                 # %if.then.i
	...
	i32.store	$3=, 12($7), $2
	i32.store	$drop=, 8($7), $6
	i32.store	$drop=, 4($7), $3
	i32.const	$push45=, .L.str.2
	i32.store	$drop=, 0($7), $pop45
	i32.const	$push44=, .L.str.1
	i32.call	$drop=, printf@FUNCTION, $pop44, $7
	i32.const	$push43=, 0
	i32.const	$push42=, 0
	i32.load	$push20=, errors($pop42)
	i32.const	$push41=, 1
	i32.add 	$push21=, $pop20, $pop41
	i32.store	$drop=, errors($pop43), $pop21
.LBB2_3:                                # %for.inc.i
                                        #   in Loop: Header=BB2_1 Depth=1
	end_block                       # label6:
	i32.const	$push46=, 10
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, 60($pop33), $3
	i32.load	$3=, 60($8)
	i32.const	$push1=, 2
	i32.store	$drop=, 24($8), $pop1
	i32.const	$push32=, 4
	...
	i32.store	$drop=, 60($8), $pop4
	i32.load	$7=, 4($3)
	i32.const	$push5=, 12
	i32.add 	$push6=, $3, $pop5
	i32.store	$drop=, 60($8), $pop6
	i32.load	$4=, 8($3)
	i32.const	$push7=, 16
	i32.add 	$push8=, $3, $pop7
	i32.store	$drop=, 60($8), $pop8
	i32.load	$5=, 12($3)
	i32.store	$drop=, 28($8), $6
	i32.store	$drop=, 32($8), $7
	i32.store	$drop=, 36($8), $4
	i32.store	$drop=, 40($8), $5
	i32.const	$push9=, 20
	...
	i32.store	$drop=, 60($8), $pop12
	i32.load	$7=, 20($3)
	i32.const	$push13=, 28
	i32.add 	$push14=, $3, $pop13
	i32.store	$drop=, 60($8), $pop14
	i32.load	$4=, 24($3)
	i32.const	$push15=, 32
	i32.add 	$push16=, $3, $pop15
	i32.store	$drop=, 60($8), $pop16
	i32.load	$3=, 28($3)
	i32.store	$drop=, 44($8), $6
	i32.store	$drop=, 48($8), $7
	i32.store	$drop=, 52($8), $4
	i32.store	$drop=, 56($8), $3
	i64.const	$push0=, 4294967296
	i64.store	$drop=, 16($8), $pop0
	i32.const	$push28=, 16
...
# BB#2:                                 # %if.then.i
	...
	i32.store	$4=, 12($8), $3
	i32.store	$drop=, 8($8), $7
	i32.store	$drop=, 4($8), $4
	i32.const	$push41=, .L.str.3
	i32.store	$drop=, 0($8), $pop41
	i32.const	$push40=, .L.str.1
	i32.call	$drop=, printf@FUNCTION, $pop40, $8
	i32.const	$push39=, 0
	i32.const	$push38=, 0
	i32.load	$push18=, errors($pop38)
	i32.const	$push37=, 1
	i32.add 	$push19=, $pop18, $pop37
	i32.store	$drop=, errors($pop39), $pop19
.LBB3_3:                                # %for.inc.i
                                        #   in Loop: Header=BB3_1 Depth=1
	end_block                       # label9:
	i32.const	$push42=, 10
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, 60($8), $pop5
	i32.load	$7=, 4($4)
	i32.const	$push6=, 12
	i32.add 	$push7=, $4, $pop6
	i32.store	$drop=, 60($8), $pop7
	i32.load	$5=, 8($4)
	i32.const	$push2=, 3
	i32.store	$drop=, 28($8), $pop2
	i32.store	$drop=, 32($8), $6
	i32.store	$drop=, 36($8), $7
	i32.store	$drop=, 40($8), $5
	i32.const	$push8=, 16
	i32.add 	$push9=, $4, $pop8
	i32.store	$drop=, 60($8), $pop9
	i32.load	$6=, 12($4)
	i32.const	$push10=, 20
	...
	i32.store	$drop=, 60($8), $pop13
	i32.load	$5=, 20($4)
	i32.const	$push14=, 28
	i32.add 	$push15=, $4, $pop14
	i32.store	$drop=, 60($8), $pop15
	i32.load	$4=, 24($4)
	i32.store	$drop=, 44($8), $6
	i32.store	$drop=, 48($8), $7
	i32.store	$drop=, 52($8), $5
	i32.store	$drop=, 56($8), $4
	i64.const	$push0=, 4294967296
	i64.store	$drop=, 16($8), $pop0
	i32.const	$push27=, 16
...
# BB#2:                                 # %if.then.i
	...
	i32.store	$5=, 12($8), $4
	i32.store	$drop=, 8($8), $7
	i32.store	$drop=, 4($8), $5
	i32.const	$push40=, .L.str.4
	i32.store	$drop=, 0($8), $pop40
	i32.const	$push39=, .L.str.1
	i32.call	$drop=, printf@FUNCTION, $pop39, $8
	i32.const	$push38=, 0
	i32.const	$push37=, 0
	i32.load	$push17=, errors($pop37)
	i32.const	$push36=, 1
	i32.add 	$push18=, $pop17, $pop36
	i32.store	$drop=, errors($pop38), $pop18
.LBB4_3:                                # %for.inc.i
                                        #   in Loop: Header=BB4_1 Depth=1
	end_block                       # label12:
	i32.const	$push41=, 10
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, 60($pop33), $5
	i32.load	$push32=, 60($10)
	tee_local	$push31=, $5=, $pop32
	i32.const	$push1=, 4
	i32.add 	$push3=, $pop31, $pop1
	i32.store	$drop=, 60($10), $pop3
	i32.load	$7=, 0($5)
	i32.const	$push4=, 8
	i32.add 	$push5=, $5, $pop4
	i32.store	$drop=, 60($10), $pop5
	i32.load	$8=, 4($5)
	i32.store	$drop=, 36($10), $7
	i32.store	$drop=, 40($10), $8
	i32.const	$push6=, 12
	i32.add 	$push7=, $5, $pop6
	i32.store	$drop=, 60($10), $pop7
	i32.load	$7=, 8($5)
	i32.const	$push8=, 16
	i32.add 	$push9=, $5, $pop8
	i32.store	$drop=, 60($10), $pop9
	i32.load	$8=, 12($5)
	i32.const	$push10=, 20
	i32.add 	$push11=, $5, $pop10
	i32.store	$drop=, 60($10), $pop11
	i32.load	$9=, 16($5)
	i32.const	$push12=, 24
	i32.add 	$push13=, $5, $pop12
	i32.store	$drop=, 60($10), $pop13
	i32.load	$5=, 20($5)
	i32.store	$drop=, 44($10), $7
	i32.store	$drop=, 48($10), $8
	i32.store	$drop=, 52($10), $9
	i32.store	$drop=, 56($10), $5
	i64.const	$push0=, 4294967296
	i64.store	$drop=, 16($10), $pop0
	i64.const	$push2=, 12884901890
	i64.store	$drop=, 24($10), $pop2
	i32.const	$push25=, 16
...
# BB#2:                                 # %if.then.i
	...
	i32.store	$6=, 12($10), $5
	i32.store	$drop=, 8($10), $8
	i32.store	$drop=, 4($10), $6
	i32.const	$push40=, .L.str.5
	i32.store	$drop=, 0($10), $pop40
	i32.const	$push39=, .L.str.1
	i32.call	$drop=, printf@FUNCTION, $pop39, $10
	i32.const	$push38=, 0
	i32.const	$push37=, 0
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, 60($10), $pop10
	i32.load	$7=, 12($6)
	i32.const	$push11=, 20
	i32.add 	$push12=, $6, $pop11
	i32.store	$drop=, 60($10), $pop12
	i32.load	$6=, 16($6)
	i32.store	$drop=, 44($10), $8
	i32.store	$drop=, 48($10), $9
	i32.store	$drop=, 52($10), $7
	i32.store	$drop=, 56($10), $6
	i64.const	$push0=, 4294967296
	i64.store	$drop=, 16($10), $pop0
	i64.const	$push1=, 12884901890
	i64.store	$drop=, 24($10), $pop1
	i64.const	$push2=, 21474836484
	i64.store	$drop=, 32($10), $pop2
	i32.const	$push24=, 16
...
# BB#2:                                 # %if.then.i
	...
	i32.store	$7=, 12($10), $6
	i32.store	$drop=, 8($10), $9
	i32.store	$drop=, 4($10), $7
	i32.const	$push39=, .L.str.6
	i32.store	$drop=, 0($10), $pop39
	...
	i32.store	$drop=, errors($pop37), $pop15
.LBB6_3:                                # %for.inc.i
                                        #   in Loop: Header=BB6_1 Depth=1
	end_block                       # label18:
	i32.const	$push40=, 10
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, 60($pop27), $7
	i32.load	$7=, 60($11)
	i32.const	$push3=, 6
	i32.store	$drop=, 40($11), $pop3
	i32.const	$push26=, 4
	i32.add 	$push4=, $7, $pop26
	i32.store	$drop=, 60($11), $pop4
	i32.load	$9=, 0($7)
	i32.const	$push5=, 8
	i32.add 	$push6=, $7, $pop5
	i32.store	$drop=, 60($11), $pop6
	i32.load	$10=, 4($7)
	i32.const	$push7=, 12
	i32.add 	$push8=, $7, $pop7
	i32.store	$drop=, 60($11), $pop8
	i32.load	$8=, 8($7)
	i32.const	$push9=, 16
	i32.add 	$push10=, $7, $pop9
	i32.store	$drop=, 60($11), $pop10
	i32.load	$7=, 12($7)
	i32.store	$drop=, 44($11), $9
	i32.store	$drop=, 48($11), $10
	i32.store	$drop=, 52($11), $8
	i32.store	$drop=, 56($11), $7
	i64.const	$push0=, 4294967296
	i64.store	$drop=, 16($11), $pop0
	i64.const	$push1=, 12884901890
	i64.store	$drop=, 24($11), $pop1
	i64.const	$push2=, 21474836484
	i64.store	$drop=, 32($11), $pop2
	i32.const	$push22=, 16
...
# BB#2:                                 # %if.then.i
	...
	i32.store	$8=, 12($11), $7
	i32.store	$drop=, 8($11), $10
	i32.store	$drop=, 4($11), $8
	...
	i32.store	$drop=, errors($pop33), $pop13
.LBB7_3:                                # %for.inc.i
                                        #   in Loop: Header=BB7_1 Depth=1
	end_block                       # label21:
	i32.const	$push36=, 10
...
# BB#0:                                 # %entry
	...
	i32.load	$8=, 8($8)
	i32.store	$drop=, 48($12), $10
	i32.store	$drop=, 52($12), $11
	i32.store	$drop=, 56($12), $8
	i64.const	$push0=, 4294967296
	i64.store	$drop=, 16($12), $pop0
	i64.const	$push1=, 12884901890
	i64.store	$drop=, 24($12), $pop1
	i64.const	$push2=, 21474836484
	i64.store	$drop=, 32($12), $pop2
	i64.const	$push3=, 30064771078
	i64.store	$drop=, 40($12), $pop3
	i32.const	$push20=, 16
...
# BB#2:                                 # %if.then.i
	...
	i32.store	$9=, 12($12), $8
	i32.store	$drop=, 8($12), $11
	i32.store	$drop=, 4($12), $9
	i32.const	$push35=, .L.str.8
	i32.store	$drop=, 0($12), $pop35
	i32.const	$push34=, .L.str.1
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, 60($pop26), $9
	i32.load	$push25=, 60($13)
	tee_local	$push24=, $9=, $pop25
	i32.const	$push23=, 4
	i32.add 	$push5=, $pop24, $pop23
	i32.store	$drop=, 60($13), $pop5
	i32.load	$11=, 0($9)
	i32.const	$push4=, 8
	i32.add 	$push6=, $9, $pop4
	i32.store	$drop=, 60($13), $pop6
	i32.load	$9=, 4($9)
	i32.const	$push22=, 8
	i32.store	$drop=, 48($13), $pop22
	i32.store	$drop=, 52($13), $11
	i32.store	$drop=, 56($13), $9
	i64.const	$push0=, 4294967296
	i64.store	$drop=, 16($13), $pop0
	i64.const	$push1=, 12884901890
	i64.store	$drop=, 24($13), $pop1
	i64.const	$push2=, 21474836484
	i64.store	$drop=, 32($13), $pop2
	i64.const	$push3=, 30064771078
	i64.store	$drop=, 40($13), $pop3
	i32.const	$push18=, 16
...
# BB#2:                                 # %if.then.i
	...
	i32.store	$drop=, 8($13), $12
	i32.store	$drop=, 4($13), $10
	i32.const	$push34=, .L.str.9
	i32.store	$drop=, 0($13), $pop34
	i32.const	$push33=, .L.str.1
	i32.call	$drop=, printf@FUNCTION, $pop33, $13
	i32.const	$push32=, 0
	i32.const	$push31=, 0
	i32.load	$push8=, errors($pop31)
	i32.const	$push30=, 1
	i32.add 	$push9=, $pop8, $pop30
	i32.store	$drop=, errors($pop32), $pop9
.LBB9_3:                                # %for.inc.i
                                        #   in Loop: Header=BB9_1 Depth=1
	end_block                       # label27:
	i32.const	$push35=, 10
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, 60($pop25), $10
	i32.load	$push24=, 60($14)
	tee_local	$push23=, $10=, $pop24
	i32.const	$push22=, 4
	i32.add 	$push5=, $pop23, $pop22
	i32.store	$drop=, 60($14), $pop5
	i32.load	$push6=, 0($10)
	i32.store	$drop=, 56($14), $pop6
	i64.const	$push0=, 4294967296
	i64.store	$drop=, 16($14), $pop0
	i64.const	$push1=, 12884901890
	i64.store	$drop=, 24($14), $pop1
	i64.const	$push2=, 21474836484
	i64.store	$drop=, 32($14), $pop2
	i64.const	$push3=, 30064771078
	i64.store	$drop=, 40($14), $pop3
	i64.const	$push4=, 38654705672
	i64.store	$drop=, 48($14), $pop4
	i32.const	$push18=, 16
...
# BB#2:                                 # %if.then.i
	...
	i32.store	$drop=, 8($14), $13
	i32.store	$drop=, 4($14), $11
	i32.const	$push33=, .L.str.10
	i32.store	$drop=, 0($14), $pop33
	i32.const	$push32=, .L.str.1
	i32.call	$drop=, printf@FUNCTION, $pop32, $14
	i32.const	$push31=, 0
	i32.const	$push30=, 0
	i32.load	$push8=, errors($pop30)
	i32.const	$push29=, 1
	i32.add 	$push9=, $pop8, $pop29
	i32.store	$drop=, errors($pop31), $pop9
.LBB10_3:                               # %for.inc.i
                                        #   in Loop: Header=BB10_1 Depth=1
	end_block                       # label30:
	i32.const	$push34=, 10
