...
# BB#0:                                 # %entry
	...
	i32.store	$discard=, 76($4), $pop1
	i32.load	$5=, 0($3)
	i32.const	$push2=, 8
	i32.add 	$push3=, $3, $pop2
	i32.store	$discard=, 76($4), $pop3
	i32.load	$6=, 4($3)
	i32.const	$push4=, 12
	i32.add 	$push5=, $3, $pop4
	i32.store	$discard=, 76($4), $pop5
	i32.load	$7=, 8($3)
	i32.const	$push6=, 16
	i32.add 	$push7=, $3, $pop6
	i32.store	$discard=, 76($4), $pop7
	i32.load	$8=, 12($3)
	i32.const	$push8=, 20
	i32.add 	$push9=, $3, $pop8
	i32.store	$discard=, 76($4), $pop9
	i32.load	$9=, 16($3)
	i32.const	$push10=, 24
	i32.add 	$push11=, $3, $pop10
	i32.store	$discard=, 76($4), $pop11
	i32.load	$10=, 20($3)
	i32.const	$push12=, 28
	i32.add 	$push13=, $3, $pop12
	i32.store	$discard=, 76($4), $pop13
	i32.load	$11=, 24($3)
	i32.const	$push14=, 32
	i32.add 	$push15=, $3, $pop14
	i32.store	$discard=, 76($4), $pop15
	i32.load	$12=, 28($3)
	i32.const	$push16=, 36
	i32.add 	$push17=, $3, $pop16
	i32.store	$discard=, 76($4), $pop17
	i32.load	$13=, 32($3)
	i32.const	$push18=, 40
	i32.add 	$push19=, $3, $pop18
	i32.store	$discard=, 76($4), $pop19
	i32.load	$14=, 36($3)
	i32.const	$push20=, 44
	i32.add 	$push21=, $3, $pop20
	i32.store	$discard=, 76($4), $pop21
	i32.load	$15=, 40($3)
	i32.const	$push22=, 48
	i32.add 	$push23=, $3, $pop22
	i32.store	$discard=, 76($4), $pop23
	i32.load	$16=, 44($3)
	i32.const	$push24=, 52
	i32.add 	$push25=, $3, $pop24
	i32.store	$discard=, 76($4), $pop25
	i32.const	$push27=, 68
	...
	i32.store	$discard=, 0($pop30), $16
	i32.const	$push31=, 60
	i32.add 	$push32=, $4, $pop31
	i32.store	$discard=, 0($pop32), $15
	i32.const	$push33=, 56
	i32.add 	$push34=, $4, $pop33
	i32.store	$discard=, 0($pop34), $14
	i32.const	$push64=, 52
	i32.add 	$push35=, $4, $pop64
	i32.store	$discard=, 0($pop35), $13
	i32.const	$push63=, 48
	i32.add 	$push36=, $4, $pop63
	i32.store	$discard=, 0($pop36), $12
	i32.const	$push62=, 44
	i32.add 	$push37=, $4, $pop62
	i32.store	$discard=, 0($pop37), $11
	i32.const	$push61=, 40
	i32.add 	$push38=, $4, $pop61
	i32.store	$discard=, 0($pop38), $10
	i32.const	$push60=, 36
