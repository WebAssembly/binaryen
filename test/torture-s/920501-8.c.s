...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop37), $pop42
	i32.store	$drop=, 76($16), $3
	i32.const	$push0=, 4
	i32.add 	$push1=, $3, $pop0
	i32.store	$drop=, 76($16), $pop1
	i32.load	$4=, 0($3)
	i32.load	$5=, 4($3)
	i32.load	$6=, 8($3)
	i32.load	$7=, 12($3)
	...
	i32.store	$drop=, 0($pop8), $15
	i32.const	$push9=, 60
	i32.add 	$push10=, $16, $pop9
	i32.store	$drop=, 0($pop10), $14
	i32.const	$push11=, 56
	i32.add 	$push12=, $16, $pop11
	i32.store	$drop=, 0($pop12), $13
	i32.const	$push41=, 52
	i32.add 	$push13=, $16, $pop41
	i32.store	$drop=, 0($pop13), $12
	i32.const	$push14=, 48
	i32.add 	$push15=, $16, $pop14
	i32.store	$drop=, 0($pop15), $11
	i32.const	$push16=, 44
	i32.add 	$push17=, $16, $pop16
	i32.store	$drop=, 0($pop17), $10
	i32.const	$push18=, 40
	i32.add 	$push19=, $16, $pop18
	i32.store	$drop=, 0($pop19), $9
	i32.const	$push20=, 36
	i32.add 	$push21=, $16, $pop20
	i32.store	$drop=, 0($pop21), $8
	i32.const	$push22=, 32
	i32.add 	$push23=, $16, $pop22
	i32.store	$drop=, 0($pop23), $7
	i32.const	$push24=, 28
	i32.add 	$push25=, $16, $pop24
	i32.store	$drop=, 0($pop25), $6
	i32.const	$push26=, 24
	i32.add 	$push27=, $16, $pop26
	i32.store	$drop=, 0($pop27), $5
	i32.const	$push28=, 20
	i32.add 	$push29=, $16, $pop28
	i32.store	$drop=, 0($pop29), $4
	i32.const	$push30=, 16
	i32.add 	$push31=, $16, $pop30
	i32.store	$drop=, 0($pop31), $2
	f64.store	$drop=, 8($16), $1
	i32.store	$drop=, 0($16), $0
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop27), $pop28
	i32.const	$push0=, 48
