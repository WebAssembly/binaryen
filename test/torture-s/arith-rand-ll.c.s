...
.LBB1_4:                                # %if.end
	...
	end_block                       # label2:
	i32.const	$push25=, 71
	i32.lt_u	$push8=, $3, $pop25
	br_if   	0, $pop8        # 0: up to label0
.LBB1_5:                                # %cleanup
	end_loop                        # label1:
	i32.const	$push9=, 0
	i64.store	$drop=, simple_rand.seed($pop9), $2
	copy_local	$push27=, $4
...
main:                                   # @main
	.result 	i32
	.local  	i64, i32, i64, i64, i32, i32, i32, i32, i32, i32, i64, i64
# BB#0:                                 # %entry
	i32.const	$push76=, 0
...
.LBB2_2:                                # %for.cond.i
	...
	br_if   	1, $pop186      # 1: down to label10
# BB#3:                                 # %if.else.i
...
.LBB2_7:                                # %for.cond.i452
	...
	br_if   	1, $pop187      # 1: down to label13
# BB#8:                                 # %if.else.i457
...
.LBB2_18:                               # %if.end79
	...
	i32.shr_s	$push125=, $9, $pop126
	tee_local	$push124=, $6=, $pop125
	i32.add 	$push30=, $9, $pop124
...
# BB#19:                                # %lor.lhs.false103
	...
	block
	i32.eqz 	$push189=, $4
	br_if   	0, $pop189      # 0: down to label18
...
.LBB2_21:                               # %cleanup.cont118.critedge
                                        #   in Loop: Header=BB2_1 Depth=1
	end_block                       # label18:
	i32.const	$push133=, 65535
	i32.and 	$push37=, $9, $pop133
	i32.eqz 	$push190=, $pop37
	br_if   	0, $pop190      # 0: down to label15
# BB#22:                                # %cleanup.cont158.critedge
                                        #   in Loop: Header=BB2_1 Depth=1
...
# BB#24:                                # %if.end209
	...
	i32.and 	$push55=, $9, $pop157
	i32.eqz 	$push191=, $pop55
	br_if   	0, $pop191      # 0: down to label15
# BB#25:                                # %cleanup.cont249.critedge
                                        #   in Loop: Header=BB2_1 Depth=1
	...
	i32.const	$push160=, 0
	i32.sub 	$push62=, $pop160, $9
	i32.const	$push159=, -16777216
	i32.gt_s	$push61=, $6, $pop159
	i32.select	$push63=, $9, $pop62, $pop61
...
# BB#26:                                # %lor.lhs.false288
                                        #   in Loop: Header=BB2_1 Depth=1
	i32.div_s	$push66=, $4, $9
	i32.mul 	$push67=, $pop66, $9
...
# BB#28:                                # %for.end
	end_loop                        # label8:
	i32.const	$push75=, 0
	i64.store	$drop=, simple_rand.seed($pop75), $2
	i32.const	$push185=, 0
...
.LBB2_29:                               # %if.then32
	end_block                       # label6:
	i32.const	$push27=, 0
	i64.store	$drop=, simple_rand.seed($pop27), $2
	call    	abort@FUNCTION
	unreachable
.LBB2_30:                               # %if.then111
	end_block                       # label5:
	i32.const	$push73=, 0
	i64.store	$drop=, simple_rand.seed($pop73), $2
	call    	abort@FUNCTION
	unreachable
.LBB2_31:                               # %if.then208
	end_block                       # label4:
	i32.const	$push54=, 0
	i64.store	$drop=, simple_rand.seed($pop54), $2
	call    	abort@FUNCTION
	unreachable
.LBB2_32:                               # %if.then299
	end_block                       # label3:
	i32.const	$push72=, 0
	i64.store	$drop=, simple_rand.seed($pop72), $2
	call    	abort@FUNCTION
	unreachable
	.endfunc
.Lfunc_end2:
