...
# BB#0:                                 # %entry
	i32.const	$push1=, 0
	i32.const	$push9=, 0
	i64.load	$push2=, simple_rand.seed($pop9)
	i64.const	$push3=, 1103515245
	i64.mul 	$push4=, $pop2, $pop3
	i64.const	$push5=, 12345
	i64.add 	$push6=, $pop4, $pop5
	i64.store	$push0=, simple_rand.seed($pop1), $pop6
	i64.const	$push7=, 8
	i64.shr_u	$push8=, $pop0, $pop7
