...
# BB#0:                                 # %entry
	...
	i32.store8	$discard=, 0($pop15), $pop10
	i32.const	$push6=, 1
	...
	i32.store8	$discard=, 0($pop16), $pop9
	i32.const	$push4=, 254
...
# BB#0:                                 # %entry
	...
	i32.store8	$discard=, 0($pop14), $pop12
	i32.const	$push15=, 2
	...
	i32.store8	$discard=, 0($pop16), $pop11
	i32.const	$push17=, 1
