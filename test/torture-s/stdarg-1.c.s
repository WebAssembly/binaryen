...
# BB#0:                                 # %entry
	...
	i32.store	$discard=, x($pop18), $pop6
	block
	i32.const	$push7=, 5
	i32.ne  	$push8=, $0, $pop7
...
# BB#1:                                 # %foo.exit
	i32.const	$push23=, 0
	i32.load	$push9=, 0($1)
	i32.store	$discard=, foo_arg($pop23), $pop9
...
# BB#0:                                 # %entry
	...
	i32.store	$discard=, 12($pop20), $1
	i32.const	$push0=, 0
	i32.const	$push14=, 12
	i32.add 	$push15=, $3, $pop14
	i32.store	$discard=, pap($pop0), $pop15
	call    	bar@FUNCTION, $0
	i32.load	$push1=, 12($3)
	i32.const	$push2=, 7
...
# BB#0:                                 # %entry
	...
	i64.store	$discard=, d($pop74), $pop1
	i32.const	$push2=, 28
