	.text
	.file	"/usr/local/google/home/dschuff/s/wasm-waterfall/src/work/gcc/gcc/testsuite/gcc.c-torture/execute/pr38051.c"
...
.LBB0_25:                               # %if.end37.i
	...
	br_if   	69, $pop225     # 69: down to label16
...
.LBB0_29:                               # %do.body.i
	...
	end_block                       # label84:
	i32.ne  	$push84=, $6, $5
	br_if   	45, $pop84      # 45: down to label38
...
.LBB0_31:                               # %do3.i
	...
	br_if   	59, $pop87      # 59: down to label23
...
.LBB0_35:                               # %do2.i
	...
	br_if   	59, $pop90      # 59: down to label21
...
.LBB0_40:                               # %do.body.i116.i
	...
	copy_local	$10=, $pop10
	i32.eq  	$push81=, $2, $0
	br_if   	60, $pop81      # 60: down to label17
...
.LBB0_45:                               # %do.body.i.i
	...
	copy_local	$10=, $pop2
	i32.eq  	$push85=, $2, $0
	br_if   	50, $pop85      # 50: down to label24
...
.LBB0_50:                               # %do.body.i140.i
	...
	copy_local	$10=, $pop6
	i32.eq  	$push88=, $2, $0
	br_if   	49, $pop88      # 49: down to label22
...
.LBB0_55:                               # %do.body.i128.i
	...
	copy_local	$10=, $pop8
	i32.eq  	$push91=, $2, $0
	br_if   	48, $pop91      # 48: down to label20
...
.LBB0_58:                               # %do0.i
	...
	i32.const	$1=, 0
	i32.eq  	$push92=, $6, $5
	br_if   	41, $pop92      # 41: down to label25
...
.LBB0_62:                               # %do.body.i104.i
	...
	copy_local	$10=, $pop12
	i32.eq  	$push93=, $2, $0
	br_if   	49, $pop93      # 49: down to label15
...
.LBB0_67:                               # %if.end54.i
	...
	br_if   	33, $pop226     # 33: down to label28
