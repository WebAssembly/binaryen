...
.LBB0_23:                               # =>This Inner Loop Header: Depth=1
	...
	block   	
	block   	
	br_table 	$11, 26, 34, 35, 36, 27, 37, 38, 39, 28, 29, 40, 41, 42, 30, 23, 31, 32, 33, 24, 25, 43, 44, 45, 46, 47, 6, 7, 8, 9, 0, 10, 11, 12, 1, 2, 13, 14, 15, 3, 4, 16, 17, 18, 5, 19, 20, 21, 22, 22 # 26: down to label60
                                        # 34: down to label52
                                        # 35: down to label51
                                        # 36: down to label50
                                        # 27: down to label59
...
.LBB0_28:                               # %do2.i
	...
	i32.ne  	$push91=, $pop166, $pop164
	br_if   	63, $pop91      # 63: down to label20
...
.LBB0_49:                               # %do.body.i128.i
	...
	copy_local	$1=, $pop9
	i32.const	$push181=, 1
	i32.add 	$push8=, $10, $pop181
	copy_local	$10=, $pop8
	i32.eq  	$push92=, $2, $0
	br_if   	52, $pop92      # 52: down to label19
...
.LBB0_64:                               # %do1.i56
	...
	br_if   	32, $pop48      # 32: down to label30
...
.LBB0_66:                               # %if.end54.i
	...
	br_if   	33, $pop227     # 33: down to label28
...
.LBB0_70:                               # %do.body.i23
	...
	br_if   	22, $pop54      # 22: down to label37
...
.LBB0_72:                               # %do3.i42
	...
	br_if   	23, $pop58      # 23: down to label35
...
.LBB0_76:                               # %do2.i50
	...
	br_if   	23, $pop63      # 23: down to label33
...
.LBB0_81:                               # %do.body.i170.i
	...
	copy_local	$10=, $pop22
	i32.eq  	$push49=, $2, $0
	br_if   	24, $pop49      # 24: down to label29
...
.LBB0_86:                               # %do.body.i.i30
	...
	copy_local	$10=, $pop15
	i32.eq  	$push55=, $2, $0
	br_if   	14, $pop55      # 14: down to label36
...
.LBB0_91:                               # %do.body.i194.i
	...
	copy_local	$10=, $pop18
	i32.eq  	$push60=, $2, $0
	br_if   	13, $pop60      # 13: down to label34
...
.LBB0_96:                               # %do.body.i182.i
	...
	copy_local	$10=, $pop20
	i32.eq  	$push65=, $2, $0
	br_if   	12, $pop65      # 12: down to label32
...
# BB#0:                                 # %entry
	i32.const	$push32=, 0
	i32.const	$push31=, 0
	i32.load8_u	$push0=, .L.str+14($pop31)
	i32.store8	buf+39($pop32), $pop0
	i32.const	$push30=, 0
	i32.const	$push29=, 0
	i32.load16_u	$push1=, .L.str+12($pop29):p2align=0
	i32.store16	buf+37($pop30):p2align=0, $pop1
	i32.const	$push28=, 0
	i32.const	$push27=, 0
	i32.load	$push2=, .L.str+8($pop27):p2align=0
	i32.store	buf+33($pop28):p2align=0, $pop2
	i32.const	$push26=, 0
	i32.const	$push25=, 0
	i64.load	$push3=, .L.str($pop25):p2align=0
	i64.store	buf+25($pop26):p2align=0, $pop3
	i32.const	$push24=, 0
	i32.const	$push23=, 0
	i32.load8_u	$push4=, .L.str.1+14($pop23)
	i32.store8	buf+182($pop24), $pop4
	i32.const	$push22=, 0
	i32.const	$push21=, 0
	i32.load16_u	$push5=, .L.str.1+12($pop21):p2align=0
	i32.store16	buf+180($pop22), $pop5
	i32.const	$push20=, 0
	i32.const	$push19=, 0
	i32.load	$push6=, .L.str.1+8($pop19):p2align=0
	i32.store	buf+176($pop20), $pop6
	i32.const	$push18=, 0
	i32.const	$push17=, 0
	i32.load	$push7=, .L.str.1+4($pop17):p2align=0
	i32.store	buf+172($pop18), $pop7
	i32.const	$push16=, 0
	i32.const	$push15=, 0
	i32.load	$push8=, .L.str.1($pop15):p2align=0
	i32.store	buf+168($pop16), $pop8
	block   	
	i32.const	$push11=, buf+25
	i32.const	$push10=, buf+168
	i32.const	$push9=, 33
	i32.call	$push12=, mymemcmp@FUNCTION, $pop11, $pop10, $pop9
	i32.const	$push13=, -51
	i32.ne  	$push14=, $pop12, $pop13
	br_if   	0, $pop14       # 0: down to label87
# BB#1:                                 # %cleanup
	i32.const	$push33=, 0
	return  	$pop33
.LBB1_2:                                # %if.then26
