...
# BB#0:                                 # %entry
	...
	i32.call	$drop=, memset@FUNCTION, $pop60, $pop65, $pop64
	f32.const	$41=, 0x0p0
	f32.const	$42=, 0x0p0
	f32.const	$43=, 0x0p0
	f32.const	$44=, 0x0p0
...
.LBB1_3:                                # %while.end
	...
	end_block                       # label0:
	i32.const	$push169=, 0
	f32.store	$drop=, results($pop169), $60
	i32.const	$push168=, 0
	f32.store	$drop=, results+4($pop168), $59
	i32.const	$push167=, 0
	f32.store	$drop=, results+8($pop167), $58
	i32.const	$push166=, 0
	f32.store	$drop=, results+12($pop166), $57
	i32.const	$push165=, 0
	f32.store	$drop=, results+16($pop165), $56
	i32.const	$push164=, 0
	f32.store	$drop=, results+20($pop164), $55
	i32.const	$push163=, 0
	f32.store	$drop=, results+24($pop163), $54
	i32.const	$push162=, 0
	f32.store	$drop=, results+28($pop162), $53
	i32.const	$push161=, 0
	f32.store	$drop=, results+32($pop161), $52
	i32.const	$push160=, 0
	f32.store	$drop=, results+36($pop160), $51
	i32.const	$push159=, 0
	f32.store	$drop=, results+40($pop159), $50
	i32.const	$push158=, 0
	f32.store	$drop=, results+44($pop158), $49
	i32.const	$push157=, 0
	f32.store	$drop=, results+48($pop157), $48
	i32.const	$push156=, 0
	f32.store	$drop=, results+52($pop156), $47
	i32.const	$push155=, 0
	f32.store	$drop=, results+56($pop155), $46
	i32.const	$push154=, 0
	f32.store	$drop=, results+60($pop154), $45
	i32.const	$push153=, 0
	f32.store	$drop=, results+64($pop153), $44
	i32.const	$push152=, 0
	f32.store	$drop=, results+68($pop152), $43
	i32.const	$push151=, 0
	f32.store	$drop=, results+72($pop151), $42
	i32.const	$push150=, 0
	f32.store	$drop=, results+76($pop150), $41
...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, ptrs+4($pop162), $pop1
	i32.const	$push161=, 0
	i32.const	$push3=, input+8
	i32.store	$drop=, ptrs+8($pop161), $pop3
	i32.const	$push160=, 0
	i32.const	$push4=, input+12
	i32.store	$drop=, ptrs+12($pop160), $pop4
	i32.const	$push159=, 0
	i32.const	$push5=, 3
	i32.store	$drop=, incs+12($pop159), $pop5
	i32.const	$push158=, 0
	i32.const	$push6=, input+16
	i32.store	$drop=, ptrs+16($pop158), $pop6
	i32.const	$push157=, 0
	i32.const	$push8=, input+20
	i32.store	$drop=, ptrs+20($pop157), $pop8
	i32.const	$push156=, 0
	i32.const	$push9=, 5
	i32.store	$drop=, incs+20($pop156), $pop9
	i32.const	$push155=, 0
	i32.const	$push10=, input+24
	i32.store	$drop=, ptrs+24($pop155), $pop10
	i32.const	$push154=, 0
	i32.const	$push11=, 6
	i32.store	$drop=, incs+24($pop154), $pop11
	i32.const	$push153=, 0
	i32.const	$push12=, input+28
	i32.store	$drop=, ptrs+28($pop153), $pop12
	i32.const	$push152=, 0
	i32.const	$push13=, 7
	i32.store	$drop=, incs+28($pop152), $pop13
	i32.const	$push151=, 0
	i32.const	$push14=, input+32
	i32.store	$drop=, ptrs+32($pop151), $pop14
	i32.const	$push150=, 0
	i32.const	$push15=, 8
	i32.store	$drop=, incs+32($pop150), $pop15
	i32.const	$push149=, 0
	i32.const	$push16=, input+36
	i32.store	$drop=, ptrs+36($pop149), $pop16
	i32.const	$push148=, 0
	i32.const	$push17=, 9
	i32.store	$drop=, incs+36($pop148), $pop17
	i32.const	$push147=, 0
	i32.const	$push18=, input+40
	i32.store	$drop=, ptrs+40($pop147), $pop18
	i32.const	$push146=, 0
	i32.const	$push19=, 10
	i32.store	$drop=, incs+40($pop146), $pop19
	i32.const	$push145=, 0
	i32.const	$push20=, input+44
	i32.store	$drop=, ptrs+44($pop145), $pop20
	i32.const	$push144=, 0
	i32.const	$push21=, 11
	i32.store	$drop=, incs+44($pop144), $pop21
	i32.const	$push143=, 0
	i32.const	$push22=, input+48
	i32.store	$drop=, ptrs+48($pop143), $pop22
	i32.const	$push142=, 0
	i32.const	$push23=, 12
	i32.store	$drop=, incs+48($pop142), $pop23
	i32.const	$push141=, 0
	i32.const	$push24=, input+52
	i32.store	$drop=, ptrs+52($pop141), $pop24
	i32.const	$push140=, 0
	i32.const	$push25=, 13
	i32.store	$drop=, incs+52($pop140), $pop25
	i32.const	$push139=, 0
	i32.const	$push26=, input+56
	i32.store	$drop=, ptrs+56($pop139), $pop26
	i32.const	$push138=, 0
	i32.const	$push27=, 14
	i32.store	$drop=, incs+56($pop138), $pop27
	i32.const	$push137=, 0
	i32.const	$push28=, input+60
	i32.store	$drop=, ptrs+60($pop137), $pop28
	i32.const	$push136=, 0
	i32.const	$push29=, 15
	i32.store	$drop=, incs+60($pop136), $pop29
	i32.const	$push135=, 0
	i32.const	$push30=, input+64
	i32.store	$drop=, ptrs+64($pop135), $pop30
	i32.const	$push134=, 0
	i32.const	$push31=, 16
	i32.store	$drop=, incs+64($pop134), $pop31
	i32.const	$push133=, 0
	i32.const	$push32=, input+68
	i32.store	$drop=, ptrs+68($pop133), $pop32
	i32.const	$push132=, 0
	i32.const	$push33=, 17
	i32.store	$drop=, incs+68($pop132), $pop33
	i32.const	$push131=, 0
	i32.const	$push34=, input+72
	i32.store	$drop=, ptrs+72($pop131), $pop34
	i32.const	$push130=, 0
	i32.const	$push35=, 18
	i32.store	$drop=, incs+72($pop130), $pop35
	i32.const	$push129=, 0
	i32.const	$push36=, input+76
	i32.store	$drop=, ptrs+76($pop129), $pop36
	i32.const	$push128=, 0
	i32.const	$push37=, 19
	i32.store	$drop=, incs+76($pop128), $pop37
	i32.const	$push127=, 0
	...
	i32.store	$drop=, ptrs($pop126), $pop125
	i32.const	$push124=, 0
	i32.const	$push123=, 0
