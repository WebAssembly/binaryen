...
.LBB1_3:                                # %while.end
	...
	end_block                       # label0:
	i32.const	$push191=, 0
	f32.store	$drop=, results+4($pop191), $44
	i32.const	$push190=, 0
	f32.store	$drop=, results($pop190), $43
	i32.const	$push189=, 0
	f32.store	$drop=, results+8($pop189), $45
	i32.const	$push188=, 0
	f32.store	$drop=, results+12($pop188), $46
	i32.const	$push187=, 0
	f32.store	$drop=, results+16($pop187), $47
	i32.const	$push186=, 0
	f32.store	$drop=, results+20($pop186), $48
	i32.const	$push185=, 0
	f32.store	$drop=, results+24($pop185), $49
	i32.const	$push184=, 0
	f32.store	$drop=, results+28($pop184), $50
	i32.const	$push183=, 0
	f32.store	$drop=, results+32($pop183), $51
	i32.const	$push182=, 0
	f32.store	$drop=, results+36($pop182), $52
	i32.const	$push181=, 0
	f32.store	$drop=, results+40($pop181), $53
	i32.const	$push180=, 0
	f32.store	$drop=, results+44($pop180), $54
	i32.const	$push179=, 0
	f32.store	$drop=, results+48($pop179), $55
	i32.const	$push178=, 0
	f32.store	$drop=, results+52($pop178), $56
	i32.const	$push177=, 0
	f32.store	$drop=, results+56($pop177), $57
	i32.const	$push176=, 0
	f32.store	$drop=, results+60($pop176), $58
	i32.const	$push175=, 0
	f32.store	$drop=, results+64($pop175), $59
	i32.const	$push174=, 0
	f32.store	$drop=, results+68($pop174), $60
	i32.const	$push173=, 0
	f32.store	$drop=, results+72($pop173), $61
	i32.const	$push172=, 0
	f32.store	$drop=, results+76($pop172), $62
