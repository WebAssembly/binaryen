...
.LBB1_2:                                # %while.body
	...
	br_if   	0, $pop135      # 0: up to label1
.LBB1_3:                                # %while.end
	end_loop                        # label2:
	end_block                       # label0:
	i32.const	$push160=, 0
	f32.store	$drop=, results+4($pop160), $42
	i32.const	$push159=, 0
	f32.store	$drop=, results($pop159), $41
	i32.const	$push158=, 0
	f32.store	$drop=, results+8($pop158), $43
	i32.const	$push157=, 0
	f32.store	$drop=, results+12($pop157), $44
	i32.const	$push156=, 0
	f32.store	$drop=, results+16($pop156), $45
	i32.const	$push155=, 0
	f32.store	$drop=, results+20($pop155), $46
	i32.const	$push154=, 0
	f32.store	$drop=, results+24($pop154), $47
	i32.const	$push153=, 0
	f32.store	$drop=, results+28($pop153), $48
	i32.const	$push152=, 0
	f32.store	$drop=, results+32($pop152), $49
	i32.const	$push151=, 0
	f32.store	$drop=, results+36($pop151), $50
	i32.const	$push150=, 0
	f32.store	$drop=, results+40($pop150), $51
	i32.const	$push149=, 0
	f32.store	$drop=, results+44($pop149), $52
	i32.const	$push148=, 0
	f32.store	$drop=, results+48($pop148), $53
	i32.const	$push147=, 0
	f32.store	$drop=, results+52($pop147), $54
	i32.const	$push146=, 0
	f32.store	$drop=, results+56($pop146), $55
	i32.const	$push145=, 0
	f32.store	$drop=, results+60($pop145), $56
	i32.const	$push144=, 0
	f32.store	$drop=, results+64($pop144), $57
	i32.const	$push143=, 0
	f32.store	$drop=, results+68($pop143), $58
	i32.const	$push142=, 0
	f32.store	$drop=, results+72($pop142), $59
	i32.const	$push141=, 0
	f32.store	$drop=, results+76($pop141), $60
	...
	i32.store	$drop=, __stack_pointer($pop67), $pop66
                                        # fallthrough-return
	.endfunc
.Lfunc_end1:
