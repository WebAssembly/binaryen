...
# BB#0:                                 # %entry
	...
	i32.store	$drop=, __stack_pointer($pop18), $pop39
	i32.const	$push38=, 0
	i32.const	$push37=, 0
	...
	f32.store	$drop=, z+4($pop31), $pop25
	i32.const	$push19=, 8
	...
	f32.store	$drop=, y($pop24), $pop7
	i32.const	$push23=, 0
	f32.load	$push8=, 12($4)
	f32.add 	$push9=, $2, $pop8
	f32.store	$drop=, y+4($pop23), $pop9
	block
	i32.const	$push22=, 0
