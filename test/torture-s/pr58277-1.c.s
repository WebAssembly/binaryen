...
# BB#14:                                # %for.cond9.for.end29_crit_edge
	end_loop                        # label12:
	i32.const	$push52=, 0
	i32.store	$discard=, c($pop52), $0
	i32.const	$push131=, 0
	i32.const	$push130=, 0
	i32.store	$discard=, b($pop131), $pop130
.LBB2_15:                               # %for.end29
	end_block                       # label10:
	call    	baz@FUNCTION
	block
...
# BB#16:                                # %if.end47
	...
	i32.store	$discard=, 0($pop92), $pop91
	i32.const	$push85=, 0
	return  	$pop85
.LBB2_17:                               # %if.then46
	end_block                       # label15:
