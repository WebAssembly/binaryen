...
# BB#5:                                 # %if.end3
	...
	end_loop                        # label5:
	i32.const	$push12=, 0
	i32.store	$drop=, f1.beenhere($pop12), $4
	i32.load	$6=, 0($0)
...
.LBB0_9:                                # %if.then
	end_block                       # label1:
	i32.const	$push4=, 0
	i32.store	$drop=, f1.beenhere($pop4), $4
	i32.const	$push13=, 0
	return  	$pop13
.LBB0_10:                               # %if.then.i
	end_block                       # label0:
...
# BB#4:                                 # %if.then.i.i.loopexit
	end_loop                        # label11:
	i32.const	$push5=, 0
	i32.store	$drop=, f1.beenhere($pop5), $2
	i32.const	$push23=, 2
	i32.add 	$2=, $4, $pop23
...
.LBB3_5:                                # %foo.exit
	end_block                       # label9:
	i32.const	$push24=, 0
	i32.store	$drop=, f1.beenhere($pop24), $2
	block
