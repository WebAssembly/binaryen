(module
 ...
 (func $bad0 (; 0 ;) (type $FUNCSIG$i) (result i32)
  (return
   (i32.const 0)
  )
 )
 (func $bad1 (; 1 ;) (type $FUNCSIG$i) (result i32)
  (return
   (i32.const 0)
  )
 )
 (func $bad2 (; 2 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (return
   (i32.const 0)
  )
 )
 (func $bad3 (; 3 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (return
   (i32.const 0)
  )
 )
 (func $bad4 (; 4 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (return
   (i32.const 0)
  )
 )
 (func $bad5 (; 5 ;) (type $FUNCSIG$i) (result i32)
  (return
   (i32.const 0)
  )
 )
 (func $bad6 (; 6 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (return
   (i32.const 0)
  )
 )
 (func $bad7 (; 7 ;) (type $FUNCSIG$i) (result i32)
  (return
   (i32.const 0)
  )
 )
 (func $bad8 (; 8 ;) (type $FUNCSIG$i) (result i32)
  (return
   (i32.const 0)
  )
 )
 (func $bad9 (; 9 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (return
   (i32.const 0)
  )
 )
 (func $bad10 (; 10 ;) (type $FUNCSIG$i) (result i32)
  (return
   (i32.const 0)
  )
 )
 (func $good0 (; 11 ;) (type $FUNCSIG$i) (result i32)
  (return
   (i32.const 1)
  )
 )
 (func $good1 (; 12 ;) (type $FUNCSIG$i) (result i32)
  (return
   (i32.const 1)
  )
 )
 (func $good2 (; 13 ;) (type $FUNCSIG$i) (result i32)
  (return
   (i32.const 1)
  )
 )
 (func $opt0 (; 14 ;) (type $FUNCSIG$i) (result i32)
  (return
   (i32.const 0)
  )
 )
 (func $opt1 (; 15 ;) (type $FUNCSIG$i) (result i32)
  (return
   (i32.const 0)
  )
 )
 (func $opt2 (; 16 ;) (type $FUNCSIG$i) (result i32)
  (return
   (i32.const 1)
  )
 )
 (func $main (; 17 ;) (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (set_local $0
 ...
 (func $dynCall_i (; 22 ;) (param $fptr i32) (result i32)
  (call_indirect $FUNCSIG$i
   (get_local $fptr)
  )
 )
 (func $dynCall_ii (; 23 ;) (param $fptr i32) (param $0 i32) (result i32)
  (call_indirect $FUNCSIG$ii
   (get_local $0)
   (get_local $fptr)
  )
