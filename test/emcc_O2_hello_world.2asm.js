function asmFunc(global, env, buffer) {
     ...
     if (i15) {
      ...
      label$break$L123 : {
       if ((i4 | 0) == (0 | 0)) {
        ...
        i10 = 0;
        wasm2asm_i32$2 = i5;
        if ((i32 | 0) == (31 | 0)) wasm2asm_i32$3 = 0; else wasm2asm_i32$3 = 25 - (i32 >>> 1 | 0) | 0;
      ...
      if (wasm2asm_i32$1) {
       ...
       do_once$19 : {
        if ((i43 >>> 0 | 0) >>> 0 >= 16 >>> 0) {
         ...
         wasm2asm_i32$2 = i43;
         if ((i52 | 0) == (31 | 0)) wasm2asm_i32$3 = 0; else wasm2asm_i32$3 = 25 - (i52 >>> 1 | 0) | 0;
         wasm2asm_i32$1 = wasm2asm_i32$2 << wasm2asm_i32$3 | 0;
         i4 = wasm2asm_i32$1;
         i7 = HEAPU32[i3 >> 2] | 0;
         while_out$20 : do {
    ...
    do_once$27 : {
     if (i60) {
      ...
      do_out$28 : do {
       ...
       if ((i63 | 0) != (0 | 0)) continue do_out$28;
      } while (0);
      ...
      if ((i36 | 0) == (211 | 0)) if (((HEAPU32[(i70 + 12 | 0) >> 2] | 0) & 8 | 0 | 0) == (0 | 0)) {
       ...
       i63 = i58 + 8 | 0;
       wasm2asm_i32$2 = i58;
       if ((i63 & 7 | 0 | 0) == (0 | 0)) wasm2asm_i32$3 = 0; else wasm2asm_i32$3 = (0 - i63 | 0) & 7 | 0;
       wasm2asm_i32$1 = wasm2asm_i32$2 + wasm2asm_i32$3 | 0;
       i44 = wasm2asm_i32$1;
       i63 = i61 + 8 | 0;
       wasm2asm_i32$2 = i61;
       ...
       do_once$32 : {
        if ((i43 | 0) != (i60 | 0)) {
         ...
         if ((i62 & 3 | 0 | 0) == (1 | 0)) {
          ...
          label$break$L331 : {
           if ((i62 >>> 0 | 0) >>> 0 >= 256 >>> 0) {
            ...
            if ((i54 | 0) == (0 | 0)) break label$break$L331;
         ...
         wasm2asm_i32$2 = i79;
         if ((i82 | 0) == (31 | 0)) wasm2asm_i32$3 = 0; else wasm2asm_i32$3 = 25 - (i82 >>> 1 | 0) | 0;
         wasm2asm_i32$1 = wasm2asm_i32$2 << wasm2asm_i32$3 | 0;
         i50 = wasm2asm_i32$1;
         i62 = HEAPU32[i5 >> 2] | 0;
         while_out$42 : do {
      ...
      i53 = i44 + 8 | 0;
      wasm2asm_i32$2 = i44;
      if ((i53 & 7 | 0 | 0) == (0 | 0)) wasm2asm_i32$3 = 0; else wasm2asm_i32$3 = (0 - i53 | 0) & 7 | 0;
      wasm2asm_i32$1 = wasm2asm_i32$2 + wasm2asm_i32$3 | 0;
      i63 = wasm2asm_i32$1;
      i53 = i60 + 16 | 0;
      ...
      i63 = i44 + 8 | 0;
      i43 = i58 + 8 | 0;
      if ((i43 & 7 | 0 | 0) == (0 | 0)) wasm2asm_i32$1 = 0; else wasm2asm_i32$1 = (0 - i43 | 0) & 7 | 0;
      i61 = wasm2asm_i32$1;
      i43 = i58 + i61 | 0;
      ...
      if ((i44 | 0) != (i60 | 0)) {
       ...
       wasm2asm_i32$2 = i63;
       if ((i89 | 0) == (31 | 0)) wasm2asm_i32$3 = 0; else wasm2asm_i32$3 = 25 - (i89 >>> 1 | 0) | 0;
       wasm2asm_i32$1 = wasm2asm_i32$2 << wasm2asm_i32$3 | 0;
       i5 = wasm2asm_i32$1;
       i62 = HEAPU32[i43 >> 2] | 0;
       while_out$48 : do {
      ...
      do_out$50 : do {
       ...
       i5 = i5 + 1 | 0;
       if ((i5 | 0) != (32 | 0)) continue do_out$50;
      } while (0);
      i5 = i58 + 8 | 0;
      if ((i5 & 7 | 0 | 0) == (0 | 0)) wasm2asm_i32$1 = 0; else wasm2asm_i32$1 = (0 - i5 | 0) & 7 | 0;
      i62 = wasm2asm_i32$1;
      i5 = i58 + i62 | 0;
  ...
  topmost : {
   ...
   if ((i2 & 2 | 0 | 0) == (0 | 0)) {
    if ((i6 | 0) == (HEAPU32[200 >> 2] | 0 | 0)) {
     ...
     if ((i12 | 0) != (HEAPU32[196 >> 2] | 0 | 0)) break topmost;
     HEAP32[196 >> 2] = 0;
     HEAP32[184 >> 2] = 0;
     break topmost;
    }
 ...
 function ___stdio_write(i1, i2, i3) {
  ...
  topmost : {
   ...
   if ((i15 | 0) == (6 | 0)) {
    ...
    if ((i17 | 0) == (2 | 0)) i24 = 0; else i24 = i3 - (HEAPU32[(i16 + 4 | 0) >> 2] | 0) | 0;
   }
   HEAP32[8 >> 2] = i4;
   wasm2asm_i32$0 = i24;
  }
 ...
 function _cleanup_418(i1) {
  i1 = i1 | 0;
  topmost : {
   if ((HEAPU32[(i1 + 68 | 0) >> 2] | 0 | 0) == (0 | 0)) ___unlockfile(i1 | 0);
   break topmost;
  }
 }
