...
;; PRIMARY-REF-NEXT:  (table $%table 1 funcref)
;; PRIMARY-REF-NEXT:  (elem $0 (table $table) (global.get $g) func $foo)
;; PRIMARY-REF-NEXT:  (elem $1 (table $%table) (i32.const 0) func $placeholder_0)
...
;; PRIMARY-REF-NEXT:   (call_indirect $%table (type $0)
...
;; SECONDARY-REF-NEXT:  (import "primary" "%table" (table $%table 1 funcref))
