...
;; RUN: wasm-dis -all %t1.wasm | filecheck %s --check-prefix=MOD1
;; RUN: wasm-dis -all %t2.wasm | filecheck %s --check-prefix=MOD2
;; RUN: wasm-dis -all %t3.wasm | filecheck %s --check-prefix=MOD3
...
;; RUN: wasm-dis -all %t.wasm | filecheck %s --check-prefix=PRIMARY-OPTIONS
;; RUN: wasm-dis -all %t1.wasm | filecheck %s --check-prefix=MOD1-OPTIONS
;; RUN: wasm-dis -all %t2.wasm | filecheck %s --check-prefix=MOD2-OPTIONS
;; RUN: wasm-dis -all %t3.wasm | filecheck %s --check-prefix=MOD3-OPTIONS
