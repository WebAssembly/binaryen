...
;; CHECK: [fuzz-exec] export __fuzz_split_func
...
;;
;; REVERSE: [fuzz-exec] export second
;; REVERSE: [fuzz-exec] note result: second => 1337
;; REVERSE: [fuzz-exec] export first
;; REVERSE: [fuzz-exec] note result: first => 42
;; REVERSE: [fuzz-exec] export __fuzz_split_func
...
;;
;; WASM_SPLIT: [fuzz-exec] export first
;; WASM_SPLIT: [fuzz-exec] note result: first => 42
;; WASM_SPLIT-NOT: [fuzz-exec] export second
;; WASM_SPLIT-NOT: [fuzz-exec] export __fuzz_split_func
