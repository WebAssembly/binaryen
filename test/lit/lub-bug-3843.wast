...
(module
 ...
 ;; CHECK:      (type $D (struct (field (mut (ref $A)) (mut (ref $A)))))
 ;; NOMNL:      (type $D (struct_subtype (field (mut (ref $A)) (mut (ref $A))) $C))
 ...
 ;; CHECK-NEXT:  )
 ;; CHECK-NEXT: )
 ;; NOMNL:      (func $foo (type $func.0) (param $a (ref null $A)) (result (ref null $A))
