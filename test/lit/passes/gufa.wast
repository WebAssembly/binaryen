...
;; RUN: foreach %s %t wasm-opt -all --hybrid --gufa -S -o - | filecheck %s
...
(module
  ;; CHECK:      (type $i (func_subtype (param i32) func))
...
(module
  ...
  ;; CHECK:      (type $f (func_subtype (param f32) func))
...
(module
  ...
  ;; CHECK:      (type $i32_funcref_=>_none (func_subtype (param i32 funcref) func))
