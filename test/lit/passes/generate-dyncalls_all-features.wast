...
(module
 ...
 ;; CHECK:      (type $2 (func (param i32) (result i64)))

 ;; CHECK:      (type $3 (func (param i32) (result i32)))

 ;; CHECK:      (type $4 (func (param i32 i32) (result i64)))
 ...
 ;; CHECK:      (func $f1 (type $1) (result i32)
 ;; CHECK-NEXT:  (i32.const 1024)
 ;; CHECK-NEXT: )
 (func $f1 (result i32)
  (i32.const 1024)
 )
 ;; CHECK:      (func $f2 (type $2) (param $0 i32) (result i64)
...
;; CHECK:      (func $dynCall_i (type $3) (param $fptr i32) (result i32)
;; CHECK-NEXT:  (call_indirect $0 (type $1)
;; CHECK-NEXT:   (local.get $fptr)
;; CHECK-NEXT:  )
;; CHECK-NEXT: )

;; CHECK:      (func $dynCall_ji (type $4) (param $fptr i32) (param $0 i32) (result i64)
...
;; CHECK:      (func $dynCall_vii (type $0) (param $fptr i32) (param $0 i32) (param $1 i32)
;; CHECK-NEXT:  (call_indirect $0 (type $5)
;; CHECK-NEXT:   (local.get $0)
...
(module
 ...
 (elem (i32.const 0) $f)
 ;; CHECK:      (elem $0 (offset (i32.const 0)) $f)

 ;; CHECK:      (export "dynCall_i" (func $dynCall_i))

 ;; CHECK:      (export "dynCall_vii" (func $dynCall_vii))

 ;; CHECK:      (func $f (type $1) (result i32)
...
;; CHECK:      (func $dynCall_i (type $2) (param $fptr i32) (result i32)
;; CHECK-NEXT:  (call_indirect $timport$0 (type $1)
;; CHECK-NEXT:   (local.get $fptr)
;; CHECK-NEXT:  )
;; CHECK-NEXT: )

;; CHECK:      (func $dynCall_vii (type $0) (param $fptr i32) (param $0 i32) (param $1 i32)
;; CHECK-NEXT:  (call_indirect $timport$0 (type $3)
;; CHECK-NEXT:   (local.get $0)
;; CHECK-NEXT:   (local.get $1)
;; CHECK-NEXT:   (local.get $fptr)
;; CHECK-NEXT:  )
