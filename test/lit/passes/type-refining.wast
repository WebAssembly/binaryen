...
;; Also test the GUFA variant.

;; RUN: foreach %s %t wasm-opt -all --closed-world --preserve-type-order \
;; RUN:     --type-refining-gufa -S -o - | filecheck %s --check-prefix=GUFA__
...
(module
  ...
  ;; GUFA__:      (type $struct (sub (struct (field (mut anyref)) (field (mut (ref i31))) (field (mut anyref)))))
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; GUFA__:      (type $1 (func (param (ref $struct))))

  ;; GUFA__:      (func $work (type $1) (param $struct (ref $struct))
  ;; GUFA__-NEXT:  (struct.set $struct 1
  ;; GUFA__-NEXT:   (local.get $struct)
  ;; GUFA__-NEXT:   (ref.i31
  ;; GUFA__-NEXT:    (i32.const 0)
  ;; GUFA__-NEXT:   )
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT:  (struct.set $struct 2
  ;; GUFA__-NEXT:   (local.get $struct)
  ;; GUFA__-NEXT:   (ref.i31
  ;; GUFA__-NEXT:    (i32.const 0)
  ;; GUFA__-NEXT:   )
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT:  (drop
  ;; GUFA__-NEXT:   (struct.get $struct 2
  ;; GUFA__-NEXT:    (local.get $struct)
  ;; GUFA__-NEXT:   )
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT: )
...
(module
  ...
  ;; GUFA__:      (rec
  ;; GUFA__-NEXT:  (type $struct (sub (struct (field (mut nullref)))))
  ...
  ;; GUFA__:      (func $work (type $1) (param $struct (ref $struct))
  ;; GUFA__-NEXT:  (drop
  ;; GUFA__-NEXT:   (struct.new_default $struct)
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT:  (struct.set $struct 0
  ;; GUFA__-NEXT:   (local.get $struct)
  ;; GUFA__-NEXT:   (ref.cast (ref none)
  ;; GUFA__-NEXT:    (ref.i31
  ;; GUFA__-NEXT:     (i32.const 0)
  ;; GUFA__-NEXT:    )
  ;; GUFA__-NEXT:   )
...
(module
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; GUFA__:      (type $3 (func (param (ref $struct) (ref $child-A) (ref $child-B))))

  ;; GUFA__:      (func $work (type $3) (param $struct (ref $struct)) (param $child-A (ref $child-A)) (param $child-B (ref $child-B))
  ;; GUFA__-NEXT:  (struct.set $struct 0
  ;; GUFA__-NEXT:   (local.get $struct)
  ;; GUFA__-NEXT:   (local.get $child-A)
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT:  (struct.set $struct 0
  ;; GUFA__-NEXT:   (local.get $struct)
  ;; GUFA__-NEXT:   (local.get $child-B)
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT: )
...
(module
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; GUFA__:      (type $3 (func (param (ref $struct) (ref $child-A))))

  ;; GUFA__:      (type $4 (func))

  ;; GUFA__:      (func $work (type $3) (param $struct (ref $struct)) (param $child-A (ref $child-A))
  ;; GUFA__-NEXT:  (struct.set $struct 0
  ;; GUFA__-NEXT:   (local.get $struct)
  ;; GUFA__-NEXT:   (local.get $child-A)
  ;; GUFA__-NEXT:  )
  ...
  ;; CHECK-NEXT: )
  ;; GUFA__:      (func $keepalive (type $4)
  ;; GUFA__-NEXT:  (local $temp (ref null $child-B))
  ;; GUFA__-NEXT: )
  (func $keepalive
...
(module
  ...
  ;; CHECK:      (rec
  ;; CHECK-NEXT:  (type $struct (sub (struct (field (mut (ref $struct))))))
  ;; GUFA__:      (type $struct (sub (struct (field (mut structref)))))
  (type $struct (sub (struct (field (mut structref)))))

  ;; CHECK:       (type $child (sub $struct (struct (field (mut (ref $struct))))))
  ;; GUFA__:      (type $child (sub $struct (struct (field (mut structref)))))
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; GUFA__:      (type $2 (func (param (ref $struct) (ref $child))))

  ;; GUFA__:      (func $work (type $2) (param $struct (ref $struct)) (param $child (ref $child))
  ;; GUFA__-NEXT:  (struct.set $struct 0
  ;; GUFA__-NEXT:   (local.get $struct)
  ;; GUFA__-NEXT:   (local.get $child)
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT:  (struct.set $child 0
  ;; GUFA__-NEXT:   (local.get $child)
  ;; GUFA__-NEXT:   (local.get $struct)
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT: )
...
(module
  ...
  ;; GUFA__:      (func $work (type $2) (param $struct (ref $struct)) (param $child (ref $child))
  ;; GUFA__-NEXT:  (drop
  ;; GUFA__-NEXT:   (struct.new $struct
  ;; GUFA__-NEXT:    (local.get $child)
  ;; GUFA__-NEXT:   )
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT:  (drop
  ;; GUFA__-NEXT:   (struct.new $child
  ;; GUFA__-NEXT:    (local.get $struct)
  ;; GUFA__-NEXT:   )
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT: )
...
(module
  ...
  ;; GUFA__:      (type $struct (sub (struct (field structref))))
  (type $struct (sub (struct (field structref))))

  ;; CHECK:       (type $child (sub $struct (struct (field (ref $child)))))
  ;; GUFA__:      (type $child (sub $struct (struct (field structref))))
...
(module
  ...
  ;; GUFA__:      (type $child (sub $struct (struct (field (mut structref)) (field (mut structref)))))
...
(module
  ...
  ;; GUFA__-NEXT:  (struct.set $struct 0
  ;; GUFA__-NEXT:   (local.get $struct)
  ;; GUFA__-NEXT:   (struct.get $struct 0
  ;; GUFA__-NEXT:    (local.get $struct)
  ;; GUFA__-NEXT:   )
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT: )
...
(module
  ...
  ;; GUFA__:      (func $foo (type $5)
  ;; GUFA__-NEXT:  (local $unused (ref null $C))
  ;; GUFA__-NEXT:  (drop
  ;; GUFA__-NEXT:   (struct.new $B
  ;; GUFA__-NEXT:    (struct.new_default $Y)
  ;; GUFA__-NEXT:   )
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT: )
  (func $foo
...
(module
  ...
  (rec
    ...
    ;; GUFA__:       (type $A (sub (struct (field (ref $X)))))
    (type $A (sub (struct (field (ref $X)))))

    ;; CHECK:       (type $B (sub $A (struct (field (ref $X)))))
    ;; GUFA__:       (type $B (sub $A (struct (field (ref $X)))))
    (type $B (sub $A (struct (field (ref $X)))))

    ;; CHECK:       (type $C (sub $A (struct (field (ref $X)))))
    ;; GUFA__:       (type $C (sub $A (struct (field (ref $X)))))
    (type $C (sub $A (struct (field (ref $X)))))
  )
  ...
  ;; GUFA__:      (func $foo (type $5)
  ;; GUFA__-NEXT:  (local $unused1 (ref null $C))
  ;; GUFA__-NEXT:  (local $unused2 (ref null $B))
  ;; GUFA__-NEXT:  (drop
  ;; GUFA__-NEXT:   (struct.new_default $Y)
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT: )
...
(module
  ...
  ;; GUFA__:      (func $foo (type $4)
  ;; GUFA__-NEXT:  (local $unused2 (ref null $B))
  ;; GUFA__-NEXT:  (drop
  ;; GUFA__-NEXT:   (struct.new $A
  ;; GUFA__-NEXT:    (struct.new_default $X)
  ;; GUFA__-NEXT:   )
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT: )
  (func $foo
...
(module
  ...
  ;; GUFA__:      (func $update-null (type $1) (param $struct (ref $struct))
  ;; GUFA__-NEXT:  (struct.set $struct 0
  ;; GUFA__-NEXT:   (local.get $struct)
  ;; GUFA__-NEXT:   (local.get $struct)
  ;; GUFA__-NEXT:  )
...
(module
  ...
  ;; GUFA__:      (func $update-null (type $2) (param $struct (ref $struct)) (param $child (ref $child))
  ;; GUFA__-NEXT:  (struct.set $struct 0
  ;; GUFA__-NEXT:   (local.get $struct)
  ;; GUFA__-NEXT:   (local.get $struct)
  ;; GUFA__-NEXT:  )
...
(module
  ...
  ;; GUFA__:      (rec
  ;; GUFA__-NEXT:  (type $struct (sub (struct (field (mut nullref)) (field (mut nullref)))))
  ...
  ;; GUFA__:       (type $child (sub $struct (struct (field (mut nullref)) (field (mut nullref)))))
...
(module
  ...
  ;; GUFA__:       (type $Leaf2-Outer (sub $Root-Outer (struct (field (ref $Leaf2-Inner)))))
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; GUFA__:       (type $6 (func (param (ref null $Leaf1-Outer))))

  ;; GUFA__:      (func $func (type $6) (param $Leaf1-Outer (ref null $Leaf1-Outer))
  ;; GUFA__-NEXT:  (drop
  ;; GUFA__-NEXT:   (block ;; (replaces unreachable StructGet we can't emit)
  ;; GUFA__-NEXT:    (drop
  ;; GUFA__-NEXT:     (block
  ;; GUFA__-NEXT:      (drop
  ;; GUFA__-NEXT:       (local.get $Leaf1-Outer)
  ;; GUFA__-NEXT:      )
  ;; GUFA__-NEXT:      (unreachable)
  ;; GUFA__-NEXT:     )
  ;; GUFA__-NEXT:    )
  ;; GUFA__-NEXT:    (unreachable)
  ;; GUFA__-NEXT:   )
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT:  (drop
  ;; GUFA__-NEXT:   (struct.new $Leaf2-Outer
  ;; GUFA__-NEXT:    (struct.new_default $Leaf2-Inner)
  ;; GUFA__-NEXT:   )
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT: )
...
(module
  ...
  ;; GUFA__:      (type $A (sub (struct (field (mut (ref null $A))))))
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; GUFA__:      (type $1 (func (param (ref $A) (ref null $A))))

  ;; GUFA__:      (func $non-nullability (type $1) (param $nn (ref $A)) (param $A (ref null $A))
  ;; GUFA__-NEXT:  (local $temp (ref null $A))
  ;; GUFA__-NEXT:  (struct.set $A 0
  ;; GUFA__-NEXT:   (local.get $A)
  ;; GUFA__-NEXT:   (local.get $nn)
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT:  (struct.set $A 0
  ;; GUFA__-NEXT:   (local.get $A)
  ;; GUFA__-NEXT:   (local.tee $temp
  ;; GUFA__-NEXT:    (struct.get $A 0
  ;; GUFA__-NEXT:     (local.get $A)
  ;; GUFA__-NEXT:    )
  ;; GUFA__-NEXT:   )
  ;; GUFA__-NEXT:  )
...
(module
  ...
  ;; GUFA__:      (type $A (sub (struct (field (ref null $A)))))
  (type $A (sub (struct (field (ref null $A)))))
  ;; CHECK:       (type $B (sub $A (struct (field (ref null $B)))))
  ;; GUFA__:      (type $B (sub $A (struct (field (ref null $A)))))
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; GUFA__:      (type $2 (func (param (ref null $B) (ref null $A))))

  ;; GUFA__:      (func $heap-type (type $2) (param $b (ref null $B)) (param $A (ref null $A))
  ;; GUFA__-NEXT:  (local $a (ref null $A))
  ;; GUFA__-NEXT:  (drop
  ;; GUFA__-NEXT:   (struct.new $B
  ;; GUFA__-NEXT:    (local.get $b)
  ;; GUFA__-NEXT:   )
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT:  (drop
  ;; GUFA__-NEXT:   (struct.new $A
  ;; GUFA__-NEXT:    (local.tee $a
  ;; GUFA__-NEXT:     (struct.get $A 0
  ;; GUFA__-NEXT:      (local.get $A)
  ;; GUFA__-NEXT:     )
  ;; GUFA__-NEXT:    )
...
(module
  ...
  ;; GUFA__:      (func $non-nullability-block (type $1) (param $nn (ref $A)) (param $A (ref null $A))
  ;; GUFA__-NEXT:  (struct.set $A 0
  ;; GUFA__-NEXT:   (local.get $A)
  ;; GUFA__-NEXT:   (local.get $nn)
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT:  (struct.set $A 0
  ;; GUFA__-NEXT:   (local.get $A)
  ;; GUFA__-NEXT:   (if (result (ref null $A))
  ;; GUFA__-NEXT:    (i32.const 1)
  ;; GUFA__-NEXT:    (then
  ;; GUFA__-NEXT:     (struct.get $A 0
  ;; GUFA__-NEXT:      (local.get $A)
  ;; GUFA__-NEXT:     )
...
(module
  ...
  ;; GUFA__:      (type $struct (struct (field (mut structref))))
  ...
  ;; GUFA__-NEXT:   (local.get $struct)
  ;; GUFA__-NEXT:   (struct.get $struct 0
  ;; GUFA__-NEXT:    (block (result (ref null $struct))
  ;; GUFA__-NEXT:     (ref.null none)
  ;; GUFA__-NEXT:    )
  ;; GUFA__-NEXT:   )
  ;; GUFA__-NEXT:  )
...
(module
  (rec
    ...
    ;; GUFA__:      (rec
    ;; GUFA__-NEXT:  (type $A (struct (field (ref $B))))
    (type $A (struct (field (ref struct))))
    ;; CHECK:       (type $B (struct))
    ;; GUFA__:       (type $B (struct))
    (type $B (struct))
  )
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; GUFA__:       (type $2 (func (result (ref $A))))

  ;; GUFA__:      (func $0 (type $2) (result (ref $A))
  ;; GUFA__-NEXT:  (struct.new $A
  ;; GUFA__-NEXT:   (ref.cast (ref $B)
  ;; GUFA__-NEXT:    (struct.get $A 0
  ;; GUFA__-NEXT:     (struct.new $A
  ;; GUFA__-NEXT:      (struct.new_default $B)
  ;; GUFA__-NEXT:     )
  ;; GUFA__-NEXT:    )
  ;; GUFA__-NEXT:   )
  ;; GUFA__-NEXT:  )
...
(module
  (rec
    ...
    ;; GUFA__:      (rec
    ;; GUFA__-NEXT:  (type $A (struct (field (mut nullref))))
    (type $A (struct (field (mut anyref))))
    ;; CHECK:       (type $B (struct (field (mut nullref))))
    ;; GUFA__:       (type $B (struct (field (mut nullref))))
  ...
  ;; GUFA__:      (func $0 (type $2)
  ;; GUFA__-NEXT:  (block ;; (replaces unreachable StructSet we can't emit)
  ;; GUFA__-NEXT:   (drop
  ;; GUFA__-NEXT:    (block ;; (replaces unreachable StructNew we can't emit)
  ;; GUFA__-NEXT:     (drop
  ;; GUFA__-NEXT:      (block
  ;; GUFA__-NEXT:       (drop
  ;; GUFA__-NEXT:        (struct.get $B 0
  ;; GUFA__-NEXT:         (struct.new_default $B)
  ;; GUFA__-NEXT:        )
  ;; GUFA__-NEXT:       )
  ;; GUFA__-NEXT:       (unreachable)
...
(module
  ...
  ;; GUFA__:      (type $A (struct (field (mut externref))))
  ...
  ;; GUFA__:      (type $2 (func (param externref) (result anyref)))

  ;; GUFA__:      (type $3 (func (param (ref $A) externref)))

  ;; GUFA__:      (type $4 (func (param (ref none) (ref noextern))))

  ;; GUFA__:      (type $5 (func (param (ref noextern))))

  ;; GUFA__:      (tag $tag (type $1))
  (tag $tag)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; GUFA__:      (func $struct.new (type $2) (param $extern externref) (result anyref)
  ;; GUFA__-NEXT:  (struct.new $A
  ;; GUFA__-NEXT:   (try (result externref)
  ;; GUFA__-NEXT:    (do
  ;; GUFA__-NEXT:     (struct.get $A 0
  ;; GUFA__-NEXT:      (struct.new $A
  ;; GUFA__-NEXT:       (ref.as_non_null
  ;; GUFA__-NEXT:        (ref.null noextern)
  ;; GUFA__-NEXT:       )
  ;; GUFA__-NEXT:      )
  ;; GUFA__-NEXT:     )
  ;; GUFA__-NEXT:    )
  ;; GUFA__-NEXT:    (catch $tag
  ;; GUFA__-NEXT:     (local.get $extern)
  ;; GUFA__-NEXT:    )
  ;; GUFA__-NEXT:   )
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT: )
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; GUFA__:      (func $struct.set (type $3) (param $ref (ref $A)) (param $extern externref)
  ;; GUFA__-NEXT:  (struct.set $A 0
  ;; GUFA__-NEXT:   (local.get $ref)
  ;; GUFA__-NEXT:   (try (result externref)
  ;; GUFA__-NEXT:    (do
  ;; GUFA__-NEXT:     (struct.get $A 0
  ;; GUFA__-NEXT:      (struct.new $A
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; GUFA__:      (func $bottom.type (type $4) (param $ref (ref none)) (param $value (ref noextern))
  ;; GUFA__-NEXT:  (block ;; (replaces unreachable StructSet we can't emit)
  ;; GUFA__-NEXT:   (drop
  ;; GUFA__-NEXT:    (local.get $ref)
  ;; GUFA__-NEXT:   )
  ;; GUFA__-NEXT:   (drop
  ;; GUFA__-NEXT:    (local.get $value)
  ;; GUFA__-NEXT:   )
  ;; GUFA__-NEXT:   (unreachable)
  ;; GUFA__-NEXT:  )
  ;; GUFA__-NEXT: )
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; GUFA__:      (func $unreachable (type $5) (param $value (ref noextern))
  ;; GUFA__-NEXT:  (block ;; (replaces unreachable StructSet we can't emit)
  ;; GUFA__-NEXT:   (drop
  ;; GUFA__-NEXT:    (unreachable)
  ;; GUFA__-NEXT:   )
...
(module
  ...
  ;; GUFA__:      (type $A (sub (struct (field (mut anyref)))))
  ...
  (rec
    ...
    ;; GUFA__:      (rec
    ;; GUFA__-NEXT:  (type $B (sub $A (struct (field (mut anyref)))))
    (type $B (sub $A (struct (field (mut anyref)))))
    ;; CHECK:       (type $brand (struct))
    ;; GUFA__:       (type $brand (struct))
    (type $brand (struct))
  )
  ...
  (rec
    ...
    ;; GUFA__:      (rec
    ;; GUFA__-NEXT:  (type $C (sub $A (struct (field (mut anyref)))))
    (type $C (sub $A (struct (field (mut anyref)))))
    ;; CHECK:       (type $brand2 (struct))
    ;; GUFA__:       (type $brand2 (struct))
    (type $brand2 (struct))
    ;; CHECK:       (type $brand3 (struct))
    ;; GUFA__:       (type $brand3 (struct))
    (type $brand3 (struct))
  )
  ...
  ;; GUFA__:      (type $6 (func (param (ref any))))

  ;; GUFA__:      (global $global (ref null $B) (ref.null none))
  (global $global (ref null $B) (ref.null $B))

  ;; CHECK:      (export "global" (global $global))
  ;; GUFA__:      (export "global" (global $global))
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; GUFA__:      (func $work (type $6) (param $nn (ref any))
  ;; GUFA__-NEXT:  (drop
  ;; GUFA__-NEXT:   (struct.new $A
  ;; GUFA__-NEXT:    (local.get $nn)
  ;; GUFA__-NEXT:   )
...
(module
  ...
  ;; GUFA__:      (type $A (sub (struct (field anyref))))
  ...
  (rec
    ...
    ;; GUFA__:      (rec
    ;; GUFA__-NEXT:  (type $B (sub $A (struct (field anyref))))
  ...
  (rec
    ...
    ;; GUFA__:      (rec
    ;; GUFA__-NEXT:  (type $C (sub $A (struct (field anyref))))
...
(module
 ...
 ;; GUFA__:      (type $1 (sub (struct (field (mut (ref null $1))))))
 ...
 (rec
  ...
  ;; GUFA__:      (rec
  ;; GUFA__-NEXT:  (type $7 (sub (struct (field (ref $1)))))

  ;; GUFA__:       (type $8 (sub (func)))

  ;; GUFA__:      (type $3 (func (result (ref null $8))))

  ;; GUFA__:      (rec
  ;; GUFA__-NEXT:  (type $5 (sub (struct (field (ref $3)))))
  (type $5 (sub (struct (field (ref func)))))
  ;; CHECK:       (type $6 (sub $1 (struct (field (mut (ref null $1))))))
  ;; GUFA__:       (type $6 (sub $1 (struct (field (mut (ref null $1))))))
 ...
 ;; GUFA__:       (type $9 (sub $6 (struct (field (mut (ref null $1))))))
 (type $9 (sub $6 (struct (field (mut (ref null $1))))))

 ;; CHECK:      (elem declare func $1)

 ;; CHECK:      (export "func" (func $1))
 ;; GUFA__:      (elem declare func $1)

 ;; GUFA__:      (export "func" (func $1))
 (export "func" (func $1))
 ...
 ;; CHECK-NEXT: )
 ;; GUFA__:      (func $1 (type $3) (result (ref null $8))
 ;; GUFA__-NEXT:  (local $l (ref $9))
 ;; GUFA__-NEXT:  (drop
 ;; GUFA__-NEXT:   (struct.get $5 0
 ;; GUFA__-NEXT:    (struct.new $5
 ;; GUFA__-NEXT:     (ref.func $1)
 ;; GUFA__-NEXT:    )
 ;; GUFA__-NEXT:   )
 ;; GUFA__-NEXT:  )
 ;; GUFA__-NEXT:  (ref.null nofunc)
 ;; GUFA__-NEXT: )
...
(module
 ...
 ;; GUFA__:      (type $never (sub (struct (field i32))))
 (type $never (sub (struct (field i32))))

 ;; CHECK:      (rec
 ;; CHECK-NEXT:  (type $optimizable (struct (field (mut nullfuncref))))
 ;; GUFA__:      (rec
 ;; GUFA__-NEXT:  (type $optimizable (struct (field (mut nullfuncref))))
 ...
 ;; GUFA__:      (global $never (ref null $never) (ref.null none))
 ...
 ;; CHECK-NEXT:  )
 ;; CHECK-NEXT: )
 ;; GUFA__:      (export "never" (global $never))

 ;; GUFA__:      (func $setup (type $2)
 ;; GUFA__-NEXT:  (drop
 ;; GUFA__-NEXT:   (struct.new $optimizable
 ;; GUFA__-NEXT:    (ref.null nofunc)
 ;; GUFA__-NEXT:   )
 ;; GUFA__-NEXT:  )
 ;; GUFA__-NEXT:  (drop
 ;; GUFA__-NEXT:   (block
 ;; GUFA__-NEXT:    (drop
 ;; GUFA__-NEXT:     (block (result (ref none))
 ;; GUFA__-NEXT:      (ref.as_non_null
 ;; GUFA__-NEXT:       (ref.null none)
 ;; GUFA__-NEXT:      )
 ;; GUFA__-NEXT:     )
...
(module
 (rec
  ...
  ;; GUFA__:      (rec
  ;; GUFA__-NEXT:  (type $A (sub (struct (field i32))))
  (type $A (sub (struct (field i32))))
  ;; CHECK:       (type $B (sub (struct (field i32))))
  ;; GUFA__:       (type $B (sub (struct (field i32))))
  (type $B (sub (struct (field i32))))
 )
 ;; CHECK:      (type $2 (func (param (ref null $A) (ref null $B))))

 ;; CHECK:      (type $optimizable (sub (struct (field (ref $2)))))
 ;; GUFA__:      (type $2 (func (param (ref null $A) (ref null $B))))

 ;; GUFA__:      (type $optimizable (sub (struct (field (ref $2)))))
 ...
 ;; CHECK-NEXT:  )
 ;; CHECK-NEXT: )
 ;; GUFA__:      (elem declare func $test)

 ;; GUFA__:      (export "test" (func $test))

 ;; GUFA__:      (func $test (type $2) (param $x (ref null $A)) (param $y (ref null $B))
 ;; GUFA__-NEXT:  (drop
 ;; GUFA__-NEXT:   (struct.new $optimizable
 ;; GUFA__-NEXT:    (ref.func $test)
 ;; GUFA__-NEXT:   )
 ;; GUFA__-NEXT:  )
 ;; GUFA__-NEXT:  (drop
 ;; GUFA__-NEXT:   (struct.get $A 0
