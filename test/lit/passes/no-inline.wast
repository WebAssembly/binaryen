...
;; RUN: foreach %s %t wasm-opt --no-partial-inline=*no* --inlining --optimize-level=3 --partial-inlining-ifs=1 -S -o - | filecheck %s --check-prefix INLINE_FULL
;; RUN: foreach %s %t wasm-opt --no-full-inline=*no*    --inlining --optimize-level=3 --partial-inlining-ifs=1 -S -o - | filecheck %s --check-prefix INLINE_PART
;; RUN: foreach %s %t wasm-opt --no-inline=*no*         --inlining --optimize-level=3 --partial-inlining-ifs=1 -S -o - | filecheck %s --check-prefix INLINE_NONE
...
(module
  ...
  ;; INLINE_PART:      (func $full-no-inline (param $x i32)
  ;; INLINE_PART-NEXT:  (call $import)
  ;; INLINE_PART-NEXT: )
  ;; INLINE_NONE:      (func $full-no-inline (param $x i32)
  ...
  ;; INLINE_NONE:      (func $partial-no-inline (param $x i32)
  ;; INLINE_NONE-NEXT:  (if
  ...
  ;; INLINE_PART-NEXT:   )
  ;; INLINE_PART-NEXT:  )
  ;; INLINE_PART-NEXT:  (call $full-no-inline
  ...
  ;; INLINE_PART-NEXT:  )
  ;; INLINE_PART-NEXT:  (block
  ;; INLINE_PART-NEXT:   (block $__inlined_func$partial-no-inline$2
  ...
  ;; INLINE_PART-NEXT:      (br $__inlined_func$partial-no-inline$2)
  ;; INLINE_PART-NEXT:     )
  ...
  ;; INLINE_NONE-NEXT:   )
  ;; INLINE_NONE-NEXT:  )
  ;; INLINE_NONE-NEXT:  (call $full-no-inline
  ...
  ;; INLINE_NONE-NEXT:   )
  ;; INLINE_NONE-NEXT:  )
  ;; INLINE_NONE-NEXT:  (call $partial-no-inline
