...
(module
 ...
 ;; CHECK:      (func $various-params-no (type $6) (param $x (ref null $"{}")) (param $y (ref null $"{}"))
 ;; CHECK-NEXT:  (drop
 ...
 ;; CHECK:      (func $"get_{}" (type $7) (result (ref null $"{}"))
 ;; CHECK-NEXT:  (unreachable)
 ;; CHECK-NEXT: )
 (func $"get_{}" (result (ref null $"{}"))
  (unreachable)
 )
 ;; CHECK:      (func $"get_{i32}" (type $8) (result (ref null $"{i32}"))
 ;; CHECK-NEXT:  (unreachable)
 ;; CHECK-NEXT: )
 (func $"get_{i32}" (result (ref null $"{i32}"))
  (unreachable)
 )
 ;; CHECK:      (func $"get_{f64}" (type $9) (result (ref null $"{f64}"))
 ;; CHECK-NEXT:  (unreachable)
 ;; CHECK-NEXT: )
 ...
 ;; its parameters (see last function).
 ;; CHECK:      (func $various-params-yes (type $10) (param $x (ref null (exact $"{i32}"))) (param $i i32) (param $y (ref null $"{i32}"))
 ;; CHECK-NEXT:  (drop
 ;; CHECK-NEXT:   (local.get $x)
 ;; CHECK-NEXT:  )
 ;; CHECK-NEXT:  (drop
 ...
 ;; CHECK:      (func $various-params-set (type $11) (param $x (ref null (exact $"{i32}"))) (param $y (ref null $"{i32}"))
 ...
 ;; CHECK:      (func $various-params-tee (type $12) (param $x (ref null (exact $"{i32}")))
 ;; CHECK-NEXT:  (local $1 (ref null $"{}"))
 ...
 ;; non-nullable.
 ;; CHECK:      (func $various-params-null (type $13) (param $x (ref none)) (param $y (ref null (exact $"{i32}")))
 ...
 ;; CHECK:      (func $various-params-middle (type $14) (param $x (ref null $"{i32}"))
 ;; CHECK-NEXT:  (drop
 ;; CHECK-NEXT:   (local.get $x)
 ;; CHECK-NEXT:  )
 ;; CHECK-NEXT: )
 ...
 ;; CHECK:      (func $non-nullable-fixup (type $15) (param $0 (ref (exact $"{}")))
 ...
 ;; CHECK:      (func $update-null (type $16) (param $x (ref null (exact $"{}")))
 ;; CHECK-NEXT:  (drop
 ;; CHECK-NEXT:   (local.get $x)
 ;; CHECK-NEXT:  )
 ;; CHECK-NEXT: )
 ...
 ;; CHECK:      (func $"get_null_{i32}" (type $17) (result (ref null (exact $"{i32}")))
 ;; CHECK-NEXT:  (select (result (ref null (exact $"{i32}")))
 ;; CHECK-NEXT:   (ref.null none)
 ...
 ;; CHECK:      (func $"get_null_{i32_i64}" (type $18) (result (ref null (exact $"{i32_i64}")))
 ...
 ;; CHECK:      (func $"get_null_{i32_f32}" (type $19) (result (ref null (exact $"{i32_f32}")))
