...
(module
  ...
  ;; CHECK:      (type $B (struct (field i32 i32 f32)))

  ;; CHECK:      (type $array (array (mut i8)))
  ;; NOMNL:      (type $B (struct_subtype (field i32 i32 f32) $A))
  ...
  ;; CHECK:      (type $B-child (struct (field i32 i32 f32 i64)))
  ;; NOMNL:      (type $B-child (struct_subtype (field i32 i32 f32 i64) $B))
  ...
  ;; CHECK:      (type $C (struct (field i32 i32 f64)))
  ;; NOMNL:      (type $C (struct_subtype (field i32 i32 f64) $A))
  ...
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $if-arms-subtype-fold (type $func.3) (result anyref)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $if-arms-subtype-nofold (type $func.3) (result anyref)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $store-trunc (type $func.2) (param $x (ref null $struct))
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $store-trunc2 (type $func.13) (param $x (ref null $array))
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $unneeded_is (type $func.4) (param $struct (ref $struct)) (param $func (ref func)) (param $data dataref) (param $i31 i31ref)
  ;; NOMNL-NEXT:  (drop
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $unneeded_is_null (type $func.5) (param $struct (ref null $struct)) (param $func funcref) (param $data (ref null data)) (param $i31 (ref null i31))
  ;; NOMNL-NEXT:  (drop
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $unneeded_is_bad_kinds (type $func.6) (param $func funcref) (param $data (ref null data)) (param $i31 (ref null i31))
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (block (result i32)
  ;; NOMNL-NEXT:    (drop
  ;; NOMNL-NEXT:     (local.get $data)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $unneeded_as (type $func.4) (param $struct (ref $struct)) (param $func (ref func)) (param $data dataref) (param $i31 i31ref)
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (local.get $struct)
  ;; NOMNL-NEXT:  )
  ;; NOMNL-NEXT:  (drop
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $unneeded_as_null (type $func.5) (param $struct (ref null $struct)) (param $func funcref) (param $data (ref null data)) (param $i31 (ref null i31))
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.as_non_null
  ;; NOMNL-NEXT:    (local.get $struct)
  ;; NOMNL-NEXT:   )
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $unneeded_as_bad_kinds (type $func.6) (param $func funcref) (param $data (ref null data)) (param $i31 (ref null i31))
  ;; NOMNL-NEXT:  (drop
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $unneeded_unreachability (type $func.1)
  ;; NOMNL-NEXT:  (drop
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $redundant-non-null-casts (type $func.14) (param $x (ref null $struct)) (param $y (ref null $array))
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.as_non_null
  ;; NOMNL-NEXT:    (local.get $x)
  ;; NOMNL-NEXT:   )
  ...
  ;; CHECK-NEXT:  (unreachable)
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $get-eqref (type $func.15) (result eqref)
  ;; NOMNL-NEXT:  (unreachable)
  ;; NOMNL-NEXT: )
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-eq (type $func.16) (param $x eqref) (param $y eqref)
  ...
  ;; CHECK-NEXT:  (nop)
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $nothing (type $func.1)
  ;; NOMNL-NEXT:  (nop)
  ;; NOMNL-NEXT: )
  (func $nothing)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-eq-corner-cases (type $func.0) (param $x eqref)
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.eq
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-eq-ref-cast (type $func.0) (param $x eqref)
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.eq
  ;; NOMNL-NEXT:    (local.get $x)
  ;; NOMNL-NEXT:    (ref.cast
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $flip-cast-of-as-non-null (type $func.7) (param $x anyref)
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.as_non_null
  ;; NOMNL-NEXT:    (ref.cast
  ;; NOMNL-NEXT:     (local.get $x)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $flip-tee-of-as-non-null (type $func.7) (param $x anyref)
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.as_non_null
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $flip-tee-of-as-non-null-non-nullable (type $func.17) (param $x (ref any))
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (local.tee $x
  ;; NOMNL-NEXT:    (ref.as_non_null
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ternary-identical-arms (type $func.18) (param $x i32) (param $y (ref null $struct)) (param $z (ref null $struct))
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.is_null
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $select-identical-arms-but-side-effect (type $func.8) (param $x (ref null $struct)) (param $y (ref null $struct)) (param $z i32)
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (select
  ;; NOMNL-NEXT:    (struct.get_u $struct $i8
  ;; NOMNL-NEXT:     (local.get $x)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ternary-identical-arms-no-side-effect (type $func.19) (param $x (ref $struct)) (param $y (ref $struct)) (param $z i32)
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (struct.get_u $struct $i8
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $if-identical-arms-with-side-effect (type $func.8) (param $x (ref null $struct)) (param $y (ref null $struct)) (param $z i32)
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (struct.get_u $struct $i8
  ;; NOMNL-NEXT:    (if (result (ref null $struct))
  ;; NOMNL-NEXT:     (local.get $z)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-cast-squared (type $func.0) (param $x eqref)
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.cast
  ;; NOMNL-NEXT:    (local.get $x)
  ;; NOMNL-NEXT:    (rtt.canon $struct)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-cast-squared-fallthrough (type $func.0) (param $x eqref)
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (local.tee $x
  ;; NOMNL-NEXT:    (ref.cast
  ;; NOMNL-NEXT:     (local.get $x)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-cast-cubed (type $func.0) (param $x eqref)
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.cast
  ;; NOMNL-NEXT:    (local.get $x)
  ;; NOMNL-NEXT:    (rtt.canon $struct)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-cast-squared-different (type $func.0) (param $x eqref)
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.cast
  ;; NOMNL-NEXT:    (ref.cast
  ;; NOMNL-NEXT:     (local.get $x)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-cast-squared-effects (type $func.0) (param $x eqref)
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.cast
  ;; NOMNL-NEXT:    (ref.cast
  ;; NOMNL-NEXT:     (local.get $x)
  ...
  ;; CHECK-NEXT:  (unreachable)
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $get-rtt (type $func.20) (result (rtt $empty))
  ;; NOMNL-NEXT:  (unreachable)
  ;; NOMNL-NEXT: )
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-eq-null (type $func.0) (param $x eqref)
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.is_null
  ;; NOMNL-NEXT:    (local.get $x)
  ;; NOMNL-NEXT:   )
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $hoist-LUB-danger (type $func.21) (param $x i32) (result i32)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $incompatible-cast-of-non-null (type $func.22) (param $struct (ref $struct))
  ;; NOMNL-NEXT:  (drop
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $incompatible-cast-of-null (type $func.1)
  ;; NOMNL-NEXT:  (drop
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $incompatible-cast-of-unknown (type $func.2) (param $struct (ref null $struct))
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.cast
  ;; NOMNL-NEXT:    (local.get $struct)
  ;; NOMNL-NEXT:    (rtt.canon $array)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $incompatible-test (type $func.2) (param $struct (ref null $struct))
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (block (result i32)
  ;; NOMNL-NEXT:    (drop
  ;; NOMNL-NEXT:     (local.get $struct)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $subtype-compatible (type $func.9) (param $A (ref null $A)) (param $B (ref null $B))
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.test
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref.test-unreachable (type $func.23) (param $A (ref null $A))
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.test
  ;; NOMNL-NEXT:    (unreachable)
  ;; NOMNL-NEXT:    (rtt.canon $A)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $consecutive-opts-with-unreachable (type $func.24) (param $func funcref)
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.cast
  ;; NOMNL-NEXT:    (block (result dataref)
  ;; NOMNL-NEXT:     (drop
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-cast-static-null (type $func.1)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-cast-static-impossible (type $func.25) (param $func (ref func))
  ;; NOMNL-NEXT:  (drop
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-cast-static-general (type $func.9) (param $a (ref null $A)) (param $b (ref null $B))
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (local.get $a)
  ;; NOMNL-NEXT:  )
  ;; NOMNL-NEXT:  (drop
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-cast-static-squared (type $func.0) (param $x eqref)
  ;; NOMNL-NEXT:  (drop
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-cast-static-many (type $func.0) (param $x eqref)
  ;; NOMNL-NEXT:  (drop
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-cast-static-very-many (type $func.0) (param $x eqref)
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.cast_static $B-child
  ;; NOMNL-NEXT:    (local.get $x)
  ;; NOMNL-NEXT:   )
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-cast-static-fallthrough-remaining (type $func.0) (param $x eqref)
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (block (result (ref null $B))
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-cast-static-fallthrough-remaining-child (type $func.0) (param $x eqref)
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.cast_static $B
  ;; NOMNL-NEXT:    (block (result eqref)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-cast-static-fallthrough-remaining-impossible (type $func.10) (param $x (ref eq))
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (block (result (ref $array))
  ;; NOMNL-NEXT:    (drop
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-cast-static-fallthrough-remaining-nonnull (type $func.10) (param $x (ref eq))
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.cast_static $A
  ;; NOMNL-NEXT:    (block (result (ref eq))
  ;; NOMNL-NEXT:     (call $ref-cast-static-fallthrough-remaining
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-cast-static-squared-impossible (type $func.0) (param $x eqref)
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.cast_static $struct
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-test-static-same-type (type $func.11) (param $nullable (ref null $A)) (param $non-nullable (ref $A))
  ;; NOMNL-NEXT:  (drop
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-test-static-subtype (type $func.26) (param $nullable (ref null $B)) (param $non-nullable (ref $B))
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (ref.test_static $A
  ;; NOMNL-NEXT:    (local.get $nullable)
  ;; NOMNL-NEXT:   )
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-test-static-supertype (type $func.11) (param $nullable (ref null $A)) (param $non-nullable (ref $A))
  ;; NOMNL-NEXT:  (drop
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NOMNL:      (func $ref-test-static-impossible (type $func.27) (param $nullable (ref null $array)) (param $non-nullable (ref $array))
  ;; NOMNL-NEXT:  (drop
  ;; NOMNL-NEXT:   (block (result i32)
  ;; NOMNL-NEXT:    (drop
  ;; NOMNL-NEXT:     (local.get $nullable)
