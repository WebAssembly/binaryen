...
(module
  ...
  ;; CHECK:      (type $i32_f64_f64_f32_i32_=>_f64 (func (param i32 f64 f64 f32 i32) (result f64)))

  ;; CHECK:      (import "env" "waka" (func $waka))

  ;; CHECK:      (import "env" "waka_int" (func $waka_int (result i32)))

  ;; CHECK:      (import "env" "i64sub" (func $_i64Subtract (param i32 i32 i32 i32) (result i32)))

  ;; CHECK:      (import "env" "moddi" (func $___udivmoddi4 (param i32 i32 i32 i32 i32) (result i32)))

  ;; CHECK:      (import "env" "lp" (func $lp (param i32 i32) (result i32)))

  ;; CHECK:      (import "fuzzing-support" "log-f32" (func $fimport$0 (param f32)))
  ...
  ;; CHECK:      (func $Ia (param $a i32) (result i32)
  ;; CHECK-NEXT:  (local $b i32)
  ...
  ;; CHECK:      (func $memories (param $i2 i32) (param $i3 i32) (param $bi2 i32) (param $bi3 i32) (param $ci3 i32) (param $di3 i32)
  ...
  ;; CHECK:      (func $___remdi3 (param $$a$0 i32) (param $$a$1 i32) (param $$b$0 i32) (param $$b$1 i32) (result i32)
  ...
  ;; CHECK:      (func $multiple (param $s i32) (param $r i32) (param $f i32) (param $p i32) (param $t i32) (param $m i32)
  ;; CHECK-NEXT:  (nop)
  ...
  ;; CHECK:      (func $switch-def (param $i3 i32) (result i32)
  ...
  ;; CHECK:      (func $no-out-of-label (param $x i32) (param $y i32)
  ;; CHECK-NEXT:  (nop)
  ;; CHECK-NEXT:  (local.set $x
  ...
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (block $moar18
  ;; CHECK-NEXT:   (local.set $y
  ;; CHECK-NEXT:    (block $block19 (result i32)
  ;; CHECK-NEXT:     (br_if $moar18
  ;; CHECK-NEXT:      (local.get $y)
  ;; CHECK-NEXT:     )
  ;; CHECK-NEXT:     (i32.const 0)
  ;; CHECK-NEXT:    )
  ...
  ;; CHECK:      (func $freetype-cd (param $a i32) (result i32)
  ...
  ;; CHECK:      (func $drop-if-value (param $x i32) (param $y i32) (param $z i32) (result i32)
  ...
  ;; CHECK:      (func $drop-br_if (param $label i32) (param $$cond2 i32) (param $$$0151 i32) (result i32)
  ;; CHECK-NEXT:  (nop)
  ...
  ;; CHECK:      (func $drop-tee-unreachable
  ;; CHECK-NEXT:  (local $x i32)
  ;; CHECK-NEXT:  (local.tee $x
  ...
  ;; CHECK:      (func $if-return-but-unreachable (param $var$0 i64)
  ;; CHECK-NEXT:  (if
  ;; CHECK-NEXT:   (unreachable)
  ;; CHECK-NEXT:   (drop
  ...
  ;; CHECK:      (func $if-one-side-undo (result i32)
  ;; CHECK-NEXT:  (local $x i32)
  ;; CHECK-NEXT:  (local $y i32)
  ;; CHECK-NEXT:  (local.set $y
  ;; CHECK-NEXT:   (i32.const 0)
  ...
  ;; CHECK:      (func $if-one-side-multi (param $0 i32) (result i32)
  ;; CHECK-NEXT:  (nop)
  ...
  ;; CHECK:      (func $if-one-side-undo-but-its-a-tee (param $0 i32) (result i32)
  ...
  ;; CHECK:      (func $splittable-ifs-multicycle (param $20 i32) (result i32)
  ;; CHECK-NEXT:  (nop)
  ...
  ;; CHECK:      (func $update-getCounter (param $0 i32) (param $1 f64) (param $2 f64) (param $3 f32) (param $4 i32) (result f64)
...
(module
  ...
  ;; CHECK:      (import "fuzzing-support" "log1" (func $fimport$0 (result i32)))
  (import "fuzzing-support" "log1" (func $fimport$0 (result i32)))
  ;; CHECK:      (import "fuzzing-support" "log2" (func $fimport$1 (param i32)))
  (import "fuzzing-support" "log2" (func $fimport$1 (param i32)))
  ;; CHECK:      (import "fuzzing-support" "log3" (func $fimport$2 (param f32)))
  (import "fuzzing-support" "log3" (func $fimport$2 (param f32)))
  ;; CHECK:      (global $global$0 (mut i32) (i32.const 10))
  (global $global$0 (mut i32) (i32.const 10))
  ;; CHECK:      (memory $0 (shared 256 256))

  ;; CHECK:      (func $nonatomics (result i32)
  ;; CHECK-NEXT:  (local $x i32)
  ;; CHECK-NEXT:  (nop)
  ;; CHECK-NEXT:  (drop
  ;; CHECK-NEXT:   (i32.load
  ...
  ;; CHECK:      (func $nonatomic-growmem (result i32)
  ;; CHECK-NEXT:  (local $x i32)
  ;; CHECK-NEXT:  (local.set $x
  ;; CHECK-NEXT:   (i32.load
  ...
  ;; CHECK:      (func $atomic-growmem (result i32)
  ;; CHECK-NEXT:  (local $x i32)
  ;; CHECK-NEXT:  (local.set $x
  ;; CHECK-NEXT:   (i32.load
  ;; CHECK-NEXT:    (memory.grow
  ...
  ;; CHECK:      (func $br-value-reordering (result i32)
  ;; CHECK-NEXT:  (local $temp i32)
  ...
  ;; CHECK:      (func $br-value-reordering-safe (result i32)
  ;; CHECK-NEXT:  (local $temp i32)
  ;; CHECK-NEXT:  (local.set $temp
  ...
  ;; CHECK:      (func $if-one-side-unreachable
  ;; CHECK-NEXT:  (local $x i32)
  ...
  ;; CHECK:      (func $if-one-side-unreachable-blocks
  ;; CHECK-NEXT:  (local $x i32)
  ;; CHECK-NEXT:  (local $y i32)
  ;; CHECK-NEXT:  (block $out
  ;; CHECK-NEXT:   (drop
  ...
  ;; CHECK:      (func $loop-value (param $x i32) (result i32)
  ;; CHECK-NEXT:  (loop $loopy
  ;; CHECK-NEXT:   (unreachable)
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (nop)
  ;; CHECK-NEXT:  (loop $loopy9 (result i32)
  ;; CHECK-NEXT:   (nop)
  ;; CHECK-NEXT:   (i32.const 1)
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ...
  ;; CHECK:      (func $loop-loop-loopy-value (param $x i32) (result i32)
  ;; CHECK-NEXT:  (nop)
  ...
  ;; CHECK:      (func $loop-modified-during-main-pass-be-careful-fuzz (result i32)
  ...
  ;; CHECK:      (func $loop-later (param $var$0 i32) (param $var$1 i32) (param $var$2 i32) (param $var$3 i32) (param $var$4 i32) (result i32)
  ;; CHECK-NEXT:  (nop)
  ;; CHECK-NEXT:  (i32.const 0)
  ;; CHECK-NEXT: )
  ...
  ;; CHECK:      (func $loop-copies (param $x i32) (param $y i32)
  ;; CHECK-NEXT:  (loop $loop
  ;; CHECK-NEXT:   (nop)
  ;; CHECK-NEXT:   (drop
  ;; CHECK-NEXT:    (local.get $y)
  ...
  ;; CHECK:      (func $set-tee-need-one-of-them (param $var$0 i32) (param $var$1 i32) (result i32)
  ;; CHECK-NEXT:  (local $var$2 i32)
  ...
  ;; CHECK:      (func $loop-value-harder (result i32)
  ;; CHECK-NEXT:  (local $0 i32)
  ;; CHECK-NEXT:  (local $1 i32)
  ;; CHECK-NEXT:  (local $2 i32)
  ...
  ;; CHECK:      (func $tee-chain (param $x i32) (param $z i32) (param $t1 i32) (param $t2 i32) (param $t3 i32) (result i32)
  ;; CHECK-NEXT:  (nop)
  ;; CHECK-NEXT:  (drop
  ;; CHECK-NEXT:   (i32.const 10)
  ;; CHECK-NEXT:  )
...
(module
 ...
 ;; CHECK:      (data "hello, there!")
 (data "hello, there!")
 ;; CHECK:      (func $memory-init-load
 ;; CHECK-NEXT:  (local $x i32)
 ;; CHECK-NEXT:  (local.set $x
 ;; CHECK-NEXT:   (i32.load
 ;; CHECK-NEXT:    (i32.const 0)
 ...
 ;; CHECK:      (func $data-drop-memory-init
 ;; CHECK-NEXT:  (local $x i32)
 ;; CHECK-NEXT:  (local.set $x
 ;; CHECK-NEXT:   (block $block (result i32)
 ;; CHECK-NEXT:    (memory.init 0
...
;; CHECK:      (type $eqref_ref?|i31|_=>_i32 (func (param eqref (ref null i31)) (result i32)))

;; CHECK:      (export "test" (func $0))

;; CHECK:      (func $0 (param $0 eqref) (param $1 (ref null i31)) (result i32)
;; CHECK-NEXT:  (local $2 eqref)
;; CHECK-NEXT:  (local $3 (ref null i31))
