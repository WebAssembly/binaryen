...
;; RUN: foreach %s %t wasm-opt --NOMNL --type-ssa -all -S -o - | filecheck %s --check-prefix NOMNL

;; Test in both isorecursive and NOMNL modes to make sure we create the new
