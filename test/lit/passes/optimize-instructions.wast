...
(module
  ...
  ;; CHECK:      (func $optimize-compaund-relationals (param $x i32) (param $y i32) (param $a i64) (param $b i64)
  ;; CHECK-NEXT:  (drop
  ;; CHECK-NEXT:   (i32.eqz
  ;; CHECK-NEXT:    (i32.or
  ;; CHECK-NEXT:     (local.get $x)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  (func $optimize-compaund-relationals (param $x i32) (param $y i32) (param $a i64) (param $b i64)
