...
(module
  ...
  ;; CHECK:      (type $i32_i64_f32_f64_=>_none (func (param i32 i64 f32 f64)))
  ...
  ;; CHECK:      (type $i32_i64_f32_=>_none (func (param i32 i64 f32)))
  ;; CHECK:      (type $f32_f32_i32_=>_none (func (param f32 f32 i32)))
  ...
  ;; CHECK:      (type $i32_i64_f64_i32_=>_none (func (param i32 i64 f64 i32)))
  ;; CHECK:      (type $none_=>_f64 (func (result f64)))
  ;; CHECK:      (type $f32_f64_=>_none (func (param f32 f64)))
  ;; CHECK:      (type $f64_f32_=>_none (func (param f64 f32)))
  ;; CHECK:      (type $i32_i32_i32_f64_=>_none (func (param i32 i32 i32 f64)))
  ;; CHECK:      (type $f64_f64_f32_f32_=>_none (func (param f64 f64 f32 f32)))
  ;; CHECK:      (type $f64_f64_i32_=>_none (func (param f64 f64 i32)))
  ;; CHECK:      (memory $0 0)
