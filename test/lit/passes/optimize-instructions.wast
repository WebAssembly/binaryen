...
(module
 ...
 ;; CHECK:  (drop
 ;; CHECK:   (i32.lt_u
 ;; CHECK:    (i32.const 2000)
 ;; CHECK:    (i32.const 3000)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK: )
  (func $and-pos1
 ...
 ;; CHECK:  (drop
 ;; CHECK:   (i32.and
 ;; CHECK:    (block $block4 (result i32)
 ;; CHECK:     (i32.const 5)
 ;; CHECK:    )
 ;; CHECK:    (loop $loop-in (result i32)
 ;; CHECK:     (i32.const 6)
 ;; CHECK:    )
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (i32.and
 ;; CHECK:    (block $block6 (result i32)
 ;; CHECK:     (i32.const 8)
 ;; CHECK:    )
 ;; CHECK:    (loop $loop-in5 (result i32)
 ;; CHECK:     (i32.const 7)
 ;; CHECK:    )
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (i32.and
 ;; CHECK:    (block $block8 (result i32)
 ;; CHECK:     (i32.const 10)
 ;; CHECK:    )
 ;; CHECK:    (loop $loop-in7 (result i32)
 ;; CHECK:     (call $and-pos1)
 ;; CHECK:     (i32.const 9)
 ;; CHECK:    )
 ;; CHECK:   )
 ...
 ;; CHECK:  (drop
 ;; CHECK:   (i32.and
 ;; CHECK:    (block $block10 (result i32)
 ;; CHECK:     (call $and-pos1)
 ;; CHECK:     (i32.const 12)
 ;; CHECK:    )
 ;; CHECK:    (loop $loop-in9 (result i32)
 ;; CHECK:     (i32.const 11)
 ;; CHECK:    )
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (i32.and
 ;; CHECK:    (loop $loop-in11 (result i32)
 ;; CHECK:     (call $and-pos1)
 ;; CHECK:     (i32.const 13)
 ;; CHECK:    )
 ;; CHECK:    (block $block12 (result i32)
 ;; CHECK:     (call $and-pos1)
 ;; CHECK:     (i32.const 14)
 ;; CHECK:    )
 ;; CHECK:   )
 ...
 ;; CHECK:  (drop
 ;; CHECK:   (i32.and
 ;; CHECK:    (block $block13 (result i32)
 ;; CHECK:     (call $and-pos1)
 ;; CHECK:     (i32.const 14)
 ;; CHECK:    )
 ;; CHECK:    (loop $loop-in14 (result i32)
 ;; CHECK:     (call $and-pos1)
 ;; CHECK:     (i32.const 13)
 ;; CHECK:    )
 ;; CHECK:   )
 ...
 ;; CHECK:  (drop
 ;; CHECK:   (i32.and
 ;; CHECK:    (block $block15 (result i32)
 ;; CHECK:     (i32.const 15)
 ;; CHECK:    )
 ;; CHECK:    (local.get $x)
 ;; CHECK:   )
 ...
 ;; CHECK:  (drop
 ;; CHECK:   (i32.and
 ;; CHECK:    (block $block16 (result i32)
 ;; CHECK:     (i32.const 15)
 ;; CHECK:    )
 ;; CHECK:    (local.get $x)
 ;; CHECK:   )
 ...
 ;; CHECK:   (f64.ge
 ;; CHECK:    (local.get $fx)
 ;; CHECK:    (f64.const nan:0x8000000000000)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (f64.ge
 ...
 ;; CHECK:  (local $$0 i32)
 ;; CHECK:  (local $$conv i32)
 ;; CHECK:  (local.set $$0
 ;; CHECK:   (i32.load8_s
 ;; CHECK:    (i32.const 1024)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (local.set $$conv
 ;; CHECK:   (i32.and
 ;; CHECK:    (local.get $$0)
 ;; CHECK:    (i32.const 255)
 ;; CHECK:   )
 ...
 ;; CHECK:  (drop
 ;; CHECK:   (i32.eq
 ;; CHECK:    (i32.load16_s align=1
 ;; CHECK:     (i32.const 790656516)
 ;; CHECK:    )
 ;; CHECK:    (i32.const -5431187)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (i32.eq
 ...
 ;; CHECK:  (return
 ;; CHECK:   (i64.eq
 ;; CHECK:    (i64.load16_s align=1
 ;; CHECK:     (i32.const 790656516)
 ;; CHECK:    )
 ;; CHECK:    (i64.const -1337)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK: )
 ...
 ;; CHECK:   (i32.shr_u
 ;; CHECK:    (unreachable)
 ;; CHECK:    (i32.const 1031)
 ;; CHECK:   )
 ;; CHECK:   (i32.const 4098)
 ;; CHECK:  )
 ;; CHECK: )
 ...
 ;; CHECK:  (i32.sub
 ;; CHECK:   (i32.shl
 ;; CHECK:    (i32.const -536870912)
 ;; CHECK:    (i32.wrap_i64
 ;; CHECK:     (i64.const 0)
 ;; CHECK:    )
 ;; CHECK:   )
 ;; CHECK:   (i32.const 31744)
 ;; CHECK:  )
 ;; CHECK: )
 ...
 ;; CHECK:   (f32.mul
 ;; CHECK:    (local.get $x)
 ;; CHECK:    (f32.const 2.3283064365386963e-10)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (f32.mul
 ;; CHECK:    (local.get $x)
 ;; CHECK:    (f32.const 5.421010862427522e-20)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (f32.mul
 ;; CHECK:    (local.get $x)
 ;; CHECK:    (f32.const 8507059173023461586584365e13)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (f32.mul
 ;; CHECK:    (local.get $x)
 ;; CHECK:    (f32.const 1.1754943508222875e-38)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (f32.mul
 ...
 ;; CHECK:   (f32.div
 ;; CHECK:    (local.get $x)
 ;; CHECK:    (f32.const 5.877471754111438e-39)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (f32.div
 ...
 ;; CHECK:   (f64.mul
 ;; CHECK:    (local.get $x)
 ;; CHECK:    (f64.const 2.3283064365386963e-10)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (f64.mul
 ;; CHECK:    (local.get $x)
 ;; CHECK:    (f64.const 5.421010862427522e-20)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (f64.mul
 ;; CHECK:    (local.get $x)
 ;; CHECK:    (f64.const 4494232837155789769323262e283)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (f64.mul
 ;; CHECK:    (local.get $x)
 ;; CHECK:    (f64.const 2.2250738585072014e-308)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (f64.mul
 ...
 ;; CHECK:   (f64.div
 ;; CHECK:    (local.get $x)
 ;; CHECK:    (f64.const 1.1125369292536007e-308)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (f64.div
 ;; CHECK:    (local.get $x)
 ;; CHECK:    (f64.const 8988465674311579538646525e283)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (f64.div
 ...
 ;; CHECK:   (i32.rem_s
 ;; CHECK:    (local.get $x)
 ;; CHECK:    (i32.const -2147483648)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (i64.rem_s
 ;; CHECK:    (local.get $y)
 ;; CHECK:    (i64.const -9223372036854775808)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK: )
 ...
 ;; CHECK:    (i64.and
 ;; CHECK:     (local.get $y)
 ;; CHECK:     (i64.const 9223372036854775807)
 ;; CHECK:    )
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ...
 ;; CHECK:   (f32.div
 ;; CHECK:    (local.get $y32)
 ;; CHECK:    (f32.const 1.2000000476837158)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (i32.sub
 ...
 ;; CHECK:   (i32.sub
 ;; CHECK:    (local.get $x)
 ;; CHECK:    (i32.const -8192)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (i32.sub
 ;; CHECK:    (local.get $x)
 ;; CHECK:    (i32.const -1048576)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (i32.sub
 ;; CHECK:    (local.get $x)
 ;; CHECK:    (i32.const -134217728)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (i64.sub
 ...
 ;; CHECK:   (i64.sub
 ;; CHECK:    (local.get $y)
 ;; CHECK:    (i64.const -8192)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (i64.sub
 ;; CHECK:    (local.get $y)
 ;; CHECK:    (i64.const -1048576)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (i64.sub
 ;; CHECK:    (local.get $y)
 ;; CHECK:    (i64.const -134217728)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (i64.sub
 ;; CHECK:    (local.get $y)
 ;; CHECK:    (i64.const -17179869184)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (i64.sub
 ;; CHECK:    (local.get $y)
 ;; CHECK:    (i64.const -2199023255552)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (i64.sub
 ;; CHECK:    (local.get $y)
 ;; CHECK:    (i64.const -281474976710656)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (i64.sub
 ;; CHECK:    (local.get $y)
 ;; CHECK:    (i64.const -36028797018963968)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (i64.sub
 ;; CHECK:    (local.get $y)
 ;; CHECK:    (i64.const -4611686018427387904)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
 ;; CHECK:   (f32.add
 ...
 ;; CHECK:  (local $var$0 i32)
 ;; CHECK:  (block $label$1 (result f64)
 ;; CHECK:   (local.tee $var$0
 ;; CHECK:    (br_if $label$1
 ;; CHECK:     (f64.const 1)
 ;; CHECK:     (unreachable)
 ;; CHECK:    )
 ...
 ;; CHECK:    (i32.sub
 ;; CHECK:     (i32.const 0)
 ;; CHECK:     (local.get $temp)
 ;; CHECK:    )
 ;; CHECK:    (local.tee $temp
 ;; CHECK:     (i32.const 1)
 ;; CHECK:    )
 ;; CHECK:   )
 ;; CHECK:   (i32.const 2)
 ...
 ;; CHECK:    (i32.sub
 ;; CHECK:     (local.get $x)
 ;; CHECK:     (block $block29 (result i32)
 ;; CHECK:      (i32.const -2147483648)
 ;; CHECK:     )
 ;; CHECK:    )
 ;; CHECK:    (i32.const 0)
 ...
 ;; CHECK:  (drop
 ;; CHECK:   (f64.mul
 ;; CHECK:    (call $tee-with-unreachable-value)
 ;; CHECK:    (f64.const 2)
 ;; CHECK:   )
 ;; CHECK:  )
 ;; CHECK:  (drop
