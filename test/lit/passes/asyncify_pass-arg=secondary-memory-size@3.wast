...
;; RUN: foreach %s %t wasm-opt --enable-multi-memories --asyncify --pass-arg=in-secondary-memory --pass-arg=secondary-memory-size@3 -S -o - | filecheck %s
...
(module
  ...
  ;; CHECK:      (memory $asyncify_memory 3 3)
