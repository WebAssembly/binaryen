...
(module
 ...
 (export "func_294_invoker" (func $3))

 (func $2 (type $0) (result externref)
  (string.const "")
 )
 (func $3
  (call $9
 ...
 (func $5 (type $0) (result externref)
  (extern.convert_any
   (ref.i31
    (i32.const 0)
   )
 ...
 (func $9 (param $0 (ref $0))
  ;; This reference suggests that $0 may contain either $2 (from the call
  ;; above) or $5, which means the return can be a string or an externalized
  ;; i31. The cast may succeed, or it may fail. We should not be confused by
  ;; the combination of PossibleContents(string) and PossibleContents(ext i31) -
  ;; that combination is "anything", not "nothing".
  (drop
   (ref.func $5)
  )
  (drop
