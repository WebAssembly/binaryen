...
;; RUN: foreach %s %t wasm-opt --optimize-added-constants-propagate --low-memory-unused -S -o - | filecheck %s
...
(module
  ...
  ;; CHECK:      (func $offset-propagate7 (param $z i32)
  ;; CHECK-NEXT:  (local $x i32)
  ;; CHECK-NEXT:  (local $y i32)
  ;; CHECK-NEXT:  (local.set $y
  ;; CHECK-NEXT:   (local.get $z)
  ...
  ;; CHECK:      (func $multiadd (param $sp i32)
  ;; CHECK-NEXT:  (local $$vararg_buffer i32)
  ;; CHECK-NEXT:  (local $$vararg_ptr1 i32)
  ;; CHECK-NEXT:  (nop)
  ;; CHECK-NEXT:  (nop)
  ;; CHECK-NEXT:  (i32.store offset=20
  ;; CHECK-NEXT:   (local.get $sp)
  ;; CHECK-NEXT:   (i32.const 1)
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ...
  ;; CHECK:      (func $multiadd-extraUse (param $sp i32)
  ;; CHECK-NEXT:  (local $$vararg_buffer i32)
  ;; CHECK-NEXT:  (local $$vararg_ptr1 i32)
  ;; CHECK-NEXT:  (local.set $$vararg_buffer
  ;; CHECK-NEXT:   (i32.add
  ;; CHECK-NEXT:    (local.get $sp)
  ...
  ;; CHECK-NEXT:  (nop)
  ;; CHECK-NEXT:  (drop
  ;; CHECK-NEXT:   (local.get $$vararg_buffer)
  ;; CHECK-NEXT:  )
