...
(module
  ...
  ;; CHECK:      (type $f32_i32_f32_i32_i32_f64_f32_=>_i32 (func (param f32 i32 f32 i32 i32 f64 f32) (result i32)))
  ...
  ;; CHECK:      (type $i32_f64_i32_f64_f32_f32_=>_i32 (func (param i32 f64 i32 f64 f32 f32) (result i32)))
  ...
  ;; CHECK-NEXT:  (if (result i32 i64)
  ;; CHECK-NEXT:   (i32.const 1)
  ;; CHECK-NEXT:   (block $topmost (result i32 i64)
  ;; CHECK-NEXT:    (block $block1 (result i32 i64)
  ...
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:   (block $block3 (result i32 i64)
  ;; CHECK-NEXT:    (tuple.make
  ;; CHECK-NEXT:     (i32.const 27)
  ...
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:   (if
  ;; CHECK-NEXT:    (block $a17 (result i32)
  ;; CHECK-NEXT:     (i32.const 0)
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:    (block $a18
  ...
  ;; CHECK-NEXT:     )
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:    (block $a20
  ;; CHECK-NEXT:     (block $block21
  ;; CHECK-NEXT:      (drop
  ;; CHECK-NEXT:       (i32.const 2)
  ;; CHECK-NEXT:      )
  ;; CHECK-NEXT:     )
  ...
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (block $do-once$022
  ;; CHECK-NEXT:   (if
  ;; CHECK-NEXT:    (call $b13)
  ;; CHECK-NEXT:    (block $block24
  ;; CHECK-NEXT:     (drop
  ;; CHECK-NEXT:      (call $b14)
  ;; CHECK-NEXT:     )
  ;; CHECK-NEXT:     (br $do-once$022)
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:   (drop
  ;; CHECK-NEXT:    (i32.const 1)
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (block $do-once$025
  ;; CHECK-NEXT:   (if
  ;; CHECK-NEXT:    (i32.const 0)
  ;; CHECK-NEXT:    (block $block27
  ;; CHECK-NEXT:     (drop
  ;; CHECK-NEXT:      (call $b14)
  ;; CHECK-NEXT:     )
  ;; CHECK-NEXT:     (br $do-once$025)
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:   (drop
  ;; CHECK-NEXT:    (i32.const 1)
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (block $do-once$028 (result i32)
  ;; CHECK-NEXT:   (if
  ;; CHECK-NEXT:    (local.tee $x
  ;; CHECK-NEXT:     (i32.const 1)
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:    (br $do-once$028
  ;; CHECK-NEXT:     (local.tee $x
  ;; CHECK-NEXT:      (i32.const 2)
  ;; CHECK-NEXT:     )
  ;; CHECK-NEXT:    )
  ...
  ;; CHECK-NEXT:   (block $out31
  ;; CHECK-NEXT:    (br_if $out31
  ;; CHECK-NEXT:     (i32.const 0)
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (loop $in33
  ;; CHECK-NEXT:   (block $out34
  ;; CHECK-NEXT:    (br_if $out34
  ;; CHECK-NEXT:     (i32.const 0)
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (loop $in36
  ;; CHECK-NEXT:   (nop)
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (loop $in37
  ;; CHECK-NEXT:   (block $out38
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (loop $in39
  ;; CHECK-NEXT:   (if
  ;; CHECK-NEXT:    (i32.eqz
  ;; CHECK-NEXT:     (i32.const 0)
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:    (block $out40
  ;; CHECK-NEXT:     (nop)
  ;; CHECK-NEXT:     (br_if $in39
  ;; CHECK-NEXT:      (i32.const 1)
  ;; CHECK-NEXT:     )
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (loop $in42
  ;; CHECK-NEXT:   (block $out43
  ;; CHECK-NEXT:    (br_if $in42
  ;; CHECK-NEXT:     (i32.const 0)
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (loop $in45
  ;; CHECK-NEXT:   (if
  ;; CHECK-NEXT:    (i32.const 0)
  ;; CHECK-NEXT:    (block $out46
  ;; CHECK-NEXT:     (unreachable)
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:    (br $in45)
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (loop $in48
  ;; CHECK-NEXT:   (if
  ;; CHECK-NEXT:    (i32.const 0)
  ;; CHECK-NEXT:    (block $out49
  ;; CHECK-NEXT:     (block $block
  ...
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (loop $in52
  ;; CHECK-NEXT:   (if
  ;; CHECK-NEXT:    (i32.const 0)
  ;; CHECK-NEXT:    (block $out53
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:    (block
  ;; CHECK-NEXT:     (call $loops)
  ;; CHECK-NEXT:     (br $in52)
  ...
  ;; CHECK-NEXT:     (br $in55)
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:    (block $out56
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (loop $in58
  ;; CHECK-NEXT:   (if
  ;; CHECK-NEXT:    (i32.const 0)
  ;; CHECK-NEXT:    (block
  ;; CHECK-NEXT:     (block $block61
  ;; CHECK-NEXT:      (drop
  ;; CHECK-NEXT:       (i32.const 1)
  ;; CHECK-NEXT:      )
  ;; CHECK-NEXT:      (call $loops)
  ...
  ;; CHECK-NEXT:     (br $in58)
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:    (block $out59
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (loop $in62
  ;; CHECK-NEXT:   (if
  ;; CHECK-NEXT:    (i32.const 0)
  ;; CHECK-NEXT:    (block $out63
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:    (block
  ;; CHECK-NEXT:     (call $loops)
  ;; CHECK-NEXT:     (drop
  ...
  ;; CHECK-NEXT:     (br $in65)
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:    (block $out66
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (loop $in68
  ;; CHECK-NEXT:   (if
  ;; CHECK-NEXT:    (i32.const 0)
  ;; CHECK-NEXT:    (block
  ;; CHECK-NEXT:     (block $block71
  ;; CHECK-NEXT:      (drop
  ;; CHECK-NEXT:       (i32.const 1)
  ;; CHECK-NEXT:      )
  ;; CHECK-NEXT:      (call $loops)
  ...
  ;; CHECK-NEXT:     (br $in68)
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:    (block $out69
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (loop $in72
  ;; CHECK-NEXT:   (if
  ;; CHECK-NEXT:    (i32.eqz
  ;; CHECK-NEXT:     (i32.const 0)
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:    (block $out73
  ;; CHECK-NEXT:     (nop)
  ;; CHECK-NEXT:     (call $loops)
  ;; CHECK-NEXT:     (return)
  ;; CHECK-NEXT:     (br $in72)
  ...
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (loop $in75
  ;; CHECK-NEXT:   (block $out76
  ;; CHECK-NEXT:    (br_if $out76
  ;; CHECK-NEXT:     (i32.const 0)
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:    (call $loops)
  ;; CHECK-NEXT:    (br $out76)
  ...
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (loop $in78
  ;; CHECK-NEXT:   (if
  ;; CHECK-NEXT:    (i32.const 0)
  ;; CHECK-NEXT:    (block $out79
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:    (block
  ;; CHECK-NEXT:     (call $loops)
  ;; CHECK-NEXT:     (drop
  ...
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (loop $in81
  ;; CHECK-NEXT:   (block $out82
  ;; CHECK-NEXT:    (br_if $in81
  ;; CHECK-NEXT:     (i32.eqz
  ;; CHECK-NEXT:      (i32.const 0)
  ;; CHECK-NEXT:     )
  ;; CHECK-NEXT:    )
  ...
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (loop $in83
  ;; CHECK-NEXT:   (block $out84
  ;; CHECK-NEXT:    (br $out84)
  ;; CHECK-NEXT:    (br $in83)
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (loop $in85
  ;; CHECK-NEXT:   (block $out86
  ;; CHECK-NEXT:    (drop
  ;; CHECK-NEXT:     (i32.const 0)
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:    (br $in85)
  ...
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (loop $in-todo287
  ;; CHECK-NEXT:   (if
  ;; CHECK-NEXT:    (i32.const 0)
  ;; CHECK-NEXT:    (block $out-todo288
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:    (block
  ;; CHECK-NEXT:     (call $loops)
  ;; CHECK-NEXT:     (drop
  ...
  ;; CHECK-NEXT:     (i32.const 607395945)
  ;; CHECK-NEXT:    )
  ;; CHECK-NEXT:    (br_if $label$1
  ...
  ;; CHECK-NEXT:          )
  ;; CHECK-NEXT:         )
  ;; CHECK-NEXT:         (i32.const 1764950569)
  ;; CHECK-NEXT:        )
