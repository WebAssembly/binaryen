...
(module
  ...
  ;; CHECK:      (func $propagate (type $func.1)
  ...
  ;; CHECK:      (func $non-constant (type $func.0) (param $param i32)
  ...
  ;; CHECK:      (func $unreachable (type $func.1)
  ;; CHECK-NEXT:  (local $ref-imm (ref null $struct-imm))
  ...
  ;; CHECK:      (func $param (type $func.2) (param $ref-imm (ref null $struct-imm))
  ;; CHECK-NEXT:  (call $helper
  ;; CHECK-NEXT:   (struct.get $struct-imm 0
  ;; CHECK-NEXT:    (local.get $ref-imm)
  ;; CHECK-NEXT:   )
  ...
  ;; CHECK:      (func $local-null (type $func.1)
  ;; CHECK-NEXT:  (local $ref-imm (ref null $struct-imm))
  ;; CHECK-NEXT:  (call $helper
  ;; CHECK-NEXT:   (struct.get $struct-imm 0
  ...
  ;; CHECK:      (func $local-unknown (type $func.0) (param $x i32)
  ;; CHECK-NEXT:  (local $ref-imm (ref null $struct-imm))
  ;; CHECK-NEXT:  (if
  ...
  ;; CHECK:      (func $local-unknown-ref-same-value (type $func.0) (param $x i32)
  ;; CHECK-NEXT:  (local $ref-imm (ref null $struct-imm))
  ;; CHECK-NEXT:  (if
  ;; CHECK-NEXT:   (local.get $x)
  ;; CHECK-NEXT:   (local.set $ref-imm
  ...
  ;; CHECK:      (func $propagate-multi-refs (type $func.0) (param $x i32)
  ;; CHECK-NEXT:  (local $ref-imm (ref null $struct-imm))
  ;; CHECK-NEXT:  (if
  ;; CHECK-NEXT:   (local.get $x)
  ...
  ;; CHECK:      (func $propagate-multi-values (type $func.0) (param $x i32)
  ;; CHECK-NEXT:  (local $ref-imm (ref null $struct-imm))
  ;; CHECK-NEXT:  (local.set $ref-imm
  ;; CHECK-NEXT:   (struct.new $struct-imm
  ;; CHECK-NEXT:    (i32.const 1)
  ...
  ;; CHECK:      (func $helper (type $func.0) (param $0 i32)
  ;; CHECK-NEXT:  (nop)
  ;; CHECK-NEXT: )
...
(module
  ...
  ;; former.
  ;; CHECK:      (type $struct (struct_subtype (field (mut i32) i32) data))
  (type $struct (struct_subtype (mut i32) i32 data))

  ;; CHECK:      (func $propagate (type $func.0)
  ...
  ;; CHECK:      (func $helper (type $func.1) (param $0 i32)
  ;; CHECK-NEXT:  (nop)
  ;; CHECK-NEXT: )
  (func $helper (param i32))
)
...
(module
  ...
  ;; CHECK:      (func $nested-creations (type $func.0)
  ...
  ;; CHECK:      (func $helper (type $func.1) (param $0 funcref)
  ;; CHECK-NEXT:  (nop)
  ;; CHECK-NEXT: )
...
(module
  ...
  ;; CHECK:      (func $nested-creations (type $func.0) (param $param i32)
  ;; CHECK-NEXT:  (local $ref (ref null $object))
  ;; CHECK-NEXT:  (local.set $ref
  ;; CHECK-NEXT:   (struct.new $object
  ;; CHECK-NEXT:    (global.get $vtable)
