...
(module
  ...
  ;; CHECK-NEXT:    (i32.load8_s $0 offset=1
  ;; CHECK-NEXT:     (call $load_ptr
  ;; CHECK-NEXT:      (i32.const 15)
  ;; CHECK-NEXT:      (i32.const 1)
  ...
  ;; CHECK-NEXT:    (i32.load16_s $0 offset=3 align=1
  ;; CHECK-NEXT:     (call $load_ptr
  ;; CHECK-NEXT:      (i32.const 17)
  ;; CHECK-NEXT:      (i32.const 2)
  ...
  ;; CHECK-NEXT:    (i32.load16_u $0 offset=4 align=1
  ;; CHECK-NEXT:     (call $load_ptr
  ;; CHECK-NEXT:      (i32.const 18)
  ;; CHECK-NEXT:      (i32.const 2)
  ...
  ;; CHECK-NEXT:    (i32.load $0 offset=5 align=2
  ;; CHECK-NEXT:     (call $load_ptr
  ;; CHECK-NEXT:      (i32.const 19)
  ;; CHECK-NEXT:      (i32.const 4)
  ...
  ;; CHECK-NEXT:    (i64.load8_s $0 offset=6
  ;; CHECK-NEXT:     (call $load_ptr
  ;; CHECK-NEXT:      (i32.const 20)
  ;; CHECK-NEXT:      (i32.const 1)
  ...
  ;; CHECK-NEXT:    (i64.load8_u $0 offset=7
  ;; CHECK-NEXT:     (call $load_ptr
  ;; CHECK-NEXT:      (i32.const 21)
  ;; CHECK-NEXT:      (i32.const 1)
  ...
  ;; CHECK-NEXT:    (i64.load16_s $0 offset=8 align=1
  ;; CHECK-NEXT:     (call $load_ptr
  ;; CHECK-NEXT:      (i32.const 22)
  ;; CHECK-NEXT:      (i32.const 2)
  ...
  ;; CHECK-NEXT:    (i64.load16_u $0 offset=9 align=1
  ;; CHECK-NEXT:     (call $load_ptr
  ;; CHECK-NEXT:      (i32.const 23)
  ;; CHECK-NEXT:      (i32.const 2)
  ...
  ;; CHECK-NEXT:    (i64.load32_s $0 offset=10 align=2
  ;; CHECK-NEXT:     (call $load_ptr
  ;; CHECK-NEXT:      (i32.const 24)
  ;; CHECK-NEXT:      (i32.const 4)
  ...
  ;; CHECK-NEXT:    (i64.load32_u $0 offset=11 align=2
  ;; CHECK-NEXT:     (call $load_ptr
  ;; CHECK-NEXT:      (i32.const 25)
  ;; CHECK-NEXT:      (i32.const 4)
  ...
  ;; CHECK-NEXT:    (i64.load $0 offset=12 align=2
  ;; CHECK-NEXT:     (call $load_ptr
  ;; CHECK-NEXT:      (i32.const 26)
  ;; CHECK-NEXT:      (i32.const 8)
  ...
  ;; CHECK-NEXT:    (f32.load $0 offset=13 align=2
  ;; CHECK-NEXT:     (call $load_ptr
  ;; CHECK-NEXT:      (i32.const 27)
  ;; CHECK-NEXT:      (i32.const 4)
  ...
  ;; CHECK-NEXT:    (f64.load $0 offset=14 align=2
  ;; CHECK-NEXT:     (call $load_ptr
  ;; CHECK-NEXT:      (i32.const 28)
  ;; CHECK-NEXT:      (i32.const 8)
  ...
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (i32.store16 $0 offset=2 align=1
  ;; CHECK-NEXT:   (call $store_ptr
  ...
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (i32.store $0 offset=3 align=2
  ;; CHECK-NEXT:   (call $store_ptr
  ...
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (i64.store8 $0 offset=4
  ;; CHECK-NEXT:   (call $store_ptr
  ...
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (i64.store16 $0 offset=5
  ;; CHECK-NEXT:   (call $store_ptr
  ...
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (i64.store32 $0 offset=6 align=2
  ;; CHECK-NEXT:   (call $store_ptr
  ...
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (i64.store $0 offset=7 align=2
  ;; CHECK-NEXT:   (call $store_ptr
  ...
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (f32.store $0 offset=8 align=2
  ;; CHECK-NEXT:   (call $store_ptr
  ...
  ;; CHECK-NEXT:   )
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT:  (f64.store $0 offset=9 align=2
  ;; CHECK-NEXT:   (call $store_ptr
