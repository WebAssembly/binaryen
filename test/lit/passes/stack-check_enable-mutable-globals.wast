...
(module
 ...
 ;; CHECK:      (global $__stack_base_0 (mut i32) (i32.const 0))

 ;; CHECK:      (global $__stack_limit_0 (mut i32) (i32.const 0))
...
;; CHECK:      (func $__set_stack_limits (param $0 i32) (param $1 i32)
;; CHECK-NEXT:  (global.set $__stack_base_0
;; CHECK-NEXT:   (local.get $0)
;; CHECK-NEXT:  )
;; CHECK-NEXT:  (global.set $__stack_limit_0
;; CHECK-NEXT:   (local.get $1)
;; CHECK-NEXT:  )
;; CHECK-NEXT: )
