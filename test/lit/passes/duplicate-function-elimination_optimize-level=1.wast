...
;; RUN: foreach %s %t wasm-opt --duplicate-function-elimination --optimize-level=1 -S -o - | filecheck %s
...
(module
  ...
  ;; CHECK:      (elem (i32.const 0) $keep2 $keep2 $caller)
...
(module
  ...
  ;; CHECK:      (elem (i32.const 0) $erase $erase)
...
(module
  ...
  ;; CHECK:      (elem (i32.const 0) $keep2 $other)
...
(module
  ...
  ;; CHECK:      (elem (i32.const 0) $keep2 $keep2)

  ;; CHECK:      (func $keep2
  ;; CHECK-NEXT:  (call_indirect (type $S)
  ;; CHECK-NEXT:   (i32.const 0)
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  (func $keep2 (type $T)
