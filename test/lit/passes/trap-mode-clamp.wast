...
;; RUN: foreach %s %t wasm-opt --trap-mode-clamp -S -o - | filecheck %s
...
(module
 ...
 ;; CHECK:      (type $3 (func (param f32) (result i32)))

 ;; CHECK:      (type $4 (func (param f32) (result i64)))

 ;; CHECK:      (type $5 (func (param f64) (result i32)))

 ;; CHECK:      (type $6 (func (param f64) (result i64)))

 ;; CHECK:      (type $7 (func (param f32)))

 ;; CHECK:      (type $8 (func (param f64)))
 ...
 ;; CHECK-NEXT:  (drop
 ;; CHECK-NEXT:   (call $f32-to-int
 ;; CHECK-NEXT:    (local.get $0)
 ;; CHECK-NEXT:   )
 ;; CHECK-NEXT:  )
 ;; CHECK-NEXT:  (drop
 ;; CHECK-NEXT:   (call $f32-to-uint
 ;; CHECK-NEXT:    (local.get $0)
 ;; CHECK-NEXT:   )
 ;; CHECK-NEXT:  )
 ;; CHECK-NEXT:  (drop
...
;; CHECK:      (func $f32-to-int (param $0 f32) (result i32)
...
;; CHECK:      (func $f32-to-uint (param $0 f32) (result i32)
;; CHECK-NEXT:  (if (result i32)
;; CHECK-NEXT:   (f32.ne
;; CHECK-NEXT:    (local.get $0)
;; CHECK-NEXT:    (local.get $0)
...
;; CHECK:      (func $f64-to-int (param $0 f64) (result i32)
;; CHECK-NEXT:  (if (result i32)
;; CHECK-NEXT:   (f64.ne
;; CHECK-NEXT:    (local.get $0)
;; CHECK-NEXT:    (local.get $0)
...
;; CHECK:      (func $f64-to-uint (param $0 f64) (result i32)
;; CHECK-NEXT:  (if (result i32)
;; CHECK-NEXT:   (f64.ne
;; CHECK-NEXT:    (local.get $0)
;; CHECK-NEXT:    (local.get $0)
