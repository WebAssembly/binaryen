...
(module
  ...
  ;; CHECK:      (func $Gu (param $b i32) (param $e f64) (param $l i32) (param $d i32)
  ;; CHECK-NEXT:  (if
  ...
  ;; CHECK:      (func $relooperJumpThreading1
  ...
  ;; CHECK:      (func $relooperJumpThreading2
  ;; CHECK-NEXT:  (nop)
  ;; CHECK-NEXT: )
  ...
  ;; CHECK:      (func $relooperJumpThreading3
  ;; CHECK-NEXT:  (nop)
  ;; CHECK-NEXT: )
  ...
  ;; CHECK:      (func $if2drops (result i32)
  ;; CHECK-NEXT:  (drop
  ;; CHECK-NEXT:   (if (result i32)
  ...
  ;; CHECK:      (func $if2drops-different (result i32)
  ;; CHECK-NEXT:  (if
  ;; CHECK-NEXT:   (call $if2drops)
  ;; CHECK-NEXT:   (drop
  ;; CHECK-NEXT:    (call $if2drops)
  ...
  ;; CHECK:      (func $if-const (param $x i32)
  ...
  ;; CHECK:      (func $drop-if-both-unreachable (param $0 i32)
  ;; CHECK-NEXT:  (block $out
  ;; CHECK-NEXT:   (drop
  ;; CHECK-NEXT:    (if (result i32)
  ...
  ;; CHECK:      (func $if-1-block (param $x i32)
  ;; CHECK-NEXT:  (block $out
  ;; CHECK-NEXT:   (if
  ;; CHECK-NEXT:    (local.get $x)
  ...
  ;; CHECK:      (func $block-resize-br-gone
  ;; CHECK-NEXT:  (block $out
  ;; CHECK-NEXT:   (block $in
  ...
  ;; CHECK:      (func $block-unreachable-but-last-element-concrete
  ...
  ;; CHECK:      (func $leave-block-even-if-br-not-taken (result f64)
  ...
  ;; CHECK:      (func $executed-if-in-block
  ;; CHECK-NEXT:  (unreachable)
  ;; CHECK-NEXT: )
  ...
  ;; CHECK:      (func $executed-if-in-block2
  ;; CHECK-NEXT:  (unreachable)
  ;; CHECK-NEXT: )
  ...
  ;; CHECK:      (func $executed-if-in-block3
  ...
  ;; CHECK:      (func $load-may-have-side-effects (result i32)
  ;; CHECK-NEXT:  (i64.ge_s
  ...
  ;; CHECK:      (func $unreachable-if-with-nop-arm-that-leaves-a-concrete-value-if-nop-is-removed
  ;; CHECK-NEXT:  (block $label$0
  ;; CHECK-NEXT:   (loop $label$1
  ;; CHECK-NEXT:    (drop
  ;; CHECK-NEXT:     (br_if $label$0
  ...
  ;; CHECK:      (func $if-arm-vanishes (result i32)
  ...
  ;; CHECK:      (func $if-arm-vanishes-2 (result i32)
  ;; CHECK-NEXT:  (block $label$0 (result i32)
  ;; CHECK-NEXT:   (br $label$0
  ;; CHECK-NEXT:    (i32.const 1)
  ;; CHECK-NEXT:   )
  ...
  ;; CHECK:      (func $nop-if-type-changes
...
(module ;; a child with a different type, cannot simply replace the parent with it
 ...
 ;; CHECK:      (func $1 (param $0 f32) (param $1 i32) (result i32)
 ;; CHECK-NEXT:  (drop
...
(module ;; vacuum away a drop on an if where both arms can be vacuumed
 ...
 ;; CHECK:      (func $_deflate (param $0 i32) (result i32)
 ...
 ;; CHECK:      (func $_deflateInit2_ (param $0 i32) (result i32)
 ...
 ;; CHECK:      (func $_deflateEnd (param $0 i32) (result i32)
...
;; CHECK:      (func $3 (param $0 i32) (param $1 i32) (param $2 i32)
