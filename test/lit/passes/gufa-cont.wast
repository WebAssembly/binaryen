...
(module
 ...
 ;; CHECK:      (type $5 (func (result i32 (ref $cont-i32))))

 ;; CHECK:      (elem declare func $cont $cont-i32)

 ;; CHECK:      (tag $tag (type $func))
 ;; OPEN_WORLD:      (type $4 (func (param i32)))

 ;; OPEN_WORLD:      (type $5 (func (result i32 (ref $cont-i32))))
 ...
 ;; CHECK:      (tag $tag-i32 (type $4) (param i32))
 ;; OPEN_WORLD:      (tag $tag-i32 (type $4) (param i32))
 ...
 ;; CHECK-NEXT:   (block $block (type $5) (result i32 (ref $cont-i32))
 ;; CHECK-NEXT:    (drop
 ...
 ;; OPEN_WORLD-NEXT:   (block $block (type $5) (result i32 (ref $cont-i32))
 ;; OPEN_WORLD-NEXT:    (drop
 ...
 (func $resume-i32 (export "resume-i32")
  ...
  (tuple.drop 2
   (block $block (result i32 (ref $cont-i32))
...
(module
 ...
 ;; CHECK:      (tag $tag (type $2) (result i32))
