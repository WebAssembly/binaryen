...
(module
 ...
 ;; CHECK-BIN-NEXT:  )
 ;; CHECK-BIN-NEXT: )
 ;; CHECK-BIN-NODEBUG:      (func $grow (type $0) (param $0 i32) (result i32)
 ...
 ;; CHECK-BIN-NEXT: )
 ;; CHECK-BIN-NODEBUG:      (func $current (type $1) (result i32)
