...
;; CHECK-BIN:      (import "env" "table" (table $table 256 funcref))

;; CHECK-BIN-NODEBUG:      (import "env" "memory" (memory $memory 256))

;; CHECK-BIN-NODEBUG:      (import "env" "table" (table $table 256 funcref))
