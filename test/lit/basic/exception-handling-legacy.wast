...
(module
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $simple-try-catch
  ;; CHECK-BIN-NEXT:  (try
  ;; CHECK-BIN-NEXT:   (do
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $try-catch-multivalue-tag
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $try-with-block-label
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $multiple-insts-within-try-and-catch-bodies
  ;; CHECK-BIN-NEXT:  (try
  ;; CHECK-BIN-NEXT:   (do
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $multiple-catches
  ;; CHECK-BIN-NEXT:  (try
  ;; CHECK-BIN-NEXT:   (do
  ;; CHECK-BIN-NEXT:    (throw $e-i32
  ;; CHECK-BIN-NEXT:     (i32.const 0)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $catch-and-catch-all-together
  ;; CHECK-BIN-NEXT:  (try
  ;; CHECK-BIN-NEXT:   (do
  ;; CHECK-BIN-NEXT:    (throw $e-i32
  ;; CHECK-BIN-NEXT:     (i32.const 0)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $nested-try-catch
  ;; CHECK-BIN-NEXT:  (try
  ;; CHECK-BIN-NEXT:   (do
  ;; CHECK-BIN-NEXT:    (try
  ;; CHECK-BIN-NEXT:     (do
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $catchless-delegateless-try
  ;; CHECK-BIN-NEXT:  (try
  ;; CHECK-BIN-NEXT:   (do
  ;; CHECK-BIN-NEXT:    (throw $e-i32
  ;; CHECK-BIN-NEXT:     (i32.const 0)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $inner-delegate-target-outer-catch
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $branch-and-delegate-target-same-try-label
  ;; CHECK-BIN-NEXT:  (block $block
  ;; CHECK-BIN-NEXT:   (try $label
  ;; CHECK-BIN-NEXT:    (do
  ;; CHECK-BIN-NEXT:     (try
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $inner-delegate-target-outer-delegate
  ;; CHECK-BIN-NEXT:  (try $label
  ;; CHECK-BIN-NEXT:   (do
  ;; CHECK-BIN-NEXT:    (try
  ;; CHECK-BIN-NEXT:     (do
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $empty-catch-body
  ;; CHECK-BIN-NEXT:  (try
  ;; CHECK-BIN-NEXT:   (do
  ;; CHECK-BIN-NEXT:   )
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $try-catch-rethrow
  ;; CHECK-BIN-NEXT:  (try $label
  ;; CHECK-BIN-NEXT:   (do
  ;; CHECK-BIN-NEXT:    (call $foo)
  ;; CHECK-BIN-NEXT:   )
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $branch-and-rethrow-target-same-try-label
  ;; CHECK-BIN-NEXT:  (block $block
  ;; CHECK-BIN-NEXT:   (try $label
  ;; CHECK-BIN-NEXT:    (do
  ;; CHECK-BIN-NEXT:     (call $foo)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $rnested-rethrow-with-interleaving-block
  ;; CHECK-BIN-NEXT:  (try $label
  ;; CHECK-BIN-NEXT:   (do
  ;; CHECK-BIN-NEXT:    (call $foo)
  ;; CHECK-BIN-NEXT:   )
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $rethrow-within-nested-try-part
  ;; CHECK-BIN-NEXT:  (try $label
  ;; CHECK-BIN-NEXT:   (do
  ;; CHECK-BIN-NEXT:    (call $foo)
  ;; CHECK-BIN-NEXT:   )
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $pop-within-if-condition
  ;; CHECK-BIN-NEXT:  (try
  ;; CHECK-BIN-NEXT:   (do
  ;; CHECK-BIN-NEXT:   )
  ;; CHECK-BIN-NEXT:   (catch $e-i32
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $pop-can-be-supertype
  ;; CHECK-BIN-NEXT:  (try
  ;; CHECK-BIN-NEXT:   (do
  ;; CHECK-BIN-NEXT:   )
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $catchless-try-with-inner-delegate
  ;; CHECK-BIN-NEXT:  (try $label
  ;; CHECK-BIN-NEXT:   (do
  ;; CHECK-BIN-NEXT:    (try
  ;; CHECK-BIN-NEXT:     (do
  ...
  ;; CHECK-TEXT-NEXT:  (nop)
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $nested-delegate-within-block
  ;; CHECK-BIN-NEXT:  (block
  ;; CHECK-BIN-NEXT:   (block
  ;; CHECK-BIN-NEXT:   )
  ;; CHECK-BIN-NEXT:   (try
