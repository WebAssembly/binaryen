...
(module
 ...
 ;; CHECK-BIN:      (func $f32.load_f16 (param $0 i32) (result f32)
 ...
 ;; CHECK-TEXT-NEXT:  )
 ;; CHECK-TEXT-NEXT: )
 ;; CHECK-BIN:      (func $f32.store_f16 (param $0 i32) (param $1 f32)
 ...
 ;; CHECK-TEXT-NEXT:  )
 ;; CHECK-TEXT-NEXT: )
 ;; CHECK-BIN:      (func $f16x8.splat (param $0 f32) (result v128)
 ...
 (func $f16x8.splat (param $0 f32) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.extract_lane (param $0 v128) (result f32)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.replace_lane (param $0 v128) (param $1 f32) (result v128)
 ...
 ;; CHECK-TEXT-NEXT:  )
 ;; CHECK-TEXT-NEXT: )
 ;; CHECK-BIN:      (func $f16x8.eq (param $0 v128) (param $1 v128) (result v128)
 ...
 ;; CHECK-TEXT-NEXT:  )
 ;; CHECK-TEXT-NEXT: )
 ;; CHECK-BIN:      (func $f16x8.ne (param $0 v128) (param $1 v128) (result v128)
 ...
 (func $f16x8.ne (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.lt (param $0 v128) (param $1 v128) (result v128)
  ...
  (f16x8.lt
   ...
   ;; CHECK-TEXT-NEXT:  )
   ;; CHECK-TEXT-NEXT: )
   ;; CHECK-BIN:      (func $f16x8.gt (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.le (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.ge (param $0 v128) (param $1 v128) (result v128)
 ...
 ;; CHECK-TEXT-NEXT:  )
 ;; CHECK-TEXT-NEXT: )
 ;; CHECK-BIN:      (func $f16x8.add (param $0 v128) (param $1 v128) (result v128)
 ...
 (func $f16x8.add (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.sub (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.mul (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.div (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.min (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.max (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.pmin (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.pmax (param $0 v128) (param $1 v128) (result v128)
 ...
 ;; CHECK-TEXT-NEXT:  )
 ;; CHECK-TEXT-NEXT: )
 ;; CHECK-BIN:      (func $f16x8.abs (param $0 v128) (result v128)
 ...
 (func $f16x8.abs (param $0 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.neg (param $0 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.sqrt (param $0 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.ceil (param $0 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.floor (param $0 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.trunc (param $0 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.nearest (param $0 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.relaxed_madd (param $0 v128) (param $1 v128) (param $2 v128) (result v128)
 ...
 ;; CHECK-TEXT-NEXT:  )
 ;; CHECK-TEXT-NEXT: )
 ;; CHECK-BIN:      (func $f16x8.relaxed_nmadd (param $0 v128) (param $1 v128) (param $2 v128) (result v128)
 ...
 ;; CHECK-TEXT-NEXT:  )
 ;; CHECK-TEXT-NEXT: )
 ;; CHECK-BIN:      (func $i16x8.trunc_sat_f16x8_s (param $0 v128) (result v128)
 ...
 ;; CHECK-TEXT-NEXT:  )
 ;; CHECK-TEXT-NEXT: )
 ;; CHECK-BIN:      (func $i16x8.trunc_sat_f16x8_u (param $0 v128) (result v128)
 ...
 ;; CHECK-TEXT-NEXT:  )
 ;; CHECK-TEXT-NEXT: )
 ;; CHECK-BIN:      (func $f16x8.convert_i16x8_s (param $0 v128) (result v128)
 ...
 ;; CHECK-TEXT-NEXT:  )
 ;; CHECK-TEXT-NEXT: )
 ;; CHECK-BIN:      (func $f16x8.convert_i16x8_u (param $0 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $0 (param $0 i32) (result f32)
;; CHECK-BIN-NODEBUG-NEXT:  (f32.load_f16
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $1 (param $0 i32) (param $1 f32)
...
;; CHECK-BIN-NODEBUG:      (func $2 (param $0 f32) (result v128)
;; CHECK-BIN-NODEBUG-NEXT:  (f16x8.splat
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $3 (param $0 v128) (result f32)
;; CHECK-BIN-NODEBUG-NEXT:  (f16x8.extract_lane 0
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $4 (param $0 v128) (param $1 f32) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $5 (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $6 (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $7 (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $8 (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $9 (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $10 (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $11 (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $12 (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $19 (param $0 v128) (result v128)
;; CHECK-BIN-NODEBUG-NEXT:  (f16x8.abs
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $20 (param $0 v128) (result v128)
;; CHECK-BIN-NODEBUG-NEXT:  (f16x8.neg
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $21 (param $0 v128) (result v128)
;; CHECK-BIN-NODEBUG-NEXT:  (f16x8.sqrt
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $22 (param $0 v128) (result v128)
;; CHECK-BIN-NODEBUG-NEXT:  (f16x8.ceil
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $23 (param $0 v128) (result v128)
;; CHECK-BIN-NODEBUG-NEXT:  (f16x8.floor
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $24 (param $0 v128) (result v128)
;; CHECK-BIN-NODEBUG-NEXT:  (f16x8.trunc
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $25 (param $0 v128) (result v128)
;; CHECK-BIN-NODEBUG-NEXT:  (f16x8.nearest
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $26 (param $0 v128) (param $1 v128) (param $2 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $27 (param $0 v128) (param $1 v128) (param $2 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $28 (param $0 v128) (result v128)
;; CHECK-BIN-NODEBUG-NEXT:  (i16x8.trunc_sat_f16x8_s
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $29 (param $0 v128) (result v128)
;; CHECK-BIN-NODEBUG-NEXT:  (i16x8.trunc_sat_f16x8_u
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $30 (param $0 v128) (result v128)
;; CHECK-BIN-NODEBUG-NEXT:  (f16x8.convert_i16x8_s
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $31 (param $0 v128) (result v128)
