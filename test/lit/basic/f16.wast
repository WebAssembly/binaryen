...
(module
 ...
 ;; CHECK-BIN:      (type $5 (func (param v128 v128) (result v128)))

 ;; CHECK-BIN:      (type $6 (func (param v128) (result v128)))

 ;; CHECK-BIN:      (type $7 (func (param v128 v128 v128) (result v128)))
 ...
 ;; CHECK-TEXT-NEXT:  )
 ;; CHECK-TEXT-NEXT: )
 ;; CHECK-BIN:      (func $f16x8.eq (type $5) (param $0 v128) (param $1 v128) (result v128)
 ...
 ;; CHECK-TEXT-NEXT:  )
 ;; CHECK-TEXT-NEXT: )
 ;; CHECK-BIN:      (func $f16x8.ne (type $5) (param $0 v128) (param $1 v128) (result v128)
 ...
 (func $f16x8.ne (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.lt (type $5) (param $0 v128) (param $1 v128) (result v128)
  ...
  (f16x8.lt
   ...
   ;; CHECK-TEXT-NEXT:  )
   ;; CHECK-TEXT-NEXT: )
   ;; CHECK-BIN:      (func $f16x8.gt (type $5) (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.le (type $5) (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.ge (type $5) (param $0 v128) (param $1 v128) (result v128)
 ...
 ;; CHECK-TEXT-NEXT:  )
 ;; CHECK-TEXT-NEXT: )
 ;; CHECK-BIN:      (func $f16x8.add (type $5) (param $0 v128) (param $1 v128) (result v128)
 ...
 (func $f16x8.add (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.sub (type $5) (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.mul (type $5) (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.div (type $5) (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.min (type $5) (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.max (type $5) (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.pmin (type $5) (param $0 v128) (param $1 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.pmax (type $5) (param $0 v128) (param $1 v128) (result v128)
 ...
 ;; CHECK-TEXT-NEXT:  )
 ;; CHECK-TEXT-NEXT: )
 ;; CHECK-BIN:      (func $f16x8.abs (type $6) (param $0 v128) (result v128)
 ...
 (func $f16x8.abs (param $0 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.neg (type $6) (param $0 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.sqrt (type $6) (param $0 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.ceil (type $6) (param $0 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.floor (type $6) (param $0 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.trunc (type $6) (param $0 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.nearest (type $6) (param $0 v128) (result v128)
  ...
  ;; CHECK-TEXT-NEXT:  )
  ;; CHECK-TEXT-NEXT: )
  ;; CHECK-BIN:      (func $f16x8.relaxed_madd (type $7) (param $0 v128) (param $1 v128) (param $2 v128) (result v128)
 ...
 ;; CHECK-TEXT-NEXT:  )
 ;; CHECK-TEXT-NEXT: )
 ;; CHECK-BIN:      (func $f16x8.relaxed_nmadd (type $7) (param $0 v128) (param $1 v128) (param $2 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (type $5 (func (param v128 v128) (result v128)))

;; CHECK-BIN-NODEBUG:      (type $6 (func (param v128) (result v128)))

;; CHECK-BIN-NODEBUG:      (type $7 (func (param v128 v128 v128) (result v128)))
...
;; CHECK-BIN-NODEBUG:      (func $5 (type $5) (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $6 (type $5) (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $7 (type $5) (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $8 (type $5) (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $9 (type $5) (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $10 (type $5) (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $11 (type $5) (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $12 (type $5) (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $13 (type $5) (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $14 (type $5) (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $15 (type $5) (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $16 (type $5) (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $17 (type $5) (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $18 (type $5) (param $0 v128) (param $1 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $19 (type $6) (param $0 v128) (result v128)
;; CHECK-BIN-NODEBUG-NEXT:  (f16x8.abs
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $20 (type $6) (param $0 v128) (result v128)
;; CHECK-BIN-NODEBUG-NEXT:  (f16x8.neg
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $21 (type $6) (param $0 v128) (result v128)
;; CHECK-BIN-NODEBUG-NEXT:  (f16x8.sqrt
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $22 (type $6) (param $0 v128) (result v128)
;; CHECK-BIN-NODEBUG-NEXT:  (f16x8.ceil
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $23 (type $6) (param $0 v128) (result v128)
;; CHECK-BIN-NODEBUG-NEXT:  (f16x8.floor
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $24 (type $6) (param $0 v128) (result v128)
;; CHECK-BIN-NODEBUG-NEXT:  (f16x8.trunc
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $25 (type $6) (param $0 v128) (result v128)
;; CHECK-BIN-NODEBUG-NEXT:  (f16x8.nearest
;; CHECK-BIN-NODEBUG-NEXT:   (local.get $0)
;; CHECK-BIN-NODEBUG-NEXT:  )
;; CHECK-BIN-NODEBUG-NEXT: )

;; CHECK-BIN-NODEBUG:      (func $26 (type $7) (param $0 v128) (param $1 v128) (param $2 v128) (result v128)
...
;; CHECK-BIN-NODEBUG:      (func $27 (type $7) (param $0 v128) (param $1 v128) (param $2 v128) (result v128)
