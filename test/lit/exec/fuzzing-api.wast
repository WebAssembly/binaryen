...
(module
 ...
 ;; CHECK-NEXT: [LoggingExternalInterface logging 1000]
 ;; CHECK-NEXT: [LoggingExternalInterface logging 1000]
 ;; CHECK-NEXT: [LoggingExternalInterface logging 1000]
 ;; CHECK-NEXT: [LoggingExternalInterface logging 1000]
 ;; CHECK-NEXT: [LoggingExternalInterface logging 1000]
 ...
 (func $ref.calling.illegal2 (export "ref.calling.illegal2") (result v128)
  ...
  ;; error happens *after* the call, so the first logging goes through. And
  ;; since we call ourselves recursively, we end up logging a lot, until we
  ;; trap on exhausting the stack. XXX a
  (call $log-i32
   (i32.const 1000)
  )
  (call $log-i32
