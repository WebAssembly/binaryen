...
(module
   ...
   ;; CHECK:      (tag $tag1 (type $0))

   ;; CHECK:      (tag $tag2 (type $0))

   ;; CHECK:      (tag $tag3 (type $0))
   ...
   ;; CHECK:      (export "tag3" (tag $tag3))

   ;; CHECK:      (export "func2" (func $func2_5))
...
;; CHECK:      (func $func (type $3) (param $x (ref $t))
;; CHECK-NEXT: )

;; CHECK:      (func $func2 (type $0)
;; CHECK-NEXT: )

;; CHECK:      (func $f3 (type $0)
;; CHECK-NEXT: )

;; CHECK:      (func $func2_5 (type $4) (param $0 (ref $u))
;; CHECK-NEXT: )
