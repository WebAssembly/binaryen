...
;; R--UN: wasm-merge %s first %s.second second 2>&1 | filecheck %s
...
;; conflicts.
;; RUN: wasm-merge %s first %s.second second --keep-only-first-module-exports -S -o - | filecheck %s --check-prefix KEEP_1
